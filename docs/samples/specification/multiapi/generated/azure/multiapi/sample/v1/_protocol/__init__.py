...
try:
    ...
    from ._preparers_py3 import prepare_test_lro_initial_request
    from ._preparers_py3 import prepare_test_lro_and_paging_initial_request
    ...
    from ._preparers import prepare_test_lro_initial_request  # type: ignore
    from ._preparers import prepare_test_lro_and_paging_initial_request  # type: ignore
...
__all__ = [
    ...
    'prepare_test_lro_initial_request',
    'prepare_test_lro_and_paging_initial_request',
