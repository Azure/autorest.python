...
class MultiapiServiceClientOperationsMixin(object):
    ...
    def begin_test_lro(
        ...
        **kwargs  # type: Any
        ...
        return mixin_instance.begin_test_lro(product=product, **kwargs)
    ...
    def begin_test_lro_and_paging(
        ...
        **kwargs  # type: Any
        ...
        mixin_instance._serialize.client_side_validation = False
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return mixin_instance.begin_test_lro_and_paging(client_request_id=client_request_id, test_lro_and_paging_options=test_lro_and_paging_options, **kwargs)
    ...
    def test_different_calls(
        ...
        **kwargs  # type: Any
        ...
        mixin_instance._serialize.client_side_validation = False
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return mixin_instance.test_different_calls(greeting_in_english=greeting_in_english, greeting_in_chinese=greeting_in_chinese, greeting_in_french=greeting_in_french, api_version=api_version, **kwargs)
    ...
    def test_one(
        ...
        **kwargs  # type: Any
        ...
        mixin_instance._serialize.client_side_validation = False
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return mixin_instance.test_one(id=id, message=message, api_version=api_version, **kwargs)
