...
class MultiapiServiceClient(MultiapiServiceClientOperationsMixin):
    ...
    :vartype operation_group_one: azure.multiapi.sample.v1.aio.operations.OperationGroupOneOperations
    ...
    async def _send_request(self, http_request: HttpRequest, **kwargs: Any) -> AsyncHttpResponse:
        ...
        >>> from azure.multiapi.sample.v1.rest import prepare_test_one
