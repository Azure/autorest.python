...
from ._polling_paging_example_operations import build_basic_paging_request, build_basic_polling_request_initial
...
class PollingPagingExampleOperationsMixin(object):
    ...
    def basic_paging(
        self,
        **kwargs: Any
    ) -> Iterable["_models.ProductResult"]:
