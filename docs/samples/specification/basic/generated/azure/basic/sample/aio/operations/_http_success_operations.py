...
class HttpSuccessOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        Instead, you should access the following operations through :class:`~azure.basic.sample.aio.AutoRestHeadTestService`'s
        :attr:`~azure.basic.sample.aio.AutoRestHeadTestService.http_success` attribute.
    """
