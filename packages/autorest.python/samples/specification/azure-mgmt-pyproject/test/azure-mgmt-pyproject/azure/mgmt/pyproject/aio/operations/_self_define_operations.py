...
from ...operations._self_define_operations import build_post_request
...
class SelfDefineOperations:
    ...
    @overload
    async def post(self, body: List[str], *, content_type: str = "application/json", **kwargs: Any) -> None:
    ...
    @overload
    async def post(self, body: IO[bytes], *, content_type: str = "application/json", **kwargs: Any) -> None:
        """Process list of strings.
    ...
    async def post(self, body: Union[List[str], IO[bytes]], **kwargs: Any) -> None:
        """Process list of strings.
