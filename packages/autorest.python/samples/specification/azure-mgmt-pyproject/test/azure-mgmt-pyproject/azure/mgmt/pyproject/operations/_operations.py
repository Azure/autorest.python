...
def build_list_request(**kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/self-define/post1")
...
class Operations:
    ...
    @overload
    def list(self, body: List[str], *, content_type: str = "application/json", **kwargs: Any) -> None:
    ...
    @overload
    def list(self, body: IO[bytes], *, content_type: str = "application/json", **kwargs: Any) -> None:
        """Process list of strings.
