...
class OperationGroup(BaseModel):
    ...
    def imports_for_multiapi(self, async_mode: bool, enable_special_import: bool = True) -> FileImport:
        file_import = FileImport()
        relative_path = ".." if async_mode else "."
        for operation in self.operations:
            file_import.merge(
                operation.imports_for_multiapi(async_mode, relative_path=relative_path, enable_special_import=enable_special_import)
            )
        if (
