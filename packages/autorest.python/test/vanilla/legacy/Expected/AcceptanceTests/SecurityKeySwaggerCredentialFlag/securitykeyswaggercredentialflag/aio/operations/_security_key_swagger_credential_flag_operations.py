...
class _SecurityKeySwaggerCredentialFlagOperationsMixin(  # pylint: disable=name-too-long
    ClientMixinABC[AsyncPipelineClient[HttpRequest, AsyncHttpResponse], SecurityKeySwaggerCredentialFlagConfiguration]
):
