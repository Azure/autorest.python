...
class MediaTypesClientOperationsMixin(MediaTypesClientMixinABC):
    ...
    async def analyze_body(
        ...
        :type input: ~internaloperation.models.SourcePath
    ...
    @distributed_trace_async
    async def _body_three_types(self, message: Union[Any, IO[AnyStr], str], **kwargs: Any) -> str:
        ...
        request = build_body_three_types_request(
            ...
            json=_json,
            content=_content,
            template_url=self._body_three_types.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    _body_three_types.metadata = {"url": "/mediatypes/bodyThreeTypes"}
