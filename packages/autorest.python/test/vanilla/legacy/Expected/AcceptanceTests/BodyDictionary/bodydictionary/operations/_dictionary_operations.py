...
class DictionaryOperations:  # pylint: disable=too-many-public-methods
    ...
    @distributed_trace
    def put_empty(  # pylint: disable=inconsistent-return-statements
        self, array_body: Union[Dict[str, str], IO[AnyStr]], **kwargs: Any
    ) -> None:
        """Set dictionary value empty {}.
    ...
    @distributed_trace
    def put_boolean_tfft(  # pylint: disable=inconsistent-return-statements
        self, array_body: Union[Dict[str, bool], IO[AnyStr]], **kwargs: Any
    ) -> None:
        """Set dictionary value empty {"0": true, "1": false, "2": false, "3": true }.

        :param array_body: Is either a {str: bool} type or a IO[AnyStr] type. Required.
    ...
    @distributed_trace
    def put_integer_valid(  # pylint: disable=inconsistent-return-statements
        self, array_body: Union[Dict[str, int], IO[AnyStr]], **kwargs: Any
    ) -> None:
        """Set dictionary value empty {"0": 1, "1": -1, "2": 3, "3": 300}.

        :param array_body: Is either a {str: int} type or a IO[AnyStr] type. Required.
    ...
    @distributed_trace
    def put_float_valid(  # pylint: disable=inconsistent-return-statements
        self, array_body: Union[Dict[str, float], IO[AnyStr]], **kwargs: Any
    ) -> None:
        """Set dictionary value {"0": 0, "1": -0.01, "2": 1.2e20}.

        :param array_body: Is either a {str: float} type or a IO[AnyStr] type. Required.
    ...
    @distributed_trace
    def put_date_valid(  # pylint: disable=inconsistent-return-statements
        self, array_body: Union[Dict[str, datetime.date], IO[AnyStr]], **kwargs: Any
    ) -> None:
        """Set dictionary value  {"0": "2000-12-01", "1": "1980-01-02", "2": "1492-10-12"}.

        :param array_body: Is either a {str: datetime.date} type or a IO[AnyStr] type. Required.
    ...
    @distributed_trace
    def put_date_time_valid(  # pylint: disable=inconsistent-return-statements
        self, array_body: Union[Dict[str, datetime.datetime], IO[AnyStr]], **kwargs: Any
    ) -> None:
        """Set dictionary value  {"0": "2000-12-01t00:00:01z", "1": "1980-01-02T00:11:35+01:00", "2":
        "1492-10-12T10:15:01-08:00"}.

        :param array_body: Is either a {str: datetime.datetime} type or a IO[AnyStr] type. Required.
    ...
    @distributed_trace
    def put_duration_valid(  # pylint: disable=inconsistent-return-statements
        self, array_body: Union[Dict[str, datetime.timedelta], IO[AnyStr]], **kwargs: Any
    ) -> None:
        """Set dictionary value  {"0": "P123DT22H14M12.011S", "1": "P5DT1H0M0S"}.

        :param array_body: Is either a {str: datetime.timedelta} type or a IO[AnyStr] type. Required.
    ...
    @distributed_trace
    def put_byte_valid(  # pylint: disable=inconsistent-return-statements
        self, array_body: Union[Dict[str, bytes], IO[AnyStr]], **kwargs: Any
    ) -> None:
        """Put the dictionary value {"0": hex(FF FF FF FA), "1": hex(01 02 03), "2": hex (25, 29, 43)}
        with each elementencoded in base 64.

        :param array_body: Is either a {str: bytes} type or a IO[AnyStr] type. Required.
    ...
    @distributed_trace
    def put_complex_valid(  # pylint: disable=inconsistent-return-statements
        self, array_body: Union[Dict[str, _models.Widget], IO[AnyStr]], **kwargs: Any
    ) -> None:
        """Put an dictionary of complex type with values {"0": {"integer": 1, "string": "2"}, "1":
        {"integer": 3, "string": "4"}, "2": {"integer": 5, "string": "6"}}.

        :param array_body: Is either a {str: Widget} type or a IO[AnyStr] type. Required.
    ...
    @distributed_trace
    def put_array_valid(  # pylint: disable=inconsistent-return-statements
        self, array_body: Union[Dict[str, List[str]], IO[AnyStr]], **kwargs: Any
    ) -> None:
        """Put An array of array of strings {"0": ["1", "2", "3"], "1": ["4", "5", "6"], "2": ["7", "8",
        "9"]}.
    ...
    @distributed_trace
    def put_dictionary_valid(  # pylint: disable=inconsistent-return-statements
        self, array_body: Union[Dict[str, Dict[str, str]], IO[AnyStr]], **kwargs: Any
    ) -> None:
        """Get an dictionaries of dictionaries of type <string, string> with value {"0": {"1": "one", "2":
        "two", "3": "three"}, "1": {"4": "four", "5": "five", "6": "six"}, "2": {"7": "seven", "8":
        "eight", "9": "nine"}}.

        :param array_body: Is either a {str: {str: str}} type or a IO[AnyStr] type. Required.
