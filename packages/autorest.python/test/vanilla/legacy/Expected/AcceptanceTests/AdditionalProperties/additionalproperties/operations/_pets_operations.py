...
class PetsOperations:
    ...
    @distributed_trace
    def create_ap_true(self, create_parameters: Union[_models.PetAPTrue, JSON, IO], **kwargs: Any) -> _models.PetAPTrue:
        """Create a Pet which contains more properties than what is defined.

        :param create_parameters: Is one of the following types: model, JSON, IO Required.
        :type create_parameters: ~additionalproperties.models.PetAPTrue or JSON or IO
    ...
    @distributed_trace
    def create_cat_ap_true(
        self, create_parameters: Union[_models.CatAPTrue, JSON, IO], **kwargs: Any
    ) -> _models.CatAPTrue:
        """Create a CatAPTrue which contains more properties than what is defined.

        :param create_parameters: Is one of the following types: model, JSON, IO Required.
        :type create_parameters: ~additionalproperties.models.CatAPTrue or JSON or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    @distributed_trace
    def create_ap_object(
        self, create_parameters: Union[_models.PetAPObject, JSON, IO], **kwargs: Any
    ) -> _models.PetAPObject:
        """Create a Pet which contains more properties than what is defined.

        :param create_parameters: Is one of the following types: model, JSON, IO Required.
        :type create_parameters: ~additionalproperties.models.PetAPObject or JSON or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    @distributed_trace
    def create_ap_string(
        self, create_parameters: Union[_models.PetAPString, JSON, IO], **kwargs: Any
    ) -> _models.PetAPString:
        """Create a Pet which contains more properties than what is defined.

        :param create_parameters: Is one of the following types: model, JSON, IO Required.
        :type create_parameters: ~additionalproperties.models.PetAPString or JSON or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    @distributed_trace
    def create_ap_in_properties(
        self, create_parameters: Union[_models.PetAPInProperties, JSON, IO], **kwargs: Any
    ) -> _models.PetAPInProperties:
        """Create a Pet which contains more properties than what is defined.

        :param create_parameters: Is one of the following types: model, JSON, IO Required.
        :type create_parameters: ~additionalproperties.models.PetAPInProperties or JSON or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    @distributed_trace
    def create_ap_in_properties_with_ap_string(
        self, create_parameters: Union[_models.PetAPInPropertiesWithAPString, JSON, IO], **kwargs: Any
    ) -> _models.PetAPInPropertiesWithAPString:
        """Create a Pet which contains more properties than what is defined.

        :param create_parameters: Is one of the following types: model, JSON, IO Required.
        :type create_parameters: ~additionalproperties.models.PetAPInPropertiesWithAPString or JSON or
         IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
