...
def build_create_ap_true_request(*, json: _models.PetAPTrue, **kwargs: Any) -> HttpRequest:
...
def build_create_cat_ap_true_request(*, json: _models.CatAPTrue, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_create_ap_object_request(*, json: _models.PetAPObject, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_create_ap_string_request(*, json: _models.PetAPString, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_create_ap_in_properties_request(*, json: _models.PetAPInProperties, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_create_ap_in_properties_with_ap_string_request(
    *, json: _models.PetAPInPropertiesWithAPString, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class PetsOperations:
    ...
    @distributed_trace
    def create_ap_true(self, create_parameters: _models.PetAPTrue, **kwargs: Any) -> _models.PetAPTrue:
    ...
    @distributed_trace
    def create_cat_ap_true(self, create_parameters: _models.CatAPTrue, **kwargs: Any) -> _models.CatAPTrue:
    ...
    @distributed_trace
    def create_ap_object(self, create_parameters: _models.PetAPObject, **kwargs: Any) -> _models.PetAPObject:
        """Create a Pet which contains more properties than what is defined.
    ...
    @distributed_trace
    def create_ap_string(self, create_parameters: _models.PetAPString, **kwargs: Any) -> _models.PetAPString:
        """Create a Pet which contains more properties than what is defined.
