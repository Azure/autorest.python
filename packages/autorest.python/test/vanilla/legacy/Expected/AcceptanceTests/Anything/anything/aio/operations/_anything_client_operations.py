...
class AnythingClientOperationsMixin(AnythingClientMixinABC):
    ...
    async def get_object(self, **kwargs: Any) -> JSON:
    ...
    @distributed_trace_async
    async def put_object(self, input: JSON, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
    ...
    @distributed_trace_async
    async def put_string(self, input: JSON, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
    ...
    @distributed_trace_async
    async def get_array(self, **kwargs: Any) -> JSON:
    ...
    @distributed_trace_async
    async def put_array(self, input: JSON, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
