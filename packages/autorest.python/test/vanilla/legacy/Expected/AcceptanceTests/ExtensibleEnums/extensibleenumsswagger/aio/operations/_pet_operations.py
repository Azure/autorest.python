...
class PetOperations:
    ...
    @distributed_trace_async
    async def add_pet(self, pet_param: Optional[Union[_models.Pet, JSON, IO]] = None, **kwargs: Any) -> _models.Pet:
        """add pet.

        :param pet_param: pet param. Is one of the following types: model, JSON, IO Default value is
         None.
        :type pet_param: ~extensibleenumsswagger.models.Pet or JSON or IO
