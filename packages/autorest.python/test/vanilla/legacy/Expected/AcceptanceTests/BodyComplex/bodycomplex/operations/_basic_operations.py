...
class BasicOperations:
    ...
    def get_valid(self, **kwargs: Any) -> _models.Basic:
        ...
        deserialized = self._deserialize("Basic", pipeline_response.http_response)
    ...
    @overload
    def put_valid(self, complex_body: _models.Basic, *, content_type: str = "application/json", **kwargs: Any) -> None:
