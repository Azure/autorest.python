...
class MultipleInheritanceServiceClientOperationsMixin(MultipleInheritanceServiceClientMixinABC):
    ...
    @distributed_trace_async
    async def put_horse(self, horse: Union[_models.Horse, JSON, IO], **kwargs: Any) -> str:
        """Put a horse with name 'General' and isAShowHorse false.

        :param horse: Put a horse with name 'General' and isAShowHorse false. Is one of the following
         types: model, JSON, IO Required.
        :type horse: ~multipleinheritance.models.Horse or JSON or IO
    ...
    @distributed_trace_async
    async def put_feline(self, feline: Union[_models.Feline, JSON, IO], **kwargs: Any) -> str:
        """Put a feline who hisses and doesn't meow.

        :param feline: Put a feline who hisses and doesn't meow. Is one of the following types: model,
         JSON, IO Required.
        :type feline: ~multipleinheritance.models.Feline or JSON or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    @distributed_trace_async
    async def put_cat(self, cat: Union[_models.Cat, JSON, IO], **kwargs: Any) -> str:
        """Put a cat with name 'Boots' where likesMilk and hisses is false, meows is true.
        ...
        :type cat: ~multipleinheritance.models.Cat or JSON or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    @distributed_trace_async
    async def put_kitten(self, kitten: Union[_models.Kitten, JSON, IO], **kwargs: Any) -> str:
        """Put a kitten with name 'Kitty' where likesMilk and hisses is false, meows and eatsMiceYet is
        true.

        :param kitten: Put a kitten with name 'Kitty' where likesMilk and hisses is false, meows and
         eatsMiceYet is true. Is one of the following types: model, JSON, IO Required.
        :type kitten: ~multipleinheritance.models.Kitten or JSON or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
