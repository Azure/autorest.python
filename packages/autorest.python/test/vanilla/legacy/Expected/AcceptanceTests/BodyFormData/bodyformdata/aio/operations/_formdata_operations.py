...
# --------------------------------------------------------------------------
from typing import Any, AnyStr, AsyncIterator, Callable, Dict, IO, List, Optional, TypeVar
...
class FormdataOperations:
    ...
    async def upload_file(self, file_content: IO[AnyStr], file_name: str, **kwargs: Any) -> AsyncIterator[bytes]:
        """Upload file.
    ...
    @distributed_trace_async
    async def upload_file_via_body(self, file_content: IO[AnyStr], **kwargs: Any) -> AsyncIterator[bytes]:
        """Upload file.
    ...
    @distributed_trace_async
    async def upload_files(self, file_content: List[IO[AnyStr]], **kwargs: Any) -> AsyncIterator[bytes]:
