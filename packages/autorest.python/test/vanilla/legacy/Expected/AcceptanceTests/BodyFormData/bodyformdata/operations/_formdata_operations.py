...
# --------------------------------------------------------------------------
from typing import Any, AnyStr, Callable, Dict, IO, Iterator, List, Optional, TypeVar
...
def build_upload_file_via_body_request(*, content: IO[AnyStr], **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class FormdataOperations:
    ...
    @distributed_trace
    def upload_file(self, file_content: IO[AnyStr], file_name: str, **kwargs: Any) -> Iterator[bytes]:
        """Upload file.
    ...
    @distributed_trace
    def upload_file_via_body(self, file_content: IO[AnyStr], **kwargs: Any) -> Iterator[bytes]:
        """Upload file.
    ...
    @distributed_trace
    def upload_files(self, file_content: List[IO[AnyStr]], **kwargs: Any) -> Iterator[bytes]:
