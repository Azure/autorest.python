...
class AutoRestComplexTestServiceConfiguration:  # pylint: disable=too-many-instance-attributes,name-too-long
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        kwargs.setdefault(
            "sdk_moniker", "autorestcomplextestservice/{}".format(VERSION)
        )
