...
class AutoRestRFC1123DateTimeTestServiceConfiguration:  # pylint: disable=too-many-instance-attributes,name-too-long
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        kwargs.setdefault(
            "sdk_moniker", "autorestrfc1123datetimetestservice/{}".format(VERSION)
        )
