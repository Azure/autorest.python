...
class Helpers:
    @staticmethod
    def _operation_with_data_param_request(
        ...
        return HttpRequest(
            method="PUT", url=_url, headers=_headers, data=data, params=_params
        )

    @staticmethod
    def _operation_with_data_param_deserialize(
        pipeline_response: PipelineResponse, **kwargs
    ) -> Any:
    ...
    @staticmethod
    def _operation_with_files_param_request(
        *, files: Dict[str, Any], **kwargs: Any
    ) -> HttpRequest:
        _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
        _params = kwargs.pop("params", {}) or {}
        ...
        return HttpRequest(
            method="PUT", url=_url, headers=_headers, files=files, params=_params
        )

    @staticmethod
    def _operation_with_files_param_deserialize(
        pipeline_response: PipelineResponse, **kwargs
    ) -> Any:
        cls = kwargs.pop("cls", None)
