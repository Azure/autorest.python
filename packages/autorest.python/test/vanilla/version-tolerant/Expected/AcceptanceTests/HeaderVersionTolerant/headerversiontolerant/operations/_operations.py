...
def build_header_param_existing_key_request(
    *, user_agent_parameter: str, **kwargs: Any
) -> HttpRequest:
    ...
    # Construct headers
    _headers["User-Agent"] = _SERIALIZER.header(
...
def build_header_param_integer_request(
    *, scenario: str, value: int, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_header_param_float_request(
    *, scenario: str, value: float, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_header_param_bool_request(
    *, scenario: str, value: bool, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_header_param_string_request(
    *, scenario: str, value: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_header_param_date_request(
    *, scenario: str, value: datetime.date, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_header_param_datetime_request(
    *, scenario: str, value: datetime.datetime, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_header_param_duration_request(
    *, scenario: str, value: datetime.timedelta, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_header_param_byte_request(
    *, scenario: str, value: bytes, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class HeaderOperations:  # pylint: disable=too-many-public-methods
    ...
    def param_existing_key(  # pylint: disable=inconsistent-return-statements
        ...
        _request = build_header_param_existing_key_request(
    ...
    def response_existing_key(
        ...
        _request = build_header_response_existing_key_request(
            headers=_headers,
            params=_params,
        )
        _request.url = self._client.format_url(_request.url)
        ...
        response_headers = {}
        response_headers["User-Agent"] = self._deserialize(
            "str", response.headers.get("User-Agent")
        )
    ...
    def param_protected_key(
        ...
        _request = build_header_param_protected_key_request(
    ...
    def response_protected_key(
        ...
        _request = build_header_response_protected_key_request(
            headers=_headers,
            params=_params,
        )
        _request.url = self._client.format_url(_request.url)
    ...
    def param_integer(  # pylint: disable=inconsistent-return-statements
        ...
        _request = build_header_param_integer_request(
            scenario=scenario,
            value=value,
            headers=_headers,
            params=_params,
    ...
    def response_integer(  # pylint: disable=inconsistent-return-statements
        ...
        _request = build_header_response_integer_request(
            scenario=scenario,
            headers=_headers,
            params=_params,
        )
        ...
        response_headers = {}
        response_headers["value"] = self._deserialize(
            "int", response.headers.get("value")
        )
    ...
    def param_long(  # pylint: disable=inconsistent-return-statements
        ...
        _request = build_header_param_long_request(
            scenario=scenario,
            value=value,
            headers=_headers,
            params=_params,
    ...
    def response_long(
        ...
        _request = build_header_response_long_request(
            scenario=scenario,
            headers=_headers,
            params=_params,
        )
    ...
    def param_float(  # pylint: disable=inconsistent-return-statements
        ...
        _request = build_header_param_float_request(
            scenario=scenario,
            value=value,
            headers=_headers,
            params=_params,
    ...
    def response_float(
        ...
        _request = build_header_response_float_request(
            scenario=scenario,
            headers=_headers,
            params=_params,
        )
        ...
        response_headers = {}
        response_headers["value"] = self._deserialize(
            "float", response.headers.get("value")
        )
    ...
    def param_double(  # pylint: disable=inconsistent-return-statements
        ...
        _request = build_header_param_double_request(
            scenario=scenario,
            value=value,
            headers=_headers,
            params=_params,
    ...
    def response_double(  # pylint: disable=inconsistent-return-statements
        ...
        _request = build_header_response_double_request(
            scenario=scenario,
            headers=_headers,
            params=_params,
        )
    ...
    def param_bool(  # pylint: disable=inconsistent-return-statements
        ...
        _request = build_header_param_bool_request(
            scenario=scenario,
            value=value,
            headers=_headers,
            params=_params,
    ...
    def response_bool(
        ...
        _request = build_header_response_bool_request(
            scenario=scenario,
            headers=_headers,
            params=_params,
        )
        ...
        response_headers = {}
        response_headers["value"] = self._deserialize(
            "bool", response.headers.get("value")
        )
    ...
    def param_string(  # pylint: disable=inconsistent-return-statements
        ...
        _request = build_header_param_string_request(
            scenario=scenario,
            value=value,
            headers=_headers,
            params=_params,
    ...
    def response_string(  # pylint: disable=inconsistent-return-statements
        ...
        _request = build_header_response_string_request(
            scenario=scenario,
            headers=_headers,
            params=_params,
        )
        ...
        response_headers = {}
        response_headers["value"] = self._deserialize(
            "str", response.headers.get("value")
        )
    ...
    def param_date(  # pylint: disable=inconsistent-return-statements
        ...
        _request = build_header_param_date_request(
            scenario=scenario,
            value=value,
            headers=_headers,
            params=_params,
    ...
    def response_date(
        ...
        _request = build_header_response_date_request(
            scenario=scenario,
            headers=_headers,
            params=_params,
        )
        ...
        response_headers = {}
        response_headers["value"] = self._deserialize(
            "date", response.headers.get("value")
        )
    ...
    def param_datetime(  # pylint: disable=inconsistent-return-statements
        ...
        _request = build_header_param_datetime_request(
            scenario=scenario,
            value=value,
            headers=_headers,
            params=_params,
    ...
    def response_datetime(  # pylint: disable=inconsistent-return-statements
        ...
        _request = build_header_response_datetime_request(
            scenario=scenario,
            headers=_headers,
            params=_params,
        )
        ...
        response_headers = {}
        response_headers["value"] = self._deserialize(
            "iso-8601", response.headers.get("value")
        )
    ...
    def param_datetime_rfc1123(  # pylint: disable=inconsistent-return-statements
        ...
        _request = build_header_param_datetime_rfc1123_request(
            scenario=scenario,
            value=value,
            headers=_headers,
            params=_params,
    ...
    def response_datetime_rfc1123(  # pylint: disable=inconsistent-return-statements
        ...
        _request = build_header_response_datetime_rfc1123_request(
            scenario=scenario,
            headers=_headers,
            params=_params,
        )
        ...
        response_headers = {}
        response_headers["value"] = self._deserialize(
            "rfc-1123", response.headers.get("value")
        )
    ...
    def param_duration(  # pylint: disable=inconsistent-return-statements
        ...
        _request = build_header_param_duration_request(
            scenario=scenario,
            value=value,
            headers=_headers,
            params=_params,
    ...
    def response_duration(  # pylint: disable=inconsistent-return-statements
        ...
        _request = build_header_response_duration_request(
            scenario=scenario,
            headers=_headers,
            params=_params,
        )
        ...
        response_headers = {}
        response_headers["value"] = self._deserialize(
            "duration", response.headers.get("value")
        )
    ...
    def param_byte(  # pylint: disable=inconsistent-return-statements
        ...
        _request = build_header_param_byte_request(
            scenario=scenario,
            value=value,
            headers=_headers,
            params=_params,
    ...
    def response_byte(
        ...
        _request = build_header_response_byte_request(
            scenario=scenario,
            headers=_headers,
            params=_params,
        )
        ...
        response_headers = {}
        response_headers["value"] = self._deserialize(
            "bytearray", response.headers.get("value")
        )
    ...
    def param_enum(  # pylint: disable=inconsistent-return-statements
        ...
        _request = build_header_param_enum_request(
            scenario=scenario,
            value=value,
            headers=_headers,
            params=_params,
    ...
    def response_enum(
        ...
        _request = build_header_response_enum_request(
            scenario=scenario,
            headers=_headers,
            params=_params,
        )
    ...
    def custom_request_id(
        ...
        _request = build_header_custom_request_id_request(
            headers=_headers,
            params=_params,
        )
        _request.url = self._client.format_url(_request.url)
