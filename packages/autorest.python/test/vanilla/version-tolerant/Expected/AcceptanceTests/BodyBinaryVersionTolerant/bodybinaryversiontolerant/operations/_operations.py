...
# --------------------------------------------------------------------------
from typing import Any, AnyStr, Callable, Dict, IO, Iterator, Optional, TypeVar, cast
...
def build_upload_file_request(*, content: IO[AnyStr], **kwargs: Any) -> HttpRequest:
...
def build_upload_binary_request(*, content: IO[AnyStr], **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class UploadOperations:
    ...
    @distributed_trace
    def file(self, file_param: IO[AnyStr], **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        """Uploading json file.
    ...
    @distributed_trace
    def binary(self, file_param: IO[AnyStr], **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
