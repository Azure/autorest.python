...
# --------------------------------------------------------------------------
from typing import Any, AnyStr, AsyncIterator, Callable, Dict, IO, Optional, TypeVar, cast
...
class UploadOperations:
    ...
    async def file(  # pylint: disable=inconsistent-return-statements
        self, file_param: IO[AnyStr], **kwargs: Any
    ) -> None:
        """Uploading json file.
...
class DownloadOperations:
    ...
    async def error_stream(self, **kwargs: Any) -> AsyncIterator[bytes]:
        ...
        request = build_download_error_stream_request(
            headers=_headers,
            params=_params,
        )
        request.url = self._client.format_url(request.url)
