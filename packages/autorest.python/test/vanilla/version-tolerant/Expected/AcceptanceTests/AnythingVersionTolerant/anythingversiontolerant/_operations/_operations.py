...
def build_anything_put_object_request(*, json: JSON, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_anything_put_string_request(*, json: JSON, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_anything_put_array_request(*, json: JSON, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class AnythingClientOperationsMixin(AnythingClientMixinABC):
    @distributed_trace
    def get_object(self, **kwargs: Any) -> JSON:
    ...
    @distributed_trace
    def put_object(self, input: JSON, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
    ...
    @distributed_trace
    def put_string(self, input: JSON, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
    ...
    @distributed_trace
    def get_array(self, **kwargs: Any) -> JSON:
    ...
    @distributed_trace
    def put_array(self, input: JSON, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
