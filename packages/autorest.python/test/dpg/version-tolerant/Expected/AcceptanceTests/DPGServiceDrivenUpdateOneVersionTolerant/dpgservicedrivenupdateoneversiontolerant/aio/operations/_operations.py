...
class ParamsOperations:
    ...
    @overload
    async def post_parameters(self, parameter: IO[bytes], *, content_type: str = "image/jpeg", **kwargs: Any) -> JSON:
        """POST a JSON or a JPEG.
    ...
    async def delete_parameters(self, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        ...
        _request = build_params_delete_parameters_request(
            headers=_headers,
            params=_params,
        )
        _request.url = self._client.format_url(_request.url)
    ...
    async def get_new_operation(self, **kwargs: Any) -> JSON:
        ...
        _request = build_params_get_new_operation_request(
            headers=_headers,
            params=_params,
        )
        _request.url = self._client.format_url(_request.url)
