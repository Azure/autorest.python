...
class DPGClientOperationsMixin(DPGClientMixinABC):
    ...
    @distributed_trace_async
    async def post_model(self, mode: str, input: Union[_models.Input, JSON, IO], **kwargs: Any) -> _models.Product:
        """Post either raw response as a model and pass in 'raw' for mode, or grow up your operation to
        take a model instead, and put in 'model' as mode.
        ...
        :param input: Please put {'hello': 'world!'}. Is one of the following types: model, JSON, IO
         Required.
        :type input: ~dpgtestmodelsversiontolerant.models.Input or JSON or IO
