...
class PagingOperations:  # pylint: disable=too-many-public-methods
    ...
    @distributed_trace
    def get_empty_next_link_name_pages(self, **kwargs: Any) -> AsyncIterable[JSON]:
    ...
    async def begin_get_multiple_pages_lro(
        ...
        if cont_token:
            return AsyncCustomPoller[AsyncIterable[JSON]].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncCustomPoller[AsyncIterable[JSON]](self._client, raw_result, get_long_running_output, polling_method)  # type: ignore
