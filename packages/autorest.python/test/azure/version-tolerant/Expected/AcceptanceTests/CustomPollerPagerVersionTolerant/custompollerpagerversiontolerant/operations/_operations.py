...
class PagingOperations:  # pylint: disable=too-many-public-methods
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._config: AutoRestPagingTestServiceConfiguration = input_args.pop(0) if input_args else kwargs.pop("config")
    ...
    def get_no_item_name_pages(self, **kwargs: Any) -> Iterable[JSON]:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_paging_get_no_item_name_pages_request(
                    headers=_headers,
                    params=_params,
                )
    ...
    def get_empty_next_link_name_pages(self, **kwargs: Any) -> Iterable[JSON]:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_paging_get_empty_next_link_name_pages_request(
                    headers=_headers,
                    params=_params,
                )
                _request.url = self._client.format_url(_request.url)
    ...
    def get_null_next_link_name_pages(self, **kwargs: Any) -> Iterable[JSON]:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_paging_get_null_next_link_name_pages_request(
                    headers=_headers,
                    params=_params,
                )
                _request.url = self._client.format_url(_request.url)
    ...
    def get_single_pages(self, **kwargs: Any) -> Iterable[JSON]:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_paging_get_single_pages_request(
                    headers=_headers,
                    params=_params,
                )
                _request.url = self._client.format_url(_request.url)
    ...
    def get_single_pages_with_body_params(self, parameters: Union[JSON, IO[bytes]], **kwargs: Any) -> Iterable[JSON]:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_paging_get_single_pages_with_body_params_request(
    ...
    def first_response_empty(self, **kwargs: Any) -> Iterable[JSON]:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_paging_first_response_empty_request(
                    headers=_headers,
                    params=_params,
                )
                _request.url = self._client.format_url(_request.url)
    ...
    def get_multiple_pages(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_paging_get_multiple_pages_request(
    ...
    def get_with_query_params(self, *, required_query_parameter: int, **kwargs: Any) -> Iterable[JSON]:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_paging_get_with_query_params_request(
                ...
                _request = build_paging_next_operation_with_query_params_request(
                    query_constant=query_constant,
                    headers=_headers,
                    params=_params,
                )
    ...
    def duplicate_params(self, *, filter: Optional[str] = None, **kwargs: Any) -> Iterable[JSON]:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_paging_duplicate_params_request(
                    filter=filter,
                    headers=_headers,
                    params=_params,
                )
    ...
    def page_with_max_page_size(self, **kwargs: Any) -> Iterable[JSON]:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_paging_page_with_max_page_size_request(
    ...
    def get_odata_multiple_pages(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_paging_get_odata_multiple_pages_request(
                    maxresults=maxresults,
                    timeout=timeout,
                    headers=_headers,
                    params=_params,
    ...
    def get_multiple_pages_with_offset(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_paging_get_multiple_pages_with_offset_request(
                    offset=offset,
                    maxresults=maxresults,
                    timeout=timeout,
                    headers=_headers,
    ...
    def get_multiple_pages_retry_first(self, **kwargs: Any) -> Iterable[JSON]:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_paging_get_multiple_pages_retry_first_request(
                    headers=_headers,
                    params=_params,
                )
                _request.url = self._client.format_url(_request.url)
    ...
    def get_multiple_pages_retry_second(self, **kwargs: Any) -> Iterable[JSON]:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_paging_get_multiple_pages_retry_second_request(
                    headers=_headers,
                    params=_params,
                )
                _request.url = self._client.format_url(_request.url)
    ...
    def get_single_pages_failure(self, **kwargs: Any) -> Iterable[JSON]:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_paging_get_single_pages_failure_request(
                    headers=_headers,
                    params=_params,
                )
                _request.url = self._client.format_url(_request.url)
    ...
    def get_multiple_pages_failure(self, **kwargs: Any) -> Iterable[JSON]:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_paging_get_multiple_pages_failure_request(
                    headers=_headers,
                    params=_params,
                )
                _request.url = self._client.format_url(_request.url)
    ...
    def get_multiple_pages_failure_uri(self, **kwargs: Any) -> Iterable[JSON]:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_paging_get_multiple_pages_failure_uri_request(
                    headers=_headers,
                    params=_params,
                )
                _request.url = self._client.format_url(_request.url)
    ...
    def get_multiple_pages_fragment_next_link(self, tenant: str, *, api_version: str, **kwargs: Any) -> Iterable[JSON]:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_paging_get_multiple_pages_fragment_next_link_request(
                    tenant=tenant,
                ...
                _request = build_paging_next_fragment_request(
                    tenant=tenant,
                    next_link=next_link,
                    api_version=api_version,
                    headers=_headers,
    ...
    def get_multiple_pages_fragment_with_grouping_next_link(  # pylint: disable=name-too-long
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_paging_get_multiple_pages_fragment_with_grouping_next_link_request(
                    tenant=tenant,
                    api_version=api_version,
                    headers=_headers,
                    params=_params,
                ...
                _request = build_paging_next_fragment_with_grouping_request(
                    tenant=tenant,
                    next_link=next_link,
                    api_version=api_version,
                    headers=_headers,
    ...
    def append_api_version(self, **kwargs: Any) -> Iterable[JSON]:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_paging_append_api_version_request(
    ...
    def replace_api_version(self, **kwargs: Any) -> Iterable[JSON]:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_paging_replace_api_version_request(
                    api_version=self._config.api_version,
                    headers=_headers,
                    params=_params,
                )
    ...
    def get_paging_model_with_item_name_with_xms_client_name(  # pylint: disable=name-too-long
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_paging_get_paging_model_with_item_name_with_xms_client_name_request(
                    headers=_headers,
                    params=_params,
                )
                _request.url = self._client.format_url(_request.url)
