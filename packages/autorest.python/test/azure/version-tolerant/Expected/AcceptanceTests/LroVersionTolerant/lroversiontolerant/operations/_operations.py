...
class LROsOperations:  # pylint: disable=too-many-public-methods
    ...
    def begin_patch200_succeeded_ignore_headers(
        ...
        :param product: Product to patch. Is either a JSON type or a IO[AnyStr] type. Default value is
         None.
        :type product: JSON or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
    ...
    def _put201_succeeded_initial(self, product: Optional[Union[JSON, IO[AnyStr]]] = None, **kwargs: Any) -> JSON:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    def _put202_retry200_initial(self, product: Optional[Union[JSON, IO[AnyStr]]] = None, **kwargs: Any) -> JSON:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    def _put_no_header_in_retry_initial(self, product: Optional[Union[JSON, IO[AnyStr]]] = None, **kwargs: Any) -> JSON:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    def _put_async_retry_failed_initial(self, product: Optional[Union[JSON, IO[AnyStr]]] = None, **kwargs: Any) -> JSON:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    def _put_non_resource_initial(self, sku: Optional[Union[JSON, IO[AnyStr]]] = None, **kwargs: Any) -> JSON:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    @distributed_trace
    def begin_put_non_resource(self, sku: Optional[Union[JSON, IO[AnyStr]]] = None, **kwargs: Any) -> LROPoller[JSON]:
        """Long running put request with non resource.

        :param sku: sku to put. Is either a JSON type or a IO[AnyStr] type. Default value is None.
        :type sku: JSON or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
    ...
    def _put_async_non_resource_initial(self, sku: Optional[Union[JSON, IO[AnyStr]]] = None, **kwargs: Any) -> JSON:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    @distributed_trace
    def begin_put_async_non_resource(
        self, sku: Optional[Union[JSON, IO[AnyStr]]] = None, **kwargs: Any
    ) -> LROPoller[JSON]:
        """Long running put request with non resource.
    ...
    def _put_sub_resource_initial(self, product: Optional[Union[JSON, IO[AnyStr]]] = None, **kwargs: Any) -> JSON:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    def begin_put_sub_resource(
        ...
        :param product: Sub Product to put. Is either a JSON type or a IO[AnyStr] type. Default value
         is None.
        :type product: JSON or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
    ...
    def _put_async_sub_resource_initial(self, product: Optional[Union[JSON, IO[AnyStr]]] = None, **kwargs: Any) -> JSON:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    def _post202_no_retry204_initial(self, product: Optional[Union[JSON, IO[AnyStr]]] = None, **kwargs: Any) -> JSON:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    def _post_double_headers_final_location_get_initial(self, **kwargs: Any) -> JSON:  # pylint: disable=name-too-long
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
...
class LROSADsOperations:  # pylint: disable=too-many-public-methods
    ...
    def _put_non_retry400_initial(self, product: Optional[Union[JSON, IO[AnyStr]]] = None, **kwargs: Any) -> JSON:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
