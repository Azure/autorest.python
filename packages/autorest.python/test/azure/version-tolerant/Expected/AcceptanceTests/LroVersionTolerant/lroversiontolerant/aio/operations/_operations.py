...
class LROsOperations:  # pylint: disable=too-many-public-methods
    ...
    async def _put201_succeeded_initial(self, product: Optional[Union[JSON, JSON, IO]] = None, **kwargs: Any) -> JSON:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    async def _put202_retry200_initial(self, product: Optional[Union[JSON, JSON, IO]] = None, **kwargs: Any) -> JSON:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    async def _put_non_resource_initial(self, sku: Optional[Union[JSON, JSON, IO]] = None, **kwargs: Any) -> JSON:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    async def _put_async_non_resource_initial(self, sku: Optional[Union[JSON, JSON, IO]] = None, **kwargs: Any) -> JSON:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    async def _put_sub_resource_initial(self, product: Optional[Union[JSON, JSON, IO]] = None, **kwargs: Any) -> JSON:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
...
class LROSADsOperations:  # pylint: disable=too-many-public-methods
    ...
    async def _put_non_retry400_initial(self, product: Optional[Union[JSON, JSON, IO]] = None, **kwargs: Any) -> JSON:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
