...
def build_storage_accounts_check_name_availability_request(
    subscription_id: str, *, json: JSON, **kwargs: Any
) -> HttpRequest:
...
def build_storage_accounts_create_request(
    resource_group_name: str, account_name: str, subscription_id: str, *, json: JSON, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class StorageAccountsOperations:
    ...
    @distributed_trace
    def check_name_availability(self, account_name: JSON, **kwargs: Any) -> JSON:
    ...
    def _create_initial(
        self, resource_group_name: str, account_name: str, parameters: JSON, **kwargs: Any
    ) -> Optional[JSON]:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    @distributed_trace
    def update(self, resource_group_name: str, account_name: str, parameters: JSON, **kwargs: Any) -> JSON:
    ...
    @distributed_trace
    def regenerate_key(self, resource_group_name: str, account_name: str, regenerate_key: JSON, **kwargs: Any) -> JSON:
