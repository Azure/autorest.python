...
class AutoRestComplexTestService:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype basic: azurebodycomplexversiontolerant.aio.operations.BasicOperations
    :ivar primitive: PrimitiveOperations operations
    :vartype primitive: azurebodycomplexversiontolerant.aio.operations.PrimitiveOperations
    :ivar array: ArrayOperations operations
    :vartype array: azurebodycomplexversiontolerant.aio.operations.ArrayOperations
    :ivar dictionary: DictionaryOperations operations
    :vartype dictionary: azurebodycomplexversiontolerant.aio.operations.DictionaryOperations
    :ivar inheritance: InheritanceOperations operations
    :vartype inheritance: azurebodycomplexversiontolerant.aio.operations.InheritanceOperations
    :ivar polymorphism: PolymorphismOperations operations
    :vartype polymorphism: azurebodycomplexversiontolerant.aio.operations.PolymorphismOperations
    :ivar polymorphicrecursive: PolymorphicrecursiveOperations operations
    :vartype polymorphicrecursive:
     azurebodycomplexversiontolerant.aio.operations.PolymorphicrecursiveOperations
    :ivar readonlyproperty: ReadonlypropertyOperations operations
    :vartype readonlyproperty:
     azurebodycomplexversiontolerant.aio.operations.ReadonlypropertyOperations
    :ivar flattencomplex: FlattencomplexOperations operations
    :vartype flattencomplex:
     azurebodycomplexversiontolerant.aio.operations.FlattencomplexOperations
