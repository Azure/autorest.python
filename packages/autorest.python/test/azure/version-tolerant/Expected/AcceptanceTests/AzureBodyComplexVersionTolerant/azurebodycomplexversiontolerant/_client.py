...
class AutoRestComplexTestService:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype basic: azurebodycomplexversiontolerant.operations.BasicOperations
    :ivar primitive: PrimitiveOperations operations
    :vartype primitive: azurebodycomplexversiontolerant.operations.PrimitiveOperations
    :ivar array: ArrayOperations operations
    :vartype array: azurebodycomplexversiontolerant.operations.ArrayOperations
    :ivar dictionary: DictionaryOperations operations
    :vartype dictionary: azurebodycomplexversiontolerant.operations.DictionaryOperations
    :ivar inheritance: InheritanceOperations operations
    :vartype inheritance: azurebodycomplexversiontolerant.operations.InheritanceOperations
    :ivar polymorphism: PolymorphismOperations operations
    :vartype polymorphism: azurebodycomplexversiontolerant.operations.PolymorphismOperations
    :ivar polymorphicrecursive: PolymorphicrecursiveOperations operations
    :vartype polymorphicrecursive:
     azurebodycomplexversiontolerant.operations.PolymorphicrecursiveOperations
    :ivar readonlyproperty: ReadonlypropertyOperations operations
    :vartype readonlyproperty:
     azurebodycomplexversiontolerant.operations.ReadonlypropertyOperations
    :ivar flattencomplex: FlattencomplexOperations operations
    :vartype flattencomplex: azurebodycomplexversiontolerant.operations.FlattencomplexOperations
