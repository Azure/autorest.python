...
def build_group_get_sample_resource_group_request(  # pylint: disable=name-too-long
...
class GroupOperations:
    ...
    @distributed_trace
    def get_sample_resource_group(self, resource_group_name: str, **kwargs: Any) -> JSON:
