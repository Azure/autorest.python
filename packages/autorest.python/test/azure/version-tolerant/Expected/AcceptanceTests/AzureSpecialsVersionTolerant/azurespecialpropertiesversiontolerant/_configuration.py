...
class AutoRestAzureSpecialParametersTestClientConfiguration(  # pylint: disable=too-many-instance-attributes
    ...
    def _configure(self, **kwargs: Any) -> None:
        ...
        if self.credential and not self.authentication_policy:
            self.authentication_policy = cast(
                ...
                ARMChallengeAuthenticationPolicy(self.credential, *self.credential_scopes, **kwargs),
            )
