...
class PrimitiveOperations:  # pylint: disable=too-many-public-methods
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azurebodycomplex.aio.AutoRestComplexTestService`'s
    ...
    async def get_int(self, **kwargs: Any) -> _models.IntWrapper:
        ...
        :rtype: ~azurebodycomplex.models.IntWrapper
    ...
    async def put_int(  # pylint: disable=inconsistent-return-statements
        ...
        :type complex_body: ~azurebodycomplex.models.IntWrapper
    ...
    async def put_int(  # pylint: disable=inconsistent-return-statements
        ...
        :param complex_body: Please put -1 and 2. Is either a IntWrapper type or a IO[bytes] type.
         Required.
        :type complex_body: ~azurebodycomplex.models.IntWrapper or IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def get_long(self, **kwargs: Any) -> _models.LongWrapper:
        ...
        :rtype: ~azurebodycomplex.models.LongWrapper
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def put_long(  # pylint: disable=inconsistent-return-statements
        ...
        :type complex_body: ~azurebodycomplex.models.LongWrapper
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: None or the result of cls(response)
    ...
    async def put_long(  # pylint: disable=inconsistent-return-statements
        ...
        :type complex_body: ~azurebodycomplex.models.LongWrapper or IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def get_float(self, **kwargs: Any) -> _models.FloatWrapper:
        ...
        :rtype: ~azurebodycomplex.models.FloatWrapper
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def put_float(  # pylint: disable=inconsistent-return-statements
        ...
        :type complex_body: ~azurebodycomplex.models.FloatWrapper
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: None or the result of cls(response)
    ...
    async def put_float(  # pylint: disable=inconsistent-return-statements
        ...
        :param complex_body: Please put 1.05 and -0.003. Is either a FloatWrapper type or a IO[bytes]
         type. Required.
        :type complex_body: ~azurebodycomplex.models.FloatWrapper or IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def get_double(self, **kwargs: Any) -> _models.DoubleWrapper:
        ...
        :rtype: ~azurebodycomplex.models.DoubleWrapper
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def put_double(  # pylint: disable=inconsistent-return-statements
        ...
        :type complex_body: ~azurebodycomplex.models.DoubleWrapper
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: None or the result of cls(response)
    ...
    async def put_double(  # pylint: disable=inconsistent-return-statements
        ...
        :type complex_body: ~azurebodycomplex.models.DoubleWrapper or IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def get_bool(self, **kwargs: Any) -> _models.BooleanWrapper:
        ...
        :rtype: ~azurebodycomplex.models.BooleanWrapper
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def put_bool(  # pylint: disable=inconsistent-return-statements
        ...
        :type complex_body: ~azurebodycomplex.models.BooleanWrapper
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: None or the result of cls(response)
    ...
    async def put_bool(  # pylint: disable=inconsistent-return-statements
        ...
        :param complex_body: Please put true and false. Is either a BooleanWrapper type or a IO[bytes]
         type. Required.
        :type complex_body: ~azurebodycomplex.models.BooleanWrapper or IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def get_string(self, **kwargs: Any) -> _models.StringWrapper:
        ...
        :rtype: ~azurebodycomplex.models.StringWrapper
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def put_string(  # pylint: disable=inconsistent-return-statements
        ...
        :type complex_body: ~azurebodycomplex.models.StringWrapper
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: None or the result of cls(response)
    ...
    async def put_string(  # pylint: disable=inconsistent-return-statements
        ...
        :param complex_body: Please put 'goodrequest', '', and null. Is either a StringWrapper type or
         a IO[bytes] type. Required.
        :type complex_body: ~azurebodycomplex.models.StringWrapper or IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def get_date(self, **kwargs: Any) -> _models.DateWrapper:
        ...
        :rtype: ~azurebodycomplex.models.DateWrapper
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def put_date(  # pylint: disable=inconsistent-return-statements
        ...
        :type complex_body: ~azurebodycomplex.models.DateWrapper
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: None or the result of cls(response)
    ...
    async def put_date(  # pylint: disable=inconsistent-return-statements
        ...
        :param complex_body: Please put '0001-01-01' and '2016-02-29'. Is either a DateWrapper type or
         a IO[bytes] type. Required.
        :type complex_body: ~azurebodycomplex.models.DateWrapper or IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def get_date_time(self, **kwargs: Any) -> _models.DatetimeWrapper:
        ...
        :rtype: ~azurebodycomplex.models.DatetimeWrapper
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def put_date_time(  # pylint: disable=inconsistent-return-statements
        ...
        :param complex_body: Please put '0001-01-01T12:00:00-04:00' and '2015-05-18T11:38:00-08:00'.
         Required.
        :type complex_body: ~azurebodycomplex.models.DatetimeWrapper
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: None or the result of cls(response)
    ...
    async def put_date_time(  # pylint: disable=inconsistent-return-statements
        ...
        :type complex_body: ~azurebodycomplex.models.DatetimeWrapper or IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def get_date_time_rfc1123(self, **kwargs: Any) -> _models.Datetimerfc1123Wrapper:
        ...
        :rtype: ~azurebodycomplex.models.Datetimerfc1123Wrapper
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def put_date_time_rfc1123(  # pylint: disable=inconsistent-return-statements
        ...
        :param complex_body: Please put 'Mon, 01 Jan 0001 12:00:00 GMT' and 'Mon, 18 May 2015 11:38:00
         GMT'. Required.
        :type complex_body: ~azurebodycomplex.models.Datetimerfc1123Wrapper
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: None or the result of cls(response)
    ...
    async def put_date_time_rfc1123(  # pylint: disable=inconsistent-return-statements
        ...
        :type complex_body: ~azurebodycomplex.models.Datetimerfc1123Wrapper or IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def get_duration(self, **kwargs: Any) -> _models.DurationWrapper:
        ...
        :rtype: ~azurebodycomplex.models.DurationWrapper
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def get_byte(self, **kwargs: Any) -> _models.ByteWrapper:
        ...
        :rtype: ~azurebodycomplex.models.ByteWrapper
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
