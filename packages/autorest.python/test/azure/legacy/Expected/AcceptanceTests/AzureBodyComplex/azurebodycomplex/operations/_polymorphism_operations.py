...
class PolymorphismOperations:
    ...
    def get_valid(self, **kwargs: Any) -> _models.Fish:
        ...
        :rtype: ~azurebodycomplex.models.Fish
    ...
    def put_valid(  # pylint: disable=inconsistent-return-statements
        ...
        :type complex_body: ~azurebodycomplex.models.Fish
    ...
    def put_valid(  # pylint: disable=inconsistent-return-statements
        ...
        :type complex_body: ~azurebodycomplex.models.Fish or IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def get_dot_syntax(self, **kwargs: Any) -> _models.DotFish:
        ...
        :rtype: ~azurebodycomplex.models.DotFish
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def get_composed_with_discriminator(self, **kwargs: Any) -> _models.DotFishMarket:
        ...
        :rtype: ~azurebodycomplex.models.DotFishMarket
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def get_complicated(self, **kwargs: Any) -> _models.Salmon:
        ...
        :rtype: ~azurebodycomplex.models.Salmon
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def put_complicated(  # pylint: disable=inconsistent-return-statements
        ...
        :type complex_body: ~azurebodycomplex.models.Salmon
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: None or the result of cls(response)
    ...
    def put_complicated(  # pylint: disable=inconsistent-return-statements
        ...
        :type complex_body: ~azurebodycomplex.models.Salmon or IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
