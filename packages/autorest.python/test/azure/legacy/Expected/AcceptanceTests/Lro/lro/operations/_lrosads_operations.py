...
def build_put_non_retry400_request(*, json: Optional[_models.Product] = None, **kwargs: Any) -> HttpRequest:
...
def build_put_non_retry201_creating400_request(*, json: Optional[_models.Product] = None, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_put_async_relative_retry400_request(*, json: Optional[_models.Product] = None, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_post_non_retry400_request(*, json: Optional[_models.Product] = None, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_post202_non_retry400_request(*, json: Optional[_models.Product] = None, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_post_async_relative_retry400_request(*, json: Optional[_models.Product] = None, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_post202_no_location_request(*, json: Optional[_models.Product] = None, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_put200_invalid_json_request(*, json: Optional[_models.Product] = None, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_post202_retry_invalid_header_request(*, json: Optional[_models.Product] = None, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class LROSADsOperations:  # pylint: disable=too-many-public-methods
    ...
    def _put_non_retry400_initial(self, product: Optional[_models.Product] = None, **kwargs: Any) -> _models.Product:
        error_map = {
    ...
    @distributed_trace
    def begin_post_non_retry400(self, product: Optional[_models.Product] = None, **kwargs: Any) -> LROPoller[None]:
    ...
    @distributed_trace
    def begin_post202_non_retry400(self, product: Optional[_models.Product] = None, **kwargs: Any) -> LROPoller[None]:
    ...
    @distributed_trace
    def begin_post202_no_location(self, product: Optional[_models.Product] = None, **kwargs: Any) -> LROPoller[None]:
