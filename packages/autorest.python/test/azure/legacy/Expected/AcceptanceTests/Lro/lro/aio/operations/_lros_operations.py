...
class LROsOperations:  # pylint: disable=too-many-public-methods
    ...
    async def begin_post202_list(self, **kwargs: Any) -> AsyncLROPoller[List[_models.Product]]:
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return AsyncLROPoller[List[_models.Product]].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[List[_models.Product]](self._client, raw_result, get_long_running_output, polling_method)  # type: ignore
    ...
    async def begin_put_non_resource(
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return AsyncLROPoller[_models.Sku].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.Sku](self._client, raw_result, get_long_running_output, polling_method)  # type: ignore
    ...
    async def begin_put_sub_resource(
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return AsyncLROPoller[_models.SubProduct].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.SubProduct](self._client, raw_result, get_long_running_output, polling_method)  # type: ignore
