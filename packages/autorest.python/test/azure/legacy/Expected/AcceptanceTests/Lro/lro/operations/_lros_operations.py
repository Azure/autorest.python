...
class LROsOperations:  # pylint: disable=too-many-public-methods
    ...
    def _put_sub_resource_initial(self, provisioning_state: Optional[str] = None, **kwargs: Any) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        content_type: Optional[str] = (
            kwargs.pop("content_type", _headers.pop("Content-Type", "application/json")) if _product else None
        )
        cls: ClsType[Iterator[bytes]] = kwargs.pop("cls", None)
