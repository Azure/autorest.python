...
class OdataProductResult(_serialization.Model):
    ...
    :ivar values:
    :vartype values: list[~azure.packagemode.batch.paging.models.Product]
...
class OperationResult(_serialization.Model):
    ...
    :vartype status: str or ~azure.packagemode.batch.paging.models.OperationResultStatus
    """
    ...
    def __init__(self, *, status: Optional[Union[str, "_models.OperationResultStatus"]] = None, **kwargs):
        ...
        :keyword status: The status of the request. Known values are: "Succeeded", "Failed",
         ...
         and "OK".
        :paramtype status: str or ~azure.packagemode.batch.paging.models.OperationResultStatus
        """
        super().__init__(**kwargs)
        self.status = status
...
class Product(_serialization.Model):
    ...
    :ivar properties:
    :vartype properties: ~azure.packagemode.batch.paging.models.ProductProperties
    """
...
class ProductResultValue(_serialization.Model):
    ...
    :ivar value:
    :vartype value: list[~azure.packagemode.batch.paging.models.Product]
    :ivar next_link:
    :vartype next_link: str
    """
...
class ProductResultValueWithXMSClientName(_serialization.Model):
    ...
    :ivar indexes:
    :vartype indexes: list[~azure.packagemode.batch.paging.models.Product]
    :ivar next_link:
    :vartype next_link: str
    """
