...
class MixedApiVersionClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype http_success: mixedapiversion.operations.HttpSuccessOperations
    :ivar xms_client_request_id: XMsClientRequestIdOperations operations
    :vartype xms_client_request_id: mixedapiversion.operations.XMsClientRequestIdOperations
    ...
    :vartype subscription_in_method: mixedapiversion.operations.SubscriptionInMethodOperations
    :ivar api_version_default: ApiVersionDefaultOperations operations
    :vartype api_version_default: mixedapiversion.operations.ApiVersionDefaultOperations
    :ivar api_version_local: ApiVersionLocalOperations operations
    :vartype api_version_local: mixedapiversion.operations.ApiVersionLocalOperations
    :ivar skip_url_encoding: SkipUrlEncodingOperations operations
    :vartype skip_url_encoding: mixedapiversion.operations.SkipUrlEncodingOperations
    ...
    def __enter__(self) -> "MixedApiVersionClient":
