...
class PagingOperations:  # pylint: disable=too-many-public-methods
    ...
    async def begin_get_multiple_pages_lro(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return AsyncLROPoller[_models.ProductResult].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.ProductResult](self._client, raw_result, get_long_running_output, polling_method)  # type: ignore
