...
from typing import Any, Callable, Iterator, Literal, Optional, TypeVar, Union, cast
import urllib.parse
...
class PagingOperations:  # pylint: disable=too-many-public-methods
    ...
    @distributed_trace
    def get_no_item_name_pages(self, **kwargs: Any) -> ItemPaged["_models.Product"]:
    ...
    @distributed_trace
    def get_empty_next_link_name_pages(self, **kwargs: Any) -> ItemPaged["_models.Product"]:
    ...
    @distributed_trace
    def get_null_next_link_name_pages(self, **kwargs: Any) -> ItemPaged["_models.Product"]:
    ...
    @distributed_trace
    def get_single_pages(self, **kwargs: Any) -> ItemPaged["_models.Product"]:
    ...
    @distributed_trace
    def page_with_max_page_size(self, maxpagesize: Literal["5"] = "5", **kwargs: Any) -> ItemPaged["_models.Product"]:
    ...
    @distributed_trace
    def get_single_pages_failure(self, **kwargs: Any) -> ItemPaged["_models.Product"]:
    ...
    @distributed_trace
    def get_multiple_pages_failure(self, **kwargs: Any) -> ItemPaged["_models.Product"]:
    ...
    @distributed_trace
    def get_multiple_pages_failure_uri(self, **kwargs: Any) -> ItemPaged["_models.Product"]:
