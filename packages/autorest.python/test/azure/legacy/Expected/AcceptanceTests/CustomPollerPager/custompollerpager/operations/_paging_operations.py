...
class PagingOperations:  # pylint: disable=too-many-public-methods
    ...
    def begin_get_multiple_pages_lro(
        ...
        paging_get_multiple_pages_lro_options: Optional[_models.PagingGetMultiplePagesLroOptions] = None,
        **kwargs: Any,
    ) -> CustomPoller[ItemPaged["_models.Product"]]:
        ...
        if cont_token:
            return CustomPoller[ItemPaged["_models.Product"]].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return CustomPoller[ItemPaged["_models.Product"]](
