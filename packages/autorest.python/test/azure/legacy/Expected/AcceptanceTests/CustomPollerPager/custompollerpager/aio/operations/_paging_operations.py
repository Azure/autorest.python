...
# --------------------------------------------------------------------------
from typing import Any, AsyncIterable, Callable, Dict, Literal, MutableMapping, Optional, Type, TypeVar, Union, cast
import urllib.parse
...
class PagingOperations:  # pylint: disable=too-many-public-methods
    ...
    async def begin_get_multiple_pages_lro(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return AsyncCustomPoller[AsyncIterable["_models.Product"]].from_continuation_token(
