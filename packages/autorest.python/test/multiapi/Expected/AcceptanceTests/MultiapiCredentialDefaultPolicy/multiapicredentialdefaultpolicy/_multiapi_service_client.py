...
class MultiapiServiceClient(MultiapiServiceClientOperationsMixin, MultiApiClientMixin, _SDKClient):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._client = ARMPipelineClient(base_url=base_url, policies=config_policies, **kwargs)
    ...
    def models(cls, api_version=DEFAULT_API_VERSION):
        """Module depends on the API version:
           ...
           * 1.0.0: :mod:`v1.models<multiapicredentialdefaultpolicy.v1.models>`
           * 2.0.0: :mod:`v2.models<multiapicredentialdefaultpolicy.v2.models>`
           * 3.0.0: :mod:`v3.models<multiapicredentialdefaultpolicy.v3.models>`
        """
    ...
    def operation_group_one(self):
        """Instance depends on the API version:
           ...
           * 1.0.0: :class:`OperationGroupOneOperations<multiapicredentialdefaultpolicy.v1.operations.OperationGroupOneOperations>`
           * 2.0.0: :class:`OperationGroupOneOperations<multiapicredentialdefaultpolicy.v2.operations.OperationGroupOneOperations>`
           * 3.0.0: :class:`OperationGroupOneOperations<multiapicredentialdefaultpolicy.v3.operations.OperationGroupOneOperations>`
        """
    ...
    def operation_group_two(self):
        """Instance depends on the API version:
           ...
           * 2.0.0: :class:`OperationGroupTwoOperations<multiapicredentialdefaultpolicy.v2.operations.OperationGroupTwoOperations>`
           * 3.0.0: :class:`OperationGroupTwoOperations<multiapicredentialdefaultpolicy.v3.operations.OperationGroupTwoOperations>`
        """
