...
def build_multiapi_service_test_lro_request(
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class MultiapiServiceClientOperationsMixin( 
    ...
    def test_one(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop('api_version', _params.pop('api-version', self._api_version('test_one') or "1.0.0"))
    ...
    def begin_test_lro(
        ...
        **kwargs: Any
        ...
        content_type: Optional[str] = kwargs.pop('content_type', _headers.pop('Content-Type', None))
        cls: ClsType[_models.Product] = kwargs.pop(
            'cls', None
        )
    ...
    def begin_test_lro_and_paging(
        ...
        **kwargs: Any
        ...
        cls: ClsType[_models.PagingResult] = kwargs.pop(
            'cls', None
        )
    ...
    def test_different_calls(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop('api_version', _params.pop('api-version', self._api_version('test_different_calls') or "1.0.0"))
        cls: ClsType[None] = kwargs.pop(
            'cls', None
        )
...
class OperationGroupOneOperations: 
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~multiapicombiner.v1.MultiapiServiceClient`'s
