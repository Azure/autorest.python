...
class MultiapiServiceClient(MultiapiServiceClientOperationsMixin, MultiApiClientMixin, _SDKClient):
    ...
    def models(cls, api_version=DEFAULT_API_VERSION):
        """Module depends on the API version:
           ...
           * 0.0.0: :mod:`v0.models<multiapicombiner.v0.models>`
           * 1.0.0: :mod:`v1.models<multiapicombiner.v1.models>`
           * 2.0.0: :mod:`v2.models<multiapicombiner.v2.models>`
           * 3.0.0: :mod:`v3.models<multiapicombiner.v3.models>`
        """
    ...
    def operation_group_one(self):
        """Instance depends on the API version:
           ...
           * 0.0.0: :class:`OperationGroupOneOperations<multiapicombiner.v0.aio.operations.OperationGroupOneOperations>`
           * 1.0.0: :class:`OperationGroupOneOperations<multiapicombiner.v1.aio.operations.OperationGroupOneOperations>`
           * 2.0.0: :class:`OperationGroupOneOperations<multiapicombiner.v2.aio.operations.OperationGroupOneOperations>`
           * 3.0.0: :class:`OperationGroupOneOperations<multiapicombiner.v3.aio.operations.OperationGroupOneOperations>`
        """
    ...
    def operation_group_two(self):
        """Instance depends on the API version:
           ...
           * 2.0.0: :class:`OperationGroupTwoOperations<multiapicombiner.v2.aio.operations.OperationGroupTwoOperations>`
           * 3.0.0: :class:`OperationGroupTwoOperations<multiapicombiner.v3.aio.operations.OperationGroupTwoOperations>`
        """
