...
class MultiapiServiceClient(MultiapiServiceClientOperationsMixin):  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype operation_group_one: multiapicombiner.v2.aio.operations.OperationGroupOneOperations
    :ivar operation_group_two: OperationGroupTwoOperations operations
    :vartype operation_group_two: multiapicombiner.v2.aio.operations.OperationGroupTwoOperations
