...
class MultiapiServiceClient(MultiapiServiceClientOperationsMixin, MultiApiClientMixin, _SDKClient):
    ...
    def operation_group_one(self):
        """Instance depends on the API version:
           ...
           * 0.0.0: :class:`OperationGroupOneOperations<multiapicombiner.v0.operations.OperationGroupOneOperations>`
           * 1.0.0: :class:`OperationGroupOneOperations<multiapicombiner.v1.operations.OperationGroupOneOperations>`
           * 2.0.0: :class:`OperationGroupOneOperations<multiapicombiner.v2.operations.OperationGroupOneOperations>`
           * 3.0.0: :class:`OperationGroupOneOperations<multiapicombiner.v3.operations.OperationGroupOneOperations>`
        """
    ...
    def operation_group_two(self):
        """Instance depends on the API version:
           ...
           * 2.0.0: :class:`OperationGroupTwoOperations<multiapicombiner.v2.operations.OperationGroupTwoOperations>`
           * 3.0.0: :class:`OperationGroupTwoOperations<multiapicombiner.v3.operations.OperationGroupTwoOperations>`
        """
