...
def build_test_two_request(*, json: Optional[_models.ModelTwo] = None, **kwargs: Any) -> HttpRequest:
...
class OperationGroupOneOperations:
    ...
    @distributed_trace
    def test_two(self, parameter_one: Optional[_models.ModelTwo] = None, **kwargs: Any) -> _models.ModelTwo:
