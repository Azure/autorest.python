...
class OperationGroupTwoOperations:
    ...
    def test_four(  # pylint: disable=inconsistent-return-statements
        ...
        :type input: ~multiapinoasync.v3.models.SourcePath or IO
        ...
        if isinstance(input, (_serialization.Model, dict)):
            ...
            if not content_type:
                raise TypeError(
                    "Missing required keyword-only argument: content_type. Known values are: 'application/pdf', 'image/tiff', 'application/json', 'image/png', 'image/jpeg'"
                )
        else:
