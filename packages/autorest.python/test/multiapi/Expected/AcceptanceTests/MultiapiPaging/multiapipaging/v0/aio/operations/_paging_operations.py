...
class PagingOperations:  # pylint: disable=too-many-public-methods
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~multiapipaging.v0.aio.AutoRestPagingTestService`'s
    ...
    def get_no_item_name_pages(self, **kwargs: Any) -> AsyncIterable["_models.Product"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~multiapipaging.v0.models.Product]
    ...
    def get_single_pages_with_body_params(
        self, parameters: _models.BodyParam, *, content_type: str = "application/json", **kwargs: Any
        ...
        :type parameters: ~multiapipaging.v0.models.BodyParam
    ...
    @distributed_trace
    def get_single_pages_with_body_params(
        self, parameters: Union[_models.BodyParam, IO], **kwargs: Any
    ) -> AsyncIterable["_models.Product"]:
        """A paging operation that finishes on the first call with body params without a nextlink.

        :param parameters: put {'name': 'body'} to pass the test. Is either a model type or a IO type.
         Required.
        :type parameters: ~multiapipaging.v0.models.BodyParam or IO
        ...
        if isinstance(parameters, (IO, bytes)):
            ...
            _json = self._serialize.body(parameters, "BodyParam")
    ...
    def get_multiple_pages(
        ...
        **kwargs: Any
        ...
        :type paging_get_multiple_pages_options:
         ~multiapipaging.v0.models.PagingGetMultiplePagesOptions
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either Product or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~multiapipaging.v0.models.Product]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def get_odata_multiple_pages(
        ...
        **kwargs: Any
        ...
        :type paging_get_odata_multiple_pages_options:
         ~multiapipaging.v0.models.PagingGetOdataMultiplePagesOptions
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either Product or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~multiapipaging.v0.models.Product]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def get_multiple_pages_with_offset(
        ...
        **kwargs: Any
        ...
        :type paging_get_multiple_pages_with_offset_options:
         ~multiapipaging.v0.models.PagingGetMultiplePagesWithOffsetOptions
        :param client_request_id: Default value is None.
        :type client_request_id: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either Product or the result of cls(response)
    ...
    def get_multiple_pages_fragment_with_grouping_next_link(
        ...
        :type custom_parameter_group: ~multiapipaging.v0.models.CustomParameterGroup
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either Product or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~multiapipaging.v0.models.Product]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def begin_get_multiple_pages_lro(
        ...
        **kwargs: Any
        ...
        :type paging_get_multiple_pages_lro_options:
         ~multiapipaging.v0.models.PagingGetMultiplePagesLroOptions
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.core.async_paging.AsyncItemPaged[~multiapipaging.v0.models.Product]]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
