...
class PagingOperations:  # pylint: disable=too-many-public-methods
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~multiapipaging.v1.aio.AutoRestPagingTestService`'s
    ...
    def get_no_item_name_pages(self, **kwargs: Any) -> AsyncIterable["_models.Product"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~multiapipaging.v1.models.Product]
    ...
    def get_single_pages_with_body_params(
        ...
        :type parameters: ~multiapipaging.v1.models.BodyParam
    ...
    def get_single_pages_with_body_params(
        ...
        :param parameters: put {'name': 'body'} to pass the test. Is either a model type or a IO type.
         Required.
        :type parameters: ~multiapipaging.v1.models.BodyParam or IO
    ...
    def get_multiple_pages(
        ...
        **kwargs: Any
        ...
        :type paging_get_multiple_pages_options:
         ~multiapipaging.v1.models.PagingGetMultiplePagesOptions
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either Product or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~multiapipaging.v1.models.Product]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def get_odata_multiple_pages(
        ...
        **kwargs: Any
        ...
        :type paging_get_odata_multiple_pages_options:
         ~multiapipaging.v1.models.PagingGetOdataMultiplePagesOptions
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either Product or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~multiapipaging.v1.models.Product]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def get_multiple_pages_with_offset(
        ...
        **kwargs: Any
        ...
        :type paging_get_multiple_pages_with_offset_options:
         ~multiapipaging.v1.models.PagingGetMultiplePagesWithOffsetOptions
        :param client_request_id: Default value is None.
        :type client_request_id: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either Product or the result of cls(response)
    ...
    def get_multiple_pages_fragment_with_grouping_next_link(
        ...
        :type custom_parameter_group: ~multiapipaging.v1.models.CustomParameterGroup
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either Product or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~multiapipaging.v1.models.Product]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def begin_get_multiple_pages_lro(
        ...
        **kwargs: Any
        ...
        :type paging_get_multiple_pages_lro_options:
         ~multiapipaging.v1.models.PagingGetMultiplePagesLroOptions
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.core.async_paging.AsyncItemPaged[~multiapipaging.v1.models.Product]]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
