...
class OdataProductResult(_serialization.Model):
    ...
    :ivar values:
    :vartype values: list[~multiapipaging.v1.models.Product]
    ...
    def __init__(
        ...
        """
        :keyword values:
        :paramtype values: list[~multiapipaging.v1.models.Product]
...
class OperationResult(_serialization.Model):
    ...
    :vartype status: str or ~multiapipaging.v1.models.OperationResultStatus
    """
    ...
    def __init__(self, *, status: Optional[Union[str, "_models.OperationResultStatus"]] = None, **kwargs):
        ...
        :keyword status: The status of the request. Known values are: "Succeeded", "Failed",
         ...
         and "OK".
        :paramtype status: str or ~multiapipaging.v1.models.OperationResultStatus
        """
        super().__init__(**kwargs)
        self.status = status
...
class Product(_serialization.Model):
    ...
    :ivar properties:
    :vartype properties: ~multiapipaging.v1.models.ProductProperties
    """
    ...
    def __init__(self, *, properties: Optional["_models.ProductProperties"] = None, **kwargs):
        """
        :keyword properties:
        :paramtype properties: ~multiapipaging.v1.models.ProductProperties
        """
        super().__init__(**kwargs)
...
class ProductResultValue(_serialization.Model):
    ...
    :ivar value:
    :vartype value: list[~multiapipaging.v1.models.Product]
    :ivar next_link:
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: Optional[List["_models.Product"]] = None, next_link: Optional[str] = None, **kwargs):
        """
        :keyword value:
        :paramtype value: list[~multiapipaging.v1.models.Product]
        :keyword next_link:
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class ProductResultValueWithXMSClientName(_serialization.Model):
    ...
    :ivar indexes:
    :vartype indexes: list[~multiapipaging.v1.models.Product]
    :ivar next_link:
    :vartype next_link: str
    """
    ...
    def __init__(self, *, indexes: Optional[List["_models.Product"]] = None, next_link: Optional[str] = None, **kwargs):
        """
        :keyword indexes:
        :paramtype indexes: list[~multiapipaging.v1.models.Product]
        :keyword next_link:
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
