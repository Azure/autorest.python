...
from ._configuration import PolymorphisminComplexTestServiceConfiguration
...
class PolymorphisminComplexTestService:  # pylint: disable=client-accepts-api-version-keyword
    """Service client.

    :ivar basic_ops: BasicOpsOperations operations
    :vartype basic_ops: cadl.testserver.bodycomplexpolymorphism.aio.operations.BasicOpsOperations
    :ivar inheritance: InheritanceOperations operations
    :vartype inheritance:
     cadl.testserver.bodycomplexpolymorphism.aio.operations.InheritanceOperations
    :ivar polymorphism: PolymorphismOperations operations
    :vartype polymorphism:
     cadl.testserver.bodycomplexpolymorphism.aio.operations.PolymorphismOperations
    :ivar polymorphicrecursive: PolymorphicrecursiveOperations operations
    :vartype polymorphicrecursive:
     cadl.testserver.bodycomplexpolymorphism.aio.operations.PolymorphicrecursiveOperations
    """

    def __init__(self, **kwargs: Any) -> None:  # pylint: disable=missing-client-constructor-parameter-credential
        _endpoint = "http://localhost:3000"
        self._config = PolymorphisminComplexTestServiceConfiguration(**kwargs)
    ...
    async def __aenter__(self) -> "PolymorphisminComplexTestService":
