...
class PolymorphisminComplexTestService:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype basic_ops: cadl.testserver.bodycomplexpolymorphism.operations.BasicOpsOperations
    :ivar inheritance: InheritanceOperations operations
    :vartype inheritance: cadl.testserver.bodycomplexpolymorphism.operations.InheritanceOperations
    :ivar polymorphism: PolymorphismOperations operations
    :vartype polymorphism:
     cadl.testserver.bodycomplexpolymorphism.operations.PolymorphismOperations
    :ivar polymorphicrecursive: PolymorphicrecursiveOperations operations
    :vartype polymorphicrecursive:
     cadl.testserver.bodycomplexpolymorphism.operations.PolymorphicrecursiveOperations
    """
    ...
    def __enter__(self):
        # type: () -> PolymorphisminComplexTestService
