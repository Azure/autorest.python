...
from ...operations._operations import (
    build_boolean_value__get_request,
    build_boolean_value__put_request,
    build_datetime_value__get_request,
    build_datetime_value__put_request,
    build_duration_value__get_request,
    build_duration_value__put_request,
    build_float32_value__get_request,
    build_float32_value__put_request,
    build_int32_value__get_request,
    build_int32_value__put_request,
    build_int64_value__get_request,
    build_int64_value__put_request,
    build_model_value__get_request,
    build_model_value__put_request,
    build_string_value__get_request,
    build_string_value__put_request,
    build_unknown_value__get_request,
    build_unknown_value__put_request,
)
...
class Int32ValueOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~arrays.itemtypes.aio.ItemTypesClient`'s
    ...
    async def _get(self, **kwargs: Any) -> List[int]:
        """_get.
    ...
    @overload
    async def _put(  # pylint: disable=inconsistent-return-statements
...
class BooleanValueOperations:
    ...
    @distributed_trace_async
    async def _get(self, **kwargs: Any) -> List[bool]:
        """_get.
...
class StringValueOperations:
    ...
    @distributed_trace_async
    async def _get(self, **kwargs: Any) -> List[str]:
        """_get.
...
class Float32ValueOperations:
    ...
    @distributed_trace_async
    async def _get(self, **kwargs: Any) -> List[float]:
        """_get.
...
class DatetimeValueOperations:
    ...
    @distributed_trace_async
    async def _get(self, **kwargs: Any) -> List[datetime.datetime]:
        """_get.
...
class DurationValueOperations:
    ...
    @distributed_trace_async
    async def _get(self, **kwargs: Any) -> List[datetime.timedelta]:
        """_get.
...
class ModelValueOperations:
    ...
    @distributed_trace_async
    async def _get(self, **kwargs: Any) -> List[_models.InnerModel]:
        """_get.
