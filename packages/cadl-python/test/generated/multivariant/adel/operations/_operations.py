...
def build_alert_configs_create_request(alert_config_name: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = "/alertConfigs/{alertConfigName}"
    path_format_arguments = {
        "alertConfigName": _SERIALIZER.url(
            "alert_config_name", alert_config_name, "str", max_length=200, min_length=1, pattern=r"\w[\w-_]{0,199}"
        ),
    }
...
def build_alert_configs_read_request(alert_config_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_alert_configs_list_request(
    *,
...
def build_alert_configs_delete_request(alert_config_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_alert_configs_update_request(alert_config_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_hooks_create_request(hook_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    _url = "/hooks/{hookName}"
    path_format_arguments = {
        "hookName": _SERIALIZER.url(
            "hook_name", hook_name, "str", max_length=200, min_length=1, pattern=r"\w[\w-_]{0,199}"
        ),
    }
...
def build_hooks_read_request(hook_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_hooks_delete_request(hook_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_hooks_update_request(hook_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_datasets_create_request(dataset_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    # Construct URL
    _url = "/datasets/{datasetName}"
    path_format_arguments = {
        "datasetName": _SERIALIZER.url(
            "dataset_name", dataset_name, "str", max_length=200, min_length=1, pattern=r"\w[\w-_]{0,199}"
        ),
    }
...
def build_datasets_read_request(dataset_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_datasets_delete_request(dataset_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_datasets_preview_data_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_models_create_request(model_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    # Construct URL
    _url = "/multivariate/models/{modelName}"
    path_format_arguments = {
        "modelName": _SERIALIZER.url(
            "model_name", model_name, "str", max_length=200, min_length=1, pattern=r"\w[\w-_]{0,199}"
        ),
    }
...
def build_models_read_request(model_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_models_list_request(
    ...
    **kwargs: Any
    ...
    if top_per_dataset is not None:
        _params["topPerDataset"] = _SERIALIZER.query("top_per_dataset", top_per_dataset, "int")
...
def build_models_delete_request(model_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_models_detect_request(model_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    # Construct URL
    _url = "/multivariate/models/{modelName}/detect"
    path_format_arguments = {
...
def build_evaluations_create_request(evaluation_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    # Construct URL
    _url = "/multivariate/evaluations/{evaluationName}"
    path_format_arguments = {
        "evaluationName": _SERIALIZER.url(
            "evaluation_name", evaluation_name, "str", max_length=200, min_length=1, pattern=r"\w[\w-_]{0,199}"
        ),
    }
...
def build_evaluations_read_request(evaluation_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_evaluations_list_request(
    ...
    **kwargs: Any
    ...
    if model_names is not None:
        _params["modelNames"] = _SERIALIZER.query("model_names", model_names, "str")
    if top_per_model is not None:
        _params["topPerModel"] = _SERIALIZER.query("top_per_model", top_per_model, "int")
...
def build_evaluations_delete_request(evaluation_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_schedules_create_request(schedule_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    # Construct URL
    _url = "/inference/schedules/{scheduleName}"
    path_format_arguments = {
        "scheduleName": _SERIALIZER.url(
            "schedule_name", schedule_name, "str", max_length=200, min_length=1, pattern=r"\w[\w-_]{0,199}"
        ),
    }
...
def build_schedules_read_request(schedule_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_schedules_delete_request(schedule_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_schedules_get_history_request(
    schedule_name: str, *, start_time: str, end_time: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/inference/schedules/{scheduleName}/getHistory"
    path_format_arguments = {
...
def build_schedules_update_request(schedule_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_replays_create_request(replay_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    # Construct URL
    _url = "/inference/replays/{replayName}"
    path_format_arguments = {
        "replayName": _SERIALIZER.url(
            "replay_name", replay_name, "str", max_length=200, min_length=1, pattern=r"\w[\w-_]{0,199}"
        ),
    }
...
def build_replays_read_request(replay_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_replays_list_request(
    *,
    skip: Optional[int] = None,
    sort_by: Optional[str] = None,
    order_by: Optional[Union[str, "_models.OrderBy"]] = None,
    ...
    **kwargs: Any
    ...
    if schedule_name is not None:
        _params["scheduleName"] = _SERIALIZER.query("schedule_name", schedule_name, "str")
    if top_per_schedule is not None:
        _params["topPerSchedule"] = _SERIALIZER.query("top_per_schedule", top_per_schedule, "int")
...
def build_replays_delete_request(replay_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class AlertConfigsOperations:
    ...
    @distributed_trace
    def read(self, alert_config_name: str, **kwargs: Any) -> _models.AlertConfig:
        """read.
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~adel.models.AlertConfig]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    @distributed_trace
    def delete(self, alert_config_name: str, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        """delete.
...
class HooksOperations:
    ...
    @distributed_trace
    def create(self, hook_name: str, body: Union[_models.Hook, JSON, IO], **kwargs: Any) -> _models.Hook:
        """create.
    ...
    @distributed_trace
    def read(self, hook_name: str, **kwargs: Any) -> _models.Hook:
        """read.
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~adel.models.Hook]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    @distributed_trace
    def delete(self, hook_name: str, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        """delete.
    ...
    @distributed_trace
    def update(self, hook_name: str, body: Union[_models.Hook, JSON, IO], **kwargs: Any) -> _models.Hook:
        """update.
...
class DatasetsOperations:
    ...
    @distributed_trace
    def read(self, dataset_name: str, **kwargs: Any) -> _models.Dataset:
        """read.
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~adel.models.Dataset]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    @distributed_trace
    def delete(self, dataset_name: str, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        """delete.
...
class ModelsOperations:
    ...
    @distributed_trace
    def create(self, model_name: str, body: Union[_models.RequestModel, JSON, IO], **kwargs: Any) -> _models.Model:
        """create.
    ...
    @distributed_trace
    def read(self, model_name: str, **kwargs: Any) -> _models.Model:
        """read.
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~adel.models.Model]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    @distributed_trace
    def delete(self, model_name: str, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        """delete.
...
class EvaluationsOperations:
    ...
    @distributed_trace
    def read(self, evaluation_name: str, **kwargs: Any) -> _models.Evaluation:
        """read.
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~adel.models.Evaluation]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    @distributed_trace
    def delete(self, evaluation_name: str, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        """delete.
...
class SchedulesOperations:
    ...
    @distributed_trace
    def read(self, schedule_name: str, **kwargs: Any) -> _models.Schedule:
        """read.
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~adel.models.Schedule]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    @distributed_trace
    def delete(self, schedule_name: str, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        """delete.
...
class ReplaysOperations:
    ...
    @distributed_trace
    def read(self, replay_name: str, **kwargs: Any) -> _models.ScheduleReplay:
        """read.
    ...
    def list(
        ...
        *,
        ...
        top_per_schedule: Optional[int] = None,
        **kwargs: Any
    ) -> Iterable["_models.ScheduleReplay"]:
        """list.
        ...
        :rtype: ~azure.core.paging.ItemPaged[~adel.models.ScheduleReplay]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    @distributed_trace
    def delete(self, replay_name: str, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        """delete.
