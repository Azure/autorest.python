...
class Model(_MyMutableMapping):  # pylint: disable=unsubscriptable-object
    _is_model = True
    ...
    def __init_subclass__(cls, discriminator: typing.Optional[str] = None) -> None:
        for base in cls.__bases__:
            if hasattr(base, "__mapping__"):  # pylint: disable=no-member
                base.__mapping__[  # pylint: disable=no-member  # type: ignore[attr-defined]
                    discriminator or cls.__name__
                ] = cls
