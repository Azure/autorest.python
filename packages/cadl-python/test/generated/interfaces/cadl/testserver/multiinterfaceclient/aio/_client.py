...
class MultiInterfaceClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype dogs: cadl.testserver.multiinterfaceclient.aio.operations.DogsOperations
    :ivar cats: CatsOperations operations
    :vartype cats: cadl.testserver.multiinterfaceclient.aio.operations.CatsOperations
    """
