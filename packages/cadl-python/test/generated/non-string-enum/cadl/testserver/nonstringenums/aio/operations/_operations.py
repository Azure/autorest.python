...
class IntOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~cadl.testserver.nonstringenums.aio.NonStringEnumsClient`'s
        :attr:`int` attribute.
    """
    ...
    async def put(self, input: Optional[int] = None, **kwargs: Any) -> str:
        ...
        :param input: Known values are: 200, 403, 405, 406, and 429. Default value is None.
        :type input: int
...
class FloatOperations:
    ...
    async def put(self, input: Optional[float] = None, **kwargs: Any) -> str:
        ...
        :param input: Known values are: 200.4, 403.4, 405.3, 406.2, and 429.1. Default value is None.
        :type input: float
        :keyword content_type: Body parameter Content-Type. Known values are: application/json. Default
         value is "application/json".
        :paramtype content_type: str
