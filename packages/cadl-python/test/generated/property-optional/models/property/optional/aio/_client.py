...
class OptionalClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype bytes: models.property.optional.aio.operations.BytesOperations
    :ivar datetime: DatetimeOperations operations
    :vartype datetime: models.property.optional.aio.operations.DatetimeOperations
    :ivar duration: DurationOperations operations
    :vartype duration: models.property.optional.aio.operations.DurationOperations
    :ivar collections_byte: CollectionsByteOperations operations
    :vartype collections_byte: models.property.optional.aio.operations.CollectionsByteOperations
    :ivar collections_model: CollectionsModelOperations operations
    :vartype collections_model: models.property.optional.aio.operations.CollectionsModelOperations
    :ivar required_and_optional: RequiredAndOptionalOperations operations
    :vartype required_and_optional:
     models.property.optional.aio.operations.RequiredAndOptionalOperations
    """
