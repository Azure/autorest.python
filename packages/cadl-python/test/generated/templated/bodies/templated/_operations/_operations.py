...
from .._vendor import TemplatedClientMixinABC, _format_url_section
...
def build_templated_create_or_update_user_request(id: int, *, api_version: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = "/bodies/templated/users/{id}"
