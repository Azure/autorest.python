...
class DPGClientOperationsMixin(MixinABC):
    ...
    def get_model(self, mode: Union[str, "_models.Mode"], **kwargs: Any) -> _models.Product:
        ...
        :type mode: str or ~cadl.testserver.models.Mode
        :return: Product. This object is MutableMapping-compatible.
        :rtype: ~cadl.testserver.models.Product
    ...
    def post_model(
        ...
        **kwargs: Any
        ...
        :type input: ~cadl.testserver.models.Input or JSON
    ...
    def post_model(
        ...
        :type input: ~cadl.testserver.models.Input or JSON or IO
    ...
    def get_pages(self, *, api_version: str, **kwargs: Any) -> _models.ResourceOkResponseCustomPage:
        ...
        :return: ResourceOkResponseCustomPage. This object is MutableMapping-compatible.
        :rtype: ~cadl.testserver.models.ResourceOkResponseCustomPage
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    def lro(self, mode: Union[str, "_models.Mode"], **kwargs: Any) -> _models.LROProduct:
        ...
        :param mode: The mode with which you'll be handling your returned body. 'raw' for just dealing
         ...
         before returning to users. Known values are: "raw" and "model". Required.
        :type mode: str or ~cadl.testserver.models.Mode
        :return: LROProduct. This object is MutableMapping-compatible.
        :rtype: ~cadl.testserver.models.LROProduct
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
