...
class ServiceDriven1ClientOperationsMixin(ServiceDriven1ClientMixinABC):
    ...
    @overload
    def post_parameters(self, parameter: IO, **kwargs: Any) -> _models.Message:
        """POST a JSON.
    ...
    @overload
    def post_parameters(self, parameter: JSON, **kwargs: Any) -> _models.Message:
        """POST a JSON.
    ...
    @distributed_trace
    def post_parameters(self, parameter: Union[_models.PostInput, IO, JSON], **kwargs: Any) -> _models.Message:
        """POST a JSON.
