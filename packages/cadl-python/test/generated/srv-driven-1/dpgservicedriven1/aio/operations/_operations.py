...
class ParamsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~dpgservicedriven1.aio.DPGClient`'s
    ...
    async def get_required(self, *, parameter: str, **kwargs: Any) -> _models.Message:
        ...
        :rtype: ~dpgservicedriven1.models.Message
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    async def post_parameters(
        ...
        :type parameter: ~dpgservicedriven1.models.PostInput or JSON
    ...
    async def post_parameters(self, parameter: Union[_models.PostInput, JSON, IO], **kwargs: Any) -> _models.Message:
        ...
        :type parameter: ~dpgservicedriven1.models.PostInput or JSON or IO
        :keyword content_type_path: Default value is "json". Note that overriding this default value
         may result in unsupported behavior.
        :paramtype content_type_path: str
