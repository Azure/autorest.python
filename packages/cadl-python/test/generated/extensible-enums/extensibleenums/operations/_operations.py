...
def build_string_put_known_value_request(*, json: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_string_put_unknown_value_request(*, json: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class StringOperations:
    ...
    @distributed_trace
    def get_known_value(self, **kwargs: Any) -> str:
        """get_known_value.
    ...
    @distributed_trace
    def get_unknown_value(self, **kwargs: Any) -> str:
        """get_unknown_value.
    ...
    @distributed_trace
    def put_known_value(self, body: str, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        """put_known_value.
    ...
    @distributed_trace
    def put_unknown_value(self, body: str, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        """put_unknown_value.
