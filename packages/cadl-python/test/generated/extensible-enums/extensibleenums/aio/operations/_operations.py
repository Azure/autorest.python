...
class StringOperations:
    ...
    async def get_known_value(self, **kwargs: Any) -> str:
        """get_known_value.
    ...
    @distributed_trace_async
    async def get_unknown_value(self, **kwargs: Any) -> str:
        """get_unknown_value.
    ...
    @distributed_trace_async
    async def put_known_value(self, body: str, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        """put_known_value.
