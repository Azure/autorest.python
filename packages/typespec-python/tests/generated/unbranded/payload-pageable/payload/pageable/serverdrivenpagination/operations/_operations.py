...
def build_server_driven_pagination_link_string_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/payload/pageable/server-driven-pagination/link-string"
...
def build_server_driven_pagination_nested_link_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/payload/pageable/server-driven-pagination/nested-link"
...
class ServerDrivenPaginationOperations:
    ...
    def link_string(self, **kwargs: Any) -> ItemPaged["_models2.Pet"]:
        """link_string.
    ...
    def nested_link(self, **kwargs: Any) -> ItemPaged["_models2.Pet"]:
        """nested_link.
