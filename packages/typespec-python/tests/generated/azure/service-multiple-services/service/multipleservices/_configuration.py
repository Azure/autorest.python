...
class ServiceAClientConfiguration:  # pylint: disable=too-many-instance-attributes
    """Configuration for ServiceAClient.
    ...
    def __init__(self, endpoint: str = "http://localhost:3000", **kwargs: Any) -> None:
        api_version: str = kwargs.pop("api_version", "av2")

        self.endpoint = endpoint
        self.api_version = api_version
        kwargs.setdefault("sdk_moniker", "service-multipleservices/{}".format(VERSION))
...
class ServiceBClientConfiguration:  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(self, endpoint: str = "http://localhost:3000", **kwargs: Any) -> None:
        api_version: str = kwargs.pop("api_version", "bv2")
