...
class ServiceAClient:
    ...
    :vartype sub_namespace: service.multipleservices.aio.operations.SubNamespaceOperations
    :ivar operations: Operations operations
    :vartype operations: service.multipleservices.aio.operations.Operations
