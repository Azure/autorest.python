# Specs Azure Clientgenerator Core Responseasbool client library for Python
...
```bash
python -m pip install specs-azure-clientgenerator-core-responseasbool
```
...
- An existing Specs Azure Clientgenerator Core Responseasbool instance.
