...
def build_load_test_administration_upload_test_file_request(  # pylint: disable=name-too-long
...
def build_load_test_run_list_metric_definitions_request(  # pylint: disable=name-too-long
...
def build_load_test_run_list_metric_namespaces_request(  # pylint: disable=name-too-long
    test_run_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class LoadTestAdministrationClientOperationsMixin(  # pylint: disable=name-too-long
    ...
    def create_or_update_test(
        ...
        :param test_id: Unique name for the load test, must contain only lower-case alphabetic,
         numeric, underscore or hyphen characters. Required.
        :type test_id: str
        :param body: Load test model. Is one of the following types: Test, JSON, IO[bytes] Required.
        :type body: ~azureloadtesting.models.Test or JSON or IO[bytes]
        :return: Test. The Test is compatible with MutableMapping
        :rtype: ~azureloadtesting.models.Test
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def create_or_update_app_components(
        ...
        **kwargs: Any
        ...
        :type body: ~azureloadtesting.models.TestAppComponents
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/merge-patch+json".
        :paramtype content_type: str
        :return: TestAppComponents. The TestAppComponents is compatible with MutableMapping
        :rtype: ~azureloadtesting.models.TestAppComponents
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def create_or_update_app_components(
        ...
        :param body: App Component model. Is one of the following types: TestAppComponents, JSON,
         IO[bytes] Required.
        :type body: ~azureloadtesting.models.TestAppComponents or JSON or IO[bytes]
        :return: TestAppComponents. The TestAppComponents is compatible with MutableMapping
        :rtype: ~azureloadtesting.models.TestAppComponents
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def create_or_update_server_metrics_config(
        ...
        **kwargs: Any
        ...
        :type body: ~azureloadtesting.models.TestServerMetricConfig
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/merge-patch+json".
        :paramtype content_type: str
        :return: TestServerMetricConfig. The TestServerMetricConfig is compatible with MutableMapping
        :rtype: ~azureloadtesting.models.TestServerMetricConfig
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def create_or_update_server_metrics_config(
        ...
        :type body: ~azureloadtesting.models.TestServerMetricConfig or JSON or IO[bytes]
        :return: TestServerMetricConfig. The TestServerMetricConfig is compatible with MutableMapping
        :rtype: ~azureloadtesting.models.TestServerMetricConfig
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def get_test_file(self, test_id: str, file_name: str, **kwargs: Any) -> _models.FileInfo:
        ...
        :rtype: ~azureloadtesting.models.FileInfo
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list_test_files(self, test_id: str, **kwargs: Any) -> Iterable["_models.FileInfo"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azureloadtesting.models.FileInfo]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list_tests(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azureloadtesting.models.Test]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def upload_test_file(
        ...
        **kwargs: Any
        ...
        :paramtype file_type: str or ~azureloadtesting.models.FileType
        :return: FileInfo. The FileInfo is compatible with MutableMapping
        :rtype: ~azureloadtesting.models.FileInfo
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        _request = build_load_test_administration_upload_test_file_request(
            test_id=test_id,
            file_name=file_name,
            file_type=file_type,
            content_type=content_type,
...
class LoadTestRunClientOperationsMixin(LoadTestRunClientMixinABC):
    ...
    def _test_run_initial(
        ...
        **kwargs: Any
        ...
        _request = build_load_test_run_test_run_request(
    ...
    def begin_test_run(
        ...
        **kwargs: Any
        ...
        :type resource: ~azureloadtesting.models.TestRun
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/merge-patch+json".
        :paramtype content_type: str
        ...
        :return: An instance of LROPoller that returns TestRun. The TestRun is compatible with
         MutableMapping
        :rtype: ~azure.core.polling.LROPoller[~azureloadtesting.models.TestRun]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        Example:
            .. code-block:: python
                ...
                # JSON input template you can fill out and use as your body input.
                resource = {
                    "testRunId": "str",  # Unique test run name as identifier. Required.
                    "certificate": {
                        "name": "str",  # Optional. Name of the certificate.
                        "type": "str",  # Optional. Type of certificate. "AKV_CERT_URI"
                        "value": "str"  # Optional. The value of the certificate for
    ...
    def begin_test_run(
        ...
        **kwargs: Any
        ...
        :param resource: The resource instance. Is one of the following types: TestRun, JSON, IO[bytes]
         Required.
        :type resource: ~azureloadtesting.models.TestRun or JSON or IO[bytes]
        :keyword old_test_run_id: Existing test run identifier that should be rerun, if this is
         provided, the
         test will run with the JMX file, configuration and app components from the
         existing test run. You can override the configuration values for new test run
        ...
        if cont_token:
            return LROPoller[_models.TestRun].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.TestRun](
    ...
    def create_or_update_app_components(
        ...
        **kwargs: Any
        ...
        :type test_run_id: str
        :param body: App Component model. Required.
        :type body: ~azureloadtesting.models.TestRunAppComponents
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/merge-patch+json".
        :paramtype content_type: str
        :return: TestRunAppComponents. The TestRunAppComponents is compatible with MutableMapping
        :rtype: ~azureloadtesting.models.TestRunAppComponents
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def create_or_update_app_components(
        ...
        :param body: App Component model. Is one of the following types: TestRunAppComponents, JSON,
         IO[bytes] Required.
        :type body: ~azureloadtesting.models.TestRunAppComponents or JSON or IO[bytes]
        :return: TestRunAppComponents. The TestRunAppComponents is compatible with MutableMapping
        :rtype: ~azureloadtesting.models.TestRunAppComponents
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def create_or_update_server_metrics_config(
        ...
        **kwargs: Any
        ...
        :type test_run_id: str
        :param body: Server metric configuration model. Required.
        :type body: ~azureloadtesting.models.TestRunServerMetricConfig
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/merge-patch+json".
        :paramtype content_type: str
        :return: TestRunServerMetricConfig. The TestRunServerMetricConfig is compatible with
         MutableMapping
        :rtype: ~azureloadtesting.models.TestRunServerMetricConfig
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def create_or_update_server_metrics_config(
        ...
        :type body: ~azureloadtesting.models.TestRunServerMetricConfig or JSON or IO[bytes]
        :return: TestRunServerMetricConfig. The TestRunServerMetricConfig is compatible with
         MutableMapping
        :rtype: ~azureloadtesting.models.TestRunServerMetricConfig
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def get_test_run(self, test_run_id: str, **kwargs: Any) -> _models.TestRun:
        ...
        :rtype: ~azureloadtesting.models.TestRun
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list_metric_dimension_values(
        ...
        *,
        ...
        timespan: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable["_models.DimensionValueList"]:
        ...
        :paramtype interval: str or ~azureloadtesting.models.Interval
        ...
        :return: An iterator like instance of DimensionValueList
        :rtype: ~azure.core.paging.ItemPaged[~azureloadtesting.models.DimensionValueList]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        cls: ClsType[List[_models.DimensionValueList]] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(List[_models.DimensionValueList], deserialized["value"])
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("nextLink") or None, iter(list_of_elem)
    ...
    def list_metric_definitions(
        ...
        :return: MetricDefinitionCollection. The MetricDefinitionCollection is compatible with
         MutableMapping
        :rtype: ~azureloadtesting.models.MetricDefinitionCollection
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        _request = build_load_test_run_list_metric_definitions_request(
            test_run_id=test_run_id,
            metric_namespace=metric_namespace,
            api_version=self._config.api_version,
            headers=_headers,
    ...
    def list_metric_namespaces(self, test_run_id: str, **kwargs: Any) -> _models.MetricNamespaceCollection:
        ...
        :return: MetricNamespaceCollection. The MetricNamespaceCollection is compatible with
         MutableMapping
        :rtype: ~azureloadtesting.models.MetricNamespaceCollection
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        _request = build_load_test_run_list_metric_namespaces_request(
            test_run_id=test_run_id,
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
    ...
    def list_metrics(
        ...
        **kwargs: Any
        ...
        :type body: ~azureloadtesting.models.MetricRequestPayload
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azureloadtesting.models.TimeSeriesElement]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list_metrics(
        self,
        test_run_id: str,
        body: Union[_models.MetricRequestPayload, JSON, IO[bytes]],
        *,
        aggregation: Optional[str] = None,
        interval: Optional[Union[str, _models.Interval]] = None,
        metric_name: Optional[str] = None,
        ...
        **kwargs: Any
        ...
        :type body: ~azureloadtesting.models.MetricRequestPayload or JSON or IO[bytes]
        :keyword aggregation: The aggregation. Default value is None.
        :paramtype aggregation: str
        :keyword interval: The interval (i.e. timegrain) of the query. Known values are: "PT5S",
         "PT10S", "PT1M", "PT5M", and "PT1H". Default value is None.
    ...
    def list_test_runs(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azureloadtesting.models.TestRun]
        :raises ~azure.core.exceptions.HttpResponseError:
