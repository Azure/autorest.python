...
class CertificateMetadata(_model_base.Model):
    ...
    :vartype type: str or ~azureloadtesting.models.CertificateType
...
class FileInfo(_model_base.Model):
    ...
    :vartype file_type: str or ~azureloadtesting.models.FileType
    ...
    :vartype validation_status: str or ~azureloadtesting.models.FileStatus
...
class LoadTestConfiguration(_model_base.Model):
    ...
    :vartype optional_load_test_config: ~azureloadtesting.models.OptionalLoadTestConfig
    """
...
class MetricAvailability(_model_base.Model):
    ...
    :vartype time_grain: str or ~azureloadtesting.models.TimeGrain
    """
...
class MetricDefinition(_model_base.Model):
    ...
    :vartype dimensions: list[~azureloadtesting.models.NameAndDesc]
    ...
    :vartype primary_aggregation_type: str or ~azureloadtesting.models.AggregationType
    ...
    :vartype unit: str or ~azureloadtesting.models.MetricUnit
    :ivar metric_availabilities: Metric availability specifies the time grain (aggregation interval
     or
     frequency).
    :vartype metric_availabilities: list[~azureloadtesting.models.MetricAvailability]
    """
...
class MetricDefinitionCollection(_model_base.Model):
    ...
    :vartype value: list[~azureloadtesting.models.MetricDefinition]
    """
...
class MetricNamespaceCollection(_model_base.Model):
    ...
    :vartype value: list[~azureloadtesting.models.MetricNamespace]
    """
...
class MetricRequestPayload(_model_base.Model):
    ...
    :vartype filters: list[~azureloadtesting.models.DimensionFilter]
    """
...
class PagedFileInfo(_model_base.Model):
    """Collection of files.

    All required parameters must be populated in order to send to server.

    :ivar value: The FileInfo items on this page. Required.
    :vartype value: list[~azureloadtesting.models.FileInfo]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """

    value: List["_models.FileInfo"] = rest_field()
    """The FileInfo items on this page. Required."""
...
class PagedTest(_model_base.Model):
    """Collection of tests.

    All required parameters must be populated in order to send to server.

    :ivar value: The Test items on this page. Required.
    :vartype value: list[~azureloadtesting.models.Test]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """

    value: List["_models.Test"] = rest_field()
    """The Test items on this page. Required."""
    next_link: Optional[str] = rest_field(name="nextLink")
    """The link to the next page of items."""
...
class PagedTestRun(_model_base.Model):
    """Collection of test runs.

    All required parameters must be populated in order to send to server.

    :ivar value: The TestRun items on this page. Required.
    :vartype value: list[~azureloadtesting.models.TestRun]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """

    value: List["_models.TestRun"] = rest_field()
    """The TestRun items on this page. Required."""
    next_link: Optional[str] = rest_field(name="nextLink")
    """The link to the next page of items."""
...
class PagedTimeSeriesElement(_model_base.Model):
    """The response to a metrics query.

    All required parameters must be populated in order to send to server.

    :ivar value: The TimeSeriesElement items on this page. Required.
    :vartype value: list[~azureloadtesting.models.TimeSeriesElement]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
...
class PassFailCriteria(_model_base.Model):
    ...
    :vartype pass_fail_metrics: dict[str, ~azureloadtesting.models.PassFailMetric]
    """
...
class PassFailMetric(_model_base.Model):
    ...
    :vartype client_metric: str or ~azureloadtesting.models.PFMetrics
     ...
     * ‘percentage’ - for error metric , ‘avg’, ‘p50’, ‘p90’, ‘p95’, ‘p99’, ‘min’,
     ...
     "p99", "min", and "max".
    :vartype aggregate: str or ~azureloadtesting.models.PFAgFunc
    ...
    :ivar action: Action taken after the threshold is met. Default is ‘continue’. Known values are:
     "continue" and "stop".
    :vartype action: str or ~azureloadtesting.models.PFAction
    ...
    :ivar result: Outcome of the test run. Known values are: "passed", "undetermined", and
     "failed".
    :vartype result: str or ~azureloadtesting.models.PFResult
    """
...
class Secret(_model_base.Model):
    ...
    :vartype type: str or ~azureloadtesting.models.SecretType
    """
...
class Test(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype pass_fail_criteria: ~azureloadtesting.models.PassFailCriteria
    :ivar secrets: Secrets can be stored in an Azure Key Vault or any other secret store. If the
     ...
     SECRET_VALUE.
    :vartype secrets: dict[str, ~azureloadtesting.models.Secret]
    :ivar certificate: Certificates metadata.
    :vartype certificate: ~azureloadtesting.models.CertificateMetadata
    ...
    :vartype load_test_configuration: ~azureloadtesting.models.LoadTestConfiguration
    :ivar input_artifacts: The input artifacts for the test.
    :vartype input_artifacts: ~azureloadtesting.models.TestInputArtifacts
...
class TestAppComponents(_model_base.Model):
    ...
    :vartype components: dict[str, ~azureloadtesting.models.AppComponent]
...
class TestInputArtifacts(_model_base.Model):
    ...
    :vartype config_file_info: ~azureloadtesting.models.FileInfo
    :ivar test_script_file_info: File info.
    :vartype test_script_file_info: ~azureloadtesting.models.FileInfo
    :ivar user_prop_file_info: File info.
    :vartype user_prop_file_info: ~azureloadtesting.models.FileInfo
    :ivar input_artifacts_zip_file_info: File info.
    :vartype input_artifacts_zip_file_info: ~azureloadtesting.models.FileInfo
    :ivar additional_file_info: Additional supported files for the test run.
    :vartype additional_file_info: list[~azureloadtesting.models.FileInfo]
    """
...
class TestRun(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype error_details: list[~azureloadtesting.models.ErrorDetails]
    :ivar test_run_statistics: Test run statistics.
    :vartype test_run_statistics: dict[str, ~azureloadtesting.models.TestRunStatistics]
    :ivar load_test_configuration: The load test configuration.
    :vartype load_test_configuration: ~azureloadtesting.models.LoadTestConfiguration
    :ivar test_artifacts: Collection of test run artifacts.
    :vartype test_artifacts: ~azureloadtesting.models.TestRunArtifacts
    ...
    :vartype test_result: str or ~azureloadtesting.models.PFTestResult
    ...
    :ivar status: The test run status. Known values are: "ACCEPTED", "NOTSTARTED", "PROVISIONING",
     ...
     "VALIDATION_FAILURE".
    :vartype status: str or ~azureloadtesting.models.Status
...
class TestRunArtifacts(_model_base.Model):
    ...
    :vartype input_artifacts: ~azureloadtesting.models.TestRunInputArtifacts
    :ivar output_artifacts: The output artifacts for the test run.
    :vartype output_artifacts: ~azureloadtesting.models.TestRunOutputArtifacts
    """
...
class TestRunOutputArtifacts(_model_base.Model):
    ...
    :vartype result_file_info: ~azureloadtesting.models.FileInfo
    :ivar logs_file_info: File info.
    :vartype logs_file_info: ~azureloadtesting.models.FileInfo
    """
...
class TestRunServerMetricConfig(_model_base.Model):
    ...
    :ivar metrics: Azure resource metrics collection {metric id : metrics object} (Refer :
     https://docs.microsoft.com/en-us/rest/api/monitor/metric-definitions/list#metricdefinition
     for metric id).
    :vartype metrics: dict[str, ~azureloadtesting.models.ResourceMetric]
    :ivar created_date_time: The creation datetime(ISO 8601 literal format).
    :vartype created_date_time: ~datetime.datetime
    :ivar created_by: The user that created.
    :vartype created_by: str
...
class TimeSeriesElement(_model_base.Model):
    ...
    :vartype data: list[~azureloadtesting.models.MetricValue]
    :ivar dimension_values: The dimension values.
    :vartype dimension_values: list[~azureloadtesting.models.DimensionValue]
    """
