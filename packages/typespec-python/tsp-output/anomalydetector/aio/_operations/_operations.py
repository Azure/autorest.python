...
class AnomalyDetectorClientOperationsMixin(AnomalyDetectorClientMixinABC):
    ...
    async def begin_detect_multivariate_batch_anomaly(
        ...
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[_models.MultivariateDetectionResult]:
        ...
        :return: An instance of AsyncLROPoller that returns MultivariateDetectionResult. The
         MultivariateDetectionResult is compatible with MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~anomalydetector.models.MultivariateDetectionResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_detect_multivariate_batch_anomaly(
        ...
        if cont_token is None:
            raw_result = await self._detect_multivariate_batch_anomaly_initial(
                model_id=model_id,
                options=options,
                content_type=content_type,
                cls=lambda x, y, z: x,
    ...
    async def detect_multivariate_last_anomaly(
        ...
        :param model_id: Model identifier. Required.
        :type model_id: str
        :param options: Request of last detection. Is one of the following types:
