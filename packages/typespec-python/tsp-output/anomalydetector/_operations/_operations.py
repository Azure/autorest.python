...
class AnomalyDetectorClientOperationsMixin(AnomalyDetectorClientMixinABC):
    ...
    def _detect_multivariate_batch_anomaly_initial(
    ...
    def begin_detect_multivariate_batch_anomaly(
        ...
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.MultivariateDetectionResult]:
        ...
        :return: An instance of LROPoller that returns MultivariateDetectionResult. The
         MultivariateDetectionResult is compatible with MutableMapping
        :rtype: ~azure.core.polling.LROPoller[~anomalydetector.models.MultivariateDetectionResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_detect_multivariate_batch_anomaly(
        ...
        if cont_token is None:
            raw_result = self._detect_multivariate_batch_anomaly_initial(
                model_id=model_id,
                options=options,
                content_type=content_type,
                cls=lambda x, y, z: x,
