...
from testpreparer import LegacyPreparer
from testpreparer_async import LegacyClientTestBaseAsync


@pytest.mark.skip("you may need to update the auto-generated test case before run it")
class TestLegacyCreateResourcePollViaOperationLocationOperationsAsync(LegacyClientTestBaseAsync):
    @LegacyPreparer()
