...
def build_create_resource_poll_via_operation_location_and_resource_location_polling_operation_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/azure/core/lro/rpc/legacy/create-resource-poll-via-operation-location-final-result-in-resource-location/operations/{operationId}"  # pylint: disable=line-too-long
    path_format_arguments = {
...
def build_create_resource_poll_via_operation_location_and_resource_location_get_model_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/azure/core/lro/rpc/legacy/create-resource-poll-via-operation-location-final-result-in-resource-location/documentModels/{modelId}"  # pylint: disable=line-too-long
    path_format_arguments = {
...
def build_create_resource_poll_via_operation_location_and_resource_location_build_model_request(  # pylint: disable=name-too-long
    **kwargs: Any,
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2022-12-01-preview"))
    # Construct URL
    _url = "/azure/core/lro/rpc/legacy/create-resource-poll-via-operation-location-final-result-in-resource-location/documentModels:build"  # pylint: disable=line-too-long
...
class CreateResourcePollViaOperationLocationAndResourceLocationOperations:  # pylint: disable=name-too-long
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        Instead, you should access the following operations through
        :class:`~azurecore.lro.rpclegacy.LegacyClient`'s
        :attr:`create_resource_poll_via_operation_location_and_resource_location` attribute.
    """
    ...
    @distributed_trace
    def _polling_operation(  # pylint: disable=protected-access
        self, operation_id: str, **kwargs: Any
    ) -> _models._models.OperationDetails:
        # pylint: disable=line-too-long
        """Polling operation.
        ...
        :rtype: ~azurecore.lro.rpclegacy.models.OperationDetails
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        cls: ClsType[_models._models.OperationDetails] = kwargs.pop("cls", None)  # pylint: disable=protected-access

        _request = build_create_resource_poll_via_operation_location_and_resource_location_polling_operation_request(
        ...
        if _stream:
            ...
            deserialized = _deserialize(
                _models._models.OperationDetails, response.json()  # pylint: disable=protected-access
            )
    ...
    def get_model(self, model_id: str, **kwargs: Any) -> _models.DocumentModelDetails:
        ...
        :rtype: ~azurecore.lro.rpclegacy.models.DocumentModelDetails
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        _request = build_create_resource_poll_via_operation_location_and_resource_location_get_model_request(
            model_id=model_id,
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
    ...
    def _build_model_initial(  # pylint: disable=inconsistent-return-statements
        self, body: Union[_models.DocumentModel, JSON, IO[bytes]], **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
        ...
        _request = build_create_resource_poll_via_operation_location_and_resource_location_build_model_request(
            content_type=content_type,
            api_version=self._config.api_version,
            content=_content,
            headers=_headers,
    ...
    def begin_build_model(
        self, body: _models.DocumentModel, *, content_type: str = "application/json", **kwargs: Any
    ) -> LROPoller[_models.DocumentModelDetails]:
        """Creates a Model.

        :param body: Required.
        :type body: ~azurecore.lro.rpclegacy.models.DocumentModel
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns DocumentModelDetails. The DocumentModelDetails
         is compatible with MutableMapping
        :rtype: ~azure.core.polling.LROPoller[~azurecore.lro.rpclegacy.models.DocumentModelDetails]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        Example:
            .. code-block:: python
                ...
                # JSON input template you can fill out and use as your body input.
                body = {
                    "description": "str",  # Document model description. Required.
    ...
    def begin_build_model(
        ...
        :param body: Is one of the following types: DocumentModel, JSON, IO[bytes] Required.
        :type body: ~azurecore.lro.rpclegacy.models.DocumentModel or JSON or IO[bytes]
        :keyword content_type: Body parameter Content-Type. Known values are: application/json. Default
         value is None.
        :paramtype content_type: str
        :return: An instance of LROPoller that returns DocumentModelDetails. The DocumentModelDetails
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._build_model_initial(  # type: ignore
                body=body, content_type=content_type, cls=lambda x, y, z: x, headers=_headers, params=_params, **kwargs
            )
        kwargs.pop("error_map", None)
