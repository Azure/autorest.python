...
class AzureSphereClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype operations: azure.mgmt.spherejson.operations.Operations
    :ivar catalogs: CatalogsOperations operations
    :vartype catalogs: azure.mgmt.spherejson.operations.CatalogsOperations
    :ivar images: ImagesOperations operations
    :vartype images: azure.mgmt.spherejson.operations.ImagesOperations
    :ivar device_groups: DeviceGroupsOperations operations
    :vartype device_groups: azure.mgmt.spherejson.operations.DeviceGroupsOperations
    :ivar certificates: CertificatesOperations operations
    :vartype certificates: azure.mgmt.spherejson.operations.CertificatesOperations
    :ivar deployments: DeploymentsOperations operations
    :vartype deployments: azure.mgmt.spherejson.operations.DeploymentsOperations
    :ivar devices: DevicesOperations operations
    :vartype devices: azure.mgmt.spherejson.operations.DevicesOperations
    :ivar products: ProductsOperations operations
    :vartype products: azure.mgmt.spherejson.operations.ProductsOperations
