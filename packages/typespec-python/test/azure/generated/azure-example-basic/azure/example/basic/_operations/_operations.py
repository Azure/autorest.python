...
class AzureExampleClientOperationsMixin(AzureExampleClientMixinABC):
    ...
    def basic_action(
        ...
        **kwargs: Any
        ...
        :param body: Required.
        :type body: ~azure.example.basic.models.ActionRequest
        ...
        :rtype: ~azure.example.basic.models.ActionResponse
    ...
    def basic_action(
        ...
        :type body: ~azure.example.basic.models.ActionRequest or JSON or IO[bytes]
        :keyword query_param: Required.
        :paramtype query_param: str
        :keyword header_param: Required.
        :paramtype header_param: str
