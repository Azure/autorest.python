...
from ...specs.azure.example.basic import models as _models
...
class AzureExampleClientOperationsMixin(AzureExampleClientMixinABC):
    ...
    def basic_action(
        ...
        **kwargs: Any
        ...
        :param body: Required.
        :type body: ~azureexamplebasicclient.models.ActionRequest
        ...
        :rtype: ~azureexamplebasicclient.models.ActionResponse
    ...
    def basic_action(
        ...
        :type body: ~azureexamplebasicclient.models.ActionRequest or JSON or IO[bytes]
        :keyword query_param: Required.
        :paramtype query_param: str
        :keyword header_param: Required.
        :paramtype header_param: str
