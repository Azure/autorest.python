...
class Solution(_Model):
    ...
    :ivar properties_optional:
    :vartype properties_optional:
     ~specs.azure.clientgenerator.core.flattenproperty.models.SolutionProperties
    """

    name: str = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """Required."""
    properties: "_models.SolutionProperties" = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """Required."""
    properties_optional: Optional["_models.SolutionProperties"] = rest_field(
        name="propertiesOptional", visibility=["read", "create", "update", "delete", "query"]
    )

    __flattened_items = ["solution_id", "title", "content", "solution_id", "title", "content"]
    ...
    def __init__(
        ...
        *,
        name: str,
        properties: "_models.SolutionProperties",
        properties_optional: Optional["_models.SolutionProperties"] = None,
    ) -> None: ...
