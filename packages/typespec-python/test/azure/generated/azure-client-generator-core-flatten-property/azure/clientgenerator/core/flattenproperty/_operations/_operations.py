...
def build_flatten_property_put_flatten_model_request(**kwargs: Any) -> HttpRequest:
...
def build_flatten_property_put_nested_flatten_model_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
