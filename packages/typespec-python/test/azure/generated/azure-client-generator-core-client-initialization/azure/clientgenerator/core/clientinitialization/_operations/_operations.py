...
class HeaderParamClientOperationsMixin(HeaderParamClientMixinABC):
    ...
    def with_body(self, body: _models.Input, *, content_type: str = "application/json", **kwargs: Any) -> None:
        ...
        :param body: Required.
        :type body: ~azure.clientgenerator.core.clientinitialization.models.Input
    ...
    def with_body(  # pylint: disable=inconsistent-return-statements
        ...
        :type body: ~azure.clientgenerator.core.clientinitialization.models.Input or JSON or IO[bytes]
        :return: None
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
...
class MixedParamsClientOperationsMixin(MixedParamsClientMixinABC):
    ...
    def with_body(
        ...
        :param body: Required.
        :type body: ~azure.clientgenerator.core.clientinitialization.models.WithBodyRequest
        :keyword region: Required.
        :paramtype region: str
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
    ...
    def with_body(  # pylint: disable=inconsistent-return-statements
        ...
        :type body: ~azure.clientgenerator.core.clientinitialization.models.WithBodyRequest or JSON or
         IO[bytes]
        :keyword region: Required.
        :paramtype region: str
        :return: None
...
class PathParamClientOperationsMixin(PathParamClientMixinABC):
    ...
    def get_standalone(self, **kwargs: Any) -> _models.BlobProperties:
        ...
        :rtype: ~azure.clientgenerator.core.clientinitialization.models.BlobProperties
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
