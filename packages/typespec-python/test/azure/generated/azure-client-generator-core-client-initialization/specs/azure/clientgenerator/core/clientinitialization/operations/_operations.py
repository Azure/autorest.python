...
def build_child_client_with_query_request(
    blob_name: str, *, format: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})

    # Construct URL
    _url = "/azure/client-generator-core/client-initialization/child-client/{blobName}/with-query"
    path_format_arguments = {
        "blobName": _SERIALIZER.url("blob_name", blob_name, "str"),
    }
...
def build_child_client_get_standalone_request(  # pylint: disable=name-too-long
    blob_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    # Construct URL
    _url = "/azure/client-generator-core/client-initialization/child-client/{blobName}/get-standalone"
    path_format_arguments = {
        "blobName": _SERIALIZER.url("blob_name", blob_name, "str"),
    }
...
def build_child_client_delete_standalone_request(  # pylint: disable=name-too-long
    blob_name: str, **kwargs: Any
) -> HttpRequest:
    # Construct URL
    _url = "/azure/client-generator-core/client-initialization/child-client/{blobName}"
    path_format_arguments = {
        "blobName": _SERIALIZER.url("blob_name", blob_name, "str"),
    }
...
class ChildClientOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~specs.azure.clientgenerator.core.clientinitialization.ParentClient`'s
