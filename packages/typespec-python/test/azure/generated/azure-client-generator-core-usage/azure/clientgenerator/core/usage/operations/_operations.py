...
from ......specs.azure.clientgenerator.core.usage import models as _specs_azure_clientgenerator_core_usage_models10
...
class ModelInOperationOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.clientgenerator.core.usage.UsageClient`'s
    ...
    def input_to_input_output(
        self,
        body: _specs_azure_clientgenerator_core_usage_models10.InputModel,
        *,
        ...
        **kwargs: Any,
        ...
        :param body: Required.
        :type body: ~azure.clientgenerator.core.usage.models.InputModel
    ...
    def input_to_input_output(  # pylint: disable=inconsistent-return-statements
        self, body: Union[_specs_azure_clientgenerator_core_usage_models10.InputModel, JSON, IO[bytes]], **kwargs: Any
    ) -> None:
        """Expected body parameter:
        ...
        :type body: ~azure.clientgenerator.core.usage.models.InputModel or JSON or IO[bytes]
        :return: None
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @distributed_trace
    def output_to_input_output(self, **kwargs: Any) -> _specs_azure_clientgenerator_core_usage_models10.OutputModel:
        ...
        :rtype: ~azure.clientgenerator.core.usage.models.OutputModel
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        cls: ClsType[_specs_azure_clientgenerator_core_usage_models10.OutputModel] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_specs_azure_clientgenerator_core_usage_models10.OutputModel, response.json())
    ...
    def model_in_read_only_property(
        self,
        body: _specs_azure_clientgenerator_core_usage_models10.RoundTripModel,
        *,
        content_type: str = "application/json",
        **kwargs: Any,
    ) -> _specs_azure_clientgenerator_core_usage_models10.RoundTripModel:
        ...
        :param body: Required.
        :type body: ~azure.clientgenerator.core.usage.models.RoundTripModel
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: RoundTripModel. The RoundTripModel is compatible with MutableMapping
        :rtype: ~azure.clientgenerator.core.usage.models.RoundTripModel
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def model_in_read_only_property(
        self,
        body: Union[_specs_azure_clientgenerator_core_usage_models10.RoundTripModel, JSON, IO[bytes]],
        **kwargs: Any,
    ) -> _specs_azure_clientgenerator_core_usage_models10.RoundTripModel:
        """ "ResultModel" should be usage=output, as it is read-only and does not exist in request body.
        ...
        :type body: ~azure.clientgenerator.core.usage.models.RoundTripModel or JSON or IO[bytes]
        :return: RoundTripModel. The RoundTripModel is compatible with MutableMapping
        :rtype: ~azure.clientgenerator.core.usage.models.RoundTripModel
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_specs_azure_clientgenerator_core_usage_models10.RoundTripModel] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(
                _specs_azure_clientgenerator_core_usage_models10.RoundTripModel, response.json()
            )
