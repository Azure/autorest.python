...
from ...operations._operations import (
    build_nested_proxy_resources_create_or_replace_request,
    build_nested_proxy_resources_delete_request,
    ...
    build_top_level_tracked_resources_get_request,
    build_top_level_tracked_resources_list_by_resource_group_request,
    build_top_level_tracked_resources_list_by_subscription_request,
    build_top_level_tracked_resources_update_request,
)
...
class TopLevelTrackedResourcesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.arm.models.resources.aio.ResourcesClient`'s
    ...
    async def begin_create_or_replace(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.arm.models.resources.models.TopLevelTrackedResource]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list_by_resource_group(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.arm.models.resources.models.TopLevelTrackedResource]
        :raises ~azure.core.exceptions.HttpResponseError:
...
class NestedProxyResourcesOperations:
        ...
        Example:
            .. code-block:: python
                ...
                response == {
                    ...
                    "name": "str",  # Optional. The name of the resource.
                    "properties": {
                        "description": "str",  # Optional. Nested resource description.
                        "provisioningState": "str"  # Optional. Provisioning State of the
                          nested child Resource. Known values are: "Succeeded", "Failed", "Canceled",
                          "Provisioning", "Updating", "Deleting", and "Accepted".
                    },
                    "systemData": {
                        "createdAt": "2020-02-20 00:00:00",  # Optional. The timestamp of
    ...
    async def begin_create_or_replace(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.arm.models.resources.models.NestedProxyResource]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list_by_top_level_tracked_resource(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.arm.models.resources.models.NestedProxyResource]
        :raises ~azure.core.exceptions.HttpResponseError:
