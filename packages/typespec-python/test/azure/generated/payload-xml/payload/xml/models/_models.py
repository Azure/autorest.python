...
class ModelWithEncodedNames(_model_base.Model):
    ...
    model_data: "_models.SimpleModel" = rest_field(name="modelData")
    """Required."""
...
class ModelWithRenamedFields(_model_base.Model):
    ...
    input_data: "_models.SimpleModel" = rest_field(name="inputData")
    """Required."""
    output_data: "_models.SimpleModel" = rest_field(name="outputData")
    """Required."""
