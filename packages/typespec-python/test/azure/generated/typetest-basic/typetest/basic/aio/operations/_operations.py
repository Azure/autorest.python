...
class DecimalTypeOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~typetest.basic.aio.BasicClient`'s
    ...
    async def response_body(self, **kwargs: Any) -> float:
        """response_body.
    ...
    @distributed_trace_async
    async def request_body(self, body: float, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        """request_body.
