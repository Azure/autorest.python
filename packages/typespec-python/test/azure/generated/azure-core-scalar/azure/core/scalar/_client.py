...
from ....specs.azure.core.scalar.operations import AzureLocationScalarOperations
...
class ScalarClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype azure_location_scalar: azure.core.scalar.operations.AzureLocationScalarOperations
