...
from .......azure.core.scalar.aio._configuration import ScalarClientConfiguration
...
class AzureLocationScalarOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.core.scalar.aio.ScalarClient`'s
    ...
    @overload
    async def post(
        self, body: _models2.AzureLocationModel, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models2.AzureLocationModel:
    ...
    @distributed_trace_async
    async def post(
        self, body: Union[_models2.AzureLocationModel, JSON, IO[bytes]], **kwargs: Any
    ) -> _models2.AzureLocationModel:
        """post a model which has azureLocation property.
        ...
        cls: ClsType[_models2.AzureLocationModel] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models2.AzureLocationModel, response.json())
