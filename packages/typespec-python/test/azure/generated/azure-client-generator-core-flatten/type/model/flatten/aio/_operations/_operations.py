...
class FlattenClientOperationsMixin(FlattenClientMixinABC):
    ...
    async def put_flatten_model(
        ...
        :type input: ~type.model.flatten.models.FlattenModel or JSON or IO[bytes]
        :return: FlattenModel. The FlattenModel is compatible with MutableMapping
        :rtype: ~type.model.flatten.models.FlattenModel
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def put_nested_flatten_model(
        ...
        :param input: Required.
        :type input: ~type.model.flatten.models.NestedFlattenModel
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: NestedFlattenModel. The NestedFlattenModel is compatible with MutableMapping
        :rtype: ~type.model.flatten.models.NestedFlattenModel
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def put_nested_flatten_model(
        ...
        :type input: ~type.model.flatten.models.NestedFlattenModel or JSON or IO[bytes]
        :return: NestedFlattenModel. The NestedFlattenModel is compatible with MutableMapping
        :rtype: ~type.model.flatten.models.NestedFlattenModel
        :raises ~azure.core.exceptions.HttpResponseError:
