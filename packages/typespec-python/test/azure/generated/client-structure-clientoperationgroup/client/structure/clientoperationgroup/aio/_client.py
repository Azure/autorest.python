...
class FirstClient(_FirstClientOperationsMixin):  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype first_client_group3:
     client.structure.clientoperationgroup.aio.operations.FirstClientGroup3Operations
    :ivar first_client_group4: FirstClientGroup4Operations operations
    :vartype first_client_group4:
     client.structure.clientoperationgroup.aio.operations.FirstClientGroup4Operations
...
class SecondClient(_SecondClientOperationsMixin):  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype second_client_group5:
     client.structure.clientoperationgroup.aio.operations.SecondClientGroup5Operations
    :param endpoint: Need to be set as '`http://localhost:3000 <http://localhost:3000>`_' in
     client. Required.
    :type endpoint: str
    :param client: Need to be set as 'default', 'multi-client', 'renamed-operation',
    ...
    def __init__(  # pylint: disable=missing-client-constructor-parameter-credential
        ...
        _endpoint = "{endpoint}/client/structure/{client}"
        self._config = SecondClientConfiguration(endpoint=endpoint, client=client, **kwargs)
