...
def build_virtual_machines_get_request(
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachinesOld/{vmName}"
...
def build_disks_get_request(
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2024-03-02"))
    accept = _headers.pop("Accept", "application/json")

    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/disksOld/{diskName}"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
...
class VirtualMachinesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.resourcemanager.multiserviceolderversions.combined.CombinedClient`'s
    ...
    def get(self, resource_group_name: str, vm_name: str, **kwargs: Any) -> _models.VirtualMachine:
        ...
        :rtype: ~azure.resourcemanager.multiserviceolderversions.combined.models.VirtualMachine
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.resourcemanager.multiserviceolderversions.combined.models.VirtualMachine
        ...
        :return: An instance of LROPoller that returns VirtualMachine. The VirtualMachine is compatible
         with MutableMapping
        :rtype:
         ~azure.core.polling.LROPoller[~azure.resourcemanager.multiserviceolderversions.combined.models.VirtualMachine]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
...
class DisksOperations:
    ...
    def get(self, resource_group_name: str, disk_name: str, **kwargs: Any) -> _models.Disk:
        ...
        :rtype: ~azure.resourcemanager.multiserviceolderversions.combined.models.Disk
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type disk_name: str
        :param resource: Resource create parameters. Required.
        :type resource: ~azure.resourcemanager.multiserviceolderversions.combined.models.Disk
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns Disk. The Disk is compatible with MutableMapping
        :rtype:
         ~azure.core.polling.LROPoller[~azure.resourcemanager.multiserviceolderversions.combined.models.Disk]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        :param resource: Resource create parameters. Is one of the following types: Disk, JSON,
         IO[bytes] Required.
        :type resource: ~azure.resourcemanager.multiserviceolderversions.combined.models.Disk or JSON
         or IO[bytes]
        :return: An instance of LROPoller that returns Disk. The Disk is compatible with MutableMapping
        :rtype:
         ~azure.core.polling.LROPoller[~azure.resourcemanager.multiserviceolderversions.combined.models.Disk]
