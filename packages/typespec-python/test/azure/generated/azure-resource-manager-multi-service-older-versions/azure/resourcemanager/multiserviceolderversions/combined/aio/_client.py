...
class CombinedClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype virtual_machines:
     azure.resourcemanager.multiserviceolderversions.combined.aio.operations.VirtualMachinesOperations
    :ivar disks: DisksOperations operations
    :vartype disks:
     azure.resourcemanager.multiserviceolderversions.combined.aio.operations.DisksOperations
