...
from ......azure.core.page._configuration import PageClientConfiguration
...
class TwoModelsAsPageItemOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.core.page.PageClient`'s
    ...
    @distributed_trace
    def list_first_item(self, **kwargs: Any) -> Iterable["_models1.FirstItem"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.core.page.models.FirstItem]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}

        cls: ClsType[List[_models1.FirstItem]] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            ...
            list_of_elem = _deserialize(List[_models1.FirstItem], deserialized.get("value", []))
            if cls:
    ...
    @distributed_trace
    def list_second_item(self, **kwargs: Any) -> Iterable["_models1.SecondItem"]:
        """Two operations with two different page item types should be successfully generated. Should
        generate model for SecondItem.

        :return: An iterator like instance of SecondItem
        :rtype: ~azure.core.paging.ItemPaged[~azure.core.page.models.SecondItem]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}

        cls: ClsType[List[_models1.SecondItem]] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(List[_models1.SecondItem], deserialized.get("value", []))
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("nextLink") or None, iter(list_of_elem)
