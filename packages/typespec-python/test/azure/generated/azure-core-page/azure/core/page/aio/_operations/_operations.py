...
from ......specs.azure.core.page import models as _specs_azure_core_page_models9
...
class PageClientOperationsMixin(PageClientMixinABC):
    ...
    @distributed_trace
    def list_with_page(self, **kwargs: Any) -> AsyncIterable["_specs_azure_core_page_models9.User"]:
        """List with Azure.Core.Page<>.

        :return: An iterator like instance of User
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.core.page.models.User]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}

        cls: ClsType[List[_specs_azure_core_page_models9.User]] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            ...
            list_of_elem = _deserialize(List[_specs_azure_core_page_models9.User], deserialized.get("value", []))
            if cls:
    ...
    def list_with_parameters(
        self,
        body_input: _specs_azure_core_page_models9.ListItemInputBody,
        *,
        another: Optional[Union[str, _specs_azure_core_page_models9.ListItemInputExtensibleEnum]] = None,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncIterable["_specs_azure_core_page_models9.User"]:
    ...
    def list_with_parameters(
        self,
        body_input: Union[_specs_azure_core_page_models9.ListItemInputBody, JSON, IO[bytes]],
        *,
        another: Optional[Union[str, _specs_azure_core_page_models9.ListItemInputExtensibleEnum]] = None,
        **kwargs: Any
    ) -> AsyncIterable["_specs_azure_core_page_models9.User"]:
    ...
    @distributed_trace
    def list_with_custom_page_model(self, **kwargs: Any) -> AsyncIterable["_specs_azure_core_page_models9.User"]:
        ...
        async def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(List[_specs_azure_core_page_models9.User], deserialized.get("items", []))
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("nextLink") or None, AsyncList(list_of_elem)
    ...
    def with_parameterized_next_link(
        ...
        async def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(List[_specs_azure_core_page_models9.User], deserialized.get("values", []))
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("nextLink") or None, AsyncList(list_of_elem)
