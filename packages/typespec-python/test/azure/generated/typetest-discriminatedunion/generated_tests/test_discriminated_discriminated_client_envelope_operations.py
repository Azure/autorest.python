...
class TestDiscriminatedDiscriminatedClientEnvelopeOperations(DiscriminatedClientTestBase):
    ...
    def test_discriminated_client_envelope_discriminated_client_envelope_object_discriminated_client_envelope_object_default_get(
        ...
        response = (
            client.discriminated_client_envelope.discriminated_client_envelope_object.discriminated_client_envelope_object_default.get()
        )
    ...
    def test_discriminated_client_envelope_discriminated_client_envelope_object_discriminated_client_envelope_object_default_put(
        ...
        client = self.create_client(endpoint=discriminated_endpoint)
        response = client.discriminated_client_envelope.discriminated_client_envelope_object.discriminated_client_envelope_object_default.put(
    ...
    def test_discriminated_client_envelope_discriminated_client_envelope_object_discriminated_client_envelope_object_custom_properties_get(
        ...
        client = self.create_client(endpoint=discriminated_endpoint)
        response = (
            client.discriminated_client_envelope.discriminated_client_envelope_object.discriminated_client_envelope_object_custom_properties.get()
        )
    ...
    def test_discriminated_client_envelope_discriminated_client_envelope_object_discriminated_client_envelope_object_custom_properties_put(
        ...
        client = self.create_client(endpoint=discriminated_endpoint)
        response = client.discriminated_client_envelope.discriminated_client_envelope_object.discriminated_client_envelope_object_custom_properties.put(
            input={"meow": bool, "name": "str"},
        )
