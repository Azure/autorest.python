...
from ...operations._operations import (
    build_combined_storage_accounts_create_or_update_request,
    build_combined_storage_accounts_get_request,
...
class CombinedVirtualMachinesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.resourcemanager.multiservicesharedmodels.combined.aio.CombinedClient`'s
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.resourcemanager.multiservicesharedmodels.combined.models.VirtualMachine]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
...
class CombinedStorageAccountsOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        Instead, you should access the following operations through
        :class:`~azure.resourcemanager.multiservicesharedmodels.combined.aio.CombinedClient`'s
        :attr:`combined_storage_accounts` attribute.
    """
    ...
    @distributed_trace_async
    async def get(self, resource_group_name: str, account_name: str, **kwargs: Any) -> _models.StorageAccount:
        ...
        _request = build_combined_storage_accounts_get_request(
            resource_group_name=resource_group_name,
    ...
    async def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        _request = build_combined_storage_accounts_create_or_update_request(
            resource_group_name=resource_group_name,
            account_name=account_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns StorageAccount. The StorageAccount is
         compatible with MutableMapping
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.resourcemanager.multiservicesharedmodels.combined.models.StorageAccount]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
