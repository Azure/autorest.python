...
from ......typetest.property.additionalproperties._model_base import SdkJSONEncoder, _deserialize
...
class SpreadRecordDiscriminatedUnionOperations:
    ...
    @distributed_trace_async
    async def put(self, body: Union[_models.SpreadRecordForDiscriminatedUnion, JSON, IO[bytes]], **kwargs: Any) -> None:
        """Put operation.
