...
def build_azure_core_embedding_vector_get_request(**kwargs: Any) -> HttpRequest:
...
def build_azure_core_embedding_vector_put_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_azure_core_embedding_vector_post_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
