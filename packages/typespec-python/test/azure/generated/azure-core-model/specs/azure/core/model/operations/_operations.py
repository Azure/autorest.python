...
from ......azure.core.model._configuration import ModelClientConfiguration
...
class AzureCoreEmbeddingVectorOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.core.model.ModelClient`'s
    ...
    @overload
    def post(
        self, body: _models1.AzureEmbeddingModel, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models1.AzureEmbeddingModel:
    ...
    @distributed_trace
    def post(
        self, body: Union[_models1.AzureEmbeddingModel, JSON, IO[bytes]], **kwargs: Any
    ) -> _models1.AzureEmbeddingModel:
        """post a model which has an embeddingVector property.
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models1.AzureEmbeddingModel] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models1.AzureEmbeddingModel, response.json())
