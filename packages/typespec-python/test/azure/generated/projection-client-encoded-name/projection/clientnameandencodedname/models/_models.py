...
class ClientClientNameAndEncodedNameModel(_model_base.Model):
...
class JsonAndClientClientNameAndEncodedNameModel(_model_base.Model):  # pylint: disable=name-too-long
...
class JsonClientNameAndEncodedNameModel(_model_base.Model):
...
class LanguageClientNameAndEncodedNameModel(_model_base.Model):
