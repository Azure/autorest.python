...
from ......specs.azure.core.lro.standard import models as _specs_azure_core_lro_standard_models10
...
class StandardClientOperationsMixin(StandardClientMixinABC):
    ...
    def _create_or_replace_initial(
        self, name: str, resource: Union[_specs_azure_core_lro_standard_models10.User, JSON, IO[bytes]], **kwargs: Any
    ) -> Iterator[bytes]:
    ...
    def begin_create_or_replace(
        self,
        name: str,
        resource: _specs_azure_core_lro_standard_models10.User,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_specs_azure_core_lro_standard_models10.User]:
    ...
    def begin_create_or_replace(
        ...
        :param resource: The resource instance. Is one of the following types: User, JSON, IO[bytes]
         Required.
        :type resource: ~azure.core.lro.standard.models.User or JSON or IO[bytes]
        :return: An instance of LROPoller that returns User. The User is compatible with MutableMapping
        :rtype: ~azure.core.polling.LROPoller[~azure.core.lro.standard.models.User]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_specs_azure_core_lro_standard_models10.User] = kwargs.pop("cls", None)
        ...
        def get_long_running_output(pipeline_response):
            ...
            deserialized = _deserialize(_specs_azure_core_lro_standard_models10.User, response.json())
            if cls:
                return cls(pipeline_response, deserialized, response_headers)  # type: ignore
            return deserialized
        ...
        if cont_token:
            return LROPoller[_specs_azure_core_lro_standard_models9.User].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_specs_azure_core_lro_standard_models9.User](
    ...
    def begin_export(
    ...
    ) -> LROPoller[_specs_azure_core_lro_standard_models10.ExportedUser]:
        """Exports a user.
        ...
        :return: An instance of LROPoller that returns ExportedUser. The ExportedUser is compatible
         with MutableMapping
        :rtype: ~azure.core.polling.LROPoller[~azure.core.lro.standard.models.ExportedUser]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}

        cls: ClsType[_specs_azure_core_lro_standard_models10.ExportedUser] = kwargs.pop("cls", None)
        polling: Union[bool, PollingMethod] = kwargs.pop("polling", True)
        lro_delay = kwargs.pop("polling_interval", self._config.polling_interval)
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
        ...
        def get_long_running_output(pipeline_response):
            ...
            deserialized = _deserialize(
                _specs_azure_core_lro_standard_models10.ExportedUser, response.json().get("result", {})
            )
            if cls:
                return cls(pipeline_response, deserialized, response_headers)  # type: ignore
            return deserialized
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[_specs_azure_core_lro_standard_models9.ExportedUser].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_specs_azure_core_lro_standard_models9.ExportedUser](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
