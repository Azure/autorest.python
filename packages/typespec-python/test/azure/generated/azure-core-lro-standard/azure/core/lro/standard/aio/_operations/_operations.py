...
class StandardClientOperationsMixin(StandardClientMixinABC):
    ...
    async def begin_create_or_replace(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns User. The User is compatible with
         MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.core.lro.standard.models.User]
    ...
    async def begin_export(
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.core.lro.standard.models.ExportedUser]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
