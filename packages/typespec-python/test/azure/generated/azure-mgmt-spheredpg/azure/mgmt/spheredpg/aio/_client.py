...
class AzureSphereClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype operations: azure.mgmt.spheredpg.aio.operations.Operations
    :ivar custom_update_operations: CustomUpdateOperationsOperations operations
    :vartype custom_update_operations:
     azure.mgmt.spheredpg.aio.operations.CustomUpdateOperationsOperations
    :ivar catalogs: CatalogsOperations operations
    :vartype catalogs: azure.mgmt.spheredpg.aio.operations.CatalogsOperations
    :ivar images: ImagesOperations operations
    :vartype images: azure.mgmt.spheredpg.aio.operations.ImagesOperations
    :ivar device_groups: DeviceGroupsOperations operations
    :vartype device_groups: azure.mgmt.spheredpg.aio.operations.DeviceGroupsOperations
    :ivar certificates: CertificatesOperations operations
    :vartype certificates: azure.mgmt.spheredpg.aio.operations.CertificatesOperations
    :ivar deployments: DeploymentsOperations operations
    :vartype deployments: azure.mgmt.spheredpg.aio.operations.DeploymentsOperations
