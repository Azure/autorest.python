...
class TestAzureSphereDevicesOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_list_by_device_group(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_begin_generate_capability_image(self, resource_group):
        response = self.client.devices.begin_generate_capability_image(
            resource_group_name=resource_group.name,
            catalog_name="str",
            product_name="str",
            device_group_name="str",
