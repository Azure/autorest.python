...
class ResourceGroupResource(TrackedResource):
    ...
    def __init__(
        ...
        *,
        location: str,
        tags: Optional[dict[str, str]] = None,
        properties: Optional["_models.ResourceGroupResourceProperties"] = None,
    ) -> None: ...
...
class ResourceGroupResourceProperties(_Model):
    ...
    def __init__(
        self,
        *,
        resource_group_setting: Optional[str] = None,
    ) -> None: ...
...
class SubscriptionResource(ProxyResource):
    ...
    def __init__(
        self,
        *,
        properties: Optional["_models.SubscriptionResourceProperties"] = None,
    ) -> None: ...
...
class SubscriptionResource1(ProxyResource):
    ...
    def __init__(
        self,
        *,
        properties: Optional["_models.SubscriptionResource1Properties"] = None,
    ) -> None: ...
...
class SubscriptionResource2(ProxyResource):
    ...
    def __init__(
        self,
        *,
        properties: Optional["_models.SubscriptionResource2Properties"] = None,
    ) -> None: ...
...
class SubscriptionResourceProperties(_Model):
    ...
    def __init__(
        self,
        *,
        subscription_setting: Optional[str] = None,
    ) -> None: ...
