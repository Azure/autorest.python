...
from ..._operations._operations import build_hierarchy_building_update_dog_request, build_hierarchy_building_update_pet_request
...
class _HierarchyBuildingClientOperationsMixin( 
    ClientMixinABC[AsyncPipelineClient[HttpRequest, AsyncHttpResponse], HierarchyBuildingClientConfiguration]
):
