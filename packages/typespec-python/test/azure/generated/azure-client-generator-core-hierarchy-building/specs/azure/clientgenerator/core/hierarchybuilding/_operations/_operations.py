...
def build_hierarchy_building_update_pet_request(  # pylint: disable=name-too-long
    **kwargs: Any
) -> HttpRequest:
    ...
    # Construct URL
    _url = "/azure/client-generator-core/hierarchy-building/animal/pet"
...
def build_hierarchy_building_update_dog_request(  # pylint: disable=name-too-long
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    # Construct URL
    _url = "/azure/client-generator-core/hierarchy-building/animal/dog"
...
class _HierarchyBuildingClientOperationsMixin( 
    ClientMixinABC[PipelineClient[HttpRequest, HttpResponse], HierarchyBuildingClientConfiguration]
):
    ...
    def update_pet(
        self,
        animal: Union[_models.Animal, JSON, IO[bytes]],
        **kwargs: Any
    ) -> _models.Animal:
        """Update a pet.
        ...
        content_type: Optional[str] = kwargs.pop('content_type', _headers.pop('Content-Type', None))
        cls: ClsType[_models.Animal] = kwargs.pop(
            'cls', None
        )
        ...
        _request = build_hierarchy_building_update_pet_request(
    ...
    def update_dog(
        ...
        **kwargs: Any
        ...
        _request = build_hierarchy_building_update_dog_request(
            content_type=content_type,
            content=_content,
            headers=_headers,
            params=_params,
