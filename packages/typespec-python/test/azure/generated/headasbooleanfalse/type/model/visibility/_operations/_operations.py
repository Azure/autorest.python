...
from .....headasbooleanfalse._model_base import SdkJSONEncoder, _deserialize
from .....headasbooleanfalse._serialization import Serializer
...
class VisibilityClientOperationsMixin(VisibilityClientMixinABC):
    ...
    @overload
    def head_model(self, input: JSON, *, content_type: str = "application/json", **kwargs: Any) -> None:
        """head_model.
    ...
    @overload
    def head_model(self, input: IO[bytes], *, content_type: str = "application/json", **kwargs: Any) -> None:
        """head_model.
