...
class TwoOperationGroupClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype two_operation_group_client_group1:
     client.structure.twooperationgroup.aio.operations.TwoOperationGroupClientGroup1Operations
    ...
    :vartype two_operation_group_client_group2:
     client.structure.twooperationgroup.aio.operations.TwoOperationGroupClientGroup2Operations
