...
class TestValueTypesUnionStringLiteralOperationsAsync(ValueTypesClientTestBaseAsync):
    @ValueTypesPreparer()
    @recorded_by_proxy_async
    async def test_union_string_literal_get(self, valuetypes_endpoint):
    ...
    @ValueTypesPreparer()
    @recorded_by_proxy_async
    async def test_union_string_literal_put(self, valuetypes_endpoint):
        client = self.create_async_client(endpoint=valuetypes_endpoint)
