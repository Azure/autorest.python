...
from .lists.operations import ListsOperations
from .textformatting.operations import TextFormattingOperations
...
class DocumentationClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype lists: documentation.operations.ListsOperations
    :ivar text_formatting: TextFormattingOperations operations
    :vartype text_formatting: documentation.operations.TextFormattingOperations
