...
class _PreviewVersionClientOperationsMixin(
    ...
    def get_widget(self, id: str, **kwargs: Any) -> Optional[_models.Widget]:
        ...
        :rtype: ~_specs_.azure.versioning.previewversion.models.Widget or None
    ...
    def update_widget_color(
        ...
        **kwargs: Any
        ...
        :type color_update: ~_specs_.azure.versioning.previewversion.models.UpdateWidgetColorRequest
    ...
    def update_widget_color(
        ...
        :param color_update: Is one of the following types: UpdateWidgetColorRequest, JSON, IO[bytes]
         Required.
        :type color_update: ~_specs_.azure.versioning.previewversion.models.UpdateWidgetColorRequest or
         JSON or IO[bytes]
        :return: Widget or None. The Widget is compatible with MutableMapping
        :rtype: ~_specs_.azure.versioning.previewversion.models.Widget or None
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list_widgets(
        ...
        :rtype: ~_specs_.azure.versioning.previewversion.models.ListWidgetsResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
