...
class BasicClientOperationsMixin(BasicClientMixinABC):
    ...
    def create_or_update(
        ...
        :param resource: The resource instance. Is one of the following types: User, JSON, IO[bytes]
         Required.
        :type resource: ~azure.core.basic.models.User or JSON or IO[bytes]
        :return: User. The User is compatible with MutableMapping
        :rtype: ~azure.core.basic.models.User
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.core.basic.models.User]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def export_all_users(self, *, format: str, **kwargs: Any) -> _specs_azure_core_basic_models8.UserList:
        ...
        :rtype: ~azure.core.basic.models.UserList
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
