...
JPG = Path(__file__).parent.parent.parent.parent / "generic_mock_api_tests/data/image.jpg"
PNG = Path(__file__).parent.parent.parent.parent / "generic_mock_api_tests/data/image.png"
