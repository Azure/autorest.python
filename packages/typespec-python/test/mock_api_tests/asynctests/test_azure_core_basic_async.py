...
async def _list_with_page_tests(pager: AsyncIterable[models.User], num: int = 1):
...
@pytest.mark.asyncio
async def test_list_with_page_next_link(client: aio.BasicClient):
    await _list_with_page_tests(client.list_with_page_next_link(), 2)
