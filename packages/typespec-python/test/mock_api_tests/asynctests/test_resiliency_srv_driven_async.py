...
async def test_add_optional_param_from_none():
    ...
    async with V1Client(service_deployment_version="v1") as client:
        await client.from_none()

    # old client to new service with api version v1
    async with V1Client(service_deployment_version="v2") as client:
        await client.from_none()

    # new client to new service with api version v1
    async with V2Client(service_deployment_version="v2", api_version="v1") as client:
        await client.from_none()
...
async def test_break_the_glass():
    ...
    async with V1Client(service_deployment_version="v2", api_version="v2") as client:
