...
class OverloadClientOperationsMixin(OverloadClientMixinABC):
    ...
    @distributed_trace_async
    async def upload_json_or_string(  # pylint: disable=inconsistent-return-statements
        self, data: Union[str, JSON, _models.Data, IO], **kwargs: Any
    ) -> None:
        """upload_json_or_string.

        :param data: Is one of the following types: str, JSON, Data, IO Required.
        :type data: str or JSON or ~overload.models.Data or IO
