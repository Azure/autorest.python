...
def build_not_discriminated_post_valid_request(**kwargs: Any) -> HttpRequest:
...
def build_not_discriminated_get_valid_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_not_discriminated_put_valid_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class NotDiscriminatedClientOperationsMixin(NotDiscriminatedClientMixinABC):
    ...
    def post_valid(  # pylint: disable=inconsistent-return-statements
        ...
        request = build_not_discriminated_post_valid_request(
    ...
    def get_valid(self, **kwargs: Any) -> _models.Siamese:
        ...
        request = build_not_discriminated_get_valid_request(
            headers=_headers,
            params=_params,
        )
        request.url = self._client.format_url(request.url)
