...
class AccessClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype public_operation:
     _specs_.azure.clientgenerator.core.access.aio.operations.PublicOperationOperations
    :ivar internal_operation: InternalOperationOperations operations
    :vartype internal_operation:
     _specs_.azure.clientgenerator.core.access.aio.operations.InternalOperationOperations
    :ivar shared_model_in_operation: SharedModelInOperationOperations operations
    :vartype shared_model_in_operation:
     _specs_.azure.clientgenerator.core.access.aio.operations.SharedModelInOperationOperations
    :ivar relative_model_in_operation: RelativeModelInOperationOperations operations
    :vartype relative_model_in_operation:
     _specs_.azure.clientgenerator.core.access.aio.operations.RelativeModelInOperationOperations
    ...
    def __init__(  # pylint: disable=missing-client-constructor-parameter-credential
        ...
        self._config = AccessClientConfiguration(**kwargs)
    ...
    async def __aenter__(self) -> "AccessClient":
