...
def build_internal_get_internal_request(*, name: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = "/azure/client-generator-core/internal/getInternal"
...
def build_internal_post_internal_request(**kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = "/azure/client-generator-core/internal/postInternal"
...
class InternalClientOperationsMixin(InternalClientMixinABC):
    ...
    def _post_internal(
        ...
        :param body: Is one of the following types: ModelOnlyUsedByInternalOperation, JSON, IO
         Required.
        :type body:
         ~_specs_.azure.clientgenerator.core.internal.models.ModelOnlyUsedByInternalOperation or JSON or
         IO
        ...
        :return: ModelOnlyUsedByInternalOperation. The ModelOnlyUsedByInternalOperation is compatible
         with MutableMapping
        :rtype: ~_specs_.azure.clientgenerator.core.internal.models.ModelOnlyUsedByInternalOperation
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
