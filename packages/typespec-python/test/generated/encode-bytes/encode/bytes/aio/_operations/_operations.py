...
from ..._operations._operations import (
    build_bytes_header_request,
    build_bytes_property_request,
    build_bytes_query_request,
)
...
class BytesClientOperationsMixin(BytesClientMixinABC):
    ...
    @distributed_trace_async
    async def property(self, body: Union[_models.BytesProperty, JSON, IO], **kwargs: Any) -> _models.BytesProperty:
        """property.
