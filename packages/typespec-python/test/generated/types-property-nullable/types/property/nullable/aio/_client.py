...
class NullableClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype string: types.property.nullable.aio.operations.StringOperations
    :ivar bytes: BytesOperations operations
    :vartype bytes: types.property.nullable.aio.operations.BytesOperations
    :ivar datetime: DatetimeOperations operations
    :vartype datetime: types.property.nullable.aio.operations.DatetimeOperations
    :ivar duration: DurationOperations operations
    :vartype duration: types.property.nullable.aio.operations.DurationOperations
    :ivar collections_byte: CollectionsByteOperations operations
    :vartype collections_byte: types.property.nullable.aio.operations.CollectionsByteOperations
    :ivar collections_model: CollectionsModelOperations operations
    :vartype collections_model: types.property.nullable.aio.operations.CollectionsModelOperations
    """
