...
class NullableClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype string: types.property.nullable.operations.StringOperations
    :ivar bytes: BytesOperations operations
    :vartype bytes: types.property.nullable.operations.BytesOperations
    :ivar datetime: DatetimeOperations operations
    :vartype datetime: types.property.nullable.operations.DatetimeOperations
    :ivar duration: DurationOperations operations
    :vartype duration: types.property.nullable.operations.DurationOperations
    :ivar collections_byte: CollectionsByteOperations operations
    :vartype collections_byte: types.property.nullable.operations.CollectionsByteOperations
    :ivar collections_model: CollectionsModelOperations operations
    :vartype collections_model: types.property.nullable.operations.CollectionsModelOperations
    """
