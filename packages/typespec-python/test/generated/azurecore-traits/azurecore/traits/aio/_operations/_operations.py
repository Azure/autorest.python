...
class TraitsClientOperationsMixin(TraitsClientMixinABC):
    ...
    async def smoke_test(
        ...
        **kwargs: Any
        ...
        :rtype: ~azurecore.traits.models.User
    ...
    async def repeatable_action(
        ...
        :type id: int
        :param body: Required.
        :type body: ~azurecore.traits.models.UserActionParam
        ...
        :rtype: ~azurecore.traits.models.UserActionResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def repeatable_action(
        ...
        :type body: ~azurecore.traits.models.UserActionParam or JSON or IO
