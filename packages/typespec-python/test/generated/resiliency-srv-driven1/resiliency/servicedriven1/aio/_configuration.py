...
class ResiliencyServiceDrivenClientConfiguration(Configuration):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(self, service_deployment_version: str, **kwargs: Any) -> None:
        ...
        kwargs.setdefault("sdk_moniker", "resiliency-servicedriven1/{}".format(VERSION))
