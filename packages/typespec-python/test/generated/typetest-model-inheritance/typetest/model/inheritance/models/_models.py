...
class ModelRecordUnknown(_model_base.Model):
...
class Salmon(Fish, discriminator="salmon"):
    ...
    :vartype kind: str
    :ivar friends:
    :vartype friends: list[~typetest.model.inheritance.models.Fish]
    :ivar hate:
    :vartype hate: dict[str, ~typetest.model.inheritance.models.Fish]
    :ivar partner:
    :vartype partner: ~typetest.model.inheritance.models.Fish
    """
