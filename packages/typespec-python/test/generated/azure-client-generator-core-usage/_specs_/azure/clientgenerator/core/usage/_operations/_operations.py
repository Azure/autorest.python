...
class UsageClientOperationsMixin(UsageClientMixinABC):
    ...
    def input_to_input_output(  # pylint: disable=inconsistent-return-statements
        ...
        :param body: Required.
        :type body: ~_specs_.azure.clientgenerator.core.usage.models.InputModel
    ...
    def input_to_input_output(  # pylint: disable=inconsistent-return-statements
        ...
        request = build_usage_input_to_input_output_request(
    ...
    def output_to_input_output(self, **kwargs: Any) -> _models.OutputModel:
        ...
        :rtype: ~_specs_.azure.clientgenerator.core.usage.models.OutputModel
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
        ...
        request = build_usage_output_to_input_output_request(
            headers=_headers,
            params=_params,
        )
        request.url = self._client.format_url(request.url)
