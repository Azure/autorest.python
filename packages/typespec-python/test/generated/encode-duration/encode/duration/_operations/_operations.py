...
def build_duration_default_request(*, input: datetime.timedelta, **kwargs: Any) -> HttpRequest:
...
def build_duration_iso8601_request(*, input: datetime.timedelta, **kwargs: Any) -> HttpRequest:
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_duration_int32_seconds_request(*, input: int, **kwargs: Any) -> HttpRequest:
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_duration_float_seconds_request(*, input: float, **kwargs: Any) -> HttpRequest:
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_duration_default_request(**kwargs: Any) -> HttpRequest:
...
def build_duration_iso8601_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_duration_int32_seconds_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_duration_float_seconds_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class DurationClientOperationsMixin(DurationClientMixinABC):
    ...
    def default(  # pylint: disable=inconsistent-return-statements
        ...
        request = build_duration_default_request(
            input=input,
            headers=_headers,
            params=_params,
        )
    ...
    def iso8601(  # pylint: disable=inconsistent-return-statements
        ...
        request = build_duration_iso8601_request(
            input=input,
            headers=_headers,
            params=_params,
        )
    ...
    def int32_seconds(self, *, input: int, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        ...
        request = build_duration_int32_seconds_request(
            input=input,
            headers=_headers,
            params=_params,
        )
    ...
    def float_seconds(self, *, input: float, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        ...
        request = build_duration_float_seconds_request(
            input=input,
            headers=_headers,
            params=_params,
        )
