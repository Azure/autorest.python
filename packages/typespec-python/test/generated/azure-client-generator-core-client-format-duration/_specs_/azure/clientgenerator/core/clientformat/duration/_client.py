...
class DurationClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype query:
     _specs_.azure.clientgenerator.core.clientformat.duration.operations.QueryOperations
    :ivar property: PropertyOperations operations
    :vartype property:
     _specs_.azure.clientgenerator.core.clientformat.duration.operations.PropertyOperations
    """
