...
def build_query_iso8601_request(*, input: datetime.timedelta, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = "/azure/client-generator-core/client-format/duration/query/iso8601"
...
def build_query_seconds_request(*, input: float, **kwargs: Any) -> HttpRequest:
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})

    # Construct URL
    _url = "/azure/client-generator-core/client-format/duration/query/seconds"
...
def build_property_iso8601_request(**kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = "/azure/client-generator-core/client-format/duration/property/iso8601"
...
def build_property_seconds_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    # Construct URL
    _url = "/azure/client-generator-core/client-format/duration/property/seconds"
...
class QueryOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~_specs_.azure.clientgenerator.core.clientformat.duration.DurationClient`'s
    ...
    @distributed_trace
    def seconds(self, *, input: float, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        """seconds.
