...
def build_inheritance_post_valid_request(**kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = "/types/model/inheritance/valid"
...
def build_inheritance_get_model_request(**kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = "/types/model/inheritance/discriminated/model"
...
def build_inheritance_get_recursive_model_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/types/model/inheritance/discriminated/recursivemodel"
...
def build_inheritance_get_missing_discriminator_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/types/model/inheritance/discriminated/missingdiscriminator"
...
def build_inheritance_get_wrong_discriminator_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/types/model/inheritance/discriminated/wrongdiscriminator"
...
class InheritanceClientOperationsMixin(InheritanceClientMixinABC):
    ...
    def post_valid(  # pylint: disable=inconsistent-return-statements
        ...
        :type input: ~types.model.inheritance.models.Siamese
    ...
    def post_valid(  # pylint: disable=inconsistent-return-statements
        ...
        :type input: ~types.model.inheritance.models.Siamese or JSON or IO
    ...
    def get_valid(self, **kwargs: Any) -> _models.Siamese:
        ...
        :rtype: ~types.model.inheritance.models.Siamese
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def get_model(self, **kwargs: Any) -> _models.Fish:
        ...
        :rtype: ~types.model.inheritance.models.Fish
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def put_model(  # pylint: disable=inconsistent-return-statements
        ...
        :param input: Required.
        :type input: ~types.model.inheritance.models.Fish
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword bool stream: Whether to stream the response of this operation. Defaults to False. You
    ...
    def put_model(  # pylint: disable=inconsistent-return-statements
        ...
        :type input: ~types.model.inheritance.models.Fish or JSON or IO
        :keyword content_type: Body parameter Content-Type. Known values are: application/json. Default
         value is None.
        :paramtype content_type: str
        :keyword bool stream: Whether to stream the response of this operation. Defaults to False. You
