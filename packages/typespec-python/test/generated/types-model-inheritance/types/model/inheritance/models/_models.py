...
class Salmon(Fish, discriminator="salmon"):
    ...
    :vartype kind: str
    :ivar friends:
    :vartype friends: list[~types.model.inheritance.models.Fish]
    :ivar hate:
    :vartype hate: dict[str, ~types.model.inheritance.models.Fish]
    :ivar partner:
    :vartype partner: ~types.model.inheritance.models.Fish
    """
