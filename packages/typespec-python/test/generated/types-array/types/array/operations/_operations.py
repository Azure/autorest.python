...
def build_nullable_float_value_get_request(**kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = "/types/array/nullable-float"
...
class Int32ValueOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~types.array.ArrayClient`'s
...
class ModelValueOperations:
    ...
    def get(self, **kwargs: Any) -> List[_models.InnerModel]:
        ...
        :rtype: list[~types.array.models.InnerModel]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def put(  # pylint: disable=inconsistent-return-statements
        ...
        :param body: Required.
        :type body: list[~types.array.models.InnerModel]
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword bool stream: Whether to stream the response of this operation. Defaults to False. You
    ...
    def put(  # pylint: disable=inconsistent-return-statements
        ...
        :type body: list[~types.array.models.InnerModel] or IO
        :keyword content_type: Body parameter Content-Type. Known values are: application/json. Default
         value is None.
        :paramtype content_type: str
        :keyword bool stream: Whether to stream the response of this operation. Defaults to False. You
