...
def build_basic_list_with_page_next_link_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/azure/core/basic/page/nextLink"
...
class BasicClientOperationsMixin(BasicClientMixinABC):
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~_specs_.azure.core.basic.models.User]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    @distributed_trace
    def list_with_page_next_link(self, **kwargs: Any) -> Iterable["_models.User"]:
        """List with Azure.Core.Page<>. And it contains nextLink.
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_basic_list_with_page_next_link_request(
                    api_version=self._config.api_version,
                    headers=_headers,
                    params=_params,
                )
