...
def build_usage_input_and_output_request(**kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = "/types/model/usage/input-output"
...
class UsageClientOperationsMixin(UsageClientMixinABC):
    ...
    def input(  # pylint: disable=inconsistent-return-statements
        ...
        :type input: ~types.model.usage.models.InputRecord
    ...
    def input(  # pylint: disable=inconsistent-return-statements
        ...
        :type input: ~types.model.usage.models.InputRecord or JSON or IO
    ...
    def output(self, **kwargs: Any) -> _models.OutputRecord:
        ...
        :rtype: ~types.model.usage.models.OutputRecord
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def input_and_output(
        ...
        :param body: Required.
        :type body: ~types.model.usage.models.InputOutputRecord
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword bool stream: Whether to stream the response of this operation. Defaults to False. You
        ...
        :rtype: ~types.model.usage.models.InputOutputRecord
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def input_and_output(
        ...
        :type body: ~types.model.usage.models.InputOutputRecord or JSON or IO
        :keyword content_type: Body parameter Content-Type. Known values are: application/json. Default
         value is None.
        :paramtype content_type: str
        :keyword bool stream: Whether to stream the response of this operation. Defaults to False. You
