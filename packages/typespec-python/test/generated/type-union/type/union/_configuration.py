...
<<<<<<<< HEAD:packages/typespec-python/test/generated/lro-lro-basic/azure/lro/basic/_configuration.py
        kwargs.setdefault("sdk_moniker", "lro-basic/{}".format(VERSION))
========
        kwargs.setdefault("sdk_moniker", "unionclient/{}".format(VERSION))
>>>>>>>> 5b10cc9a4a3f670701209c990af76dec9d5100ec:packages/typespec-python/test/generated/type-union/type/union/_configuration.py
