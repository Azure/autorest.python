...
class UnionClientOperationsMixin(UnionClientMixinABC):
    ...
    async def send_int(  # pylint: disable=inconsistent-return-statements
        ...
        :type input: ~type.union.models.ModelWithSimpleUnionProperty
    ...
    async def send_int(  # pylint: disable=inconsistent-return-statements
        ...
        :type input: ~type.union.models.ModelWithSimpleUnionProperty or JSON or IO
    ...
    async def send_first_named_union_value(  # pylint: disable=inconsistent-return-statements
        ...
        :param input: Required.
        :type input: ~type.union.models.ModelWithNamedUnionProperty
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword bool stream: Whether to stream the response of this operation. Defaults to False. You
    ...
    async def send_first_named_union_value(  # pylint: disable=inconsistent-return-statements
        ...
        :type input: ~type.union.models.ModelWithNamedUnionProperty or JSON or IO
        :keyword content_type: Body parameter Content-Type. Known values are: application/json. Default
         value is None.
        :paramtype content_type: str
        :keyword bool stream: Whether to stream the response of this operation. Defaults to False. You
