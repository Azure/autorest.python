...
class InheritanceClientOperationsMixin(InheritanceClientMixinABC):
    ...
    async def post_valid(  # pylint: disable=inconsistent-return-statements
        ...
        :type input: ~type.model.inheritance.models.Siamese
    ...
    async def post_valid(  # pylint: disable=inconsistent-return-statements
        ...
        :type input: ~type.model.inheritance.models.Siamese or JSON or IO
    ...
    async def get_valid(self, **kwargs: Any) -> _models.Siamese:
        ...
        :rtype: ~type.model.inheritance.models.Siamese
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def get_model(self, **kwargs: Any) -> _models.Fish:
        ...
        :rtype: ~type.model.inheritance.models.Fish
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def put_model(  # pylint: disable=inconsistent-return-statements
        ...
        :param input: Required.
        :type input: ~type.model.inheritance.models.Fish
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword bool stream: Whether to stream the response of this operation. Defaults to False. You
    ...
    async def put_model(  # pylint: disable=inconsistent-return-statements
        ...
        :type input: ~type.model.inheritance.models.Fish or JSON or IO
        :keyword content_type: Body parameter Content-Type. Known values are: application/json. Default
         value is None.
        :paramtype content_type: str
        :keyword bool stream: Whether to stream the response of this operation. Defaults to False. You
