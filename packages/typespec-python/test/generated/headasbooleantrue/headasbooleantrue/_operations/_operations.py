...
class VisibilityClientOperationsMixin(VisibilityClientMixinABC):
    ...
    @overload
    def head_model(self, input: IO[AnyStr], *, content_type: str = "application/json", **kwargs: Any) -> bool:
        """head_model.
    ...
    @distributed_trace
    def head_model(self, input: Union[_models.VisibilityModel, JSON, IO[AnyStr]], **kwargs: Any) -> bool:
        """head_model.
