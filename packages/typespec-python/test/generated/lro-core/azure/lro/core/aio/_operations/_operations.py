...
class CoreClientOperationsMixin(CoreClientMixinABC):
    ...
    async def begin_create_or_replace(
        ...
        :return: An instance of AsyncLROPoller that returns User. The User is compatible with
         MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.lro.core.models.User]
    ...
    async def _delete_initial(self, name: str, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    @distributed_trace_async
    async def begin_export(self, name: str, *, format: str, **kwargs: Any) -> AsyncLROPoller[None]:
        """Exports a user.
