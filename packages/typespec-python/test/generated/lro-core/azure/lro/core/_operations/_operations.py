...
def build_core_create_or_replace_request(name: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = "/azure/lro/core/users/{name}"
...
def build_core_delete_request(name: str, **kwargs: Any) -> HttpRequest:
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_core_export_request(name: str, *, format: str, **kwargs: Any) -> HttpRequest:
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2022-12-01-preview"))
    # Construct URL
    _url = "/azure/lro/core/users/{name}:export"
    path_format_arguments = {
        "name": _SERIALIZER.url("name", name, "str"),
    }
...
class CoreClientOperationsMixin(CoreClientMixinABC):
    ...
    def begin_create_or_replace(
        ...
        :type resource: ~azure.lro.core.models.User
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.lro.core.models.User]
    ...
    def begin_create_or_replace(
        ...
        :type resource: ~azure.lro.core.models.User or JSON or IO
    ...
    @distributed_trace
    def begin_export(self, name: str, *, format: str, **kwargs: Any) -> LROPoller[None]:
        """Exports a user.
