...
class VisibilityClientOperationsMixin(VisibilityClientMixinABC):
    ...
    @overload
    async def head_model(self, input: IO[AnyStr], *, content_type: str = "application/json", **kwargs: Any) -> bool:
        """head_model.
    ...
    @distributed_trace_async
    async def head_model(self, input: Union[_models.VisibilityModel, JSON, IO[AnyStr]], **kwargs: Any) -> bool:
        """head_model.
