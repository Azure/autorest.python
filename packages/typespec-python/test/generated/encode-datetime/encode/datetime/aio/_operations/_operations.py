...
from ..._operations._operations import (
    build_datetime_header_request,
    build_datetime_property_request,
    build_datetime_query_request,
)
...
class DatetimeClientOperationsMixin(DatetimeClientMixinABC):
    ...
    async def query(  # pylint: disable=inconsistent-return-statements
        self,
        *,
    ...
    @distributed_trace_async
    async def header(  # pylint: disable=inconsistent-return-statements
        self,
        *,
        default: datetime.datetime,
        rfc3339: datetime.datetime,
