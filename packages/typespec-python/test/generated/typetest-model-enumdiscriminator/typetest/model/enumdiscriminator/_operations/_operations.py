...
class EnumDiscriminatorClientOperationsMixin(EnumDiscriminatorClientMixinABC):
    ...
    def get_extensible_model(self, **kwargs: Any) -> _models.Dog:
        ...
        request = build_enum_discriminator_get_extensible_model_request(
            headers=_headers,
            params=_params,
        )
    ...
    def put_extensible_model(  # pylint: disable=inconsistent-return-statements
        ...
        request = build_enum_discriminator_put_extensible_model_request(
    ...
    def get_extensible_model_missing_discriminator(self, **kwargs: Any) -> _models.Dog:  # pylint: disable=name-too-long
        ...
        request = build_enum_discriminator_get_extensible_model_missing_discriminator_request(
            headers=_headers,
            params=_params,
        )
        request.url = self._client.format_url(request.url)
    ...
    def get_extensible_model_wrong_discriminator(self, **kwargs: Any) -> _models.Dog:
        ...
        request = build_enum_discriminator_get_extensible_model_wrong_discriminator_request(
            headers=_headers,
            params=_params,
        )
        request.url = self._client.format_url(request.url)
    ...
    def get_fixed_model(self, **kwargs: Any) -> _models.Snake:
        ...
        request = build_enum_discriminator_get_fixed_model_request(
            headers=_headers,
            params=_params,
        )
        request.url = self._client.format_url(request.url)
    ...
    def put_fixed_model(  # pylint: disable=inconsistent-return-statements
        ...
        request = build_enum_discriminator_put_fixed_model_request(
            content_type=content_type,
            content=_content,
            headers=_headers,
            params=_params,
    ...
    def get_fixed_model_missing_discriminator(self, **kwargs: Any) -> _models.Snake:
        ...
        request = build_enum_discriminator_get_fixed_model_missing_discriminator_request(
            headers=_headers,
            params=_params,
        )
        request.url = self._client.format_url(request.url)
    ...
    def get_fixed_model_wrong_discriminator(self, **kwargs: Any) -> _models.Snake:
        ...
        request = build_enum_discriminator_get_fixed_model_wrong_discriminator_request(
            headers=_headers,
            params=_params,
        )
        request.url = self._client.format_url(request.url)
