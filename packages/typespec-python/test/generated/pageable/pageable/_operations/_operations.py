...
def build_pageable_list_request(*, name_filter: str, **kwargs: Any) -> HttpRequest:
...
class PageableClientOperationsMixin(PageableClientMixinABC):
    @distributed_trace
    def list(self, *, name_filter: str, **kwargs: Any) -> Iterable["_models.User"]:
        """List users.

        :keyword name_filter: Name filter. Required.
        :paramtype name_filter: str
        :return: An iterator like instance of User
        :rtype: ~azure.core.paging.ItemPaged[~pageable.models.User]
