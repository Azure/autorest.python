...
class ValueTypesClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype boolean: types.property.valuetypes.operations.BooleanOperations
    :ivar string: StringOperations operations
    :vartype string: types.property.valuetypes.operations.StringOperations
    :ivar bytes: BytesOperations operations
    :vartype bytes: types.property.valuetypes.operations.BytesOperations
    :ivar int: IntOperations operations
    :vartype int: types.property.valuetypes.operations.IntOperations
    :ivar float: FloatOperations operations
    :vartype float: types.property.valuetypes.operations.FloatOperations
    :ivar datetime: DatetimeOperations operations
    :vartype datetime: types.property.valuetypes.operations.DatetimeOperations
    :ivar duration: DurationOperations operations
    :vartype duration: types.property.valuetypes.operations.DurationOperations
    :ivar enum: EnumOperations operations
    :vartype enum: types.property.valuetypes.operations.EnumOperations
    :ivar extensible_enum: ExtensibleEnumOperations operations
    :vartype extensible_enum: types.property.valuetypes.operations.ExtensibleEnumOperations
    :ivar model: ModelOperations operations
    :vartype model: types.property.valuetypes.operations.ModelOperations
    :ivar collections_string: CollectionsStringOperations operations
    :vartype collections_string: types.property.valuetypes.operations.CollectionsStringOperations
    :ivar collections_int: CollectionsIntOperations operations
    :vartype collections_int: types.property.valuetypes.operations.CollectionsIntOperations
    :ivar collections_model: CollectionsModelOperations operations
    :vartype collections_model: types.property.valuetypes.operations.CollectionsModelOperations
    :ivar dictionary_string: DictionaryStringOperations operations
    :vartype dictionary_string: types.property.valuetypes.operations.DictionaryStringOperations
    :ivar never: NeverOperations operations
    :vartype never: types.property.valuetypes.operations.NeverOperations
    """
