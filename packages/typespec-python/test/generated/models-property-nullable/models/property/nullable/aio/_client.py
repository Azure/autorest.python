...
class NullableClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype string: models.property.nullable.aio.operations.StringOperations
    :ivar bytes: BytesOperations operations
    :vartype bytes: models.property.nullable.aio.operations.BytesOperations
    :ivar datetime: DatetimeOperations operations
    :vartype datetime: models.property.nullable.aio.operations.DatetimeOperations
    :ivar duration: DurationOperations operations
    :vartype duration: models.property.nullable.aio.operations.DurationOperations
    :ivar collections_byte: CollectionsByteOperations operations
    :vartype collections_byte: models.property.nullable.aio.operations.CollectionsByteOperations
    :ivar collections_model: CollectionsModelOperations operations
    :vartype collections_model: models.property.nullable.aio.operations.CollectionsModelOperations
    """
