...
class NullableClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype string: models.property.nullable.operations.StringOperations
    :ivar bytes: BytesOperations operations
    :vartype bytes: models.property.nullable.operations.BytesOperations
    :ivar datetime: DatetimeOperations operations
    :vartype datetime: models.property.nullable.operations.DatetimeOperations
    :ivar duration: DurationOperations operations
    :vartype duration: models.property.nullable.operations.DurationOperations
    :ivar collections_byte: CollectionsByteOperations operations
    :vartype collections_byte: models.property.nullable.operations.CollectionsByteOperations
    :ivar collections_model: CollectionsModelOperations operations
    :vartype collections_model: models.property.nullable.operations.CollectionsModelOperations
    """
