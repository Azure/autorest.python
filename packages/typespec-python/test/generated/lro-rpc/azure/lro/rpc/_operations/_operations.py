...
from .._vendor import RpcClientMixinABC, _format_url_section
...
def build_rpc_create_job_request(**kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = "/azure/lro/rpc/same-poll-result/jobs"
...
def build_rpc_get_job_request(job_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = "/azure/lro/rpc/same-poll-result/jobs/{jobId}"
...
def build_rpc_create_job_final_on_location_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/azure/lro/rpc/different-poll-result/jobs"
...
def build_rpc_get_poll_request(operation_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = "/azure/lro/rpc/different-poll-result/jobs/operations/{operationId}"
    path_format_arguments = {
...
class RpcClientOperationsMixin(RpcClientMixinABC):
    def _create_job_initial(self, body: Union[_models.JobData, JSON, IO], **kwargs: Any) -> Optional[_models.JobResult]:
        error_map = {
    ...
    def begin_create_job(
        ...
        :return: An instance of LROPoller that returns JobResult. The JobResult is compatible with
         MutableMapping
        :rtype: ~azure.core.polling.LROPoller[~azure.lro.rpc.models.JobResult]
    ...
    def begin_create_job_final_on_location(
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._create_job_final_on_location_initial(
                body=body, content_type=content_type, cls=lambda x, y, z: x, headers=_headers, params=_params, **kwargs
            )
        kwargs.pop("error_map", None)
    ...
    def begin_get_poll(self, operation_id: str, **kwargs: Any) -> LROPoller[_models.JobPollResult]:
        ...
        :return: An instance of LROPoller that returns JobPollResult. The JobPollResult is compatible
         with MutableMapping
        :rtype: ~azure.core.polling.LROPoller[~azure.lro.rpc.models.JobPollResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
