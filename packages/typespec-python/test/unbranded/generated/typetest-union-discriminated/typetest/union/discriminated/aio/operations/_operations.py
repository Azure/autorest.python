...
class EnvelopeOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~typetest.union.discriminated.aio.DiscriminatedClient`'s
...
class NoEnvelopeDefaultOperations:
    ...
    async def get(self, *, kind: Optional[str] = None, **kwargs: Any) -> "_types.PetInline":
        ...
        :paramtype kind: str
        :return: Cat or Dog
        :rtype: ~typetest.union.discriminated.models.Cat or ~typetest.union.discriminated.models.Dog
    ...
    async def put(
        ...
        :type input: ~typetest.union.discriminated.models.Cat
    ...
    async def put(
        ...
        :param input: Required.
        :type input: ~typetest.union.discriminated.models.Dog
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: Cat or Dog
    ...
    async def put(self, input: "_types.PetInline", **kwargs: Any) -> "_types.PetInline":
        ...
        :type input: ~typetest.union.discriminated.models.Cat or
         ~typetest.union.discriminated.models.Dog
        :return: Cat or Dog
        :rtype: ~typetest.union.discriminated.models.Cat or ~typetest.union.discriminated.models.Dog
        :raises ~corehttp.exceptions.HttpResponseError:
        """
