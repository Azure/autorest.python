...
class DiscriminatedClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype envelope: typetest.union.discriminated.operations.EnvelopeOperations
    :ivar no_envelope: NoEnvelopeOperations operations
    :vartype no_envelope: typetest.union.discriminated.operations.NoEnvelopeOperations
