...
class DiscriminatedClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype envelope: typetest.union.discriminated.aio.operations.EnvelopeOperations
    :ivar no_envelope: NoEnvelopeOperations operations
    :vartype no_envelope: typetest.union.discriminated.aio.operations.NoEnvelopeOperations
    ...
    def __init__(  # pylint: disable=missing-client-constructor-parameter-credential
        ...
        _endpoint = "{endpoint}"
        self._config = DiscriminatedClientConfiguration(endpoint=endpoint, **kwargs)
