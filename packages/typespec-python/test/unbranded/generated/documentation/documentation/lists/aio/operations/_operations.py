...
class ListsOperations:
    ...
    async def bullet_points_model(
        self, *, input: _models2.BulletPointsModel, content_type: str = "application/json", **kwargs: Any
    ) -> None:
        """bullet_points_model.
    ...
    async def bullet_points_model(
        self, body: Union[JSON, IO[bytes]] = _Unset, *, input: _models2.BulletPointsModel = _Unset, **kwargs: Any
    ) -> None:
        """bullet_points_model.
