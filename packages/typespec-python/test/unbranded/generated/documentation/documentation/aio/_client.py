...
from ..lists.aio.operations import ListsOperations
from ..textformatting.aio.operations import TextFormattingOperations
...
class DocumentationClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype lists: documentation.aio.operations.ListsOperations
    :ivar text_formatting: TextFormattingOperations operations
    :vartype text_formatting: documentation.aio.operations.TextFormattingOperations
