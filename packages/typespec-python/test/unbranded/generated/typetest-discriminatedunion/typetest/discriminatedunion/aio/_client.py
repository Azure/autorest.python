...
class DiscriminatedClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype discriminated_client_envelope:
     typetest.discriminatedunion.aio.operations.DiscriminatedClientEnvelopeOperations
    ...
    :vartype discriminated_client_no_envelope:
     typetest.discriminatedunion.aio.operations.DiscriminatedClientNoEnvelopeOperations
