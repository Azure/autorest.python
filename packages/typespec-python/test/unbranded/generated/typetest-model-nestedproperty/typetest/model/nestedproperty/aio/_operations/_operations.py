...
from ..._operations._operations import build_nested_property_get_request, build_nested_property_put_request
from .._vendor import NestedPropertyClientMixinABC
...
class NestedPropertyClientOperationsMixin(NestedPropertyClientMixinABC):
    @overload
    async def put(  # pylint: disable=inconsistent-return-statements
        ...
        :type input: ~typetest.model.nestedproperty.models.Extension
    ...
    async def put(  # pylint: disable=inconsistent-return-statements
        ...
        :type input: ~typetest.model.nestedproperty.models.Extension or JSON or IO
        ...
        _request = build_nested_property_put_request(
    ...
    async def get(self, **kwargs: Any) -> _models.Extension:
        ...
        :rtype: ~typetest.model.nestedproperty.models.Extension
        :raises ~corehttp.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
        ...
        _request = build_nested_property_get_request(
            headers=_headers,
            params=_params,
        )
        _request.url = self._client.format_url(_request.url)
