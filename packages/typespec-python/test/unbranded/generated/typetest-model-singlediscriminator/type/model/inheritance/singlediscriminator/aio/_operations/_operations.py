...
class SingleDiscriminatorClientOperationsMixin(SingleDiscriminatorClientMixinABC):
    ...
    async def get_model(self, **kwargs: Any) -> _models.Bird:
        ...
        :rtype: ~type.model.inheritance.singlediscriminator.models.Bird
    ...
    async def put_model(self, input: _models.Bird, *, content_type: str = "application/json", **kwargs: Any) -> None:
        ...
        :type input: ~type.model.inheritance.singlediscriminator.models.Bird
    ...
    async def put_model(self, input: Union[_models.Bird, JSON, IO[bytes]], **kwargs: Any) -> None:
        ...
        :type input: ~type.model.inheritance.singlediscriminator.models.Bird or JSON or IO[bytes]
        :return: None
        :rtype: None
        :raises ~corehttp.exceptions.HttpResponseError:
        """
    ...
    async def get_legacy_model(self, **kwargs: Any) -> _models.Dinosaur:
        ...
        :rtype: ~type.model.inheritance.singlediscriminator.models.Dinosaur
        :raises ~corehttp.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
