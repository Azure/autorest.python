...
class GetResponse(_model_base.Model):
    ...
    :ivar prop: Required.
    :vartype prop: ~type.union.models.MixedTypesCases
    """
...
class GetResponse1(_model_base.Model):
    ...
    :ivar prop: Required.
    :vartype prop: ~type.union.models.MixedLiteralsCases
    """
...
class GetResponse2(_model_base.Model):
    ...
    :ivar prop: Required.
    :vartype prop: ~type.union.models.StringAndArrayCases
    """
...
class GetResponse3(_model_base.Model):
    ...
    :ivar prop: Required.
    :vartype prop: ~type.union.models.EnumsOnlyCases
    """
...
class GetResponse4(_model_base.Model):
    ...
    :vartype prop: ~type.union.models.Cat or ~type.union.models.Dog
    """
...
class GetResponse7(_model_base.Model):
    ...
    :vartype prop: str or ~type.union.models.StringExtensibleNamedUnion
    """
...
class MixedTypesCases(_model_base.Model):
    ...
    :vartype model: ~type.union.models.Cat or str or int or bool
    :ivar literal: This should be receive/send the "a" variant. Required. Is one of the following
     types: Cat, Literal["a"], int, bool
    :vartype literal: ~type.union.models.Cat or str or int or bool
    ...
    :vartype int_property: ~type.union.models.Cat or str or int or bool
    :ivar boolean: This should be receive/send the boolean variant. Required. Is one of the
     following types: Cat, Literal["a"], int, bool
    :vartype boolean: ~type.union.models.Cat or str or int or bool
    :ivar array: This should be receive/send 4 element with Cat, "a", int, and boolean. Required.
    :vartype array: list[~type.union.models.Cat or str or int or bool]
    """
