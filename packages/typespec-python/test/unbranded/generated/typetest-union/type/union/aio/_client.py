...
class UnionClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype strings_only: type.union.aio.operations.StringsOnlyOperations
    :ivar string_extensible: StringExtensibleOperations operations
    :vartype string_extensible: type.union.aio.operations.StringExtensibleOperations
    :ivar string_extensible_named: StringExtensibleNamedOperations operations
    :vartype string_extensible_named: type.union.aio.operations.StringExtensibleNamedOperations
    :ivar ints_only: IntsOnlyOperations operations
    :vartype ints_only: type.union.aio.operations.IntsOnlyOperations
    :ivar floats_only: FloatsOnlyOperations operations
    :vartype floats_only: type.union.aio.operations.FloatsOnlyOperations
    :ivar models_only: ModelsOnlyOperations operations
    :vartype models_only: type.union.aio.operations.ModelsOnlyOperations
    :ivar enums_only: EnumsOnlyOperations operations
    :vartype enums_only: type.union.aio.operations.EnumsOnlyOperations
    :ivar string_and_array: StringAndArrayOperations operations
    :vartype string_and_array: type.union.aio.operations.StringAndArrayOperations
    :ivar mixed_literals: MixedLiteralsOperations operations
    :vartype mixed_literals: type.union.aio.operations.MixedLiteralsOperations
    :ivar mixed_types: MixedTypesOperations operations
    :vartype mixed_types: type.union.aio.operations.MixedTypesOperations
