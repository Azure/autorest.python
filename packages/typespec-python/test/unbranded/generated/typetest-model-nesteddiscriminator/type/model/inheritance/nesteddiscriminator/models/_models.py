...
class Salmon(Fish, discriminator="salmon"):
    ...
    :vartype kind: str
    :ivar friends:
    :vartype friends: list[~type.model.inheritance.nesteddiscriminator.models.Fish]
    :ivar hate:
    :vartype hate: dict[str, ~type.model.inheritance.nesteddiscriminator.models.Fish]
    :ivar partner:
    :vartype partner: ~type.model.inheritance.nesteddiscriminator.models.Fish
    """
