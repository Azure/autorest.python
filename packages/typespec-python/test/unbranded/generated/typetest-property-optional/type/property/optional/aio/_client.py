...
class OptionalClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype string: type.property.optional.aio.operations.StringOperations
    :ivar bytes: BytesOperations operations
    :vartype bytes: type.property.optional.aio.operations.BytesOperations
    :ivar datetime: DatetimeOperations operations
    :vartype datetime: type.property.optional.aio.operations.DatetimeOperations
    :ivar duration: DurationOperations operations
    :vartype duration: type.property.optional.aio.operations.DurationOperations
    :ivar plain_date: PlainDateOperations operations
    :vartype plain_date: type.property.optional.aio.operations.PlainDateOperations
    :ivar plain_time: PlainTimeOperations operations
    :vartype plain_time: type.property.optional.aio.operations.PlainTimeOperations
    :ivar collections_byte: CollectionsByteOperations operations
    :vartype collections_byte: type.property.optional.aio.operations.CollectionsByteOperations
    :ivar collections_model: CollectionsModelOperations operations
    :vartype collections_model: type.property.optional.aio.operations.CollectionsModelOperations
    :ivar string_literal: StringLiteralOperations operations
    :vartype string_literal: type.property.optional.aio.operations.StringLiteralOperations
    :ivar int_literal: IntLiteralOperations operations
    :vartype int_literal: type.property.optional.aio.operations.IntLiteralOperations
    :ivar float_literal: FloatLiteralOperations operations
    :vartype float_literal: type.property.optional.aio.operations.FloatLiteralOperations
    :ivar boolean_literal: BooleanLiteralOperations operations
    :vartype boolean_literal: type.property.optional.aio.operations.BooleanLiteralOperations
    :ivar union_string_literal: UnionStringLiteralOperations operations
    :vartype union_string_literal:
     type.property.optional.aio.operations.UnionStringLiteralOperations
    :ivar union_int_literal: UnionIntLiteralOperations operations
    :vartype union_int_literal: type.property.optional.aio.operations.UnionIntLiteralOperations
    :ivar union_float_literal: UnionFloatLiteralOperations operations
    :vartype union_float_literal: type.property.optional.aio.operations.UnionFloatLiteralOperations
    :ivar required_and_optional: RequiredAndOptionalOperations operations
    :vartype required_and_optional:
     type.property.optional.aio.operations.RequiredAndOptionalOperations
