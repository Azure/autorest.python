...
class AdditionalPropertiesClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype extends_unknown_derived:
     type.property.additionalproperties.operations.ExtendsUnknownDerivedOperations
    :ivar extends_unknown_discriminated: ExtendsUnknownDiscriminatedOperations operations
    :vartype extends_unknown_discriminated:
     type.property.additionalproperties.operations.ExtendsUnknownDiscriminatedOperations
    ...
    :vartype is_unknown_derived:
     type.property.additionalproperties.operations.IsUnknownDerivedOperations
    :ivar is_unknown_discriminated: IsUnknownDiscriminatedOperations operations
    :vartype is_unknown_discriminated:
     type.property.additionalproperties.operations.IsUnknownDiscriminatedOperations
    ...
    :vartype spread_string: type.property.additionalproperties.operations.SpreadStringOperations
    ...
    :vartype spread_float: type.property.additionalproperties.operations.SpreadFloatOperations
    ...
    :vartype spread_model: type.property.additionalproperties.operations.SpreadModelOperations
    ...
    :vartype extends_different_spread_string:
     type.property.additionalproperties.operations.ExtendsDifferentSpreadStringOperations
    ...
    :vartype extends_different_spread_float:
     type.property.additionalproperties.operations.ExtendsDifferentSpreadFloatOperations
    ...
    :vartype extends_different_spread_model:
     type.property.additionalproperties.operations.ExtendsDifferentSpreadModelOperations
    ...
    :vartype extends_different_spread_model_array:
     type.property.additionalproperties.operations.ExtendsDifferentSpreadModelArrayOperations
    :ivar multiple_spread: MultipleSpreadOperations operations
    :vartype multiple_spread:
     type.property.additionalproperties.operations.MultipleSpreadOperations
    :ivar spread_record_union: SpreadRecordUnionOperations operations
    :vartype spread_record_union:
     type.property.additionalproperties.operations.SpreadRecordUnionOperations
    ...
    :vartype spread_record_discriminated_union:
     type.property.additionalproperties.operations.SpreadRecordDiscriminatedUnionOperations
    ...
    :vartype spread_record_non_discriminated_union:
     type.property.additionalproperties.operations.SpreadRecordNonDiscriminatedUnionOperations
    ...
    :vartype spread_record_non_discriminated_union2:
     type.property.additionalproperties.operations.SpreadRecordNonDiscriminatedUnion2Operations
    ...
    :vartype spread_record_non_discriminated_union3:
     type.property.additionalproperties.operations.SpreadRecordNonDiscriminatedUnion3Operations
