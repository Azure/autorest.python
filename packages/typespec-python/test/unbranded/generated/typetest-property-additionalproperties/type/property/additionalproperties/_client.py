...
from ....typetest.property.additionalproperties._serialization import Deserializer, Serializer
...
class AdditionalPropertiesClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype spread_record_discriminated_union:
     typetest.property.additionalproperties.operations.SpreadRecordDiscriminatedUnionOperations
