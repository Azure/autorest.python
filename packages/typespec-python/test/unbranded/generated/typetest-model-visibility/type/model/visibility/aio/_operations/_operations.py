...
class VisibilityClientOperationsMixin(VisibilityClientMixinABC):
    ...
    async def get_model(
        ...
        :type input: ~type.model.visibility.models.VisibilityModel
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: VisibilityModel. The VisibilityModel is compatible with MutableMapping
        :rtype: ~type.model.visibility.models.VisibilityModel
    ...
    async def get_model(
        ...
        :type input: ~type.model.visibility.models.VisibilityModel or JSON or IO[bytes]
        :return: VisibilityModel. The VisibilityModel is compatible with MutableMapping
        :rtype: ~type.model.visibility.models.VisibilityModel
        :raises ~corehttp.exceptions.HttpResponseError:
        """
    ...
    async def put_read_only_model(
        ...
        :param input: Required.
        :type input: ~type.model.visibility.models.ReadOnlyModel
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ReadOnlyModel. The ReadOnlyModel is compatible with MutableMapping
        :rtype: ~type.model.visibility.models.ReadOnlyModel
        :raises ~corehttp.exceptions.HttpResponseError:
        """
    ...
    async def put_read_only_model(
        ...
        :type input: ~type.model.visibility.models.ReadOnlyModel or JSON or IO[bytes]
        :return: ReadOnlyModel. The ReadOnlyModel is compatible with MutableMapping
        :rtype: ~type.model.visibility.models.ReadOnlyModel
        :raises ~corehttp.exceptions.HttpResponseError:
        """
