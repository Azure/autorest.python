...
class SpecialWordsClientModelPropertiesOperations:  # pylint: disable=name-too-long
    ...
    @overload
    def dict_methods(
        self, body: _models1.DictMethods, *, content_type: str = "application/json", **kwargs: Any
    ) -> None:
        """dict_methods.

        :param body: Required.
        :type body: ~specialwords.modelproperties.models.DictMethods
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: None
    ...
    def dict_methods(  # pylint: disable=inconsistent-return-statements
        self, body: Union[_models1.DictMethods, JSON, IO[bytes]], **kwargs: Any
    ) -> None:
        """dict_methods.
    ...
    @overload
    def with_list(self, body: _models1.ModelWithList, *, content_type: str = "application/json", **kwargs: Any) -> None:
        """with_list.

        :param body: Required.
        :type body: ~specialwords.modelproperties.models.ModelWithList
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: None
    ...
    def with_list(  # pylint: disable=inconsistent-return-statements
        self, body: Union[_models1.ModelWithList, JSON, IO[bytes]], **kwargs: Any
    ) -> None:
        """with_list.
