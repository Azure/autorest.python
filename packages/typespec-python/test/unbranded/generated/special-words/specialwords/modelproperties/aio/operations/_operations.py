...
class SpecialWordsClientModelPropertiesOperations:  # pylint: disable=name-too-long
    ...
    async def dict_methods(
        self, body: _models2.DictMethods, *, content_type: str = "application/json", **kwargs: Any
    ) -> None:
        """dict_methods.
    ...
    @overload
    async def with_list(
        self, body: _models2.ModelWithList, *, content_type: str = "application/json", **kwargs: Any
    ) -> None:
        """with_list.
