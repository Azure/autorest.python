...
class NullableClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype string: type.property.nullable.operations.StringOperations
    :ivar bytes: BytesOperations operations
    :vartype bytes: type.property.nullable.operations.BytesOperations
    :ivar datetime: DatetimeOperations operations
    :vartype datetime: type.property.nullable.operations.DatetimeOperations
    :ivar duration: DurationOperations operations
    :vartype duration: type.property.nullable.operations.DurationOperations
    :ivar collections_byte: CollectionsByteOperations operations
    :vartype collections_byte: type.property.nullable.operations.CollectionsByteOperations
    :ivar collections_model: CollectionsModelOperations operations
    :vartype collections_model: type.property.nullable.operations.CollectionsModelOperations
    :ivar collections_string: CollectionsStringOperations operations
    :vartype collections_string: type.property.nullable.operations.CollectionsStringOperations
