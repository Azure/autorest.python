...
class NullableClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype nullable_client_collections_byte:
     typetest.property.nullable.aio.operations.NullableClientCollectionsByteOperations
    ...
    :vartype nullable_client_collections_model:
     typetest.property.nullable.aio.operations.NullableClientCollectionsModelOperations
    ...
    :vartype nullable_client_collections_string:
     typetest.property.nullable.aio.operations.NullableClientCollectionsStringOperations
