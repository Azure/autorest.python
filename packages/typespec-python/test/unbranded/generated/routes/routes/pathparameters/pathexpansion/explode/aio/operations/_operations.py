...
class RoutesClientPathParametersPathExpansionExplodeOperations:  # pylint: disable=name-too-long
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`routes_client_path_parameters_path_expansion_explode` attribute.
    """
    ...
    async def primitive(self, param: str, **kwargs: Any) -> None:
        ...
        _request = build_routes_client_path_parameters_path_expansion_explode_primitive_request(
            param=param,
            headers=_headers,
            params=_params,
        )
    ...
    async def array(self, param: list[str], **kwargs: Any) -> None:
        ...
        _request = build_routes_client_path_parameters_path_expansion_explode_array_request(
            param=param,
            headers=_headers,
            params=_params,
        )
    ...
    async def record(self, param: dict[str, int], **kwargs: Any) -> None:
        ...
        _request = build_routes_client_path_parameters_path_expansion_explode_record_request(
            param=param,
            headers=_headers,
            params=_params,
        )
