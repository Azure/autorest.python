...
def build_routes_client_path_parameters_simple_expansion_standard_primitive_request(  # pylint: disable=name-too-long
...
def build_routes_client_path_parameters_simple_expansion_standard_array_request(  # pylint: disable=name-too-long
...
def build_routes_client_path_parameters_simple_expansion_standard_record_request(  # pylint: disable=name-too-long
...
class RoutesClientPathParametersSimpleExpansionStandardOperations:  # pylint: disable=name-too-long
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`routes_client_path_parameters_simple_expansion_standard` attribute.
    """
    ...
    def array(self, param: list[str], **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        ...
        _request = build_routes_client_path_parameters_simple_expansion_standard_array_request(
            param=param,
            headers=_headers,
            params=_params,
        )
