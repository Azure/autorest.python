...
from ..header.aio.operations import DurationClientHeaderOperations
from ..property.aio.operations import DurationClientPropertyOperations
from ..query.aio.operations import DurationClientQueryOperations
