...
class ServerDrivenPaginationOperations:
    ...
    def link(self, **kwargs: Any) -> _models1.LinkResponse:
        """link.
        ...
        cls: ClsType[_models1.LinkResponse] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models1.LinkResponse, response.json())
