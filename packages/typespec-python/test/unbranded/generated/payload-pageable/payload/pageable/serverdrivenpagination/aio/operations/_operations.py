...
class ServerDrivenPaginationOperations:
    ...
    async def link(self, **kwargs: Any) -> _models2.LinkResponse:
        """link.

        :return: LinkResponse. The LinkResponse is compatible with MutableMapping
        :rtype: ~payload.pageable.models.LinkResponse
        ...
        cls: ClsType[_models2.LinkResponse] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models2.LinkResponse, response.json())
