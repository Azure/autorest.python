...
class NotDiscriminatedClientOperationsMixin(NotDiscriminatedClientMixinABC):
    ...
    def post_valid(self, input: _models.Siamese, *, content_type: str = "application/json", **kwargs: Any) -> None:
        ...
        :type input: ~type.model.inheritance.notdiscriminated.models.Siamese
    ...
    def post_valid(  # pylint: disable=inconsistent-return-statements
        ...
        :type input: ~type.model.inheritance.notdiscriminated.models.Siamese or JSON or IO[bytes]
        :return: None
        :rtype: None
        :raises ~corehttp.exceptions.HttpResponseError:
        """
    ...
    def get_valid(self, **kwargs: Any) -> _models.Siamese:
        ...
        :rtype: ~type.model.inheritance.notdiscriminated.models.Siamese
        :raises ~corehttp.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
