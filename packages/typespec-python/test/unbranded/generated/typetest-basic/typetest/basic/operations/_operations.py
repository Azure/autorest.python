...
def build_decimal_type_request_parameter_request(  # pylint: disable=name-too-long
    *, value: float, **kwargs: Any
    ...
    _params["value"] = _SERIALIZER.query("value", value, "float")
...
class DecimalTypeOperations:
    ...
    def response_body(self, **kwargs: Any) -> float:
        """response_body.
        ...
        if _stream:
            ...
            deserialized = _deserialize(float, response.json())
    ...
    def request_body(self, body: float, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        """request_body.
