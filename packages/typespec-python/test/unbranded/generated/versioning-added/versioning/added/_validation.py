...
def api_version_validation(**kwargs):
    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            if _index_with_default(method_added_on) > _index_with_default(client_api_version, -sys.maxsize):
                raise ValueError(
            ...
            unsupported = {
                ...
                and _index_with_default(api_version) > _index_with_default(client_api_version, -sys.maxsize)
            }
            if unsupported:
                raise ValueError(
                    "".join(
