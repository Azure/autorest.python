...
def _test_sample_array_file(client: MultiPartClient):
    ...
    client.form_data.binary_array_parts(
        {"id": "123", "pictures": [open(str(PNG), "rb").read(), ("my_image.png", open(str(PNG), "rb"))]}
    )
    # or
    client.form_data.binary_array_parts(
        {"id": "123", "pictures": [open(str(PNG), "rb").read(), ("my_image.png", open(str(PNG), "rb"), "image/png")]}
    )
    # List[io, bytes]
    ...
    client.form_data.binary_array_parts(
        {
            "id": "123",
            "pictures": [
                ("my_image1.png", open(str(PNG), "rb"), "image/png"),
                ("my_image2.png", open(str(PNG), "rb"), "image/png"),
            ],
        }
    )
    # ...
