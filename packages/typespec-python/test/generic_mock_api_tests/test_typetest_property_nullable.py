...
def test_collections_byte(client: NullableClient):
    non_null_model = models.CollectionsByteProperty(required_property="foo", nullable_property=["aGVsbG8sIHdvcmxkIQ==", "aGVsbG8sIHdvcmxkIQ=="])
...
def test_collections_model(client: NullableClient):
    non_null_model = models.CollectionsModelProperty(required_property="foo", nullable_property=[
