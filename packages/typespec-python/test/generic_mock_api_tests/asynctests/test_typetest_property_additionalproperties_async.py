...
async def test_extends_different_spread_model(client: AdditionalPropertiesClient):
    body = models.DifferentSpreadModelDerived({"knownProp": "abc", "prop": {"state": "ok"}, "derivedProp": {"state": "ok"}})
...
async def test_extends_different_spread_model_array(client: AdditionalPropertiesClient):
    body = models.DifferentSpreadModelArrayDerived({"knownProp": "abc", "prop": [{"state": "ok"}, {"state": "ok"}], "derivedProp": [{"state": "ok"}, {"state": "ok"}]})
...
async def test_extends_model_array(client: AdditionalPropertiesClient):
    body = models.ExtendsModelArrayAdditionalProperties({"knownProp": [{"state": "ok"}, {"state": "ok"}], "prop": [{"state": "ok"}, {"state": "ok"}]})
...
async def test_extends_unknown(client: AdditionalPropertiesClient):
    body = models.ExtendsUnknownAdditionalProperties({"name": "ExtendsUnknownAdditionalProperties", "prop1": 32, "prop2": True, "prop3": "abc"})
...
async def test_extends_unknown_derived(client: AdditionalPropertiesClient):
    body = models.ExtendsUnknownAdditionalPropertiesDerived({"name": "ExtendsUnknownAdditionalProperties", "index": 314, "age": 2.71828, "prop1": 32, "prop2": True, "prop3": "abc"})
...
async def test_extends_unknown_discriminated(client: AdditionalPropertiesClient):
    body = models.ExtendsUnknownAdditionalPropertiesDiscriminatedDerived({"kind": "derived", "name": "Derived", "index": 314, "age": 2.71828, "prop1": 32, "prop2": True, "prop3": "abc"})
...
async def test_is_model_array(client: AdditionalPropertiesClient):
    body = models.IsModelArrayAdditionalProperties({"knownProp": [{"state": "ok"}, {"state": "ok"}], "prop": [{"state": "ok"}, {"state": "ok"}]})
...
async def test_is_unknown(client: AdditionalPropertiesClient):
    body = models.IsUnknownAdditionalProperties({"name": "IsUnknownAdditionalProperties", "prop1": 32, "prop2": True, "prop3": "abc"})
...
async def test_is_unknown_derived(client: AdditionalPropertiesClient):
    body = models.IsUnknownAdditionalPropertiesDerived({"name": "IsUnknownAdditionalProperties", "index": 314, "age": 2.71828, "prop1": 32, "prop2": True, "prop3": "abc"})
...
async def test_is_unknown_discriminated(client: AdditionalPropertiesClient):
    body = models.IsUnknownAdditionalPropertiesDiscriminatedDerived({"kind": "derived", "name": "Derived", "index": 314, "age": 2.71828, "prop1": 32, "prop2": True, "prop3": "abc"})
...
async def test_spread_record_discriminated_union(client: AdditionalPropertiesClient):
    body = {'name': 'abc', 'prop1': {'fooProp': 'abc', 'kind': 'kind0'}, 'prop2': {'end': '2021-01-02T00:00:00Z', 'kind': 'kind1', 'start': '2021-01-01T00:00:00Z'}}
...
async def test_spread_record_non_discriminated_union(client: AdditionalPropertiesClient):
    body = {'name': 'abc', 'prop1': {'kind': 'kind0', 'fooProp': 'abc'}, 'prop2': {'kind': 'kind1', 'start': '2021-01-01T00:00:00Z', 'end': '2021-01-02T00:00:00Z'}}
...
async def test_spread_record_non_discriminated_union2(client: AdditionalPropertiesClient):
    body = {'name': 'abc', 'prop1': {'kind': 'kind1', 'start': '2021-01-01T00:00:00Z'}, 'prop2': {'kind': 'kind1', 'start': '2021-01-01T00:00:00Z', 'end': '2021-01-02T00:00:00Z'}}
...
async def test_spread_record_non_discriminated_union3(client: AdditionalPropertiesClient):
    body = {'name': 'abc', 'prop1': [{'kind': 'kind1', 'start': '2021-01-01T00:00:00Z'}, {'kind': 'kind1', 'start': '2021-01-01T00:00:00Z'}], 'prop2': {'kind': 'kind1', 'start': '2021-01-01T00:00:00Z', 'end': '2021-01-02T00:00:00Z'}}
