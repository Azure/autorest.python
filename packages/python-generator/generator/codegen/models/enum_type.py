...
class EnumValue(BaseModel):
    ...
    def from_yaml(
        ...
        :rtype: ~generator.models.EnumValue
        """
        return cls(
            yaml_data=yaml_data,
...
class EnumType(BaseType):
    ...
    :type element_type: ~generator.models.PrimitiveType
    :param values: List of the values for this enum
    :type values: list[~generator.models.EnumValue]
    """
    ...
    def from_yaml(
        ...
        :rtype: ~generator.models.EnumType
        """
