...
class AccountSasParameters(Model):
    ...
    _validation = {
        'signed_services': {'required': True},
        'signed_resource_types': {'required': True},
        'signed_permission': {'required': True},
    ...
    def __init__(self, **kwargs):
        ...
        self.signed_services = None
        self.signed_resource_types = None
        self.signed_permission = None
...
class AzureFilesIdentityBasedAuthentication(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.directory_service_options = None
...
class DateAfterCreation(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.days_after_creation_greater_than = None
...
class DateAfterModification(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.days_after_modification_greater_than = None
...
class EncryptionService(Model):
	...
	:type enabled: bool
    :ivar last_enabled_time: Gets a rough estimate of the date/time when the encryption was last enabled by the user. Only returned when encryption is enabled. There might be some unencrypted blobs which were written after this time, as it is just a rough estimate.
...
class GeoReplicationStats(Model):
    ...
    :ivar status: The status of the secondary location. Possible values are: - Live: Indicates that the secondary location is active and operational. - Bootstrap: Indicates initial synchronization from the primary location to the secondary location is in progress.This typically occurs when replication is first enabled. - Unavailable: Indicates that the secondary location is temporarily unavailable.
	:type status: str or GeoReplicationStatus
    :ivar last_sync_time: All primary writes preceding this UTC date/time value are guaranteed to be available for read operations. Primary writes following this point in time may or may not be available for reads. Element may be default value if value of LastSyncTime is not available, this can happen if secondary is offline or we are in bootstrap.
...
class Resource(Model):
    ...
    :ivar id: Fully qualified resource Id for the resource. Ex - /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}.
	:type id: str
...
class Restriction(Model):
	...
	:type type: str
    :ivar values: The value of restrictions. If the restriction type is set to location. This would be different locations where the SKU is restricted.
...
class SKUCapability(Model):
    ...
    :ivar name: The name of capability, The capability information in the specified SKU, including file encryption, network ACLs, change notification, etc.
	:type name: str
...
class ServiceSasParameters(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.canonicalized_resource = None
...
class Sku(Model):
    ...
    :ivar locations: The set of locations that the SKU is available. This will be supported and registered Azure Geo Regions (e.g. West US, East US, Southeast Asia, etc.).
	:type locations: list[string]
    :ivar capabilities: The capability information in the specified SKU, including file encryption, network ACLs, change notification, etc.
...
class StorageAccountKey(Model):
	...
	:type value: str
    :ivar permissions: Permissions for the key -- read-only or full permissions.
...
class StorageAccountListKeysResult(Model):
    ...
    :ivar keys: Gets the list of storage account keys and their properties for the specified storage account.
...
class StorageAccountProperties(Model):
    ...
    :ivar status_of_primary: Gets the status indicating whether the primary location of the storage account is available or unavailable.
	:type status_of_primary: str or AccountStatus
    :ivar last_geo_failover_time: Gets the timestamp of the most recent instance of a failover to the secondary location. Only the most recent timestamp is retained. This element is not returned if there has never been a failover instance. Only available if the accountType is Standard_GRS or Standard_RAGRS.
	:type last_geo_failover_time: datetime.datetime
    :ivar secondary_location: Gets the location of the geo-replicated secondary for the storage account. Only available if the accountType is Standard_GRS or Standard_RAGRS.
	:type secondary_location: str
    :ivar status_of_secondary: Gets the status indicating whether the primary location of the storage account is available or unavailable.
...
class Usage(Model):
    ...
    :ivar unit: Gets the unit of measurement.
