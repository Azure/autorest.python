...
def update_parameter(yaml_data: Dict[str, Any]) -> None:
    ...
    if yaml_data.get("propertyToParameterName"):
        ...
        yaml_data["propertyToParameterName"] = {
            pad_reserved_words(prop, PadType.PROPERTY): pad_reserved_words(param_name, PadType.PARAMETER)
...
def update_types(yaml_data: List[Dict[str, Any]]) -> None:
    for type in yaml_data:
        for property in type.get("properties", []):
            ...
            property["clientName"] = pad_reserved_words(property["clientName"].lower(), PadType.PROPERTY)
        if type.get("name"):
...
class Namer(YamlUpdatePlugin):
    ...
    def update_operation(self, yaml_data: Dict[str, Any]) -> None:
        yaml_data["groupName"] = pad_reserved_words(yaml_data["groupName"], PadType.OPERATION_GROUP)
    ...
    def update_paging_operation(self, yaml_data: Dict[str, Any]) -> None:
        ...
        if yaml_data.get("nextOperation"):
            yaml_data["nextOperation"]["groupName"] = pad_reserved_words(yaml_data["nextOperation"]["groupName"], PadType.OPERATION_GROUP)
    ...
    def update_operation_groups(self, yaml_data: Dict[str, Any]) -> None:
        ...
        for operation_group in operation_groups_yaml_data:
            operation_group["propertyName"] = pad_reserved_words(operation_group["propertyName"], PadType.OPERATION_GROUP)
