...
class MetadataSerializer:
    ...
    def serialize(self) -> str:
        ...
        if self.code_model.options["azure_arm"] and not self.code_model.service_client.endpoint:
            self.code_model.service_client.endpoint_value = "https://management.azure.com"
