...
from .. import models
from .reviews_operations import ReviewsOperations as _ReviewsOperations


class ReviewsOperations(_ReviewsOperations):
    ...
    async def get_review_async(
        ...
        """
        # Construct URL
        url = self.get_review_async.metadata['url']
        ...
        return deserialized
    get_review_async.metadata = {'url': '/contentmoderator/review/v1.0/teams/{teamName}/reviews/{reviewId}'}
    ...
    async def get_job_details_async(
        ...
        """
        # Construct URL
        url = self.get_job_details_async.metadata['url']
        path_format_arguments = {
            'Endpoint': self._serialize.url("self.config.endpoint", self.config.endpoint, 'str', skip_quote=True),
            'teamName': self._serialize.url("team_name", team_name, 'str'),
        ...
        return deserialized
    get_job_details_async.metadata = {'url': '/contentmoderator/review/v1.0/teams/{teamName}/jobs/{JobId}'}
    ...
    async def create_reviews_async(
        ...
        """
        # Construct URL
        url = self.create_reviews_async.metadata['url']
        path_format_arguments = {
            'Endpoint': self._serialize.url("self.config.endpoint", self.config.endpoint, 'str', skip_quote=True),
            'teamName': self._serialize.url("team_name", team_name, 'str')
        }
        ...
        return deserialized
    create_reviews_async.metadata = {'url': '/contentmoderator/review/v1.0/teams/{teamName}/reviews'}

    async def create_job_async(
            self, team_name, content_type, content_id, workflow_name, job_content_type, content, call_back_endpoint=None, *, custom_headers=None, raw=False, **operation_config):
        ...
        :type content:
         ~azure.cognitiveservices.vision.contentmoderator.models.Content
        ...
        """
        # Construct URL
        url = self.create_job_async.metadata['url']
        path_format_arguments = {
            'Endpoint': self._serialize.url("self.config.endpoint", self.config.endpoint, 'str', skip_quote=True),
            'teamName': self._serialize.url("team_name", team_name, 'str')
        }
        ...
        return deserialized
    create_job_async.metadata = {'url': '/contentmoderator/review/v1.0/teams/{teamName}/jobs'}

    async def add_video_frame_async(
        ...
        """
        # Construct URL
        url = self.add_video_frame_async.metadata['url']
        path_format_arguments = {
            'Endpoint': self._serialize.url("self.config.endpoint", self.config.endpoint, 'str', skip_quote=True),
            'teamName': self._serialize.url("team_name", team_name, 'str'),
            'reviewId': self._serialize.url("review_id", review_id, 'str')
        ...
        if raw:
            ...
            return client_raw_response
    add_video_frame_async.metadata = {'url': '/contentmoderator/review/v1.0/teams/{teamName}/reviews/{reviewId}/frames'}

    async def get_video_frames_async(
        ...
        """
        # Construct URL
        url = self.get_video_frames_async.metadata['url']
        path_format_arguments = {
            'Endpoint': self._serialize.url("self.config.endpoint", self.config.endpoint, 'str', skip_quote=True),
            'teamName': self._serialize.url("team_name", team_name, 'str'),
            'reviewId': self._serialize.url("review_id", review_id, 'str')
        ...
        return deserialized
    get_video_frames_async.metadata = {'url': '/contentmoderator/review/v1.0/teams/{teamName}/reviews/{reviewId}/frames'}

    async def publish_video_review_async(
            self, team_name, review_id, *, custom_headers=None, raw=False, **operation_config):
        ...
        """
        # Construct URL
        url = self.publish_video_review_async.metadata['url']
        path_format_arguments = {
            'Endpoint': self._serialize.url("self.config.endpoint", self.config.endpoint, 'str', skip_quote=True),
            'teamName': self._serialize.url("team_name", team_name, 'str'),
            'reviewId': self._serialize.url("review_id", review_id, 'str')
        ...
        if raw:
            client_raw_response = ClientRawResponse(None, response)
            return client_raw_response
    publish_video_review_async.metadata = {'url': '/contentmoderator/review/v1.0/teams/{teamName}/reviews/{reviewId}/publish'}

    async def add_video_transcript_moderation_result_async(
        ...
        """
        # Construct URL
        url = self.add_video_transcript_moderation_result_async.metadata['url']
        path_format_arguments = {
            'Endpoint': self._serialize.url("self.config.endpoint", self.config.endpoint, 'str', skip_quote=True),
            'teamName': self._serialize.url("team_name", team_name, 'str'),
            'reviewId': self._serialize.url("review_id", review_id, 'str')
        ...
        if raw:
            client_raw_response = ClientRawResponse(None, response)
            return client_raw_response
    add_video_transcript_moderation_result_async.metadata = {'url': '/contentmoderator/review/v1.0/teams/{teamName}/reviews/{reviewId}/transcriptmoderationresult'}

    async def add_video_transcript_async(
        ...
        """
        # Construct URL
        url = self.add_video_transcript_async.metadata['url']
        path_format_arguments = {
            'Endpoint': self._serialize.url("self.config.endpoint", self.config.endpoint, 'str', skip_quote=True),
            'teamName': self._serialize.url("team_name", team_name, 'str'),
            'reviewId': self._serialize.url("review_id", review_id, 'str')
        ...
        if raw:
            client_raw_response = ClientRawResponse(None, response)
            return client_raw_response
    add_video_transcript_async.metadata = {'url': '/contentmoderator/review/v1.0/teams/{teamName}/reviews/{reviewId}/transcript'}

    async def create_video_reviews_async(
        ...
        """
        # Construct URL
        url = self.create_video_reviews_async.metadata['url']
        path_format_arguments = {
            'Endpoint': self._serialize.url("self.config.endpoint", self.config.endpoint, 'str', skip_quote=True),
            'teamName': self._serialize.url("team_name", team_name, 'str')
        }
        ...
        return deserialized
    create_video_reviews_async.metadata = {'url': '/contentmoderator/review/v1.0/teams/{teamName}/reviews'}

    async def add_video_frame_url_async(
        ...
        """
        # Construct URL
        url = self.add_video_frame_url_async.metadata['url']
        path_format_arguments = {
            'Endpoint': self._serialize.url("self.config.endpoint", self.config.endpoint, 'str', skip_quote=True),
            'teamName': self._serialize.url("team_name", team_name, 'str'),
            'reviewId': self._serialize.url("review_id", review_id, 'str')
        ...
        if raw:
            client_raw_response = ClientRawResponse(None, response)
            return client_raw_response
    add_video_frame_url_async.metadata = {'url': '/contentmoderator/review/v1.0/teams/{teamName}/reviews/{reviewId}/frames'}

    async def add_video_frame_stream_async(
        ...
        """
        # Construct URL
        url = self.add_video_frame_stream_async.metadata['url']
        path_format_arguments = {
            'Endpoint': self._serialize.url("self.config.endpoint", self.config.endpoint, 'str', skip_quote=True),
            'teamName': self._serialize.url("team_name", team_name, 'str'),
            'reviewId': self._serialize.url("review_id", review_id, 'str')
        ...
        if raw:
            client_raw_response = ClientRawResponse(None, response)
            return client_raw_response
    add_video_frame_stream_async.metadata = {'url': '/contentmoderator/review/v1.0/teams/{teamName}/reviews/{reviewId}/frames'}
