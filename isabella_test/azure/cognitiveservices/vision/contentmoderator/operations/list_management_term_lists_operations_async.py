...
from .. import models
from .list_management_term_lists_operations import ListManagementTermListsOperations as _ListManagementTermListsOperations


class ListManagementTermListsOperations(_ListManagementTermListsOperations):
    ...
    async def get_details_async(
        ...
        return deserialized
    get_details_async.metadata = {'url': '/contentmoderator/lists/v1.0/termlists/{listId}'}
    ...
    async def delete_async(
        ...
        return deserialized
    delete_async.metadata = {'url': '/contentmoderator/lists/v1.0/termlists/{listId}'}
    ...
    async def update_async(
        ...
        return deserialized
    update_async.metadata = {'url': '/contentmoderator/lists/v1.0/termlists/{listId}'}
    ...
    async def create_async(
        ...
        return deserialized
    create_async.metadata = {'url': '/contentmoderator/lists/v1.0/termlists'}

    async def get_all_term_lists_async(
        ...
        """
        # Construct URL
        url = self.get_all_term_lists_async.metadata['url']
        path_format_arguments = {
            'Endpoint': self._serialize.url("self.config.endpoint", self.config.endpoint, 'str', skip_quote=True)
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        return deserialized
    get_all_term_lists_async.metadata = {'url': '/contentmoderator/lists/v1.0/termlists'}
    ...
    async def refresh_index_method_async(
        ...
        return deserialized
    refresh_index_method_async.metadata = {'url': '/contentmoderator/lists/v1.0/termlists/{listId}/RefreshIndex'}
