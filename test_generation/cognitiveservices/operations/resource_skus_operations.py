...
class ResourceSkusOperations(object):
    ...
    def list(
        ...
        :return: ResourceSkusResult or ClientRawResponse if raw=true
        :rtype: ~cognitiveservices.models.ResourceSkusResult or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('ResourceSkusResult', response)
