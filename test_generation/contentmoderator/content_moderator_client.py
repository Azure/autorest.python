...
class ContentModeratorClientConfiguration(Configuration):
    ...
    def __init__(
        ...
        self.add_user_agent('contentmoderatorclient/{}'.format(VERSION))
...
class ContentModeratorClient(SDKClient):
    ...
    :vartype image_moderation: contentmoderator.operations.ImageModerationOperations
    :ivar text_moderation: TextModeration operations
    :vartype text_moderation: contentmoderator.operations.TextModerationOperations
    :ivar list_management_image_lists: ListManagementImageLists operations
    :vartype list_management_image_lists: contentmoderator.operations.ListManagementImageListsOperations
    :ivar list_management_term_lists: ListManagementTermLists operations
    :vartype list_management_term_lists: contentmoderator.operations.ListManagementTermListsOperations
    :ivar list_management_image: ListManagementImage operations
    :vartype list_management_image: contentmoderator.operations.ListManagementImageOperations
    :ivar list_management_term: ListManagementTerm operations
    :vartype list_management_term: contentmoderator.operations.ListManagementTermOperations
    :ivar reviews: Reviews operations
    :vartype reviews: contentmoderator.operations.ReviewsOperations
    ...
    def __init__(
        ...
        self.config = ContentModeratorClientConfiguration(endpoint)
        super(ContentModeratorClient, self).__init__(None, self.config)
