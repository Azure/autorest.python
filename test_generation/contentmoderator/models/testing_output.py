...
class APIError(nextNode):
    """Error information returned by the API.

    :param error:
    :type error: ~contentmoderator.models.Error
    """
...
class Classification(nextNode):
    ...
    :type category1: ~contentmoderator.models.ClassificationCategory1
    :param category2: The category2 score details of the text. <a
     href="https://aka.ms/textClassifyCategories">Click here</a> for more
     details on category classification.
    :type category2: ~contentmoderator.models.ClassificationCategory2
    :param category3: The category3 score details of the text. <a
     href="https://aka.ms/textClassifyCategories">Click here</a> for more
     details on category classification.
    :type category3: ~contentmoderator.models.ClassificationCategory3
...
class ClassificationCategory1(nextNode):
...
class ClassificationCategory2(nextNode):
...
class ClassificationCategory3(nextNode):
...
class CreateReviewBodyItem(nextNode):
    ...
    :param type: Required. Type of the content. Possible values include:
     'Image', 'Text'
    :type type: str or ~contentmoderator.models.enum
    ...
    :type metadata:
     list[~contentmoderator.models.CreateReviewBodyItemMetadataItem]
    """
...
class CreateReviewBodyItemMetadataItem(nextNode):
...
class CreateVideoReviewsBodyItem(nextNode):
    """Schema items of the body.
    ...
    :type video_frames:
     list[~contentmoderator.models.CreateVideoReviewsBodyItemVideoFramesItem]
    :param metadata: Optional metadata details.
    :type metadata:
     list[~contentmoderator.models.CreateVideoReviewsBodyItemMetadataItem]
    ...
    :param status: Required. Status of the
     ...
     'Unpublished', 'Pending'
    :type status: str or ~contentmoderator.models.enum
...
class CreateVideoReviewsBodyItemMetadataItem(nextNode):
...
class CreateVideoReviewsBodyItemVideoFramesItem(nextNode):
    ...
    :type reviewer_result_tags:
     list[~contentmoderator.models.CreateVideoReviewsBodyItemVideoFramesItemReviewerResultTagsItem]
    :param metadata: Optional metadata details.
    :type metadata:
     list[~contentmoderator.models.CreateVideoReviewsBodyItemVideoFramesItemMetadataItem]
    """
...
class CreateVideoReviewsBodyItemVideoFramesItemMetadataItem(nextNode):
...
class CreateVideoReviewsBodyItemVideoFramesItemReviewerResultTagsItem(nextNode):
...
class DetectedLanguage(nextNode):
    ...
    :type status: ~contentmoderator.models.Status
...
class Evaluate(nextNode):
    ...
    :type advanced_info: list[~contentmoderator.models.KeyValuePair]
...
class FoundFaces(nextNode):
    ...
    :type faces: list[~contentmoderator.models.Face]
    """
...
class Frame(nextNode):
    ...
    :type metadata: list[~contentmoderator.models.KeyValuePair]
    :param reviewer_result_tags: Reviewer result tags.
    :type reviewer_result_tags: list[~contentmoderator.models.Tag]
    """
...
class Frames(nextNode):
    """The response for a Get Frames request.

    :param review_id: Id of the review.
    :type review_id: str
    :param video_frames:
    :type video_frames: list[~contentmoderator.models.Frame]
    """
...
class Image(nextNode):
    ...
    :type additional_info:
     list[~contentmoderator.models.ImageAdditionalInfoItem]
...
class ImageAdditionalInfoItem(nextNode):
...
class Job(nextNode):
    ...
    :type result_meta_data: list[~contentmoderator.models.KeyValuePair]
    :param job_execution_report: Job execution report- Array of KeyValue pairs
     object.
    :type job_execution_report:
     list[~contentmoderator.models.JobExecutionReportDetails]
    """
...
class JobExecutionReportDetails(nextNode):
...
class MatchResponse(nextNode):
    ...
    :type matches: list[~contentmoderator.models.Match]
    :param status: The evaluate status
    :type status: ~contentmoderator.models.Status
    """
...
class OCR(nextNode):
    ...
    :type candidates: list[~contentmoderator.models.Candidate]
    """
...
class PII(nextNode):
    ...
    :param email:
    :type email: list[~contentmoderator.models.Email]
    :param ssn:
    :type ssn: list[~contentmoderator.models.SSN]
    :param ipa:
    :type ipa: list[~contentmoderator.models.IPA]
    :param phone:
    :type phone: list[~contentmoderator.models.Phone]
    :param address:
    :type address: list[~contentmoderator.models.Address]
    """
...
class Review(nextNode):
    ...
    :type reviewer_result_tags: list[~contentmoderator.models.KeyValuePair]
...
class Screen(nextNode):
    ...
    :type classification: ~contentmoderator.models.Classification
    :param status: The evaluate status.
    :type status: ~contentmoderator.models.Status
    :param pii: Personal Identifier Information details.
    :type pii: ~contentmoderator.models.PII
    :param language: Language of the input text content.
    :type language: str
    :param terms:
    :type terms: list[~contentmoderator.models.DetectedTerms]
...
class Terms(nextNode):
    """Terms properties.

    :param data: Term data details.
    :type data: ~contentmoderator.models.TermsData
    :param paging: Paging details.
    :type paging: ~contentmoderator.models.TermsPaging
    """
...
class TermsData(nextNode):
    """All term Id response properties.

    :param language: Language of the terms.
    :type language: str
    :param terms: List of terms.
    :type terms: list[~contentmoderator.models.TermsInList]
...
class TranscriptModerationBodyItem(nextNode):
    """Schema items of the body.
    ...
    :type terms:
     list[~contentmoderator.models.TranscriptModerationBodyItemTermsItem]
    """
...
class TranscriptModerationBodyItemTermsItem(nextNode):
...
class VideoFrameBodyItem(nextNode):
    """Schema items of the body.
    ...
    :param reviewer_result_tags:
    :type reviewer_result_tags:
     list[~contentmoderator.models.VideoFrameBodyItemReviewerResultTagsItem]
    :param metadata: Optional metadata details.
    :type metadata:
     list[~contentmoderator.models.VideoFrameBodyItemMetadataItem]
    """
...
class VideoFrameBodyItemMetadataItem(nextNode):
...
class VideoFrameBodyItemReviewerResultTagsItem(nextNode):
