...
class LLCClient(object):
    ...
    def send_request(
        ...
        **kwargs  # type: Any
        ...
        We have helper methods to create requests specific to this service in `llcservicedrivenupdateonelowlevel.rest`.
        Use these helper methods to create the request you pass to this method.

        >>> from llcservicedrivenupdateonelowlevel.rest import params
