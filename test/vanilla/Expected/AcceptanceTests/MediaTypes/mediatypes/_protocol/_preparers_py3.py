...
def prepare_analyze_body(body: Optional[Union[IO, "_models.SourcePath"]] = None, **kwargs: Any) -> HttpRequest:
...
def prepare_content_type_with_encoding(body: Optional[str] = None, **kwargs: Any) -> HttpRequest:
