...
class MediaTypesClientOperationsMixin:
    def _analyze_body_request(
        self, body: Optional[Union[IO, "_models.SourcePath"]] = None, **kwargs: Any
    ) -> HttpRequest:
    ...
    async def analyze_body(self, input: Optional["_models.SourcePath"] = None, **kwargs: Any) -> str:
        ...
        _body = input
        request = self._analyze_body_request(body=_body, **kwargs)
    ...
    async def content_type_with_encoding(self, input: str, **kwargs: Any) -> str:
        ...
        _body = input
        request = self._content_type_with_encoding_request(body=_body, **kwargs)
        kwargs.pop("content_type", None)
