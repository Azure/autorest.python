...
class AdditionalPropertiesClientConfiguration(Configuration):
    ...
    def __init__(
        ...
        super(AdditionalPropertiesClientConfiguration, self).__init__(base_url)
        self._configure()

        self.add_user_agent('additionalpropertiesclient/{}'.format(VERSION))

    def _configure(self):
        super(AdditionalPropertiesClientConfiguration, self)._configure()
