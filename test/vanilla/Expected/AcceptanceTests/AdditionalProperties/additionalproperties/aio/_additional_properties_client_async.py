...
class AdditionalPropertiesClient(SDKClientAsync):
    ...
    def __init__(
        ...
        self.config = config or AdditionalPropertiesClientConfiguration(base_url)
        super(AdditionalPropertiesClient, self).__init__(None, self.config, pipeline=pipeline)
