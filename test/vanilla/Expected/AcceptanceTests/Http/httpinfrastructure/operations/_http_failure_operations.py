...
class HttpFailureOperations(object):
    ...
    def get_empty_error(self, cls=None, **operation_config):
    ...
    def get_no_model_error(self, cls=None, **operation_config):
        """Get empty error form server.
    ...
    def get_no_model_empty(self, cls=None, **operation_config):
