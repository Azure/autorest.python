...
class HttpRedirectsOperations(object):
    ...
    def head300(self, cls=None, **operation_config):
    ...
    def get300(self, cls=None, **operation_config):
        """Return 300 status code and redirect to /http/success/200.
    ...
    def head301(self, cls=None, **operation_config):
    ...
    def get301(self, cls=None, **operation_config):
        """Return 301 status code and redirect to /http/success/200.
    ...
    def put301(self, boolean_value=None, cls=None, **operation_config):
    ...
    def head302(self, cls=None, **operation_config):
    ...
    def get302(self, cls=None, **operation_config):
        """Return 302 status code and redirect to /http/success/200.
    ...
    def patch302(self, boolean_value=None, cls=None, **operation_config):
    ...
    def post303(self, boolean_value=None, cls=None, **operation_config):
    ...
    def head307(self, cls=None, **operation_config):
    ...
    def get307(self, cls=None, **operation_config):
    ...
    def put307(self, boolean_value=None, cls=None, **operation_config):
    ...
    def patch307(self, boolean_value=None, cls=None, **operation_config):
    ...
    def post307(self, boolean_value=None, cls=None, **operation_config):
    ...
    def delete307(self, boolean_value=None, cls=None, **operation_config):
