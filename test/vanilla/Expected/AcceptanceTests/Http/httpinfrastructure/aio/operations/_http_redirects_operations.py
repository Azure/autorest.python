...
class HttpRedirectsOperations:
    ...
    def _head300_request(self, **kwargs: Any) -> HttpRequest:
    ...
    def _get300_request(self, **kwargs: Any) -> HttpRequest:
        accept = "application/json"
    ...
    def _head301_request(self, **kwargs: Any) -> HttpRequest:
        accept = "application/json"
    ...
    def _get301_request(self, **kwargs: Any) -> HttpRequest:
        accept = "application/json"
    ...
    def _put301_request(self, body: Optional[bool] = True, **kwargs: Any) -> HttpRequest:
    ...
    async def put301(self, boolean_value: Optional[bool] = True, **kwargs: Any) -> None:
        ...
        _body = boolean_value
        request = self._put301_request(body=_body, **kwargs)
        kwargs.pop("content_type", None)
    ...
    def _head302_request(self, **kwargs: Any) -> HttpRequest:
        accept = "application/json"
    ...
    def _get302_request(self, **kwargs: Any) -> HttpRequest:
        accept = "application/json"
    ...
    def _patch302_request(self, body: Optional[bool] = True, **kwargs: Any) -> HttpRequest:
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def patch302(self, boolean_value: Optional[bool] = True, **kwargs: Any) -> None:
        ...
        _body = boolean_value
        request = self._patch302_request(body=_body, **kwargs)
        kwargs.pop("content_type", None)
    ...
    def _post303_request(self, body: Optional[bool] = True, **kwargs: Any) -> HttpRequest:
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def post303(self, boolean_value: Optional[bool] = True, **kwargs: Any) -> None:
        ...
        _body = boolean_value
        request = self._post303_request(body=_body, **kwargs)
        kwargs.pop("content_type", None)
    ...
    def _head307_request(self, **kwargs: Any) -> HttpRequest:
        accept = "application/json"
    ...
    def _get307_request(self, **kwargs: Any) -> HttpRequest:
        accept = "application/json"
    ...
    def _options307_request(self, **kwargs: Any) -> HttpRequest:
        accept = "application/json"
    ...
    def _put307_request(self, body: Optional[bool] = True, **kwargs: Any) -> HttpRequest:
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def put307(self, boolean_value: Optional[bool] = True, **kwargs: Any) -> None:
        ...
        _body = boolean_value
        request = self._put307_request(body=_body, **kwargs)
        kwargs.pop("content_type", None)
    ...
    def _patch307_request(self, body: Optional[bool] = True, **kwargs: Any) -> HttpRequest:
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def patch307(self, boolean_value: Optional[bool] = True, **kwargs: Any) -> None:
        ...
        _body = boolean_value
        request = self._patch307_request(body=_body, **kwargs)
        kwargs.pop("content_type", None)
    ...
    def _post307_request(self, body: Optional[bool] = True, **kwargs: Any) -> HttpRequest:
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def post307(self, boolean_value: Optional[bool] = True, **kwargs: Any) -> None:
        ...
        _body = boolean_value
        request = self._post307_request(body=_body, **kwargs)
        kwargs.pop("content_type", None)
    ...
    def _delete307_request(self, body: Optional[bool] = True, **kwargs: Any) -> HttpRequest:
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def delete307(self, boolean_value: Optional[bool] = True, **kwargs: Any) -> None:
        ...
        _body = boolean_value
        request = self._delete307_request(body=_body, **kwargs)
        kwargs.pop("content_type", None)
