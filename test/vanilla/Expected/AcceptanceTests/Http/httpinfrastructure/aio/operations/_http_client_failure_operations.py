...
class HttpClientFailureOperations:
    ...
    async def head400(self, **kwargs) -> None:
        ...
        request = prepare_httpclientfailure_head400(template_url=self.head400.metadata["url"], **kwargs)
    ...
    async def get400(self, **kwargs) -> None:
        ...
        request = prepare_httpclientfailure_get400(template_url=self.get400.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def options400(self, **kwargs) -> None:
        ...
        request = prepare_httpclientfailure_options400(template_url=self.options400.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def head401(self, **kwargs) -> None:
        ...
        request = prepare_httpclientfailure_head401(template_url=self.head401.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get402(self, **kwargs) -> None:
        ...
        request = prepare_httpclientfailure_get402(template_url=self.get402.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def options403(self, **kwargs) -> None:
        ...
        request = prepare_httpclientfailure_options403(template_url=self.options403.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get403(self, **kwargs) -> None:
        ...
        request = prepare_httpclientfailure_get403(template_url=self.get403.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def head410(self, **kwargs) -> None:
        ...
        request = prepare_httpclientfailure_head410(template_url=self.head410.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get411(self, **kwargs) -> None:
        ...
        request = prepare_httpclientfailure_get411(template_url=self.get411.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def options412(self, **kwargs) -> None:
        ...
        request = prepare_httpclientfailure_options412(template_url=self.options412.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get412(self, **kwargs) -> None:
        ...
        request = prepare_httpclientfailure_get412(template_url=self.get412.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get416(self, **kwargs) -> None:
        ...
        request = prepare_httpclientfailure_get416(template_url=self.get416.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def head429(self, **kwargs) -> None:
        ...
        request = prepare_httpclientfailure_head429(template_url=self.head429.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
