...
class HttpServerFailureOperations:
    ...
    async def head501(self, *, cls=None, **operation_config):
    ...
    async def get501(self, *, cls=None, **operation_config):
        """Return 501 status code - should be represented in the client as an
        error.
    ...
    async def post505(self, boolean_value=None, *, cls=None, **operation_config):
    ...
    async def delete505(self, boolean_value=None, *, cls=None, **operation_config):
        """Return 505 status code - should be represented in the client as an
        error.
