...
from ._configuration_async import AutoRestSwaggerConstantServiceConfiguration
from .operations_async import ContantsOperations
from .. import models
...
class AutoRestSwaggerConstantService(object):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.contants = ContantsOperations(
