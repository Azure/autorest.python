...
class XmlOperations:
    ...
    async def get_complex_type_ref_no_meta(
        self,
        **kwargs
    ) -> Union["models.RootWithRefAndNoMeta", ClsReturnType]:
    ...
    async def get_complex_type_ref_with_meta(
        self,
        **kwargs
    ) -> Union["models.RootWithRefAndMeta", ClsReturnType]:
    ...
    async def get_simple(
        self,
        **kwargs
    ) -> Union["models.Slideshow", ClsReturnType]:
    ...
    async def get_wrapped_lists(
        self,
        **kwargs
    ) -> Union["models.AppleBarrel", ClsReturnType]:
    ...
    async def get_root_list(
        self,
        **kwargs
    ) -> Union[List["models.Banana"], ClsReturnType]:
    ...
    async def get_empty_child_element(
        self,
        **kwargs
    ) -> Union["models.Banana", ClsReturnType]:
    ...
    async def list_containers(
        self,
        **kwargs
    ) -> Union["models.ListContainersResponse", ClsReturnType]:
    ...
    async def get_service_properties(
        self,
        **kwargs
    ) -> Union["models.StorageServiceProperties", ClsReturnType]:
    ...
    async def get_acls(
        self,
        **kwargs
    ) -> Union[List["models.SignedIdentifier"], ClsReturnType]:
    ...
    async def list_blobs(
        self,
        **kwargs
    ) -> Union["models.ListBlobsResponse", ClsReturnType]:
    ...
    async def json_output(
        self,
        **kwargs
    ) -> Union["models.JSONOutput", ClsReturnType]:
