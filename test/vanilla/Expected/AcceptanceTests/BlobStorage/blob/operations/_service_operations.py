...
class ServiceOperations(object):
    ...
    def set_properties(self, storage_service_properties, timeout=None, request_id=None, cls=None, **operation_config):
    ...
    def get_properties(self, timeout=None, request_id=None, cls=None, **operation_config):
    ...
    def get_statistics(self, timeout=None, request_id=None, cls=None, **operation_config):
    ...
    def list_containers_segment(self, prefix=None, marker=None, maxresults=None, include=None, timeout=None, request_id=None, cls=None, **operation_config):
