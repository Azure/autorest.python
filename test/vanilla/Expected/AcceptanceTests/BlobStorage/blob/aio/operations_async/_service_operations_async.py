...
class ServiceOperations:
    ...
    async def set_properties(self, storage_service_properties, timeout=None, request_id=None, *, cls=None, **operation_config):
    ...
    async def get_properties(self, timeout=None, request_id=None, *, cls=None, **operation_config):
    ...
    async def get_statistics(self, timeout=None, request_id=None, *, cls=None, **operation_config):
    ...
    async def list_containers_segment(self, prefix=None, marker=None, maxresults=None, include=None, timeout=None, request_id=None, *, cls=None, **operation_config):
