...
class ContainerOperations:
    ...
    async def create(self, timeout=None, metadata=None, access=None, request_id=None, *, cls=None, **operation_config):
    ...
    async def get_properties(self, timeout=None, request_id=None, lease_access_conditions=None, *, cls=None, **operation_config):
    ...
    async def delete(self, timeout=None, request_id=None, lease_access_conditions=None, modified_access_conditions=None, *, cls=None, **operation_config):
    ...
    async def get_access_policy(self, timeout=None, request_id=None, lease_access_conditions=None, *, cls=None, **operation_config):
    ...
    async def set_access_policy(self, container_acl=None, timeout=None, access=None, request_id=None, lease_access_conditions=None, modified_access_conditions=None, *, cls=None, **operation_config):
    ...
    async def list_blob_flat_segment(self, prefix=None, marker=None, maxresults=None, include=None, timeout=None, request_id=None, *, cls=None, **operation_config):
    ...
    async def list_blob_hierarchy_segment(self, delimiter, prefix=None, marker=None, maxresults=None, include=None, timeout=None, request_id=None, *, cls=None, **operation_config):
        """[Update] The List Blobs operation returns a list of the blobs under the
        specified container.
