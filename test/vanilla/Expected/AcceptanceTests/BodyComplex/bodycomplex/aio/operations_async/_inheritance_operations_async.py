...
class InheritanceOperations:
    ...
    async def put_valid(
        ...
        **kwargs: Any
        ...
        :param complex_body: Please put a siamese with id=2, name="Siameee", color=green, breed=persion,
         which hates 2 dogs, the 1st one named "Potato" with id=1 and food="tomato", and
