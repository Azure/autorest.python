...
class PolymorphismOperations:
    ...
    async def get_valid(
        self,
        **kwargs
    ) -> Union["models.Fish", ClsReturnType]:
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.Fish", ClsReturnType]
    ...
    async def get_dot_syntax(
        self,
        **kwargs
    ) -> Union["models.DotFish", ClsReturnType]:
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.DotFish", ClsReturnType]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
    ...
    async def get_composed_with_discriminator(
        self,
        **kwargs
    ) -> Union["models.DotFishMarket", ClsReturnType]:
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.DotFishMarket", ClsReturnType]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
    ...
    async def get_complicated(
        self,
        **kwargs
    ) -> Union["models.Salmon", ClsReturnType]:
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.Salmon", ClsReturnType]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
