...
class PrimitiveOperations:
    ...
    def _get_int_request(self, **kwargs: Any) -> HttpRequest:
    ...
    def _put_int_request(self, body: "_models.IntWrapper", **kwargs: Any) -> HttpRequest:
    ...
    async def put_int(self, complex_body: "_models.IntWrapper", **kwargs: Any) -> None:
        ...
        _body = complex_body
        request = self._put_int_request(body=_body, **kwargs)
        kwargs.pop("content_type", None)
    ...
    def _get_long_request(self, **kwargs: Any) -> HttpRequest:
        accept = "application/json"
    ...
    def _put_long_request(self, body: "_models.LongWrapper", **kwargs: Any) -> HttpRequest:
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def put_long(self, complex_body: "_models.LongWrapper", **kwargs: Any) -> None:
        ...
        _body = complex_body
        request = self._put_long_request(body=_body, **kwargs)
        kwargs.pop("content_type", None)
    ...
    def _get_float_request(self, **kwargs: Any) -> HttpRequest:
        accept = "application/json"
    ...
    def _put_float_request(self, body: "_models.FloatWrapper", **kwargs: Any) -> HttpRequest:
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def put_float(self, complex_body: "_models.FloatWrapper", **kwargs: Any) -> None:
        ...
        _body = complex_body
        request = self._put_float_request(body=_body, **kwargs)
        kwargs.pop("content_type", None)
    ...
    def _get_double_request(self, **kwargs: Any) -> HttpRequest:
        accept = "application/json"
    ...
    def _put_double_request(self, body: "_models.DoubleWrapper", **kwargs: Any) -> HttpRequest:
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def put_double(self, complex_body: "_models.DoubleWrapper", **kwargs: Any) -> None:
        ...
        _body = complex_body
        request = self._put_double_request(body=_body, **kwargs)
        kwargs.pop("content_type", None)
    ...
    def _get_bool_request(self, **kwargs: Any) -> HttpRequest:
        accept = "application/json"
    ...
    def _put_bool_request(self, body: "_models.BooleanWrapper", **kwargs: Any) -> HttpRequest:
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def put_bool(self, complex_body: "_models.BooleanWrapper", **kwargs: Any) -> None:
        ...
        _body = complex_body
        request = self._put_bool_request(body=_body, **kwargs)
        kwargs.pop("content_type", None)
    ...
    def _get_string_request(self, **kwargs: Any) -> HttpRequest:
        accept = "application/json"
    ...
    def _put_string_request(self, body: "_models.StringWrapper", **kwargs: Any) -> HttpRequest:
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def put_string(self, complex_body: "_models.StringWrapper", **kwargs: Any) -> None:
        ...
        _body = complex_body
        request = self._put_string_request(body=_body, **kwargs)
        kwargs.pop("content_type", None)
    ...
    def _get_date_request(self, **kwargs: Any) -> HttpRequest:
        accept = "application/json"
    ...
    def _put_date_request(self, body: "_models.DateWrapper", **kwargs: Any) -> HttpRequest:
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def put_date(self, complex_body: "_models.DateWrapper", **kwargs: Any) -> None:
        ...
        _body = complex_body
        request = self._put_date_request(body=_body, **kwargs)
        kwargs.pop("content_type", None)
    ...
    def _get_date_time_request(self, **kwargs: Any) -> HttpRequest:
        accept = "application/json"
    ...
    def _put_date_time_request(self, body: "_models.DatetimeWrapper", **kwargs: Any) -> HttpRequest:
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def put_date_time(self, complex_body: "_models.DatetimeWrapper", **kwargs: Any) -> None:
        ...
        _body = complex_body
        request = self._put_date_time_request(body=_body, **kwargs)
        kwargs.pop("content_type", None)
    ...
    def _get_date_time_rfc1123_request(self, **kwargs: Any) -> HttpRequest:
        accept = "application/json"
    ...
    def _put_date_time_rfc1123_request(self, body: "_models.Datetimerfc1123Wrapper", **kwargs: Any) -> HttpRequest:
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def put_date_time_rfc1123(self, complex_body: "_models.Datetimerfc1123Wrapper", **kwargs: Any) -> None:
        ...
        _body = complex_body
        request = self._put_date_time_rfc1123_request(body=_body, **kwargs)
        kwargs.pop("content_type", None)
    ...
    def _get_duration_request(self, **kwargs: Any) -> HttpRequest:
        accept = "application/json"
    ...
    async def put_duration(self, field: Optional[datetime.timedelta] = None, **kwargs: Any) -> None:
        ...
        _body = _models.DurationWrapper(field=field)
        request = self._put_duration_request(body=_body, **kwargs)
        kwargs.pop("content_type", None)
    ...
    def _get_byte_request(self, **kwargs: Any) -> HttpRequest:
        accept = "application/json"
    ...
    async def put_byte(self, field: Optional[bytearray] = None, **kwargs: Any) -> None:
        ...
        _body = _models.ByteWrapper(field=field)
        request = self._put_byte_request(body=_body, **kwargs)
        kwargs.pop("content_type", None)
