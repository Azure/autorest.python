...
class ArrayOperations:
    ...
    async def get_valid(self, **kwargs) -> "_models.ArrayWrapper":
        ...
        request = _prepare_array_get_valid_request(template_url=self.get_valid.metadata["url"], **kwargs)
    ...
    async def put_valid(self, array: Optional[List[str]] = None, **kwargs) -> None:
        ...
        request = _prepare_array_put_valid_request(
    ...
    async def get_not_provided(self, **kwargs) -> "_models.ArrayWrapper":
        ...
        request = _prepare_array_get_not_provided_request(template_url=self.get_not_provided.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
