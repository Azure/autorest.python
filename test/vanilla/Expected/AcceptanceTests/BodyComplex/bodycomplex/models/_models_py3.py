...
class DoubleWrapper(Model):
    ...
    def __init__(
        ...
        *,
        ...
        field_56_zeros_after_the_dot_and_negative_zero_before_dot_and_this_is_a_long_field_name_on_purpose: Optional[float] = None,
        **kwargs
    ) -> None:
...
class MyBaseType(Model):
    ...
    def __init__(
        ...
        *,
        ...
        helper: Optional["MyBaseHelperType"] = None,
        **kwargs
    ) -> None:
