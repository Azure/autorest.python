...
class MultipleInheritanceServiceClientOperationsMixin:
    ...
    async def get_horse(self, **kwargs) -> "_models.Horse":
        ...
        request = prepare_get_horse(template_url=self.get_horse.metadata["url"], **kwargs)
    ...
    async def get_pet(self, **kwargs) -> "_models.Pet":
        ...
        request = prepare_get_pet(template_url=self.get_pet.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_feline(self, **kwargs) -> "_models.Feline":
        ...
        request = prepare_get_feline(template_url=self.get_feline.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_cat(self, **kwargs) -> "_models.Cat":
        ...
        request = prepare_get_cat(template_url=self.get_cat.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_kitten(self, **kwargs) -> "_models.Kitten":
        ...
        request = prepare_get_kitten(template_url=self.get_kitten.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
