...
def build_upload_file_via_body_request(*, content: Optional[IO] = None, **kwargs: Any) -> HttpRequest:
    """Upload file.
...
def build_upload_files_request(*, files: Optional[List[IO]] = None, content: Any = None, **kwargs: Any) -> HttpRequest:
