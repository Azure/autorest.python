...
class QueriesOperations:
    ...
    async def array_string_multi_null(self, array_query=None, *, cls=None, **operation_config):
    ...
    async def array_string_multi_empty(self, array_query=None, *, cls=None, **operation_config):
    ...
    async def array_string_multi_valid(self, array_query=None, *, cls=None, **operation_config):
