...
class AutoRestValidationTestOperationsMixin:
    ...
    async def validation_of_method_parameters(self, resource_group_name, id, *, cls=None, **operation_config):
    ...
    async def validation_of_body(self, resource_group_name, id, body=None, *, cls=None, **operation_config):
    ...
    async def get_with_constant_in_path(self, *, cls=None, **operation_config):
        """
    ...
    async def post_with_constant_in_body(self, body=None, *, cls=None, **operation_config):
        """
