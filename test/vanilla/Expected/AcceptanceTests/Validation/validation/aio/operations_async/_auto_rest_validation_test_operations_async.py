...
if TYPE_CHECKING:
    ...
    class AbstractServiceClient(object):
        ...
        @property
        def _config(self):
            # type: () -> AutoRestValidationTestConfiguration
            """Configuration of service client
            :rtype: AutoRestValidationTestConfiguration
            """

        @_config.setter
        def _config(self, value):
            # type: (AutoRestValidationTestConfiguration) -> None
...
class AutoRestValidationTestOperationsMixin(_MIXIN_BASE):
