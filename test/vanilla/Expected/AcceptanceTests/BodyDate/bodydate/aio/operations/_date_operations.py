...
class DateOperations:
    ...
    async def get_null(self, **kwargs: Any) -> Optional[datetime.date]:
        ...
        request = _rest.date.build_get_null_request(template_url=self.get_null.metadata["url"], **kwargs)
    ...
    async def get_invalid_date(self, **kwargs: Any) -> datetime.date:
        ...
        request = _rest.date.build_get_invalid_date_request(
    ...
    async def get_overflow_date(self, **kwargs: Any) -> datetime.date:
        ...
        request = _rest.date.build_get_overflow_date_request(
    ...
    async def get_underflow_date(self, **kwargs: Any) -> datetime.date:
        ...
        request = _rest.date.build_get_underflow_date_request(
    ...
    async def put_max_date(self, date_body: datetime.date, **kwargs: Any) -> None:
        ...
        request = _rest.date.build_put_max_date_request(
    ...
    async def get_max_date(self, **kwargs: Any) -> datetime.date:
        ...
        request = _rest.date.build_get_max_date_request(template_url=self.get_max_date.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def put_min_date(self, date_body: datetime.date, **kwargs: Any) -> None:
        ...
        request = _rest.date.build_put_min_date_request(
    ...
    async def get_min_date(self, **kwargs: Any) -> datetime.date:
        ...
        request = _rest.date.build_get_min_date_request(template_url=self.get_min_date.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
