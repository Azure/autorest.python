...
class PathsOperations:
    ...
    @distributed_trace_async
    async def string_null(self, string_path: str, cls=None, **kwargs):
    ...
    @distributed_trace_async
    async def enum_valid(self, enum_path: Union[str, "UriColor"], cls=None, **kwargs):
    ...
    @distributed_trace_async
    async def enum_null(self, enum_path: Union[str, "UriColor"], cls=None, **kwargs):
    ...
    @distributed_trace_async
    async def byte_multi_byte(self, byte_path: bytearray, cls=None, **kwargs):
    ...
    @distributed_trace_async
    async def byte_null(self, byte_path: bytearray, cls=None, **kwargs):
    ...
    @distributed_trace_async
    async def date_null(self, date_path: datetime.date, cls=None, **kwargs):
    ...
    @distributed_trace_async
    async def date_time_null(self, date_time_path: datetime.datetime, cls=None, **kwargs):
    ...
    @distributed_trace_async
    async def base64_url(self, base64_url_path: bytearray, cls=None, **kwargs):
    ...
    @distributed_trace_async
    async def array_csv_in_path(self, array_path: List[str], cls=None, **kwargs):
    ...
    @distributed_trace_async
    async def unix_time_url(self, unix_time_url_path: datetime.datetime, cls=None, **kwargs):
