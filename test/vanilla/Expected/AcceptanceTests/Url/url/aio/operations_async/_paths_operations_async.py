...
class PathsOperations:
    ...
    async def get_boolean_true(self, *, cls=None, **operation_config):
    ...
    async def get_boolean_false(self, *, cls=None, **operation_config):
    ...
    async def get_int_one_million(self, *, cls=None, **operation_config):
    ...
    async def get_int_negative_one_million(self, *, cls=None, **operation_config):
        """Get '-1000000' integer value.
    ...
    async def get_ten_billion(self, *, cls=None, **operation_config):
    ...
    async def get_negative_ten_billion(self, *, cls=None, **operation_config):
        """Get '-10000000000' 64 bit integer value.
    ...
    async def float_scientific_positive(self, *, cls=None, **operation_config):
    ...
    async def float_scientific_negative(self, *, cls=None, **operation_config):
        """Get '-1.034E-20' numeric value.
    ...
    async def double_decimal_positive(self, *, cls=None, **operation_config):
    ...
    async def double_decimal_negative(self, *, cls=None, **operation_config):
        """Get '-9999999.999' numeric value.
    ...
    async def string_unicode(self, *, cls=None, **operation_config):
    ...
    async def string_url_encoded(self, *, cls=None, **operation_config):
        """Get 'begin!*'();:@ &=+$,/?#[]end.
    ...
    async def string_empty(self, *, cls=None, **operation_config):
        """Get ''.
    ...
    async def string_null(self, string_path, *, cls=None, **operation_config):
    ...
    async def enum_valid(self, enum_path, *, cls=None, **operation_config):
    ...
    async def enum_null(self, enum_path, *, cls=None, **operation_config):
    ...
    async def byte_multi_byte(self, byte_path, *, cls=None, **operation_config):
    ...
    async def byte_empty(self, *, cls=None, **operation_config):
        """Get '' as byte array.
    ...
    async def byte_null(self, byte_path, *, cls=None, **operation_config):
    ...
    async def date_valid(self, *, cls=None, **operation_config):
    ...
    async def date_null(self, date_path, *, cls=None, **operation_config):
    ...
    async def date_time_valid(self, *, cls=None, **operation_config):
    ...
    async def date_time_null(self, date_time_path, *, cls=None, **operation_config):
    ...
    async def base64_url(self, base64_url_path, *, cls=None, **operation_config):
    ...
    async def array_csv_in_path(self, array_path, *, cls=None, **operation_config):
    ...
    async def unix_time_url(self, unix_time_url_path, *, cls=None, **operation_config):
