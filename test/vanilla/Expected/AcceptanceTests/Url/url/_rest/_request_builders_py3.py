...
def build_paths_enum_valid_request(enum_path: Union[str, "_models.UriColor"], **kwargs: Any) -> HttpRequest:
...
def build_paths_enum_null_request(enum_path: Union[str, "_models.UriColor"], **kwargs: Any) -> HttpRequest:
