...
class pathsOperations(object):
    ...
    def get_boolean_true(
        ...
        request = build_get_boolean_true_request(template_url=self.get_boolean_true.metadata["url"], **kwargs)
    ...
    def get_boolean_false(
        ...
        request = build_get_boolean_false_request(template_url=self.get_boolean_false.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    def get_int_one_million(
        ...
        request = build_get_int_one_million_request(template_url=self.get_int_one_million.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    def get_ten_billion(
        ...
        request = build_get_ten_billion_request(template_url=self.get_ten_billion.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    def string_unicode(
        ...
        request = build_string_unicode_request(template_url=self.string_unicode.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    def string_url_encoded(
        ...
        request = build_string_url_encoded_request(template_url=self.string_url_encoded.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    def string_empty(
        ...
        request = build_string_empty_request(template_url=self.string_empty.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    def enum_valid(
        ...
        **kwargs  # type: Any
        ...
        request = build_enum_valid_request(enum_path=enum_path, template_url=self.enum_valid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    def enum_null(
        ...
        **kwargs  # type: Any
        ...
        request = build_enum_null_request(enum_path=enum_path, template_url=self.enum_null.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    def byte_empty(
        ...
        request = build_byte_empty_request(template_url=self.byte_empty.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    def byte_null(
        ...
        **kwargs  # type: Any
        ...
        request = build_byte_null_request(byte_path=byte_path, template_url=self.byte_null.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    def date_valid(
        ...
        request = build_date_valid_request(template_url=self.date_valid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    def date_null(
        ...
        **kwargs  # type: Any
        ...
        request = build_date_null_request(date_path=date_path, template_url=self.date_null.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    def date_time_valid(
        ...
        request = build_date_time_valid_request(template_url=self.date_time_valid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
