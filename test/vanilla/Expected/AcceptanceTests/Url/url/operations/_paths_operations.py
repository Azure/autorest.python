...
class PathsOperations(object):
    ...
    def get_boolean_true(
        ...
        request = _prepare_paths_get_boolean_true_request(template_url=self.get_boolean_true.metadata["url"], **kwargs)
    ...
    def get_boolean_false(
        ...
        request = _prepare_paths_get_boolean_false_request(
    ...
    def get_int_one_million(
        ...
        request = _prepare_paths_get_int_one_million_request(
    ...
    def get_int_negative_one_million(
        ...
        request = _prepare_paths_get_int_negative_one_million_request(
    ...
    def get_ten_billion(
        ...
        request = _prepare_paths_get_ten_billion_request(template_url=self.get_ten_billion.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    def get_negative_ten_billion(
        ...
        request = _prepare_paths_get_negative_ten_billion_request(
    ...
    def float_scientific_positive(
        ...
        request = _prepare_paths_float_scientific_positive_request(
    ...
    def float_scientific_negative(
        ...
        request = _prepare_paths_float_scientific_negative_request(
    ...
    def double_decimal_positive(
        ...
        request = _prepare_paths_double_decimal_positive_request(
    ...
    def double_decimal_negative(
        ...
        request = _prepare_paths_double_decimal_negative_request(
    ...
    def string_unicode(
        ...
        request = _prepare_paths_string_unicode_request(template_url=self.string_unicode.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    def string_url_encoded(
        ...
        request = _prepare_paths_string_url_encoded_request(
    ...
    def string_url_non_encoded(
        ...
        request = _prepare_paths_string_url_non_encoded_request(
    ...
    def string_empty(
        ...
        request = _prepare_paths_string_empty_request(template_url=self.string_empty.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    def string_null(
        ...
        **kwargs  # type: Any
        ...
        request = _prepare_paths_string_null_request(
    ...
    def enum_valid(
        ...
        **kwargs  # type: Any
        ...
        request = _prepare_paths_enum_valid_request(
    ...
    def enum_null(
        ...
        **kwargs  # type: Any
        ...
        request = _prepare_paths_enum_null_request(
    ...
    def byte_multi_byte(
        ...
        **kwargs  # type: Any
        ...
        request = _prepare_paths_byte_multi_byte_request(
    ...
    def byte_empty(
        ...
        request = _prepare_paths_byte_empty_request(template_url=self.byte_empty.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    def byte_null(
        ...
        **kwargs  # type: Any
        ...
        request = _prepare_paths_byte_null_request(
    ...
    def date_valid(
        ...
        request = _prepare_paths_date_valid_request(template_url=self.date_valid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    def date_null(
        ...
        **kwargs  # type: Any
        ...
        request = _prepare_paths_date_null_request(
    ...
    def date_time_valid(
        ...
        request = _prepare_paths_date_time_valid_request(template_url=self.date_time_valid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    def date_time_null(
        ...
        **kwargs  # type: Any
        ...
        request = _prepare_paths_date_time_null_request(
    ...
    def base64_url(
        ...
        **kwargs  # type: Any
        ...
        request = _prepare_paths_base64_url_request(
    ...
    def array_csv_in_path(
        ...
        **kwargs  # type: Any
        ...
        request = _prepare_paths_array_csv_in_path_request(
    ...
    def unix_time_url(
        ...
        **kwargs  # type: Any
        ...
        request = _prepare_paths_unix_time_url_request(
