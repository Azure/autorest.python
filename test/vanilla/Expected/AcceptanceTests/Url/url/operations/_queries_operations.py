...
class QueriesOperations(object):
    ...
    def get_boolean_true(
        ...
        request = build_queries_get_boolean_true_request(template_url=self.get_boolean_true.metadata["url"], **kwargs)
    ...
    def get_boolean_false(
        ...
        request = build_queries_get_boolean_false_request(template_url=self.get_boolean_false.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    def get_ten_billion(
        ...
        request = build_queries_get_ten_billion_request(template_url=self.get_ten_billion.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    def string_unicode(
        ...
        request = build_queries_string_unicode_request(template_url=self.string_unicode.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    def string_empty(
        ...
        request = build_queries_string_empty_request(template_url=self.string_empty.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    def byte_empty(
        ...
        request = build_queries_byte_empty_request(template_url=self.byte_empty.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    def date_valid(
        ...
        request = build_queries_date_valid_request(template_url=self.date_valid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    def date_time_valid(
        ...
        request = build_queries_date_time_valid_request(template_url=self.date_time_valid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
