...
class IntModelOperations:
    ...
    async def get_overflow_int32(self, *, cls=None, **operation_config):
    ...
    async def get_underflow_int32(self, *, cls=None, **operation_config):
    ...
    async def get_overflow_int64(self, *, cls=None, **operation_config):
    ...
    async def get_underflow_int64(self, *, cls=None, **operation_config):
    ...
    async def put_max32(self, int_body, *, cls=None, **operation_config):
        """Put max int32 value.
    ...
    async def put_max64(self, int_body, *, cls=None, **operation_config):
        """Put max int64 value.
    ...
    async def put_min32(self, int_body, *, cls=None, **operation_config):
        """Put min int32 value.
    ...
    async def put_min64(self, int_body, *, cls=None, **operation_config):
        """Put min int64 value.
    ...
    async def get_unix_time(self, *, cls=None, **operation_config):
    ...
    async def put_unix_time_date(self, int_body, *, cls=None, **operation_config):
    ...
    async def get_invalid_unix_time(self, *, cls=None, **operation_config):
    ...
    async def get_null_unix_time(self, *, cls=None, **operation_config):
