...
def build_int_put_max32_request(*, json: Any = None, content: Optional[int] = None, **kwargs: Any) -> HttpRequest:
    """Put max int32 value.
...
def build_int_put_max64_request(*, json: Any = None, content: Optional[int] = None, **kwargs: Any) -> HttpRequest:
    """Put max int64 value.
...
def build_int_put_min32_request(*, json: Any = None, content: Optional[int] = None, **kwargs: Any) -> HttpRequest:
    """Put min int32 value.
...
def build_int_put_min64_request(*, json: Any = None, content: Optional[int] = None, **kwargs: Any) -> HttpRequest:
    """Put min int64 value.
