...
# --------------------------------------------------------------------------
from typing import Any, Callable, Dict, Generic, List, Optional, TYPE_CHECKING, TypeVar, Union
import warnings
...
if TYPE_CHECKING:
    ...
    class AbstractServiceClient(object):
        ...
        @property
        def _config(self):
            # type: () -> AutoRestResourceFlatteningTestServiceConfiguration
            """Configuration of service client
            :rtype: AutoRestResourceFlatteningTestServiceConfiguration
            """

        @_config.setter
        def _config(self, value):
            # type: (AutoRestResourceFlatteningTestServiceConfiguration) -> None
...
class AutoRestResourceFlatteningTestServiceOperationsMixin(_MIXIN_BASE):
    ...
    async def get_array(
        self,
        **kwargs
    ) -> Union[List["models.FlattenedProduct"], ClsReturnType]:
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType[List["models.FlattenedProduct"], ClsReturnType]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
    ...
    async def get_wrapped_array(
        self,
        **kwargs
    ) -> Union[List["models.ProductWrapper"], ClsReturnType]:
        """No need to have a route in Express server for this operation. Used to verify the type flattened
        is not removed if it's referenced in an array.
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType[List["models.ProductWrapper"], ClsReturnType]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
    ...
    async def get_dictionary(
        self,
        **kwargs
    ) -> Union[Dict[str, "models.FlattenedProduct"], ClsReturnType]:
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType[Dict[str, "models.FlattenedProduct"], ClsReturnType]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
    ...
    async def get_resource_collection(
        self,
        **kwargs
    ) -> Union["models.ResourceCollection", ClsReturnType]:
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ResourceCollection", ClsReturnType]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
    ...
    async def put_simple_product(
        ...
        **kwargs
    ) -> Union["models.SimpleProduct", ClsReturnType]:
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.SimpleProduct", ClsReturnType]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        content_type = kwargs.pop("content_type", "application/json")
