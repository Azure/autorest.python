...
class AutoRestResourceFlatteningTestServiceOperationsMixin:
    ...
    async def put_array(self, resource_array: Optional[List["_models.Resource"]] = None, **kwargs: Any) -> None:
        ...
        if resource_array is not None:
            content = self._serialize.body(resource_array, "[Resource]")
    ...
    async def put_wrapped_array(
        ...
        content_type = kwargs.pop("content_type", "application/json")
        if resource_array is not None:
            content = self._serialize.body(resource_array, "[WrappedProduct]")
            content = json.dumps(content)
        else:
            content = None
    ...
    async def put_dictionary(
        ...
        if resource_dictionary is not None:
            content = self._serialize.body(resource_dictionary, "{FlattenedProduct}")
            content = json.dumps(content)
        else:
            content = None
    ...
    async def put_resource_collection(
        ...
        if resource_complex_object is not None:
            content = self._serialize.body(resource_complex_object, "ResourceCollection")
            content = json.dumps(content)
        else:
            content = None
    ...
    async def put_simple_product(
        ...
        if simple_body_product is not None:
            content = self._serialize.body(simple_body_product, "SimpleProduct")
            content = json.dumps(content)
        else:
            content = None
    ...
    async def post_flattened_simple_product(
        ...
        **kwargs: Any
        ...
        if _simple_body_product is not None:
            content = self._serialize.body(_simple_body_product, "SimpleProduct")
            content = json.dumps(content)
        else:
            content = None
