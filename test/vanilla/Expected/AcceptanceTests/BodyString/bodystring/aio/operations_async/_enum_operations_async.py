...
class EnumOperations:
    ...
    async def get_not_expandable(self, *, cls=None, **operation_config):
    ...
    async def put_not_expandable(self, string_body, *, cls=None, **operation_config):
    ...
    async def get_referenced(self, *, cls=None, **operation_config):
        """Get enum value 'red color' from enumeration of 'red color',
        'green-color', 'blue_color'.
    ...
    async def put_referenced(self, enum_string_body, *, cls=None, **operation_config):
        """Sends value 'red color' from enumeration of 'red color', 'green-color',
        'blue_color'.
    ...
    async def get_referenced_constant(self, *, cls=None, **operation_config):
    ...
    async def put_referenced_constant(self, field1=None, *, cls=None, **operation_config):
