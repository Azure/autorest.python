...
class StringOperations:
    ...
    def _put_null_request(self, string_body: Optional[str] = None, **kwargs) -> HttpRequest:
    ...
    def _put_base64_url_encoded_request(self, string_body: bytes, **kwargs) -> HttpRequest:
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
