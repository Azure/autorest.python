...
try:
    from ._request_builders_py3 import build_get_required_path_request
    from ._request_builders_py3 import build_put_optional_query_request
    from ._request_builders_py3 import build_put_optional_header_request
    from ._request_builders_py3 import build_put_optional_body_request
    from ._request_builders_py3 import build_put_optional_binary_body_request
    from ._request_builders_py3 import build_get_required_global_path_request
    from ._request_builders_py3 import build_get_required_global_query_request
    from ._request_builders_py3 import build_get_optional_global_query_request
except (SyntaxError, ImportError):
    from ._request_builders import build_get_required_path_request  # type: ignore
    from ._request_builders import build_put_optional_query_request  # type: ignore
