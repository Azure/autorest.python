...
class ExplicitOperations(object):
    ...
    def post_optional_integer_property(
        ...
        **kwargs  # type: Any
        ...
        if _body_parameter is not None:
            content = self._serialize.body(_body_parameter, "IntOptionalWrapper")
            content = json.dumps(content)
        else:
            content = None
    ...
    def post_optional_string_property(
        ...
        **kwargs  # type: Any
        ...
        if _body_parameter is not None:
            content = self._serialize.body(_body_parameter, "StringOptionalWrapper")
            content = json.dumps(content)
        else:
            content = None
    ...
    def post_optional_class_property(
        ...
        **kwargs  # type: Any
        ...
        if _body_parameter is not None:
            content = self._serialize.body(_body_parameter, "ClassOptionalWrapper")
            content = json.dumps(content)
        else:
            content = None
    ...
    def post_optional_array_property(
        ...
        **kwargs  # type: Any
        ...
        if _body_parameter is not None:
            content = self._serialize.body(_body_parameter, "ArrayOptionalWrapper")
            content = json.dumps(content)
        else:
            content = None
