...
class NotFoundErrorBase(BaseError):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.reason = reason
        self.what_not_found = 'NotFoundErrorBase'  # type: ignore
...
class AnimalNotFound(NotFoundErrorBase):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.what_not_found = 'AnimalNotFound'  # type: ignore
        self.name = name
...
class LinkNotFound(NotFoundErrorBase):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.what_not_found = 'InvalidResourceLink'  # type: ignore
...
class PetActionError(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.error_type = None  # type: ignore
...
class PetSadError(PetActionError):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.error_type = 'PetSadError'  # type: ignore
        self.reason = reason
...
class PetHungryOrThirstyError(PetSadError):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.error_type = 'PetHungryOrThirstyError'  # type: ignore
