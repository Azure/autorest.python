...
class NumberOperations:
    ...
    async def get_null(self, **kwargs: Any) -> Optional[float]:
        ...
        request = build_number_get_null_request(template_url=self.get_null.metadata["url"], **kwargs)
    ...
    async def get_invalid_float(self, **kwargs: Any) -> float:
        ...
        request = build_number_get_invalid_float_request(template_url=self.get_invalid_float.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_big_float(self, **kwargs: Any) -> float:
        ...
        request = build_number_get_big_float_request(template_url=self.get_big_float.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_big_double(self, **kwargs: Any) -> float:
        ...
        request = build_number_get_big_double_request(template_url=self.get_big_double.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_big_decimal(self, **kwargs: Any) -> float:
        ...
        request = build_number_get_big_decimal_request(template_url=self.get_big_decimal.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_small_float(self, **kwargs: Any) -> float:
        ...
        request = build_number_get_small_float_request(template_url=self.get_small_float.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_small_double(self, **kwargs: Any) -> float:
        ...
        request = build_number_get_small_double_request(template_url=self.get_small_double.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_small_decimal(self, **kwargs: Any) -> float:
        ...
        request = build_number_get_small_decimal_request(template_url=self.get_small_decimal.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
