...
class arrayOperations:
    ...
    async def get_enum_valid(self, **kwargs: Any) -> List[Union[str, "_models.FooEnum"]]:
        ...
        request = build_get_enum_valid_request(template_url=self.get_enum_valid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_string_enum_valid(self, **kwargs: Any) -> List[Union[str, "_models.Enum0"]]:
        ...
        request = build_get_string_enum_valid_request(template_url=self.get_string_enum_valid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_uuid_valid(self, **kwargs: Any) -> List[str]:
        ...
        request = build_get_uuid_valid_request(template_url=self.get_uuid_valid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
