...
class ArrayOperations:
    ...
    async def get_null(self, **kwargs: Any) -> List[int]:
        ...
        request = build_array_get_null_request(template_url=self.get_null.metadata["url"], **kwargs)
    ...
    async def get_invalid(self, **kwargs: Any) -> List[int]:
        ...
        request = build_array_get_invalid_request(template_url=self.get_invalid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_boolean_tfft(self, **kwargs: Any) -> List[bool]:
        ...
        request = build_array_get_boolean_tfft_request(template_url=self.get_boolean_tfft.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_integer_valid(self, **kwargs: Any) -> List[int]:
        ...
        request = build_array_get_integer_valid_request(template_url=self.get_integer_valid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_long_valid(self, **kwargs: Any) -> List[int]:
        ...
        request = build_array_get_long_valid_request(template_url=self.get_long_valid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_float_valid(self, **kwargs: Any) -> List[float]:
        ...
        request = build_array_get_float_valid_request(template_url=self.get_float_valid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_double_valid(self, **kwargs: Any) -> List[float]:
        ...
        request = build_array_get_double_valid_request(template_url=self.get_double_valid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_string_valid(self, **kwargs: Any) -> List[str]:
        ...
        request = build_array_get_string_valid_request(template_url=self.get_string_valid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_enum_valid(self, **kwargs: Any) -> List[Union[str, "_models.FooEnum"]]:
        ...
        request = build_array_get_enum_valid_request(template_url=self.get_enum_valid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_uuid_valid(self, **kwargs: Any) -> List[str]:
        ...
        request = build_array_get_uuid_valid_request(template_url=self.get_uuid_valid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_date_valid(self, **kwargs: Any) -> List[datetime.date]:
        ...
        request = build_array_get_date_valid_request(template_url=self.get_date_valid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_duration_valid(self, **kwargs: Any) -> List[datetime.timedelta]:
        ...
        request = build_array_get_duration_valid_request(template_url=self.get_duration_valid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_byte_valid(self, **kwargs: Any) -> List[bytearray]:
        ...
        request = build_array_get_byte_valid_request(template_url=self.get_byte_valid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_base64_url(self, **kwargs: Any) -> List[bytes]:
        ...
        request = build_array_get_base64_url_request(template_url=self.get_base64_url.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_complex_null(self, **kwargs: Any) -> List["_models.Product"]:
        ...
        request = build_array_get_complex_null_request(template_url=self.get_complex_null.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_complex_empty(self, **kwargs: Any) -> List["_models.Product"]:
        ...
        request = build_array_get_complex_empty_request(template_url=self.get_complex_empty.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_complex_valid(self, **kwargs: Any) -> List["_models.Product"]:
        ...
        request = build_array_get_complex_valid_request(template_url=self.get_complex_valid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_array_null(self, **kwargs: Any) -> List[List[str]]:
        ...
        request = build_array_get_array_null_request(template_url=self.get_array_null.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_array_empty(self, **kwargs: Any) -> List[List[str]]:
        ...
        request = build_array_get_array_empty_request(template_url=self.get_array_empty.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_array_valid(self, **kwargs: Any) -> List[List[str]]:
        ...
        request = build_array_get_array_valid_request(template_url=self.get_array_valid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
