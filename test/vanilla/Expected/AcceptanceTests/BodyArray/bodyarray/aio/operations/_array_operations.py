...
class ArrayOperations:
    ...
    async def get_null(self, **kwargs: Any) -> List[int]:
        ...
        request = prepare_array_get_null(template_url=self.get_null.metadata["url"], **kwargs)
    ...
    async def get_invalid(self, **kwargs: Any) -> List[int]:
        ...
        request = prepare_array_get_invalid(template_url=self.get_invalid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_empty(self, **kwargs: Any) -> List[int]:
        ...
        request = prepare_array_get_empty(template_url=self.get_empty.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_boolean_tfft(self, **kwargs: Any) -> List[bool]:
        ...
        request = prepare_array_get_boolean_tfft(template_url=self.get_boolean_tfft.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_boolean_invalid_null(self, **kwargs: Any) -> List[bool]:
        ...
        request = prepare_array_get_boolean_invalid_null(
    ...
    async def get_boolean_invalid_string(self, **kwargs: Any) -> List[bool]:
        ...
        request = prepare_array_get_boolean_invalid_string(
    ...
    async def get_integer_valid(self, **kwargs: Any) -> List[int]:
        ...
        request = prepare_array_get_integer_valid(template_url=self.get_integer_valid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_int_invalid_null(self, **kwargs: Any) -> List[int]:
        ...
        request = prepare_array_get_int_invalid_null(template_url=self.get_int_invalid_null.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_int_invalid_string(self, **kwargs: Any) -> List[int]:
        ...
        request = prepare_array_get_int_invalid_string(
    ...
    async def get_long_valid(self, **kwargs: Any) -> List[int]:
        ...
        request = prepare_array_get_long_valid(template_url=self.get_long_valid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_long_invalid_null(self, **kwargs: Any) -> List[int]:
        ...
        request = prepare_array_get_long_invalid_null(template_url=self.get_long_invalid_null.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_long_invalid_string(self, **kwargs: Any) -> List[int]:
        ...
        request = prepare_array_get_long_invalid_string(
    ...
    async def get_float_valid(self, **kwargs: Any) -> List[float]:
        ...
        request = prepare_array_get_float_valid(template_url=self.get_float_valid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_float_invalid_null(self, **kwargs: Any) -> List[float]:
        ...
        request = prepare_array_get_float_invalid_null(
    ...
    async def get_float_invalid_string(self, **kwargs: Any) -> List[float]:
        ...
        request = prepare_array_get_float_invalid_string(
    ...
    async def get_double_valid(self, **kwargs: Any) -> List[float]:
        ...
        request = prepare_array_get_double_valid(template_url=self.get_double_valid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_double_invalid_null(self, **kwargs: Any) -> List[float]:
        ...
        request = prepare_array_get_double_invalid_null(
    ...
    async def get_double_invalid_string(self, **kwargs: Any) -> List[float]:
        ...
        request = prepare_array_get_double_invalid_string(
    ...
    async def get_string_valid(self, **kwargs: Any) -> List[str]:
        ...
        request = prepare_array_get_string_valid(template_url=self.get_string_valid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_enum_valid(self, **kwargs: Any) -> List[Union[str, "_models.FooEnum"]]:
        ...
        request = prepare_array_get_enum_valid(template_url=self.get_enum_valid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_string_enum_valid(self, **kwargs: Any) -> List[Union[str, "_models.Enum0"]]:
        ...
        request = prepare_array_get_string_enum_valid(template_url=self.get_string_enum_valid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_string_with_null(self, **kwargs: Any) -> List[str]:
        ...
        request = prepare_array_get_string_with_null(template_url=self.get_string_with_null.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_string_with_invalid(self, **kwargs: Any) -> List[str]:
        ...
        request = prepare_array_get_string_with_invalid(
    ...
    async def get_uuid_valid(self, **kwargs: Any) -> List[str]:
        ...
        request = prepare_array_get_uuid_valid(template_url=self.get_uuid_valid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_uuid_invalid_chars(self, **kwargs: Any) -> List[str]:
        ...
        request = prepare_array_get_uuid_invalid_chars(
    ...
    async def get_date_valid(self, **kwargs: Any) -> List[datetime.date]:
        ...
        request = prepare_array_get_date_valid(template_url=self.get_date_valid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_date_invalid_null(self, **kwargs: Any) -> List[datetime.date]:
        ...
        request = prepare_array_get_date_invalid_null(template_url=self.get_date_invalid_null.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_date_invalid_chars(self, **kwargs: Any) -> List[datetime.date]:
        ...
        request = prepare_array_get_date_invalid_chars(
    ...
    async def get_date_time_valid(self, **kwargs: Any) -> List[datetime.datetime]:
        ...
        request = prepare_array_get_date_time_valid(template_url=self.get_date_time_valid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_date_time_invalid_null(self, **kwargs: Any) -> List[datetime.datetime]:
        ...
        request = prepare_array_get_date_time_invalid_null(
    ...
    async def get_date_time_invalid_chars(self, **kwargs: Any) -> List[datetime.datetime]:
        ...
        request = prepare_array_get_date_time_invalid_chars(
    ...
    async def get_date_time_rfc1123_valid(self, **kwargs: Any) -> List[datetime.datetime]:
        ...
        request = prepare_array_get_date_time_rfc1123_valid(
    ...
    async def get_duration_valid(self, **kwargs: Any) -> List[datetime.timedelta]:
        ...
        request = prepare_array_get_duration_valid(template_url=self.get_duration_valid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_byte_valid(self, **kwargs: Any) -> List[bytearray]:
        ...
        request = prepare_array_get_byte_valid(template_url=self.get_byte_valid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_byte_invalid_null(self, **kwargs: Any) -> List[bytearray]:
        ...
        request = prepare_array_get_byte_invalid_null(template_url=self.get_byte_invalid_null.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_base64_url(self, **kwargs: Any) -> List[bytes]:
        ...
        request = prepare_array_get_base64_url(template_url=self.get_base64_url.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_complex_null(self, **kwargs: Any) -> List["_models.Product"]:
        ...
        request = prepare_array_get_complex_null(template_url=self.get_complex_null.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_complex_empty(self, **kwargs: Any) -> List["_models.Product"]:
        ...
        request = prepare_array_get_complex_empty(template_url=self.get_complex_empty.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_complex_item_null(self, **kwargs: Any) -> List["_models.Product"]:
        ...
        request = prepare_array_get_complex_item_null(template_url=self.get_complex_item_null.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_complex_item_empty(self, **kwargs: Any) -> List["_models.Product"]:
        ...
        request = prepare_array_get_complex_item_empty(
    ...
    async def get_complex_valid(self, **kwargs: Any) -> List["_models.Product"]:
        ...
        request = prepare_array_get_complex_valid(template_url=self.get_complex_valid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_array_null(self, **kwargs: Any) -> List[List[str]]:
        ...
        request = prepare_array_get_array_null(template_url=self.get_array_null.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_array_empty(self, **kwargs: Any) -> List[List[str]]:
        ...
        request = prepare_array_get_array_empty(template_url=self.get_array_empty.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_array_item_null(self, **kwargs: Any) -> List[List[str]]:
        ...
        request = prepare_array_get_array_item_null(template_url=self.get_array_item_null.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_array_item_empty(self, **kwargs: Any) -> List[List[str]]:
        ...
        request = prepare_array_get_array_item_empty(template_url=self.get_array_item_empty.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_array_valid(self, **kwargs: Any) -> List[List[str]]:
        ...
        request = prepare_array_get_array_valid(template_url=self.get_array_valid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_dictionary_null(self, **kwargs: Any) -> List[Dict[str, str]]:
        ...
        request = prepare_array_get_dictionary_null(template_url=self.get_dictionary_null.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_dictionary_empty(self, **kwargs: Any) -> List[Dict[str, str]]:
        ...
        request = prepare_array_get_dictionary_empty(template_url=self.get_dictionary_empty.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def get_dictionary_item_null(self, **kwargs: Any) -> List[Dict[str, str]]:
        ...
        request = prepare_array_get_dictionary_item_null(
    ...
    async def get_dictionary_item_empty(self, **kwargs: Any) -> List[Dict[str, str]]:
        ...
        request = prepare_array_get_dictionary_item_empty(
    ...
    async def get_dictionary_valid(self, **kwargs: Any) -> List[Dict[str, str]]:
        ...
        request = prepare_array_get_dictionary_valid(template_url=self.get_dictionary_valid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
