...
class ArrayOperations:
    ...
    async def get_null(
        self,
        cls: _cls_type_annotation(List[int]) = None,
        **kwargs: Any
    ) -> List[int]:
    ...
    async def get_boolean_tfft(
        self,
        cls: _cls_type_annotation(List[bool]) = None,
        **kwargs: Any
    ) -> List[bool]:
    ...
    async def get_float_valid(
        self,
        cls: _cls_type_annotation(List[float]) = None,
        **kwargs: Any
    ) -> List[float]:
    ...
    async def get_enum_valid(
        self,
        cls: _cls_type_annotation(List[Union[str, "FooEnum"]]) = None,
        **kwargs: Any
    ...
    async def get_string_enum_valid(
        self,
        cls: _cls_type_annotation(List[Union[str, "Enum0"]]) = None,
        **kwargs: Any
    ...
    async def get_date_valid(
        self,
        cls: _cls_type_annotation(List[datetime.date]) = None,
        **kwargs: Any
    ) -> List[datetime.date]:
    ...
    async def get_date_time_valid(
        self,
        cls: _cls_type_annotation(List[datetime.datetime]) = None,
        **kwargs: Any
    ...
    async def get_duration_valid(
        self,
        cls: _cls_type_annotation(List[datetime.timedelta]) = None,
        **kwargs: Any
    ...
    async def get_byte_valid(
        self,
        cls: _cls_type_annotation(List[bytearray]) = None,
        **kwargs: Any
    ) -> List[bytearray]:
    ...
    async def get_base64_url(
        self,
        cls: _cls_type_annotation(List[bytes]) = None,
        **kwargs: Any
    ) -> List[bytes]:
    ...
    async def get_complex_null(
        self,
        cls: _cls_type_annotation(List["Product"]) = None,
        **kwargs: Any
    ) -> List["Product"]:
    ...
    async def get_array_null(
        self,
        cls: _cls_type_annotation(List[List[str]]) = None,
        **kwargs: Any
    ) -> List[List[str]]:
        """Get a null array.
    ...
    async def get_dictionary_null(
        self,
        cls: _cls_type_annotation(List[Dict[str, str]]) = None,
        **kwargs: Any
    ) -> List[Dict[str, str]]:
