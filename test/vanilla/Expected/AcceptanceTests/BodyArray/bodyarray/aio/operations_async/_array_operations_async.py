...
class ArrayOperations:
    ...
    @distributed_trace_async
    async def get_enum_valid(self, cls=None, **kwargs):
    ...
    @distributed_trace_async
    async def get_string_enum_valid(self, cls=None, **kwargs):
        """Get enum array value ['foo1', 'foo2', 'foo3'].
    ...
    @distributed_trace_async
    async def get_uuid_valid(self, cls=None, **kwargs):
    ...
    @distributed_trace_async
    async def get_uuid_invalid_chars(self, cls=None, **kwargs):
