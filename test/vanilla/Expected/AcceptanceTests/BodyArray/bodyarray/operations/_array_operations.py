...
class ArrayOperations(object):
    ...
    @distributed_trace
    def put_default_array(
        self,
        required_greetings=None,  # type: List[Union[str, "_models.GreetingsFromAroundTheWorld"]]
        optional_greetings=SENTINEL,  # type: Optional[List[Union[str, "_models.GreetingsFromAroundTheWorld"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> None
