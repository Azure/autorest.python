...
class ArrayOperations(object):
    ...
    def get_enum_valid(self, cls=None, **operation_config):
    ...
    def put_enum_valid(self, array_body, cls=None, **operation_config):
        """Set array value ['foo1', 'foo2', 'foo3'].
    ...
    def get_string_enum_valid(self, cls=None, **operation_config):
        """Get enum array value ['foo1', 'foo2', 'foo3'].
    ...
    def put_string_enum_valid(self, array_body, cls=None, **operation_config):
        """Set array value ['foo1', 'foo2', 'foo3'].
    ...
    def get_uuid_valid(self, cls=None, **operation_config):
    ...
    def put_uuid_valid(self, array_body, cls=None, **operation_config):
    ...
    def get_uuid_invalid_chars(self, cls=None, **operation_config):
