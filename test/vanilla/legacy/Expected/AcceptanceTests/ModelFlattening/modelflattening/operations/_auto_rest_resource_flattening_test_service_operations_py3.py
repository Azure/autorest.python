...
class AutoRestResourceFlatteningTestServiceOperationsMixin(object):
    @distributed_trace
    def put_array(self, resource_array: Optional[List["_models.Resource"]] = None, **kwargs: Any) -> None:
    ...
    @distributed_trace
    def put_wrapped_array(self, resource_array: Optional[List["_models.WrappedProduct"]] = None, **kwargs: Any) -> None:
