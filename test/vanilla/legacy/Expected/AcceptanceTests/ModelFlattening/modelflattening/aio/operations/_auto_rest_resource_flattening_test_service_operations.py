...
from ...operations._auto_rest_resource_flattening_test_service_operations import build_get_array_request, build_get_dictionary_request, build_get_resource_collection_request, build_get_wrapped_array_request, build_post_flattened_simple_product_request, build_put_array_request, build_put_dictionary_request, build_put_resource_collection_request, build_put_simple_product_request, build_put_simple_product_with_grouping_request, build_put_wrapped_array_request
T = TypeVar('T')
...
class AutoRestResourceFlatteningTestServiceOperationsMixin:
    ...
    async def get_dictionary(
        self,
        **kwargs: Any
    ) -> Dict[str, "_models.FlattenedProduct"]:
    ...
    async def post_flattened_simple_product(
        ...
        **kwargs: Any
        ...
        _simple_body_product = _models.SimpleProduct(product_id=product_id, description=description, max_product_display_name=max_product_display_name, capacity=capacity, generic_value=generic_value, odata_value=odata_value)
    ...
    async def put_simple_product_with_grouping(
        self,
        flatten_parameter_group: "_models.FlattenParameterGroup",
        **kwargs: Any
    ) -> "_models.SimpleProduct":
        """Put Simple Product with client flattening true on the model.
        ...
        _simple_body_product = _models.SimpleProduct(product_id=_product_id, description=_description, max_product_display_name=_max_product_display_name, capacity=capacity, generic_value=_generic_value, odata_value=_odata_value)
        if _simple_body_product is not None:
            _json = self._serialize.body(_simple_body_product, 'SimpleProduct')
        else:
            _json = None
