...
class MultipleResponsesOperations:  # pylint: disable=too-many-public-methods
    ...
    @distributed_trace_async
    async def get_default_none200_none(  # pylint: disable=inconsistent-return-statements
        self,
        **kwargs: Any
    ) -> None:
        """Send a 200 response with no payload.
    ...
    @distributed_trace_async
    async def get_default_none400_none(  # pylint: disable=inconsistent-return-statements
        self,
        **kwargs: Any
    ) -> None:
        """Send a 400 response with no payload.
