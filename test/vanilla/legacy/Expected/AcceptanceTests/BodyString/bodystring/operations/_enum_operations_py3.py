...
class EnumOperations(object):
    ...
    @distributed_trace
    def put_not_expandable(self, string_body: Union[str, "_models.Colors"], **kwargs: Any) -> None:
    ...
    @distributed_trace
    def put_referenced(self, enum_string_body: Union[str, "_models.Colors"], **kwargs: Any) -> None:
        """Sends value 'red color' from enumeration of 'red color', 'green-color', 'blue_color'.
    ...
    @distributed_trace
    def put_referenced_constant(self, field1: Optional[str] = None, **kwargs: Any) -> None:
