...
from ._formdata_operations import (
...
class FormdataOperations(object):
    ...
    @distributed_trace
    def upload_file(self, file_content: IO, file_name: str, **kwargs: Any) -> IO:
        """Upload file.
    ...
    @distributed_trace
    def upload_files(self, file_content: List[IO], **kwargs: Any) -> IO:
