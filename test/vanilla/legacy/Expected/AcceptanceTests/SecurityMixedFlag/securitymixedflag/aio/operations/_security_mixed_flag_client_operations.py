...
from ...operations._security_mixed_flag_client_operations import build_get_array_request, build_get_object_request, build_get_string_request, build_put_array_request, build_put_object_request, build_put_string_request
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class SecurityMixedFlagClientOperationsMixin:
    ...
    @distributed_trace_async
    async def put_object(  # pylint: disable=inconsistent-return-statements
        self,
        input: Any,
        **kwargs: Any
    ) -> None:
