...
class MediaTypesClientOperationsMixin:
    ...
    async def binary_body_with_three_content_types(
        ...
        **kwargs: Any
        ...
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[Union[str, "_models.ContentType1"]]
