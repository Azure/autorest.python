...
T = TypeVar("T")
JSON_REGEXP = ContentDecodePolicy.JSON_REGEXP
JSONType = Any
...
class MediaTypesClientOperationsMixin:
    ...
    async def analyze_body(
        ...
        **kwargs: Any
        ...
        _content = None
        if content_type:
            if JSON_REGEXP.match(content_type):
                _json = input
            else:
                _content = input
        else:
    ...
    async def binary_body_with_two_content_types(
        ...
        *,
        content_type: Optional[Union[str, "_models.ContentType1"]] = None,
        **kwargs: Any
    ) -> str:
    ...
    async def binary_body_with_three_content_types(
        self,
        message: Union[IO, JSONType, str],
        *,
        content_type: Optional[Union[str, "_models.ContentType1AutoGenerated"]] = None,
        **kwargs: Any
    ) -> str:
        ...
        :paramtype content_type: str or ~mediatypes.models.ContentType1AutoGenerated
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: str, or the result of cls(response)
        :rtype: str
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    async def put_text_and_json_body(
        ...
        message: str,
        *,
        content_type: Optional[Union[str, "_models.ContentType1AutoGenerated2"]] = None,
        **kwargs: Any
    ) -> str:
        ...
        :paramtype content_type: str or ~mediatypes.models.ContentType1AutoGenerated2
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: str, or the result of cls(response)
        :rtype: str
        :raises: ~azure.core.exceptions.HttpResponseError
