...
def build_binary_body_with_three_content_types_request(
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    content_type = kwargs.pop('content_type', None)  # type: Optional[Union[str, "_models.ContentType1AutoGenerated"]]
...
def build_put_text_and_json_body_request(
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    content_type = kwargs.pop('content_type', None)  # type: Optional[Union[str, "_models.ContentType1AutoGenerated2"]]
