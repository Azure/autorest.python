...
def build_binary_body_with_three_content_types_request(
    **kwargs  # type: Any
    ...
    content_type = kwargs.pop('content_type', _headers.pop('Content-Type', None))  # type: Optional[Union[str, "_models.ContentType1AutoGenerated"]]
    accept = _headers.pop('Accept', "text/plain")
...
def build_put_text_and_json_body_request(
    **kwargs  # type: Any
    ...
    content_type = kwargs.pop('content_type', _headers.pop('Content-Type', None))  # type: Optional[Union[str, "_models.ContentType1AutoGenerated2"]]
    accept = _headers.pop('Accept', "text/plain")
...
class MediaTypesClientOperationsMixin(object):
    ...
    def binary_body_with_three_content_types(
        self,
        message,  # type: Union[IO, JSONType, str]
        **kwargs  # type: Any
    ):
        # type: (...) -> str
        ...
        content_type = kwargs.pop(
            "content_type", _headers.pop("Content-Type", None)
        )  # type: Optional[Union[str, "_models.ContentType1AutoGenerated"]]
        cls = kwargs.pop("cls", None)  # type: ClsType[str]
    ...
    def put_text_and_json_body(
        ...
        **kwargs  # type: Any
        ...
        content_type = kwargs.pop(
            "content_type", _headers.pop("Content-Type", None)
        )  # type: Optional[Union[str, "_models.ContentType1AutoGenerated2"]]
        cls = kwargs.pop("cls", None)  # type: ClsType[str]
