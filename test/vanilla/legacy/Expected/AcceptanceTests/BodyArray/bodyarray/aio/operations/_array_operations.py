...
class ArrayOperations:  # pylint: disable=too-many-public-methods
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        Instead, you should access the following operations through :class:`~bodyarray.aio.AutoRestSwaggerBATArrayService`'s
        :attr:`~bodyarray.aio.AutoRestSwaggerBATArrayService.array` attribute.
    """
