...
class ArrayOperations(object):  # pylint: disable=too-many-public-methods
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        Instead, you should access the following operations through :class:`~bodyarray.AutoRestSwaggerBATArrayService`'s
        :attr:`~bodyarray.AutoRestSwaggerBATArrayService.array` attribute.
    """
