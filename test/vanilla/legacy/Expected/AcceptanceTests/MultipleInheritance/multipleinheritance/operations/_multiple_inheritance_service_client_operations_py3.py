...
class MultipleInheritanceServiceClientOperationsMixin(object):
    ...
    @distributed_trace
    def put_horse(self, horse: "_models.Horse", **kwargs: Any) -> str:
    ...
    @distributed_trace
    def put_feline(self, feline: "_models.Feline", **kwargs: Any) -> str:
    ...
    @distributed_trace
    def put_cat(self, cat: "_models.Cat", **kwargs: Any) -> str:
    ...
    @distributed_trace
    def put_kitten(self, kitten: "_models.Kitten", **kwargs: Any) -> str:
