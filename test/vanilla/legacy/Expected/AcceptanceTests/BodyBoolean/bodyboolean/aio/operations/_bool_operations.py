...
class BoolOperations:
    ...
    async def get_true(self, **kwargs: Any) -> bool:
        ...
        _url = self._client.format_url(self.get_true.metadata["url"])
    ...
    async def put_true(self, **kwargs: Any) -> None:
        ...
        _url = self._client.format_url(self.put_true.metadata["url"])
    ...
    async def get_false(self, **kwargs: Any) -> bool:
        ...
        _url = self._client.format_url(self.get_false.metadata["url"])
    ...
    async def put_false(self, **kwargs: Any) -> None:
        ...
        _url = self._client.format_url(self.put_false.metadata["url"])
