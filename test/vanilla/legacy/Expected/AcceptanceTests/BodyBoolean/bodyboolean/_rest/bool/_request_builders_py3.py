...
def build_put_true_request(*, json: Any = None, content: Any = None, **kwargs: Any) -> HttpRequest:
...
def build_put_false_request(*, json: Any = None, content: Any = None, **kwargs: Any) -> HttpRequest:
