...
class DictionaryOperations(object):
    ...
    def get_null_value(
        ...
        _url = self._client.format_url(self.get_null_value.metadata["url"])
    ...
    def get_null_key(
        ...
        _url = self._client.format_url(self.get_null_key.metadata["url"])
    ...
    def get_empty_string_key(
        ...
        _url = self._client.format_url(self.get_empty_string_key.metadata["url"])
