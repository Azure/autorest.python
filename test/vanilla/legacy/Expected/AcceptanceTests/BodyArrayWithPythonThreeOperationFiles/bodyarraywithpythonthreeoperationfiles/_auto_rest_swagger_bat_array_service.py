...
class AutoRestSwaggerBATArrayService(object):
    ...
    :vartype array: bodyarraywithpythonthreeoperationfiles.operations.ArrayOperations
    ...
    def _send_request(
        ...
        **kwargs  # type: Any
        ...
        We have helper methods to create requests specific to this service in `bodyarraywithpythonthreeoperationfiles.rest`.
