...
class ArrayOperations:  # pylint: disable=too-many-public-methods
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        Instead, you should access the following operations through :class:`~bodyarraywithpythonthreeoperationfiles.aio.AutoRestSwaggerBATArrayService`'s
        :attr:`~bodyarraywithpythonthreeoperationfiles.aio.AutoRestSwaggerBATArrayService.array` attribute.
    """
