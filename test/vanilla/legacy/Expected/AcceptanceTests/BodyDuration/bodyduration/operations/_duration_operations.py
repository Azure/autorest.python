...
class DurationOperations(object):
    ...
    def get_null(
        ...
        rest_request = rest_duration.build_get_null_request(template_url=self.get_null.metadata["url"], **kwargs)
    ...
    def put_positive_duration(
        ...
        **kwargs  # type: Any
        ...
        rest_request = rest_duration.build_put_positive_duration_request(
    ...
    def get_positive_duration(
        ...
        rest_request = rest_duration.build_get_positive_duration_request(
    ...
    def get_invalid(
        ...
        rest_request = rest_duration.build_get_invalid_request(template_url=self.get_invalid.metadata["url"], **kwargs)
        request = PipelineTransportHttpRequest._from_rest_request(rest_request)
        request.url = self._client.format_url(request.url)
