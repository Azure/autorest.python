...
class ArrayOperations(object):
    ...
    def get_valid(
        ...
        rest_request = rest_array.build_get_valid_request(template_url=self.get_valid.metadata["url"], **kwargs)
    ...
    def put_valid(
        ...
        **kwargs  # type: Any
        ...
        rest_request = rest_array.build_put_valid_request(
    ...
    def get_not_provided(
        ...
        rest_request = rest_array.build_get_not_provided_request(
