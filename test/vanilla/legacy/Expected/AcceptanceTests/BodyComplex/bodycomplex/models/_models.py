...
class Basic(msrest.serialization.Model):
    ...
    :ivar name: Name property with a very long description that does not fit on a single line and a
     line break.
    :vartype name: str
    :ivar color: Known values include: "cyan", "Magenta", "YELLOW", "blacK".
    ...
    def __init__(self, **kwargs):
        ...
        :keyword name: Name property with a very long description that does not fit on a single line
         and a line break.
        :paramtype name: str
        :keyword color: Known values include: "cyan", "Magenta", "YELLOW", "blacK".
...
class Goblinshark(Shark):
    ...
    :ivar jawsize:
    :vartype jawsize: int
    :ivar color: Colors possible. Known values include: "pink", "gray", "brown", "RED", "red".
     Default value: "gray".
    ...
    def __init__(self, **kwargs):
        ...
        :keyword color: Colors possible. Known values include: "pink", "gray", "brown", "RED", "red".
         Default value: "gray".
...
class MyBaseType(msrest.serialization.Model):
    ...
    :ivar kind: Required. Constant filled by server. Known values include: "Kind1".
