...
from ...operations._basic_operations import build_get_empty_request, build_get_invalid_request, build_get_not_provided_request, build_get_null_request, build_get_valid_request, build_put_valid_request
T = TypeVar('T')
...
class BasicOperations:
    ...
    async def put_valid(  # pylint: disable=inconsistent-return-statements
        self,
        complex_body: Union[_models.Basic, IO],
        **kwargs: Any
    ) -> None:
        """Please put {id: 2, name: 'abc', color: 'Magenta'}.
