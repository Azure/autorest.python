...
class PathsOperations(object):
    ...
    @distributed_trace
    def enum_valid(self, enum_path: Union[str, "_models.UriColor"], **kwargs: Any) -> None:
    ...
    @distributed_trace
    def enum_null(self, enum_path: Union[str, "_models.UriColor"], **kwargs: Any) -> None:
