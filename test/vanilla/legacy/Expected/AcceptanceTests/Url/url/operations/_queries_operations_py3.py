...
from ._queries_operations import (
...
class QueriesOperations(object):
    ...
    @distributed_trace
    def enum_valid(self, enum_query: Optional[Union[str, "_models.UriColor"]] = None, **kwargs: Any) -> None:
    ...
    @distributed_trace
    def enum_null(self, enum_query: Optional[Union[str, "_models.UriColor"]] = None, **kwargs: Any) -> None:
        """Get null (no query parameter in url).
    ...
    @distributed_trace
    def array_string_no_collection_format_empty(self, array_query: Optional[List[str]] = None, **kwargs: Any) -> None:
