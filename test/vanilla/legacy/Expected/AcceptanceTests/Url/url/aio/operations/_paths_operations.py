...
class PathsOperations:
    ...
    async def get_boolean_true(self, **kwargs: Any) -> None:
        ...
        rest_request = rest_paths.build_get_boolean_true_request(
    ...
    async def get_boolean_false(self, **kwargs: Any) -> None:
        ...
        rest_request = rest_paths.build_get_boolean_false_request(
    ...
    async def get_int_one_million(self, **kwargs: Any) -> None:
        ...
        rest_request = rest_paths.build_get_int_one_million_request(
    ...
    async def get_int_negative_one_million(self, **kwargs: Any) -> None:
        ...
        rest_request = rest_paths.build_get_int_negative_one_million_request(
    ...
    async def get_ten_billion(self, **kwargs: Any) -> None:
        ...
        rest_request = rest_paths.build_get_ten_billion_request(
    ...
    async def get_negative_ten_billion(self, **kwargs: Any) -> None:
        ...
        rest_request = rest_paths.build_get_negative_ten_billion_request(
    ...
    async def float_scientific_positive(self, **kwargs: Any) -> None:
        ...
        rest_request = rest_paths.build_float_scientific_positive_request(
    ...
    async def float_scientific_negative(self, **kwargs: Any) -> None:
        ...
        rest_request = rest_paths.build_float_scientific_negative_request(
    ...
    async def double_decimal_positive(self, **kwargs: Any) -> None:
        ...
        rest_request = rest_paths.build_double_decimal_positive_request(
    ...
    async def double_decimal_negative(self, **kwargs: Any) -> None:
        ...
        rest_request = rest_paths.build_double_decimal_negative_request(
    ...
    async def string_unicode(self, **kwargs: Any) -> None:
        ...
        rest_request = rest_paths.build_string_unicode_request(
    ...
    async def string_url_encoded(self, **kwargs: Any) -> None:
        ...
        rest_request = rest_paths.build_string_url_encoded_request(
    ...
    async def string_url_non_encoded(self, **kwargs: Any) -> None:
        ...
        rest_request = rest_paths.build_string_url_non_encoded_request(
    ...
    async def string_empty(self, **kwargs: Any) -> None:
        ...
        rest_request = rest_paths.build_string_empty_request(template_url=self.string_empty.metadata["url"], **kwargs)
        request = PipelineTransportHttpRequest._from_rest_request(rest_request)
        request.url = self._client.format_url(request.url)
    ...
    async def string_null(self, string_path: str, **kwargs: Any) -> None:
        ...
        rest_request = rest_paths.build_string_null_request(
    ...
    async def enum_valid(self, enum_path: Union[str, "_models.UriColor"], **kwargs: Any) -> None:
        ...
        rest_request = rest_paths.build_enum_valid_request(
    ...
    async def enum_null(self, enum_path: Union[str, "_models.UriColor"], **kwargs: Any) -> None:
        ...
        rest_request = rest_paths.build_enum_null_request(
    ...
    async def byte_multi_byte(self, byte_path: bytearray, **kwargs: Any) -> None:
        ...
        rest_request = rest_paths.build_byte_multi_byte_request(
    ...
    async def byte_empty(self, **kwargs: Any) -> None:
        ...
        rest_request = rest_paths.build_byte_empty_request(template_url=self.byte_empty.metadata["url"], **kwargs)
        request = PipelineTransportHttpRequest._from_rest_request(rest_request)
        request.url = self._client.format_url(request.url)
    ...
    async def byte_null(self, byte_path: bytearray, **kwargs: Any) -> None:
        ...
        rest_request = rest_paths.build_byte_null_request(
    ...
    async def date_valid(self, **kwargs: Any) -> None:
        ...
        rest_request = rest_paths.build_date_valid_request(template_url=self.date_valid.metadata["url"], **kwargs)
        request = PipelineTransportHttpRequest._from_rest_request(rest_request)
        request.url = self._client.format_url(request.url)
    ...
    async def date_null(self, date_path: datetime.date, **kwargs: Any) -> None:
        ...
        rest_request = rest_paths.build_date_null_request(
    ...
    async def date_time_valid(self, **kwargs: Any) -> None:
        ...
        rest_request = rest_paths.build_date_time_valid_request(
    ...
    async def date_time_null(self, date_time_path: datetime.datetime, **kwargs: Any) -> None:
        ...
        rest_request = rest_paths.build_date_time_null_request(
    ...
    async def base64_url(self, base64_url_path: bytes, **kwargs: Any) -> None:
        ...
        rest_request = rest_paths.build_base64_url_request(
    ...
    async def array_csv_in_path(self, array_path: List[str], **kwargs: Any) -> None:
        ...
        rest_request = rest_paths.build_array_csv_in_path_request(
    ...
    async def unix_time_url(self, unix_time_url_path: datetime.datetime, **kwargs: Any) -> None:
        ...
        rest_request = rest_paths.build_unix_time_url_request(
