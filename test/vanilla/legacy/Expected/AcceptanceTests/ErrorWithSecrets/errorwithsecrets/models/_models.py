...
class Error(msrest.serialization.Model):
    ...
    :ivar code: Required. One of a server-defined set of error codes. Known values include:
    ...
    def __init__(self, **kwargs):
        ...
        :keyword code: Required. One of a server-defined set of error codes. Known values include:
         "BadParameter", "Unauthorized".
