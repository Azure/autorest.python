...
class AutoRestDateTestService(object):
    ...
    :vartype date: bodydatecombineoperationfiles.operations.DateOperations
    ...
    def _send_request(
        ...
        **kwargs  # type: Any
        ...
        We have helper methods to create requests specific to this service in `bodydatecombineoperationfiles.rest`.
