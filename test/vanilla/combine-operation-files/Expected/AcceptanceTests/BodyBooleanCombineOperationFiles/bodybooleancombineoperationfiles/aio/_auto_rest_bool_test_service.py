...
class AutoRestBoolTestService:
    ...
    :vartype bool: bodybooleancombineoperationfiles.aio.operations.BoolOperations
    ...
    def _send_request(self, request: HttpRequest, **kwargs: Any) -> Awaitable[AsyncHttpResponse]:
        ...
        We have helper methods to create requests specific to this service in `bodybooleancombineoperationfiles.rest`.
