...
class AutoRestRFC1123DateTimeTestService:
    ...
    :vartype datetimerfc1123:
     bodydatetimerfc1123combineoperationfiles.aio.operations.Datetimerfc1123Operations
    ...
    def _send_request(self, request: HttpRequest, **kwargs: Any) -> Awaitable[AsyncHttpResponse]:
        ...
        We have helper methods to create requests specific to this service in `bodydatetimerfc1123combineoperationfiles.rest`.
