...
class LLCClient(object):
    """LLC Swagger, this is the initial swager a service could do.

    :ivar params: ParamsOperations operations
    :vartype params: llcpackagecombineoperationfiles.operations.ParamsOperations
    ...
    def _send_request(
        ...
        **kwargs  # type: Any
        ...
        We have helper methods to create requests specific to this service in `llcpackagecombineoperationfiles.rest`.
