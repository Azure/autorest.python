...
class AutoRestUrlTestService(object):
    ...
    :vartype paths: urlcombineoperationfiles.operations.PathsOperations
    :ivar queries: QueriesOperations operations
    :vartype queries: urlcombineoperationfiles.operations.QueriesOperations
    :ivar path_items: PathItemsOperations operations
    :vartype path_items: urlcombineoperationfiles.operations.PathItemsOperations
