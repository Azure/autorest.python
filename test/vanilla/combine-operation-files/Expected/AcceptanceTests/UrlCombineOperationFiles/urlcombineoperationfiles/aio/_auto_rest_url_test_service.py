...
class AutoRestUrlTestService:
    ...
    :vartype paths: urlcombineoperationfiles.aio.operations.PathsOperations
    :ivar queries: QueriesOperations operations
    :vartype queries: urlcombineoperationfiles.aio.operations.QueriesOperations
    :ivar path_items: PathItemsOperations operations
    :vartype path_items: urlcombineoperationfiles.aio.operations.PathItemsOperations
    ...
    def _send_request(self, request: HttpRequest, **kwargs: Any) -> Awaitable[AsyncHttpResponse]:
        ...
        We have helper methods to create requests specific to this service in `urlcombineoperationfiles.rest`.
