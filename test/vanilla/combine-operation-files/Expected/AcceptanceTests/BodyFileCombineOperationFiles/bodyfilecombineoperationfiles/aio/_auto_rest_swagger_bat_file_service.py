...
class AutoRestSwaggerBATFileService:
    ...
    :vartype files: bodyfilecombineoperationfiles.aio.operations.FilesOperations
    ...
    def _send_request(self, request: HttpRequest, **kwargs: Any) -> Awaitable[AsyncHttpResponse]:
        ...
        We have helper methods to create requests specific to this service in `bodyfilecombineoperationfiles.rest`.
