...
class AutoRestParameterizedHostTestClient:
    ...
    :vartype paths: custombaseurlcombineoperationfiles.aio.operations.PathsOperations
    ...
    def _send_request(self, request: HttpRequest, **kwargs: Any) -> Awaitable[AsyncHttpResponse]:
        ...
        We have helper methods to create requests specific to this service in `custombaseurlcombineoperationfiles.rest`.
