...
from ...operations._combine_operations import (
    build__get_array_request,
    build__get_dictionary_request,
    build__get_resource_collection_request,
    build__get_wrapped_array_request,
    build__post_flattened_simple_product_request,
    build__put_array_request,
    build__put_dictionary_request,
    build__put_resource_collection_request,
    build__put_simple_product_request,
    build__put_simple_product_with_grouping_request,
    build__put_wrapped_array_request,
)
...
class AutoRestResourceFlatteningTestServiceOperationsMixin:
    ...
    async def put_array(self, resource_array: Optional[List["_models.Resource"]] = None, **kwargs: Any) -> None:
        ...
        :type resource_array: list[~modelflatteningcombineoperationfiles.models.Resource]
    ...
    async def get_array(self, **kwargs: Any) -> List["_models.FlattenedProduct"]:
        ...
        :rtype: list[~modelflatteningcombineoperationfiles.models.FlattenedProduct]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def put_wrapped_array(
        ...
        :param resource_array: External Resource as an Array to put.
        :type resource_array: list[~modelflatteningcombineoperationfiles.models.WrappedProduct]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    async def get_wrapped_array(self, **kwargs: Any) -> List["_models.ProductWrapper"]:
        ...
        :rtype: list[~modelflatteningcombineoperationfiles.models.ProductWrapper]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def put_dictionary(
        ...
        :type resource_dictionary: dict[str,
         ~modelflatteningcombineoperationfiles.models.FlattenedProduct]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    async def get_dictionary(self, **kwargs: Any) -> Dict[str, "_models.FlattenedProduct"]:
        ...
        :rtype: dict[str, ~modelflatteningcombineoperationfiles.models.FlattenedProduct]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def put_resource_collection(
        ...
        :type resource_complex_object: ~modelflatteningcombineoperationfiles.models.ResourceCollection
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    async def get_resource_collection(self, **kwargs: Any) -> "_models.ResourceCollection":
        ...
        :rtype: ~modelflatteningcombineoperationfiles.models.ResourceCollection
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def put_simple_product(
        ...
        :type simple_body_product: ~modelflatteningcombineoperationfiles.models.SimpleProduct
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: SimpleProduct, or the result of cls(response)
        :rtype: ~modelflatteningcombineoperationfiles.models.SimpleProduct
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def put_simple_product_with_grouping(
        ...
        :type flatten_parameter_group:
         ~modelflatteningcombineoperationfiles.models.FlattenParameterGroup
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: SimpleProduct, or the result of cls(response)
        :rtype: ~modelflatteningcombineoperationfiles.models.SimpleProduct
        :raises: ~azure.core.exceptions.HttpResponseError
