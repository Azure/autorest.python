...
class IntOperations:
    ...
    async def put(self, input: Optional[Union[int, "_models.IntEnum"]] = None, **kwargs: Any) -> str:
        ...
        :type input: int or ~nonstringenumscombineoperationfiles.models.IntEnum
    ...
    async def get(self, **kwargs: Any) -> Union[int, "_models.IntEnum"]:
        ...
        :rtype: int or ~nonstringenumscombineoperationfiles.models.IntEnum
        :raises: ~azure.core.exceptions.HttpResponseError
        """
...
class FloatOperations:
    ...
    async def put(self, input: Optional[Union[float, "_models.FloatEnum"]] = None, **kwargs: Any) -> str:
        ...
        :type input: float or ~nonstringenumscombineoperationfiles.models.FloatEnum
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: str, or the result of cls(response)
        :rtype: str
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    async def get(self, **kwargs: Any) -> Union[float, "_models.FloatEnum"]:
        ...
        :rtype: float or ~nonstringenumscombineoperationfiles.models.FloatEnum
        :raises: ~azure.core.exceptions.HttpResponseError
        """
