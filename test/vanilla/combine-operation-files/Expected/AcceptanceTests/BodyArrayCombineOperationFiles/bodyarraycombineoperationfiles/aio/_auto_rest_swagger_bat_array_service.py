...
class AutoRestSwaggerBATArrayService:
    ...
    :vartype array: bodyarraycombineoperationfiles.aio.operations.ArrayOperations
    ...
    def _send_request(self, request: HttpRequest, **kwargs: Any) -> Awaitable[AsyncHttpResponse]:
        ...
        We have helper methods to create requests specific to this service in `bodyarraycombineoperationfiles.rest`.
