...
class AutoRestDateTimeTestService:
    ...
    :vartype datetime: bodydatetimecombineoperationfiles.aio.operations.DatetimeOperations
    ...
    def _send_request(self, request: HttpRequest, **kwargs: Any) -> Awaitable[AsyncHttpResponse]:
        ...
        We have helper methods to create requests specific to this service in `bodydatetimecombineoperationfiles.rest`.
