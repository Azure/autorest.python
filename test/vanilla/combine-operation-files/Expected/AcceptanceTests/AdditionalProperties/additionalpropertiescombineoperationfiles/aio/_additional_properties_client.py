...
class AdditionalPropertiesClient:
    ...
    :vartype pets: additionalpropertiescombineoperationfiles.aio.operations.PetsOperations
    ...
    def _send_request(self, request: HttpRequest, **kwargs: Any) -> Awaitable[AsyncHttpResponse]:
        ...
        We have helper methods to create requests specific to this service in `additionalpropertiescombineoperationfiles.rest`.
