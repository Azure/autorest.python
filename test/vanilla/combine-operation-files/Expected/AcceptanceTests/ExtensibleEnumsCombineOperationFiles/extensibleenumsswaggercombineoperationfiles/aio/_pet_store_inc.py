...
class PetStoreInc:
    ...
    :vartype pet: extensibleenumsswaggercombineoperationfiles.aio.operations.PetOperations
    ...
    def _send_request(self, request: HttpRequest, **kwargs: Any) -> Awaitable[AsyncHttpResponse]:
        ...
        We have helper methods to create requests specific to this service in `extensibleenumsswaggercombineoperationfiles.rest`.
