...
class AutoRestSwaggerBATService:
    ...
    :vartype string: bodystringcombineoperationfiles.aio.operations.StringOperations
    :ivar enum: EnumOperations operations
    :vartype enum: bodystringcombineoperationfiles.aio.operations.EnumOperations
    ...
    def _send_request(self, request: HttpRequest, **kwargs: Any) -> Awaitable[AsyncHttpResponse]:
        ...
        We have helper methods to create requests specific to this service in `bodystringcombineoperationfiles.rest`.
