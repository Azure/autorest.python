...
class AutoRestHttpInfrastructureTestService(object):
    ...
    :vartype http_failure: httpinfrastructurecombineoperationfiles.operations.HttpFailureOperations
    :ivar http_success: HttpSuccessOperations operations
    :vartype http_success: httpinfrastructurecombineoperationfiles.operations.HttpSuccessOperations
    :ivar http_redirects: HttpRedirectsOperations operations
    :vartype http_redirects:
     httpinfrastructurecombineoperationfiles.operations.HttpRedirectsOperations
    :ivar http_client_failure: HttpClientFailureOperations operations
    :vartype http_client_failure:
     httpinfrastructurecombineoperationfiles.operations.HttpClientFailureOperations
    :ivar http_server_failure: HttpServerFailureOperations operations
    :vartype http_server_failure:
     httpinfrastructurecombineoperationfiles.operations.HttpServerFailureOperations
    :ivar http_retry: HttpRetryOperations operations
    :vartype http_retry: httpinfrastructurecombineoperationfiles.operations.HttpRetryOperations
    :ivar multiple_responses: MultipleResponsesOperations operations
    :vartype multiple_responses:
     httpinfrastructurecombineoperationfiles.operations.MultipleResponsesOperations
    ...
    def _send_request(
        ...
        **kwargs  # type: Any
        ...
        We have helper methods to create requests specific to this service in `httpinfrastructurecombineoperationfiles.rest`.
