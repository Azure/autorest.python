...
class AutoRestUrlMutliCollectionFormatTestService:
    ...
    :vartype queries:
     urlmulticollectionformatcombineoperationfiles.aio.operations.QueriesOperations
    ...
    def _send_request(self, request: HttpRequest, **kwargs: Any) -> Awaitable[AsyncHttpResponse]:
        ...
        We have helper methods to create requests specific to this service in `urlmulticollectionformatcombineoperationfiles.rest`.
