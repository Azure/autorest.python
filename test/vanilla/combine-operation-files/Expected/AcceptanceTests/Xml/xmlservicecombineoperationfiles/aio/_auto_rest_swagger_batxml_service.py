...
class AutoRestSwaggerBATXMLService:
    ...
    :vartype xml: xmlservicecombineoperationfiles.aio.operations.XmlOperations
    ...
    def _send_request(self, request: HttpRequest, **kwargs: Any) -> Awaitable[AsyncHttpResponse]:
        ...
        We have helper methods to create requests specific to this service in `xmlservicecombineoperationfiles.rest`.
