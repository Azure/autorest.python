...
class ArrayOperations:
    ...
    :type models: ~bodyarraycombineoperationfiles.models
    ...
    async def get_enum_valid(self, **kwargs: Any) -> List[Union[str, "_models.FooEnum"]]:
        ...
        :rtype: list[str or ~bodyarraycombineoperationfiles.models.FooEnum]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def put_enum_valid(self, array_body: List[Union[str, "_models.FooEnum"]], **kwargs: Any) -> None:
        ...
        :param array_body:
        :type array_body: list[str or ~bodyarraycombineoperationfiles.models.FooEnum]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    async def get_string_enum_valid(self, **kwargs: Any) -> List[Union[str, "_models.Enum0"]]:
        ...
        :rtype: list[str or ~bodyarraycombineoperationfiles.models.Enum0]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def put_string_enum_valid(self, array_body: List[Union[str, "_models.Enum1"]], **kwargs: Any) -> None:
        ...
        :param array_body:
        :type array_body: list[str or ~bodyarraycombineoperationfiles.models.Enum1]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    async def get_complex_null(self, **kwargs: Any) -> List["_models.Product"]:
        ...
        :rtype: list[~bodyarraycombineoperationfiles.models.Product]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def put_complex_valid(self, array_body: List["_models.Product"], **kwargs: Any) -> None:
        ...
        :param array_body:
        :type array_body: list[~bodyarraycombineoperationfiles.models.Product]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
