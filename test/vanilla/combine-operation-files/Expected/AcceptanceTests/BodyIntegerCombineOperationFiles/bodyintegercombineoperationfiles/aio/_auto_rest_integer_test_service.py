...
class AutoRestIntegerTestService:
    ...
    :vartype int: bodyintegercombineoperationfiles.aio.operations.IntOperations
    ...
    def _send_request(self, request: HttpRequest, **kwargs: Any) -> Awaitable[AsyncHttpResponse]:
        ...
        We have helper methods to create requests specific to this service in `bodyintegercombineoperationfiles.rest`.
