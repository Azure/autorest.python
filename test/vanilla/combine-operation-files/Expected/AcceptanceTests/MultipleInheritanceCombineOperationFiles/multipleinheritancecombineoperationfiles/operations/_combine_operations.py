...
class MultipleInheritanceServiceClientOperationsMixin(object):
    ...
    def get_horse(
        ...
        :rtype: ~multipleinheritancecombineoperationfiles.models.Horse
    ...
    def put_horse(
        ...
        **kwargs  # type: Any
        ...
        :type horse: ~multipleinheritancecombineoperationfiles.models.Horse
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def get_pet(
        ...
        :rtype: ~multipleinheritancecombineoperationfiles.models.Pet
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def put_pet(
        ...
        **kwargs  # type: Any
        ...
        :type pet: ~multipleinheritancecombineoperationfiles.models.Pet
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: str, or the result of cls(response)
        :rtype: str
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def get_feline(
        ...
        :rtype: ~multipleinheritancecombineoperationfiles.models.Feline
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def put_feline(
        ...
        **kwargs  # type: Any
        ...
        :type feline: ~multipleinheritancecombineoperationfiles.models.Feline
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: str, or the result of cls(response)
        :rtype: str
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def get_cat(
        ...
        :rtype: ~multipleinheritancecombineoperationfiles.models.Cat
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def put_cat(
        ...
        **kwargs  # type: Any
        ...
        :type cat: ~multipleinheritancecombineoperationfiles.models.Cat
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: str, or the result of cls(response)
        :rtype: str
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def get_kitten(
        ...
        :rtype: ~multipleinheritancecombineoperationfiles.models.Kitten
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def put_kitten(
        ...
        **kwargs  # type: Any
        ...
        :param kitten: Put a kitten with name 'Kitty' where likesMilk and hisses is false, meows and
         eatsMiceYet is true.
        :type kitten: ~multipleinheritancecombineoperationfiles.models.Kitten
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: str, or the result of cls(response)
        :rtype: str
        :raises: ~azure.core.exceptions.HttpResponseError
