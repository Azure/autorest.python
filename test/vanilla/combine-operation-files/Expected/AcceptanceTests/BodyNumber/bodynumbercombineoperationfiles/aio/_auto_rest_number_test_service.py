...
class AutoRestNumberTestService:
    ...
    :vartype number: bodynumbercombineoperationfiles.aio.operations.NumberOperations
    ...
    def _send_request(self, request: HttpRequest, **kwargs: Any) -> Awaitable[AsyncHttpResponse]:
        ...
        We have helper methods to create requests specific to this service in `bodynumbercombineoperationfiles.rest`.
