...
from ...operations._combine_operations import (
    build__get_cat_request,
    build__get_feline_request,
    build__get_horse_request,
    build__get_kitten_request,
    build__get_pet_request,
    build__put_cat_request,
    build__put_feline_request,
    build__put_horse_request,
    build__put_kitten_request,
    build__put_pet_request,
)
