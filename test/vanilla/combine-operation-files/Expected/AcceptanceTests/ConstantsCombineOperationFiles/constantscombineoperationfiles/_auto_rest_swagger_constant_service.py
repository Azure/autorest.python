...
class AutoRestSwaggerConstantService(object):
    ...
    :vartype contants: constantscombineoperationfiles.operations.ContantsOperations
    ...
    def _send_request(
        ...
        **kwargs  # type: Any
        ...
        We have helper methods to create requests specific to this service in `constantscombineoperationfiles.rest`.
