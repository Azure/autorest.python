...
class Pet(msrest.serialization.Model):
    ...
    :type days_of_week: str or
     ~extensibleenumsswaggercombineoperationfiles.models.DaysOfWeekExtensibleEnum
    :param int_enum: Required.  Possible values include: "1", "2", "3".
    :type int_enum: str or ~extensibleenumsswaggercombineoperationfiles.models.IntEnum
    """
