...
from ...operations._combine_operations import build_pet_add_pet_request, build_pet_get_by_pet_id_request
...
class PetOperations:
    ...
    :type models: ~extensibleenumsswaggercombineoperationfiles.models
    ...
    async def get_by_pet_id(self, pet_id: str, **kwargs: Any) -> "_models.Pet":
        ...
        :rtype: ~extensibleenumsswaggercombineoperationfiles.models.Pet
    ...
    async def add_pet(self, pet_param: Optional["_models.Pet"] = None, **kwargs: Any) -> "_models.Pet":
        ...
        :type pet_param: ~extensibleenumsswaggercombineoperationfiles.models.Pet
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: Pet, or the result of cls(response)
        :rtype: ~extensibleenumsswaggercombineoperationfiles.models.Pet
        :raises: ~azure.core.exceptions.HttpResponseError
