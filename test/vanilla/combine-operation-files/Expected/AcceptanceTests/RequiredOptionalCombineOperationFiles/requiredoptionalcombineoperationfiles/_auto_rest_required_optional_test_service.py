...
class AutoRestRequiredOptionalTestService(object):
    ...
    :vartype implicit: requiredoptionalcombineoperationfiles.operations.ImplicitOperations
    :ivar explicit: ExplicitOperations operations
    :vartype explicit: requiredoptionalcombineoperationfiles.operations.ExplicitOperations
