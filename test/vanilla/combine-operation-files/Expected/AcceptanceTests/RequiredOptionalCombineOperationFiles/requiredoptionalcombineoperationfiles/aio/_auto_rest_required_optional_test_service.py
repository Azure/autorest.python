...
class AutoRestRequiredOptionalTestService:
    ...
    :vartype implicit: requiredoptionalcombineoperationfiles.aio.operations.ImplicitOperations
    :ivar explicit: ExplicitOperations operations
    :vartype explicit: requiredoptionalcombineoperationfiles.aio.operations.ExplicitOperations
    ...
    def _send_request(self, request: HttpRequest, **kwargs: Any) -> Awaitable[AsyncHttpResponse]:
        ...
        We have helper methods to create requests specific to this service in `requiredoptionalcombineoperationfiles.rest`.
