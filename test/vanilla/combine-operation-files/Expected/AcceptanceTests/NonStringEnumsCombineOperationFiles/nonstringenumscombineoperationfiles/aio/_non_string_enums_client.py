...
class NonStringEnumsClient:
    ...
    :vartype int: nonstringenumscombineoperationfiles.aio.operations.IntOperations
    :ivar float: FloatOperations operations
    :vartype float: nonstringenumscombineoperationfiles.aio.operations.FloatOperations
    ...
    def _send_request(self, request: HttpRequest, **kwargs: Any) -> Awaitable[AsyncHttpResponse]:
        ...
        We have helper methods to create requests specific to this service in `nonstringenumscombineoperationfiles.rest`.
