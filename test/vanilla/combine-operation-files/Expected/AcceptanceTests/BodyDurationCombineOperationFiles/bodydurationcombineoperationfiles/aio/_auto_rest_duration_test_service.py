...
class AutoRestDurationTestService:
    ...
    :vartype duration: bodydurationcombineoperationfiles.aio.operations.DurationOperations
    ...
    def _send_request(self, request: HttpRequest, **kwargs: Any) -> Awaitable[AsyncHttpResponse]:
        ...
        We have helper methods to create requests specific to this service in `bodydurationcombineoperationfiles.rest`.
