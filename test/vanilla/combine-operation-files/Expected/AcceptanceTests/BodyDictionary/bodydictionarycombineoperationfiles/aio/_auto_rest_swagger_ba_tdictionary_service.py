...
class AutoRestSwaggerBATDictionaryService:
    ...
    :vartype dictionary: bodydictionarycombineoperationfiles.aio.operations.DictionaryOperations
    ...
    def _send_request(self, request: HttpRequest, **kwargs: Any) -> Awaitable[AsyncHttpResponse]:
        ...
        We have helper methods to create requests specific to this service in `bodydictionarycombineoperationfiles.rest`.
