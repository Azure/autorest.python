...
class ReservedWordsClient:
    ...
    :vartype import_operations: reservedwordscombineoperationfiles.aio.operations.ImportOperations
    ...
    def _send_request(self, request: HttpRequest, **kwargs: Any) -> Awaitable[AsyncHttpResponse]:
        ...
        We have helper methods to create requests specific to this service in `reservedwordscombineoperationfiles.rest`.
    ...
    async def __aenter__(self) -> "ReservedWordsClient":
