...
class AutoRestSwaggerBATFormDataService(object):
    ...
    :vartype formdata: bodyformdatacombineoperationfiles.operations.FormdataOperations
    ...
    def _send_request(
        ...
        **kwargs  # type: Any
        ...
        We have helper methods to create requests specific to this service in `bodyformdatacombineoperationfiles.rest`.
