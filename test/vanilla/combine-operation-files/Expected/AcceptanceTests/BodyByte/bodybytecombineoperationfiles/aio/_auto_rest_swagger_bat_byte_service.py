...
class AutoRestSwaggerBATByteService:
    ...
    :vartype byte: bodybytecombineoperationfiles.aio.operations.ByteOperations
    ...
    def _send_request(self, request: HttpRequest, **kwargs: Any) -> Awaitable[AsyncHttpResponse]:
        ...
        We have helper methods to create requests specific to this service in `bodybytecombineoperationfiles.rest`.
