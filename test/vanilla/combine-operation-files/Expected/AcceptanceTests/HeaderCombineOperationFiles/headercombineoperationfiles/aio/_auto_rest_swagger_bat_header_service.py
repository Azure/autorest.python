...
class AutoRestSwaggerBATHeaderService:
    ...
    :vartype header: headercombineoperationfiles.aio.operations.HeaderOperations
    ...
    def _send_request(self, request: HttpRequest, **kwargs: Any) -> Awaitable[AsyncHttpResponse]:
        ...
        We have helper methods to create requests specific to this service in `headercombineoperationfiles.rest`.
