...
class PetOperations:
    ...
    :type models: ~xmserrorresponsecombineoperationfiles.models
    ...
    async def get_pet_by_id(self, pet_id: str, **kwargs: Any) -> Optional["_models.Pet"]:
        ...
        :rtype: ~xmserrorresponsecombineoperationfiles.models.Pet or None
    ...
    async def do_something(self, what_action: str, **kwargs: Any) -> "_models.PetAction":
        ...
        :rtype: ~xmserrorresponsecombineoperationfiles.models.PetAction
        :raises: ~azure.core.exceptions.HttpResponseError
        """
