...
class Blob(msrest.serialization.Model):
    ...
    :type properties: ~xmlservicecombineoperationfiles.models.BlobProperties
...
class BlobProperties(msrest.serialization.Model):
    ...
    :type blob_type: str or ~xmlservicecombineoperationfiles.models.BlobType
    :param lease_status:  Possible values include: "locked", "unlocked".
    :type lease_status: str or ~xmlservicecombineoperationfiles.models.LeaseStatusType
    :param lease_state:  Possible values include: "available", "leased", "expired", "breaking",
     "broken".
    :type lease_state: str or ~xmlservicecombineoperationfiles.models.LeaseStateType
    :param lease_duration:  Possible values include: "infinite", "fixed".
    :type lease_duration: str or ~xmlservicecombineoperationfiles.models.LeaseDurationType
    :param copy_id:
    :type copy_id: str
    :param copy_status:  Possible values include: "pending", "success", "aborted", "failed".
    :type copy_status: str or ~xmlservicecombineoperationfiles.models.CopyStatusType
    :param copy_source:
    ...
    :param access_tier:  Possible values include: "P4", "P6", "P10", "P20", "P30", "P40", "P50",
     "Hot", "Cool", "Archive".
    :type access_tier: str or ~xmlservicecombineoperationfiles.models.AccessTier
    ...
    :type archive_status: str or ~xmlservicecombineoperationfiles.models.ArchiveStatus
    """
...
class Blobs(msrest.serialization.Model):
    ...
    :param blob_prefix:
    :type blob_prefix: list[~xmlservicecombineoperationfiles.models.BlobPrefix]
    :param blob:
    :type blob: list[~xmlservicecombineoperationfiles.models.Blob]
    """
...
class Container(msrest.serialization.Model):
    ...
    :type properties: ~xmlservicecombineoperationfiles.models.ContainerProperties
    :param metadata: Dictionary of :code:`<string>`.
    :type metadata: dict[str, str]
    """
...
class ContainerProperties(msrest.serialization.Model):
    ...
    :type public_access: str or ~xmlservicecombineoperationfiles.models.PublicAccessType
    """
...
class ListBlobsResponse(msrest.serialization.Model):
    ...
    :type blobs: ~xmlservicecombineoperationfiles.models.Blobs
...
class ListContainersResponse(msrest.serialization.Model):
    ...
    :type max_results: int
    :param containers:
    :type containers: list[~xmlservicecombineoperationfiles.models.Container]
    :param next_marker: Required.
    :type next_marker: str
    """
...
class Logging(msrest.serialization.Model):
    ...
    :type retention_policy: ~xmlservicecombineoperationfiles.models.RetentionPolicy
    """
...
class RootWithRefAndMeta(msrest.serialization.Model):
    ...
    :type ref_to_model: ~xmlservicecombineoperationfiles.models.ComplexTypeWithMeta
...
class RootWithRefAndNoMeta(msrest.serialization.Model):
    ...
    :type ref_to_model: ~xmlservicecombineoperationfiles.models.ComplexTypeNoMeta
    :param something: Something else (just to avoid flattening).
    :type something: str
    """
...
class SignedIdentifier(msrest.serialization.Model):
    ...
    :type access_policy: ~xmlservicecombineoperationfiles.models.AccessPolicy
    """
...
class Slideshow(msrest.serialization.Model):
    ...
    :type author: str
    :param slides:
    :type slides: list[~xmlservicecombineoperationfiles.models.Slide]
    """
...
class StorageServiceProperties(msrest.serialization.Model):
    ...
    :type logging: ~xmlservicecombineoperationfiles.models.Logging
    :param hour_metrics: A summary of request statistics grouped by API in hourly aggregates for
     blobs.
    :type hour_metrics: ~xmlservicecombineoperationfiles.models.Metrics
    :param minute_metrics: a summary of request statistics grouped by API in minute aggregates for
     blobs.
    :type minute_metrics: ~xmlservicecombineoperationfiles.models.Metrics
    :param cors: The set of CORS rules.
    :type cors: list[~xmlservicecombineoperationfiles.models.CorsRule]
    ...
    :type delete_retention_policy: ~xmlservicecombineoperationfiles.models.RetentionPolicy
    """
