...
class ObjectTypeClient(object):
    ...
    def send_request(
        ...
        **kwargs  # type: Any
        ...
        We have helper methods to create requests specific to this service in `objecttypelowlevel.rest`.
        Use these helper methods to create the request you pass to this method. See our example below:

        >>> from objecttypelowlevel.rest import build_get_request
