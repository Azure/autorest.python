...
class IncorrectReturnedErrorModel:  # pylint: disable=client-suffix-needed
    ...
    def send_request(self, request: HttpRequest, **kwargs: Any) -> Awaitable[AsyncHttpResponse]:
        ...
        We have helper methods to create requests specific to this service in `incorrecterrorresponselowlevel.rest`.
        Use these helper methods to create the request you pass to this method.

        >>> from incorrecterrorresponselowlevel.rest import build_get_incorrect_error_from_server_request
