...
class BodyFormsDataURLEncoded:
    ...
    def send_request(self, request: HttpRequest, **kwargs: Any) -> Awaitable[AsyncHttpResponse]:
        ...
        We have helper methods to create requests specific to this service in `bodyformurlencodeddatalowlevel.rest`.
        Use these helper methods to create the request you pass to this method.

        >>> from bodyformurlencodeddatalowlevel.rest import formdataurlencoded
        >>> request = formdataurlencoded.build_update_pet_with_form_request(pet_id, data, **kwargs)
