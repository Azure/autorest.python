...
class MediaTypesClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def send_request(self, request: HttpRequest, **kwargs: Any) -> Awaitable[AsyncHttpResponse]:
        ...
        We have helper methods to create requests specific to this service in `mediatypeslowlevel.rest`.
