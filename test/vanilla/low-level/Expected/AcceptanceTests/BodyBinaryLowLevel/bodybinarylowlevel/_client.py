...
class BinaryWithContentTypeApplicationJson:
    ...
    def send_request(self, request: HttpRequest, **kwargs: Any) -> HttpResponse:
        ...
        We have helper methods to create requests specific to this service in `bodybinarylowlevel.rest`.
        Use these helper methods to create the request you pass to this method.

        >>> from bodybinarylowlevel.rest import upload
        >>> request = upload.build_file_request(content=content, **kwargs)
    ...
    def __enter__(self):
        # type: () -> BinaryWithContentTypeApplicationJson
