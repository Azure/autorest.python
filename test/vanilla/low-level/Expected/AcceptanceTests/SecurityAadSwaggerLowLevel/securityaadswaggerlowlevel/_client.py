...
class AutorestSecurityAad:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def send_request(self, request: HttpRequest, **kwargs: Any) -> HttpResponse:
        ...
        We have helper methods to create requests specific to this service in `securityaadswaggerlowlevel.rest`.
        Use these helper methods to create the request you pass to this method.

        >>> from securityaadswaggerlowlevel.rest import build_head_request
        >>> request = build_head_request(**kwargs)
        <HttpRequest [HEAD], url: '/securityaad'>
