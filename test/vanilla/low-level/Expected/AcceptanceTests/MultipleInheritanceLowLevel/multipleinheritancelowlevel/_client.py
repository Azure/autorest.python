...
class MultipleInheritanceServiceClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def send_request(self, request: HttpRequest, **kwargs: Any) -> HttpResponse:
        ...
        We have helper methods to create requests specific to this service in `multipleinheritancelowlevel.rest`.
        Use these helper methods to create the request you pass to this method.

        >>> from multipleinheritancelowlevel.rest import build_get_horse_request
