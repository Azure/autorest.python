...
import datetime
import sys
from typing import Any, Callable, Dict, IO, List, Optional, Optional, TypeVar, Union, cast, overload
...
@overload
def build_array_put_empty_request(*, json: List[str], content_type: Optional[str] = None, **kwargs: Any) -> HttpRequest:
    ...
...
def build_array_put_boolean_tfft_request(**kwargs) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_array_put_integer_valid_request(**kwargs) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_array_put_long_valid_request(**kwargs) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_array_put_float_valid_request(**kwargs) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_array_put_double_valid_request(**kwargs) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_array_put_string_valid_request(**kwargs) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_array_put_enum_valid_request(**kwargs) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_array_put_string_enum_valid_request(**kwargs) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_array_put_uuid_valid_request(**kwargs) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_array_put_date_valid_request(**kwargs) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_array_put_date_time_valid_request(**kwargs) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_array_put_date_time_rfc1123_valid_request(**kwargs) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_array_put_duration_valid_request(**kwargs) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_array_put_byte_valid_request(**kwargs) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_array_put_complex_valid_request(**kwargs) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_array_put_array_valid_request(**kwargs) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_array_put_dictionary_valid_request(**kwargs) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class ArrayOperations:  # pylint: disable=too-many-public-methods
    ...
    @distributed_trace
    def put_empty(  # pylint: disable=inconsistent-return-statements
        self, array_body: Union[List[str], IO], *, content_type: Optional[str] = None, **kwargs: Any
    ) -> None:
        """Set array value empty [].

        :param array_body: Is either a list type or a IO type.
    ...
    @distributed_trace
    def put_boolean_tfft(  # pylint: disable=inconsistent-return-statements
        self, array_body: Union[List[bool], IO], *, content_type: Optional[str] = None, **kwargs: Any
    ) -> None:
        """Set array value empty [true, false, false, true].
    ...
    @distributed_trace
    def put_integer_valid(  # pylint: disable=inconsistent-return-statements
        self, array_body: Union[List[int], IO], *, content_type: Optional[str] = None, **kwargs: Any
    ) -> None:
        """Set array value empty [1, -1, 3, 300].
    ...
    @distributed_trace
    def put_float_valid(  # pylint: disable=inconsistent-return-statements
        self, array_body: Union[List[float], IO], *, content_type: Optional[str] = None, **kwargs: Any
    ) -> None:
        """Set array value [0, -0.01, 1.2e20].
    ...
    @distributed_trace
    def put_date_valid(  # pylint: disable=inconsistent-return-statements
        self, array_body: Union[List[datetime.date], IO], *, content_type: Optional[str] = None, **kwargs: Any
    ) -> None:
        """Set array value  ['2000-12-01', '1980-01-02', '1492-10-12'].
    ...
    @distributed_trace
    def put_date_time_valid(  # pylint: disable=inconsistent-return-statements
        self, array_body: Union[List[datetime.datetime], IO], *, content_type: Optional[str] = None, **kwargs: Any
    ) -> None:
        """Set array value  ['2000-12-01t00:00:01z', '1980-01-02T00:11:35+01:00',
        '1492-10-12T10:15:01-08:00'].
    ...
    @distributed_trace
    def put_duration_valid(  # pylint: disable=inconsistent-return-statements
        self, array_body: Union[List[datetime.timedelta], IO], *, content_type: Optional[str] = None, **kwargs: Any
    ) -> None:
        """Set array value  ['P123DT22H14M12.011S', 'P5DT1H0M0S'].
    ...
    @distributed_trace
    def put_byte_valid(  # pylint: disable=inconsistent-return-statements
        self, array_body: Union[List[bytes], IO], *, content_type: Optional[str] = None, **kwargs: Any
    ) -> None:
        """Put the array value [hex(FF FF FF FA), hex(01 02 03), hex (25, 29, 43)] with each
        elementencoded in base 64.
    ...
    @distributed_trace
    def put_complex_valid(  # pylint: disable=inconsistent-return-statements
        self, array_body: Union[List[JSON], IO], *, content_type: Optional[str] = None, **kwargs: Any
    ) -> None:
        """Put an array of complex type with values [{'integer': 1 'string': '2'}, {'integer': 3,
        'string': '4'}, {'integer': 5, 'string': '6'}].
    ...
    @distributed_trace
    def put_array_valid(  # pylint: disable=inconsistent-return-statements
        self, array_body: Union[List[List[str]], IO], *, content_type: Optional[str] = None, **kwargs: Any
    ) -> None:
        """Put An array of array of strings [['1', '2', '3'], ['4', '5', '6'], ['7', '8', '9']].
    ...
    @distributed_trace
    def put_dictionary_valid(  # pylint: disable=inconsistent-return-statements
        self, array_body: Union[List[Dict[str, str]], IO], *, content_type: Optional[str] = None, **kwargs: Any
    ) -> None:
        """Get an array of Dictionaries of type <string, string> with value [{'1': 'one', '2': 'two', '3':
        'three'}, {'4': 'four', '5': 'five', '6': 'six'}, {'7': 'seven', '8': 'eight', '9': 'nine'}].
