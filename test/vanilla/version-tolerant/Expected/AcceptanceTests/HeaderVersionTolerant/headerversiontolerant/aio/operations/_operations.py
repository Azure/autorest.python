...
class HeaderOperations:  # pylint: disable=too-many-public-methods
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        Instead, you should access the following operations through :class:`~headerversiontolerant.aio.AutoRestSwaggerBATHeaderService`'s
        :attr:`~headerversiontolerant.aio.AutoRestSwaggerBATHeaderService.header` attribute.
    """
