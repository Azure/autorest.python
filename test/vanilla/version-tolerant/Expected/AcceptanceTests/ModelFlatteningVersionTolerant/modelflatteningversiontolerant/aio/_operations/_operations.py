...
class AutoRestResourceFlatteningTestServiceOperationsMixin:
    ...
    async def put_array(
        self,
        resource_array: Optional[List[JSONType]] = None,
        **kwargs: Any
    ) -> None:
    ...
    async def put_dictionary(
        self,
        resource_dictionary: Optional[Dict[str, JSONType]] = None,
        **kwargs: Any
    ) -> None:
    ...
    async def put_resource_collection(
        self,
        resource_complex_object: JSONType = None,
        **kwargs: Any
    ) -> None:
    ...
    async def put_simple_product(
        self,
        simple_body_product: JSONType = None,
        **kwargs: Any
    ) -> JSONType:
