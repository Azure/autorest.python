...
class MediaTypesClientOperationsMixin(MixinABC):
    @distributed_trace
    def analyze_body(
        self, input: Optional[Union[JSONType, IO]] = None, *, content_type: Optional[str] = None, **kwargs: Any
    ) -> str:
    ...
    def binary_body_with_three_content_types(
        self, message: Union[IO, JSONType, str], *, content_type: Optional[str] = None, **kwargs: Any
    ) -> str:
