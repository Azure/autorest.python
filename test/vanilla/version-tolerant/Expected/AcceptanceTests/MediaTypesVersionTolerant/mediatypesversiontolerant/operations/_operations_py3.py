...
class MediaTypesClientOperationsMixin(object):
    @distributed_trace
    def analyze_body(self, input: Optional[Union[IO, Any]] = None, **kwargs: Any) -> str:
    ...
    @distributed_trace
    def analyze_body_no_accept_header(self, input: Optional[Union[IO, Any]] = None, **kwargs: Any) -> None:
