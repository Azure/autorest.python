...
class AutoRestValidationTestOperationsMixin(object):
    @distributed_trace
    def validation_of_method_parameters(self, resource_group_name: str, id: int, **kwargs: Any) -> Any:
    ...
    @distributed_trace
    def validation_of_body(self, resource_group_name: str, id: int, body: Any = None, **kwargs: Any) -> Any:
    ...
    @distributed_trace
    def post_with_constant_in_body(self, body: Any = None, **kwargs: Any) -> Any:
