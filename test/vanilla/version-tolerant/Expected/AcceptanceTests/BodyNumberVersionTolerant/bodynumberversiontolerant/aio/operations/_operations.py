...
class NumberOperations:  # pylint: disable=too-many-public-methods
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        Instead, you should access the following operations through :class:`~bodynumberversiontolerant.aio.AutoRestNumberTestService`'s
        :attr:`~bodynumberversiontolerant.aio.AutoRestNumberTestService.number` attribute.
    """
