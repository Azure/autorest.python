...
class ImplicitOperations:
    ...
    @distributed_trace_async
    async def put_optional_binary_body(
        self,
        body_parameter: Optional[IO] = None,
        **kwargs: Any
    ) -> None:
        """Test implicitly optional body parameter.
...
class ExplicitOperations:  # pylint: disable=too-many-public-methods
    ...
    @distributed_trace_async
    async def put_required_binary_body(
        self,
        body_parameter: IO,
        **kwargs: Any
    ) -> None:
