...
class Blob(msrest.serialization.Model):
    ...
    :type properties: ~xmlserviceversiontolerant.models.BlobProperties
...
class BlobProperties(msrest.serialization.Model):
    ...
    :type blob_type: str or ~xmlserviceversiontolerant.models.BlobType
    :param lease_status:  Possible values include: "locked", "unlocked".
    :type lease_status: str or ~xmlserviceversiontolerant.models.LeaseStatusType
    :param lease_state:  Possible values include: "available", "leased", "expired", "breaking",
     "broken".
    :type lease_state: str or ~xmlserviceversiontolerant.models.LeaseStateType
    :param lease_duration:  Possible values include: "infinite", "fixed".
    :type lease_duration: str or ~xmlserviceversiontolerant.models.LeaseDurationType
    :param copy_id:
    :type copy_id: str
    :param copy_status:  Possible values include: "pending", "success", "aborted", "failed".
    :type copy_status: str or ~xmlserviceversiontolerant.models.CopyStatusType
    :param copy_source:
    ...
    :param access_tier:  Possible values include: "P4", "P6", "P10", "P20", "P30", "P40", "P50",
     "Hot", "Cool", "Archive".
    :type access_tier: str or ~xmlserviceversiontolerant.models.AccessTier
    ...
    :type archive_status: str or ~xmlserviceversiontolerant.models.ArchiveStatus
    """
...
class Blobs(msrest.serialization.Model):
    ...
    :param blob_prefix:
    :type blob_prefix: list[~xmlserviceversiontolerant.models.BlobPrefix]
    :param blob:
    :type blob: list[~xmlserviceversiontolerant.models.Blob]
    """
...
class Container(msrest.serialization.Model):
    ...
    :type properties: ~xmlserviceversiontolerant.models.ContainerProperties
    :param metadata: Dictionary of :code:`<string>`.
    :type metadata: dict[str, str]
    """
...
class ContainerProperties(msrest.serialization.Model):
    ...
    :type public_access: str or ~xmlserviceversiontolerant.models.PublicAccessType
    """
...
class ListBlobsResponse(msrest.serialization.Model):
    ...
    :type blobs: ~xmlserviceversiontolerant.models.Blobs
...
class ListContainersResponse(msrest.serialization.Model):
    ...
    :type max_results: int
    :param containers:
    :type containers: list[~xmlserviceversiontolerant.models.Container]
    :param next_marker: Required.
    :type next_marker: str
    """
...
class Logging(msrest.serialization.Model):
    ...
    :type retention_policy: ~xmlserviceversiontolerant.models.RetentionPolicy
    """
...
class RootWithRefAndMeta(msrest.serialization.Model):
    ...
    :type ref_to_model: ~xmlserviceversiontolerant.models.ComplexTypeWithMeta
...
class RootWithRefAndNoMeta(msrest.serialization.Model):
    ...
    :type ref_to_model: ~xmlserviceversiontolerant.models.ComplexTypeNoMeta
    :param something: Something else (just to avoid flattening).
    :type something: str
    """
...
class SignedIdentifier(msrest.serialization.Model):
    ...
    :type access_policy: ~xmlserviceversiontolerant.models.AccessPolicy
    """
...
class Slideshow(msrest.serialization.Model):
    ...
    :type author: str
    :param slides:
    :type slides: list[~xmlserviceversiontolerant.models.Slide]
    """
...
class StorageServiceProperties(msrest.serialization.Model):
    ...
    :type logging: ~xmlserviceversiontolerant.models.Logging
    :param hour_metrics: A summary of request statistics grouped by API in hourly aggregates for
     blobs.
    :type hour_metrics: ~xmlserviceversiontolerant.models.Metrics
    :param minute_metrics: a summary of request statistics grouped by API in minute aggregates for
     blobs.
    :type minute_metrics: ~xmlserviceversiontolerant.models.Metrics
    :param cors: The set of CORS rules.
    :type cors: list[~xmlserviceversiontolerant.models.CorsRule]
    ...
    :type delete_retention_policy: ~xmlserviceversiontolerant.models.RetentionPolicy
    """
