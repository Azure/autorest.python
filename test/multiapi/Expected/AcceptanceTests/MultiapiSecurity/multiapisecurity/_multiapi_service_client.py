...
class MultiapiServiceClient(MultiapiServiceClientOperationsMixin, MultiApiClientMixin, _SDKClient):
    ...
    def operation_group_one(self):
        """Instance depends on the API version:
           ...
           * 2.0.0: :class:`OperationGroupOneOperations<multiapisecurity.v2.operations.OperationGroupOneOperations>`
           * 3.0.0: :class:`OperationGroupOneOperations<multiapisecurity.v3.operations.OperationGroupOneOperations>`
        """
    ...
    def operation_group_two(self):
        """Instance depends on the API version:
           ...
           * 2.0.0: :class:`OperationGroupTwoOperations<multiapisecurity.v2.operations.OperationGroupTwoOperations>`
           * 3.0.0: :class:`OperationGroupTwoOperations<multiapisecurity.v3.operations.OperationGroupTwoOperations>`
        """
