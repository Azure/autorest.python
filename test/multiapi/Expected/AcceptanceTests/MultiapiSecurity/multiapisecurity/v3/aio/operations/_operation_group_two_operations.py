...
class OperationGroupTwoOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~multiapisecurity.v3.aio.MultiapiServiceClient`'s
    ...
    async def test_four(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type input: IO or ~multiapisecurity.v3.models.SourcePath
        :keyword content_type: Media type of the body sent to the API. Possible values are:
         "application/pdf", "image/jpeg", "image/png", "image/tiff", and "application/json". Default
         value is "application/json".
        :paramtype content_type: str or ~multiapisecurity.v3.models.ContentType
