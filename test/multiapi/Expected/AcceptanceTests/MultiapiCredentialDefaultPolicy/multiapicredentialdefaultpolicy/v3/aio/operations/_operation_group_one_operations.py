...
class OperationGroupOneOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        Instead, you should access the following operations through :class:`~multiapicredentialdefaultpolicy.v3.aio.MultiapiServiceClient`'s
        :attr:`~multiapicredentialdefaultpolicy.v3.aio.MultiapiServiceClient.operation_group_one` attribute.
    """
