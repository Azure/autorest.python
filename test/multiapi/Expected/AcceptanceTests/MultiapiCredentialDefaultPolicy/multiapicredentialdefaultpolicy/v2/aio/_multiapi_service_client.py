...
class MultiapiServiceClient(MultiapiServiceClientOperationsMixin):
    ...
    :vartype operation_group_one: multiapicredentialdefaultpolicy.v2.aio.operations.OperationGroupOneOperations
    :ivar operation_group_two: OperationGroupTwoOperations operations
    :vartype operation_group_two: multiapicredentialdefaultpolicy.v2.aio.operations.OperationGroupTwoOperations
    ...
    async def _send_request(self, http_request: HttpRequest, **kwargs: Any) -> AsyncHttpResponse:
        ...
        >>> from multiapicredentialdefaultpolicy.v2.rest import build_test_one_request
