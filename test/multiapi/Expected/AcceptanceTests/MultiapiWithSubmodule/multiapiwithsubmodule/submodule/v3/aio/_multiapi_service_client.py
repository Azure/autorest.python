...
class MultiapiServiceClient(MultiapiServiceClientOperationsMixin):
    ...
    :vartype operation_group_one: multiapiwithsubmodule.submodule.v3.aio.operations.OperationGroupOneOperations
    :ivar operation_group_two: OperationGroupTwoOperations operations
    :vartype operation_group_two: multiapiwithsubmodule.submodule.v3.aio.operations.OperationGroupTwoOperations
