...
class OperationGroupTwoOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        Instead, you should access the following operations through :class:`~multiapiwithsubmodule.submodule.v3.aio.MultiapiServiceClient`'s
        :attr:`~multiapiwithsubmodule.submodule.v3.aio.MultiapiServiceClient.operation_group_two` attribute.
    """
    ...
    async def test_four(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :paramtype content_type: str or ~multiapiwithsubmodule.submodule.v3.models.ContentType
