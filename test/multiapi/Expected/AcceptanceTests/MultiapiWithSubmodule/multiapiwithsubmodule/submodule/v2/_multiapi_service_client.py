...
class MultiapiServiceClient(MultiapiServiceClientOperationsMixin):
    ...
    :vartype operation_group_one: multiapiwithsubmodule.submodule.v2.operations.OperationGroupOneOperations
    :ivar operation_group_two: OperationGroupTwoOperations operations
    :vartype operation_group_two: multiapiwithsubmodule.submodule.v2.operations.OperationGroupTwoOperations
    ...
    def _send_request(self, http_request, **kwargs):
        ...
        We have helper methods to create requests specific to this service in `multiapiwithsubmodule.submodule.v2.rest`.
        Use these helper methods to create the request you pass to this method. See our example below:

        >>> from multiapiwithsubmodule.submodule.v2.rest import build_test_one_request
