...
class MultiapiServiceClient(MultiapiServiceClientOperationsMixin):
    ...
    :vartype operation_group_one: multiapiwithsubmodule.submodule.v2.aio.operations_async.OperationGroupOneOperations
    :ivar operation_group_two: OperationGroupTwoOperations operations
    :vartype operation_group_two: multiapiwithsubmodule.submodule.v2.aio.operations_async.OperationGroupTwoOperations
