...
class MultiapiServiceClient(MultiapiServiceClientOperationsMixin):
    ...
    def _send_request(
        ...
        **kwargs  # type: Any
        ...
        We have helper methods to create requests specific to this service in `multiapiwithsubmodule.submodule.v1.rest`.
        Use these helper methods to create the request you pass to this method. See our example below:

        >>> from multiapiwithsubmodule.submodule.v1._rest import build_test_one_request
