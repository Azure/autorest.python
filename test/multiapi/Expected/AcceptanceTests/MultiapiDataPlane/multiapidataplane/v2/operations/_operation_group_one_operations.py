...
class OperationGroupOneOperations(object):
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        Instead, you should access the following operations through :class:`~multiapidataplane.v2.MultiapiServiceClient`'s
        :attr:`~multiapidataplane.v2.MultiapiServiceClient.operation_group_one` attribute.
    """
