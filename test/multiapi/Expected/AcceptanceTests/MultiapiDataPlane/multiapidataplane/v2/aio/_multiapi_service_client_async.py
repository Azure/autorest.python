...
class MultiapiServiceClient(MultiapiServiceClientOperationsMixin):
    ...
    :vartype operation_group_one: multiapidataplane.v2.aio.operations_async.OperationGroupOneOperations
    :ivar operation_group_two: OperationGroupTwoOperations operations
    :vartype operation_group_two: multiapidataplane.v2.aio.operations_async.OperationGroupTwoOperations
