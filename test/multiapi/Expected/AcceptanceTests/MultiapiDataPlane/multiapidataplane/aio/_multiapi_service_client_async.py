...
class MultiapiServiceClient(MultiapiServiceClientOperationsMixin, MultiApiClientMixin, _SDKClient):
    ...
    _PROFILE_TAG = "multiapidataplane.aio.MultiapiServiceClient"
    ...
    def operation_group_one(self):
        """Instance depends on the API version:
           ...
           * 1.0.0: :class:`OperationGroupOneOperations<multiapidataplane.v1.aio.operations_async.OperationGroupOneOperations>`
           * 2.0.0: :class:`OperationGroupOneOperations<multiapidataplane.v2.aio.operations_async.OperationGroupOneOperations>`
           * 3.0.0: :class:`OperationGroupOneOperations<multiapidataplane.v3.aio.operations_async.OperationGroupOneOperations>`
        """
    ...
    def operation_group_two(self):
        """Instance depends on the API version:
           ...
           * 2.0.0: :class:`OperationGroupTwoOperations<multiapidataplane.v2.aio.operations_async.OperationGroupTwoOperations>`
           * 3.0.0: :class:`OperationGroupTwoOperations<multiapidataplane.v3.aio.operations_async.OperationGroupTwoOperations>`
        """
