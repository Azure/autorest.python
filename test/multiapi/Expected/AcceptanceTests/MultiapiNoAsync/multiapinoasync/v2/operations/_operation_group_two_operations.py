...
class OperationGroupTwoOperations(object):
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        Instead, you should access the following operations through :class:`~multiapinoasync.v2.MultiapiServiceClient`'s
        :attr:`~multiapinoasync.v2.MultiapiServiceClient.operation_group_two` attribute.
    """
