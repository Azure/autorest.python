...
class OperationGroupOneOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        Instead, you should access the following operations through :class:`~multiapi.v0.aio.MultiapiServiceClient`'s
        :attr:`~multiapi.v0.aio.MultiapiServiceClient.operation_group_one` attribute.
    """
