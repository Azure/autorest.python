...
class OperationGroupOneOperations(object):
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        Instead, you should access the following operations through :class:`~multiapi.v0.MultiapiServiceClient`'s
        :attr:`~multiapi.v0.MultiapiServiceClient.operation_group_one` attribute.
    """
