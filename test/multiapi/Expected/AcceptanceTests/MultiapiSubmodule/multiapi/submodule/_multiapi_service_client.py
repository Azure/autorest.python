...
class MultiapiServiceClient(MultiapiServiceClientOperationsMixin, MultiApiClientMixin, _SDKClient):
    ...
    _PROFILE_TAG = "multiapi.submodule.MultiapiServiceClient"
    ...
    def models(cls, api_version=DEFAULT_API_VERSION):
        """Module depends on the API version:
           ...
           * 1.0.0: :mod:`v1.models<multiapi.submodule.v1.models>`
           * 2.0.0: :mod:`v2.models<multiapi.submodule.v2.models>`
           * 3.0.0: :mod:`v3.models<multiapi.submodule.v3.models>`
        """
    ...
    def operation_group_one(self):
        """Instance depends on the API version:
           ...
           * 1.0.0: :class:`OperationGroupOneOperations<multiapi.submodule.v1.operations.OperationGroupOneOperations>`
           * 2.0.0: :class:`OperationGroupOneOperations<multiapi.submodule.v2.operations.OperationGroupOneOperations>`
           * 3.0.0: :class:`OperationGroupOneOperations<multiapi.submodule.v3.operations.OperationGroupOneOperations>`
        """
    ...
    def operation_group_two(self):
        """Instance depends on the API version:
           ...
           * 2.0.0: :class:`OperationGroupTwoOperations<multiapi.submodule.v2.operations.OperationGroupTwoOperations>`
           * 3.0.0: :class:`OperationGroupTwoOperations<multiapi.submodule.v3.operations.OperationGroupTwoOperations>`
        """
