...
class MultiapiTest(MultiapiTestOperationsMixin):
    ...
    :vartype operation_group_one: autorest.multiapi.v2.operations.OperationGroupOneOperations
    :ivar operation_group_two: OperationGroupTwoOperations operations
    :vartype operation_group_two: autorest.multiapi.v2.operations.OperationGroupTwoOperations
