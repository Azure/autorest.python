...
class MultiapiTest(object):
    ...
    :vartype operation_group_one: autorest.multiapi.v3.aio.operations_async.OperationGroupOneOperations
    :ivar operation_group_two: OperationGroupTwoOperations operations
    :vartype operation_group_two: autorest.multiapi.v3.aio.operations_async.OperationGroupTwoOperations
