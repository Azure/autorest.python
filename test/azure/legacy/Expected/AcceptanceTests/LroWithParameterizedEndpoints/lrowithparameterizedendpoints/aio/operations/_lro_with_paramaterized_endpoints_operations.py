...
from ...operations._lro_with_paramaterized_endpoints_operations import build_poll_with_constant_parameterized_endpoints_request_initial, build_poll_with_parameterized_endpoints_request_initial
T = TypeVar('T')
