...
class PagingOperations:
    ...
    :type models: ~azure.packagemode.customize.models
    ...
    def get_no_item_name_pages(self, **kwargs: Any) -> AsyncIterable["_models.ProductResultValue"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.packagemode.customize.models.ProductResultValue]
    ...
    def get_null_next_link_name_pages(self, **kwargs: Any) -> AsyncIterable["_models.ProductResult"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.packagemode.customize.models.ProductResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_multiple_pages(
        ...
        **kwargs: Any
        ...
        :type paging_get_multiple_pages_options:
         ~azure.packagemode.customize.models.PagingGetMultiplePagesOptions
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ProductResult or the result of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.packagemode.customize.models.ProductResult]
    ...
    def get_odata_multiple_pages(
        ...
        **kwargs: Any
        ...
        :type paging_get_odata_multiple_pages_options:
         ~azure.packagemode.customize.models.PagingGetOdataMultiplePagesOptions
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either OdataProductResult or the result of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.packagemode.customize.models.OdataProductResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_multiple_pages_with_offset(
        ...
        **kwargs: Any
        ...
        :type paging_get_multiple_pages_with_offset_options:
         ~azure.packagemode.customize.models.PagingGetMultiplePagesWithOffsetOptions
        :param client_request_id:  Default value is None.
        :type client_request_id: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ProductResult or the result of cls(response)
    ...
    def get_multiple_pages_fragment_with_grouping_next_link(
        ...
        :type custom_parameter_group: ~azure.packagemode.customize.models.CustomParameterGroup
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either OdataProductResult or the result of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.packagemode.customize.models.OdataProductResult]
    ...
    async def begin_get_multiple_pages_lro(
        ...
        **kwargs: Any
        ...
        :type paging_get_multiple_pages_lro_options:
         ~azure.packagemode.customize.models.PagingGetMultiplePagesLroOptions
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.core.async_paging.AsyncItemPaged[~azure.packagemode.customize.models.ProductResult]]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_paging_model_with_item_name_with_xms_client_name(
        ...
        :return: An iterator like instance of either ProductResultValueWithXMSClientName or the result
         of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.packagemode.customize.models.ProductResultValueWithXMSClientName]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
