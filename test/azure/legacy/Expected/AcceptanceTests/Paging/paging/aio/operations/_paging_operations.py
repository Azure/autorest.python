...
class PagingOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        Instead, you should access the following operations through :class:`~paging.aio.AutoRestPagingTestService`'s
        :attr:`~paging.aio.AutoRestPagingTestService.paging` attribute.
    """
