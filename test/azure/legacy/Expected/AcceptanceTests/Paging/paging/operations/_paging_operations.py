...
def build_page_with_api_version_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/paging/apiVersion/1")
...
class PagingOperations:
    ...
    @distributed_trace
    def page_with_api_version(self, **kwargs: Any) -> Iterable["_models.Product"]:
