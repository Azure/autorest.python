...
from ...operations._parameter_grouping_operations import build_post_multi_param_groups_request, build_post_optional_request, build_post_required_request, build_post_reserved_words_request, build_post_shared_parameter_group_object_request
T = TypeVar('T')
...
class ParameterGroupingOperations:
    ...
    async def post_reserved_words(
        self,
        parameter_grouping_post_reserved_words_parameters: Optional["_models.ParameterGroupingPostReservedWordsParameters"] = None,
        **kwargs: Any
    ) -> None:
