...
class LROSADsOperations(object):
    ...
    def _put_non_retry400_initial(
        ...
        **kwargs  # type: Any
        ...
        request = rest_lrosads.build_put_non_retry400_request_initial(
            content_type=content_type, json=json, template_url=self._put_non_retry400_initial.metadata["url"], **kwargs
    ...
    def _post_non_retry400_initial(
        ...
        **kwargs  # type: Any
        ...
        request = rest_lrosads.build_post_non_retry400_request_initial(
            content_type=content_type, json=json, template_url=self._post_non_retry400_initial.metadata["url"], **kwargs
        )._to_pipeline_transport_request()
        request.url = self._client.format_url(request.url)
    ...
    def _delete_async_relative_retry_invalid_json_polling_initial(
        ...
        request = rest_lrosads.build_delete_async_relative_retry_invalid_json_polling_request_initial(
            template_url=self._delete_async_relative_retry_invalid_json_polling_initial.metadata["url"], **kwargs
        )._to_pipeline_transport_request()
        request.url = self._client.format_url(request.url)
