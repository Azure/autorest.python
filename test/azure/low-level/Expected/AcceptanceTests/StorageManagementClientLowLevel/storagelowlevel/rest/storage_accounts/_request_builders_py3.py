...
def build_delete_request(
    ...
    return HttpRequest(method="DELETE", url=url, params=_params, **kwargs)
...
def build_update_request(
    ...
    **kwargs: Any
    ...
    return HttpRequest(method="PATCH", url=url, params=_params, headers=_headers, json=json, content=content, **kwargs)
