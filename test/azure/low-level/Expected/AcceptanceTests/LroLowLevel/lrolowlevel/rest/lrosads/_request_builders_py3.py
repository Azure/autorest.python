...
def build_put_non_retry201_creating400_request(*, json: Any = None, content: Any = None, **kwargs: Any) -> HttpRequest:
...
def build_put_async_relative_retry400_request(*, json: Any = None, content: Any = None, **kwargs: Any) -> HttpRequest:
...
def build_post_async_relative_retry400_request(*, json: Any = None, content: Any = None, **kwargs: Any) -> HttpRequest:
...
def build_post202_no_location_request(*, json: Any = None, content: Any = None, **kwargs: Any) -> HttpRequest:
...
def build_put200_invalid_json_request(*, json: Any = None, content: Any = None, **kwargs: Any) -> HttpRequest:
...
def build_post202_retry_invalid_header_request(*, json: Any = None, content: Any = None, **kwargs: Any) -> HttpRequest:
