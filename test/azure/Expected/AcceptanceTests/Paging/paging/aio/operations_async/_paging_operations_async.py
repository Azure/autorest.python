...
class PagingOperations:
    ...
    def get_no_item_name_pages(
        self,
        **kwargs
    ) -> AsyncItemPaged["models.ProductResultValue"]:
    ...
    def get_null_next_link_name_pages(
        self,
        **kwargs
    ) -> AsyncItemPaged["models.ProductResult"]:
    ...
    def get_odata_multiple_pages(
        ...
        **kwargs
    ) -> AsyncItemPaged["models.OdataProductResult"]:
    ...
    def get_paging_model_with_item_name_with_xms_client_name(
        self,
        **kwargs
    ) -> AsyncItemPaged["models.ProductResultValueWithXMSClientName"]:
