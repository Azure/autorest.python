...
class PagingOperations:
    ...
    @distributed_trace
    def get_multiple_pages(self, client_request_id: Optional[str] = None, maxresults: Optional[int] = None, timeout: Optional[int] = None, cls=None, **kwargs):
    ...
    @distributed_trace
    def get_odata_multiple_pages(self, client_request_id: Optional[str] = None, maxresults: Optional[int] = None, timeout: Optional[int] = None, cls=None, **kwargs):
    ...
    @distributed_trace
    def get_multiple_pages_with_offset(self, offset: int, client_request_id: Optional[str] = None, maxresults: Optional[int] = None, timeout: Optional[int] = None, cls=None, **kwargs):
        """A paging operation that includes a nextLink that has 10 pages.
    ...
    @distributed_trace
    def get_multiple_pages_fragment_next_link(self, api_version: str, tenant: str, cls=None, **kwargs):
    ...
    @distributed_trace
    def get_multiple_pages_fragment_with_grouping_next_link(self, api_version: str, tenant: str, cls=None, **kwargs):
    ...
    async def get_multiple_pages_lro(self, client_request_id: Optional[str] = None, maxresults: Optional[int] = None, timeout: Optional[int] = None, cls=None, polling=True, **kwargs):
