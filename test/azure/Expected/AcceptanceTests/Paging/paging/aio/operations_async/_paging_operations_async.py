...
class PagingOperations:
    ...
    async def get_multiple_pages_lro(self, client_request_id: Optional[str] = None, maxresults: Optional[int] = None, timeout: Optional[int] = None, cls=None, polling=True, **kwargs) -> "ProductResult":
