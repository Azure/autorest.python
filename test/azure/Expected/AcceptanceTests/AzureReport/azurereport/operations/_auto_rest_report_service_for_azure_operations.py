...
if TYPE_CHECKING:
    ...
    class AbstractServiceClient(object):
        ...
        @property
        def _config(self):
            # type: () -> AutoRestReportServiceForAzureConfiguration
            """Configuration of service client
            :rtype: AutoRestReportServiceForAzureConfiguration
            """

        @_config.setter
        def _config(self, value):
            # type: (AutoRestReportServiceForAzureConfiguration) -> None
...
class AutoRestReportServiceForAzureOperationsMixin(_MIXIN_BASE):
