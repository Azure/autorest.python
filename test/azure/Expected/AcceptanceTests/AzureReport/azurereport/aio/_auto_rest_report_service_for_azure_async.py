...
class AutoRestReportServiceForAzure(AutoRestReportServiceForAzureOperationsMixin, SDKClientAsync):
    ...
    def __init__(
        ...
        super(AutoRestReportServiceForAzure, self).__init__(self.config)
