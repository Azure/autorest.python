...
class AutoRestReportServiceForAzureAsync(AutoRestReportServiceForAzureOperationsMixin, SDKClientAsync):
    ...
    def __init__(
        ...
        super(AutoRestReportServiceForAzureAsync, self).__init__(self.config)
