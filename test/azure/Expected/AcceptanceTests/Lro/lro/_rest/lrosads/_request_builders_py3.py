...
def build_put_non_retry400_request_initial(*, json: Any = None, content: Any = None, **kwargs: Any) -> HttpRequest:
...
def build_delete_non_retry400_request_initial(**kwargs: Any) -> HttpRequest:
...
def build_delete202_non_retry400_request_initial(**kwargs: Any) -> HttpRequest:
...
def build_delete_async_relative_retry400_request_initial(**kwargs: Any) -> HttpRequest:
...
def build_post_non_retry400_request_initial(*, json: Any = None, content: Any = None, **kwargs: Any) -> HttpRequest:
...
def build_post202_non_retry400_request_initial(*, json: Any = None, content: Any = None, **kwargs: Any) -> HttpRequest:
...
def build_delete_async_relative_retry_no_status_request_initial(**kwargs: Any) -> HttpRequest:
    """Long running delete request, service returns a 202 to the initial request. Poll the endpoint
    indicated in the Azure-AsyncOperation header for operation status.
...
def build_post202_no_location_request_initial(*, json: Any = None, content: Any = None, **kwargs: Any) -> HttpRequest:
...
def build_put200_invalid_json_request_initial(*, json: Any = None, content: Any = None, **kwargs: Any) -> HttpRequest:
...
def build_delete202_retry_invalid_header_request_initial(**kwargs: Any) -> HttpRequest:
...
def build_delete_async_relative_retry_invalid_header_request_initial(**kwargs: Any) -> HttpRequest:
...
def build_delete_async_relative_retry_invalid_json_polling_request_initial(**kwargs: Any) -> HttpRequest:
    """Long running delete request, service returns a 202 to the initial request. Poll the endpoint
    indicated in the Azure-AsyncOperation header for operation status.
