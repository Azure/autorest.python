    ...
    def _put200_succeeded_initial(
        ...
        **kwargs  # type: Any
        ...
        request = rest_lros.build_put200_succeeded_request_initial(
            json=json, content_type=content_type, template_url=self._put200_succeeded_initial.metadata["url"], **kwargs
        )._internal_request
    ...
    def _put201_succeeded_initial(
        ...
        **kwargs  # type: Any
        ...
        request = rest_lros.build_put201_succeeded_request_initial(
            json=json, content_type=content_type, template_url=self._put201_succeeded_initial.metadata["url"], **kwargs
        )._internal_request
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    def _put202_retry200_initial(
        ...
        **kwargs  # type: Any
        ...
        request = rest_lros.build_put202_retry200_request_initial(
            json=json, content_type=content_type, template_url=self._put202_retry200_initial.metadata["url"], **kwargs
        )._internal_request
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    def _put_non_resourc_initial(
        ...
        **kwargs  # type: Any
        ...
        request = rest_lros.build_put_non_resource_request_initial(
            json=json, content_type=content_type, template_url=self._put_non_resourc_initial.metadata["url"], **kwargs
        )._internal_request
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    def _put_sub_resourc_initial(
        ...
        **kwargs  # type: Any
        ...
        request = rest_lros.build_put_sub_resource_request_initial(
            json=json, content_type=content_type, template_url=self._put_sub_resourc_initial.metadata["url"], **kwargs
        )._internal_request
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    def _post202_retry200_initial(
        ...
        **kwargs  # type: Any
        ...
        request = rest_lros.build_post202_retry200_request_initial(
            json=json, content_type=content_type, template_url=self._post202_retry200_initial.metadata["url"], **kwargs
        )._internal_request
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
