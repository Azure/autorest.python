...
class LROsOperations(object):
    ...
    def _put200_succeeded_initial(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Union[Optional["models.Product"], ClsReturnType]
    ...
    def begin_put200_succeeded(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller[Union["models.Product", ClsReturnType]]
    ...
    def _post202_list_initial(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Union[Optional[List["models.Product"]], ClsReturnType]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional[List["models.Product"]], ClsReturnType]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def begin_post202_list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller[Union[List["models.Product"], ClsReturnType]]
    ...
    def _put_non_resource_initial(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Union["models.Sku", ClsReturnType]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.Sku", ClsReturnType]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        content_type = kwargs.pop("content_type", "application/json")
    ...
    def begin_put_non_resource(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller[Union["models.Sku", ClsReturnType]]
    ...
    def _put_sub_resource_initial(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Union["models.SubProduct", ClsReturnType]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.SubProduct", ClsReturnType]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def begin_put_sub_resource(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller[Union["models.SubProduct", ClsReturnType]]
    ...
    def begin_delete204_succeeded(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller[Optional[ClsReturnType]]
    ...
    object.
        ...
        if polling is True: polling_method = cast(PollingMethod, ARMPolling(lro_delay, lro_options={'final-state-via': 'location'},  **kwargs))
        elif polling is False: polling_method = cast(PollingMethod, NoPolling())
        else: polling_method = cast(PollingMethod, polling)
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    ...
    final object.
        ...
        if polling is True: polling_method = cast(PollingMethod, ARMPolling(lro_delay, lro_options={'final-state-via': 'azure-async-operation'},  **kwargs))
        elif polling is False: polling_method = cast(PollingMethod, NoPolling())
        else: polling_method = cast(PollingMethod, polling)
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
