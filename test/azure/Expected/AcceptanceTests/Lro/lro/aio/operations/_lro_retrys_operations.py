...
class LRORetrysOperations:
    ...
    async def _put201_creating_succeeded200_initial(
        ...
        request = _rest.lro_retrys.build_put201_creating_succeeded200_request_initial(
            content=content,
    ...
    async def _put_async_relative_retry_succeeded_initial(
        ...
        request = _rest.lro_retrys.build_put_async_relative_retry_succeeded_request_initial(
            content=content,
            content_type=content_type,
    ...
    async def _delete_provisioning202_accepted200_succeeded_initial(self, **kwargs: Any) -> "_models.Product":
        ...
        request = _rest.lro_retrys.build_delete_provisioning202_accepted200_succeeded_request_initial(
    ...
    async def _delete202_retry200_initial(self, **kwargs: Any) -> None:
        ...
        request = _rest.lro_retrys.build_delete202_retry200_request_initial(
    ...
    async def _delete_async_relative_retry_succeeded_initial(self, **kwargs: Any) -> None:
        ...
        request = _rest.lro_retrys.build_delete_async_relative_retry_succeeded_request_initial(
    ...
    async def _post202_retry200_initial(self, product: Optional["_models.Product"] = None, **kwargs: Any) -> None:
        ...
        request = _rest.lro_retrys.build_post202_retry200_request_initial(
            content=content,
            content_type=content_type,
    ...
    async def _post_async_relative_retry_succeeded_initial(
        ...
        request = _rest.lro_retrys.build_post_async_relative_retry_succeeded_request_initial(
            content=content,
            content_type=content_type,
