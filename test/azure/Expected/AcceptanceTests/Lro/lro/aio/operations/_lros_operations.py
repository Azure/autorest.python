...
class LROsOperations:
    ...
    def _put200_succeeded_initial_request(self, body: Optional["_models.Product"] = None, **kwargs: Any) -> HttpRequest:
    ...
    def _put201_succeeded_initial_request(self, body: Optional["_models.Product"] = None, **kwargs: Any) -> HttpRequest:
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    def _post202_list_initial_request(self, **kwargs: Any) -> HttpRequest:
        accept = "application/json"
    ...
    def _put202_retry200_initial_request(self, body: Optional["_models.Product"] = None, **kwargs: Any) -> HttpRequest:
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    def _put_non_resource_initial_request(self, body: Optional["_models.Sku"] = None, **kwargs: Any) -> HttpRequest:
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def _put_non_resourc_initial(self, sku: Optional["_models.Sku"] = None, **kwargs: Any) -> "_models.Sku":
    ...
    def _put_async_non_resource_initial_request(
        self, body: Optional["_models.Sku"] = None, **kwargs: Any
    ) -> HttpRequest:
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def _put_async_non_resourc_initial(self, sku: Optional["_models.Sku"] = None, **kwargs: Any) -> "_models.Sku":
        cls = kwargs.pop("cls", None)  # type: ClsType["_models.Sku"]
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}))
    ...
    def _delete_provisioning202_deleting_failed200_initial_request(self, **kwargs: Any) -> HttpRequest:
        accept = "application/json"
    ...
    def _delete_provisioning202_deletingcanceled200_initial_request(self, **kwargs: Any) -> HttpRequest:
        accept = "application/json"
    ...
    def _delete202_no_retry204_initial_request(self, **kwargs: Any) -> HttpRequest:
        accept = "application/json"
    ...
    def _delete_no_header_in_retry_initial_request(self, **kwargs: Any) -> HttpRequest:
        accept = "application/json"
    ...
    def _delete_async_no_header_in_retry_initial_request(self, **kwargs: Any) -> HttpRequest:
        accept = "application/json"
    ...
    def _delete_async_retry_succeeded_initial_request(self, **kwargs: Any) -> HttpRequest:
        accept = "application/json"
    ...
    def _delete_async_no_retry_succeeded_initial_request(self, **kwargs: Any) -> HttpRequest:
        accept = "application/json"
    ...
    def _delete_async_retry_failed_initial_request(self, **kwargs: Any) -> HttpRequest:
        accept = "application/json"
    ...
    def _delete_async_retrycanceled_initial_request(self, **kwargs: Any) -> HttpRequest:
        accept = "application/json"
    ...
    def _post200_with_payload_initial_request(self, **kwargs: Any) -> HttpRequest:
        accept = "application/json"
    ...
    def _post_double_headers_final_location_get_initial_request(self, **kwargs: Any) -> HttpRequest:
        accept = "application/json"
    ...
    def _post_double_headers_final_azure_header_get_initial_request(self, **kwargs: Any) -> HttpRequest:
        accept = "application/json"
    ...
    def _post_double_headers_final_azure_header_get_default_initial_request(self, **kwargs: Any) -> HttpRequest:
        accept = "application/json"
