...
class LROSADsOperations:
    ...
    async def _put_non_retry400_initial(
        ...
        request = _rest.lrosads.build_put_non_retry400_request_initial(
            content=content,
    ...
    async def _put_non_retry201_creating400_initial(
        ...
        request = _rest.lrosads.build_put_non_retry201_creating400_request_initial(
            content=content,
            content_type=content_type,
    ...
    async def _put_non_retry201_creating400_invalid_jso_initial(
        ...
        request = _rest.lrosads.build_put_non_retry201_creating400_invalid_json_request_initial(
            content=content,
            content_type=content_type,
            template_url=self._put_non_retry201_creating400_invalid_jso_initial.metadata["url"],
            **kwargs
        )
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def _put_async_relative_retry400_initial(
        ...
        request = _rest.lrosads.build_put_async_relative_retry400_request_initial(
            content=content,
            content_type=content_type,
    ...
    async def _delete_non_retry400_initial(self, **kwargs: Any) -> None:
        ...
        request = _rest.lrosads.build_delete_non_retry400_request_initial(
    ...
    async def _delete202_non_retry400_initial(self, **kwargs: Any) -> None:
        ...
        request = _rest.lrosads.build_delete202_non_retry400_request_initial(
    ...
    async def _delete_async_relative_retry400_initial(self, **kwargs: Any) -> None:
        ...
        request = _rest.lrosads.build_delete_async_relative_retry400_request_initial(
    ...
    async def _post_non_retry400_initial(self, product: Optional["_models.Product"] = None, **kwargs: Any) -> None:
        ...
        request = _rest.lrosads.build_post_non_retry400_request_initial(
            content=content,
            content_type=content_type,
    ...
    async def _post202_non_retry400_initial(self, product: Optional["_models.Product"] = None, **kwargs: Any) -> None:
        ...
        request = _rest.lrosads.build_post202_non_retry400_request_initial(
            content=content,
            content_type=content_type,
    ...
    async def _post_async_relative_retry400_initial(
        ...
        request = _rest.lrosads.build_post_async_relative_retry400_request_initial(
            content=content,
            content_type=content_type,
    ...
    async def _put_error201_no_provisioning_state_payload_initial(
        ...
        request = _rest.lrosads.build_put_error201_no_provisioning_state_payload_request_initial(
            content=content,
            content_type=content_type,
    ...
    async def _put_async_relative_retry_no_status_initial(
        ...
        request = _rest.lrosads.build_put_async_relative_retry_no_status_request_initial(
            content=content,
            content_type=content_type,
    ...
    async def _put_async_relative_retry_no_status_payload_initial(
        ...
        request = _rest.lrosads.build_put_async_relative_retry_no_status_payload_request_initial(
            content=content,
            content_type=content_type,
    ...
    async def _delete204_succeeded_initial(self, **kwargs: Any) -> None:
        ...
        request = _rest.lrosads.build_delete204_succeeded_request_initial(
    ...
    async def _delete_async_relative_retry_no_status_initial(self, **kwargs: Any) -> None:
        ...
        request = _rest.lrosads.build_delete_async_relative_retry_no_status_request_initial(
    ...
    async def _post202_no_locatio_initial(self, product: Optional["_models.Product"] = None, **kwargs: Any) -> None:
        ...
        request = _rest.lrosads.build_post202_no_location_request_initial(
            content=content,
            content_type=content_type,
            template_url=self._post202_no_locatio_initial.metadata["url"],
            **kwargs
        )
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def _post_async_relative_retry_no_payload_initial(
        ...
        request = _rest.lrosads.build_post_async_relative_retry_no_payload_request_initial(
            content=content,
            content_type=content_type,
    ...
    async def _put200_invalid_jso_initial(
        ...
        request = _rest.lrosads.build_put200_invalid_json_request_initial(
            content=content,
            content_type=content_type,
            template_url=self._put200_invalid_jso_initial.metadata["url"],
            **kwargs
        )
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
    ...
    async def _put_async_relative_retry_invalid_header_initial(
        ...
        request = _rest.lrosads.build_put_async_relative_retry_invalid_header_request_initial(
            content=content,
            content_type=content_type,
    ...
    async def _put_async_relative_retry_invalid_json_poll_initial(
        ...
        request = _rest.lrosads.build_put_async_relative_retry_invalid_json_polling_request_initial(
            content=content,
            content_type=content_type,
    ...
    async def _delete202_retry_invalid_header_initial(self, **kwargs: Any) -> None:
        ...
        request = _rest.lrosads.build_delete202_retry_invalid_header_request_initial(
    ...
    async def _delete_async_relative_retry_invalid_header_initial(self, **kwargs: Any) -> None:
        ...
        request = _rest.lrosads.build_delete_async_relative_retry_invalid_header_request_initial(
    ...
    async def _delete_async_relative_retry_invalid_json_poll_initial(self, **kwargs: Any) -> None:
        ...
        request = _rest.lrosads.build_delete_async_relative_retry_invalid_json_polling_request_initial(
    ...
    async def _post202_retry_invalid_header_initial(
        ...
        request = _rest.lrosads.build_post202_retry_invalid_header_request_initial(
            content=content,
            content_type=content_type,
    ...
    async def _post_async_relative_retry_invalid_header_initial(
        ...
        request = _rest.lrosads.build_post_async_relative_retry_invalid_header_request_initial(
            content=content,
            content_type=content_type,
    ...
    async def _post_async_relative_retry_invalid_json_poll_initial(
        ...
        request = _rest.lrosads.build_post_async_relative_retry_invalid_json_polling_request_initial(
            content=content,
            content_type=content_type,
