...
class LROSADsOperations:
    ...
    async def _put_non_retry400_initial(
        ...
        request = rest_lrosads.build_put_non_retry400_request_initial(
            json=json, content_type=content_type, template_url=self._put_non_retry400_initial.metadata["url"], **kwargs
        )._internal_request
    ...
    async def _post_non_retry400_initial(self, product: Optional["_models.Product"] = None, **kwargs: Any) -> None:
        ...
        request = rest_lrosads.build_post_non_retry400_request_initial(
            json=json, content_type=content_type, template_url=self._post_non_retry400_initial.metadata["url"], **kwargs
        )._internal_request
        request.url = self._client.format_url(request.url)
        kwargs.pop("content_type", None)
