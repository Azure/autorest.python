...
class LROSADsOperations:
    ...
    async def begin_put_non_retry400(
        ...
        if cont_token is None:
            _body = product
            request = self._put_non_retry400_request(body=_body, **kwargs)
    ...
    async def begin_put_non_retry201_creating400(
        ...
        if cont_token is None:
            _body = product
            request = self._put_non_retry201_creating400_request(body=_body, **kwargs)
            kwargs.pop("content_type", None)
            pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
            response = pipeline_response.http_response
            if response.status_code not in [200, 201]:
    ...
    async def begin_put_non_retry201_creating400_invalid_json(
        ...
        if cont_token is None:
            _body = product
            request = self._put_non_retry201_creating400_invalid_json_request(body=_body, **kwargs)
            kwargs.pop("content_type", None)
            pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
            response = pipeline_response.http_response
            if response.status_code not in [200, 201]:
    ...
    async def begin_put_async_relative_retry400(
        ...
        if cont_token is None:
            _body = product
            request = self._put_async_relative_retry400_request(body=_body, **kwargs)
            kwargs.pop("content_type", None)
            pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
            response = pipeline_response.http_response
    ...
    async def begin_post_non_retry400(
        ...
        if cont_token is None:
            _body = product
            request = self._post_non_retry400_request(body=_body, **kwargs)
            kwargs.pop("content_type", None)
            pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
            response = pipeline_response.http_response
            if response.status_code not in [202]:
    ...
    async def begin_post202_non_retry400(
        ...
        if cont_token is None:
            _body = product
            request = self._post202_non_retry400_request(body=_body, **kwargs)
            kwargs.pop("content_type", None)
            pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
            response = pipeline_response.http_response
            if response.status_code not in [202]:
    ...
    async def begin_post_async_relative_retry400(
        ...
        if cont_token is None:
            _body = product
            request = self._post_async_relative_retry400_request(body=_body, **kwargs)
            kwargs.pop("content_type", None)
            pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
            response = pipeline_response.http_response
            if response.status_code not in [202]:
    ...
    async def begin_put_error201_no_provisioning_state_payload(
        ...
        if cont_token is None:
            _body = product
            request = self._put_error201_no_provisioning_state_payload_request(body=_body, **kwargs)
            kwargs.pop("content_type", None)
            pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
            response = pipeline_response.http_response
            if response.status_code not in [200, 201]:
    ...
    async def begin_put_async_relative_retry_no_status(
        ...
        if cont_token is None:
            _body = product
            request = self._put_async_relative_retry_no_status_request(body=_body, **kwargs)
            kwargs.pop("content_type", None)
            pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
            response = pipeline_response.http_response
            if response.status_code not in [200]:
    ...
    async def begin_put_async_relative_retry_no_status_payload(
        ...
        if cont_token is None:
            _body = product
            request = self._put_async_relative_retry_no_status_payload_request(body=_body, **kwargs)
            kwargs.pop("content_type", None)
            pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
            response = pipeline_response.http_response
            if response.status_code not in [200]:
    ...
    async def begin_post202_no_location(
        ...
        if cont_token is None:
            _body = product
            request = self._post202_no_location_request(body=_body, **kwargs)
            kwargs.pop("content_type", None)
            pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
            response = pipeline_response.http_response
            if response.status_code not in [202]:
    ...
    async def begin_post_async_relative_retry_no_payload(
        ...
        if cont_token is None:
            _body = product
            request = self._post_async_relative_retry_no_payload_request(body=_body, **kwargs)
            kwargs.pop("content_type", None)
            pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
            response = pipeline_response.http_response
            if response.status_code not in [202]:
    ...
    async def begin_put200_invalid_json(
        ...
        if cont_token is None:
            _body = product
            request = self._put200_invalid_json_request(body=_body, **kwargs)
            kwargs.pop("content_type", None)
            pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
            response = pipeline_response.http_response
    ...
    async def begin_put_async_relative_retry_invalid_header(
        ...
        if cont_token is None:
            _body = product
            request = self._put_async_relative_retry_invalid_header_request(body=_body, **kwargs)
            kwargs.pop("content_type", None)
            pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
            response = pipeline_response.http_response
            if response.status_code not in [200]:
    ...
    async def begin_put_async_relative_retry_invalid_json_polling(
        ...
        if cont_token is None:
            _body = product
            request = self._put_async_relative_retry_invalid_json_polling_request(body=_body, **kwargs)
            kwargs.pop("content_type", None)
            pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
            response = pipeline_response.http_response
            if response.status_code not in [200]:
    ...
    async def begin_post202_retry_invalid_header(
        ...
        if cont_token is None:
            _body = product
            request = self._post202_retry_invalid_header_request(body=_body, **kwargs)
            kwargs.pop("content_type", None)
            pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
            response = pipeline_response.http_response
            if response.status_code not in [202]:
    ...
    async def begin_post_async_relative_retry_invalid_header(
        ...
        if cont_token is None:
            _body = product
            request = self._post_async_relative_retry_invalid_header_request(body=_body, **kwargs)
            kwargs.pop("content_type", None)
            pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
            response = pipeline_response.http_response
            if response.status_code not in [202]:
    ...
    async def begin_post_async_relative_retry_invalid_json_polling(
        ...
        if cont_token is None:
            _body = product
            request = self._post_async_relative_retry_invalid_json_polling_request(body=_body, **kwargs)
            kwargs.pop("content_type", None)
            pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
            response = pipeline_response.http_response
            if response.status_code not in [202]:
