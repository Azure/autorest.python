...
class LROsOperations:
    ...
    async def _post202_list_initial(
        self,
        **kwargs
    ) -> Union[Optional[List["models.Product"]], ClsReturnType]:
    ...
    async def begin_post202_list(
        self,
        **kwargs
    ) -> AsyncLROPoller[Union[List["models.Product"], ClsReturnType]]:
    ...
    async def _put_non_resource_initial(
        ...
        **kwargs
    ) -> Union["models.Sku", ClsReturnType]:
    ...
    async def begin_put_non_resource(
        ...
        sku: Optional["models.Sku"] = None,
        **kwargs
    ) -> AsyncLROPoller[Union["models.Sku", ClsReturnType]]:
    ...
    async def _put_sub_resource_initial(
        ...
        **kwargs
    ) -> Union["models.SubProduct", ClsReturnType]:
    ...
    async def begin_put_sub_resource(
        ...
        provisioning_state: Optional[str] = None,
        **kwargs
    ) -> AsyncLROPoller[Union["models.SubProduct", ClsReturnType]]:
    ...
    object.
        ...
        if polling is True: polling_method = cast(AsyncPollingMethod, AsyncARMPolling(lro_delay, lro_options={'final-state-via': 'location'},  **kwargs))
        elif polling is False: polling_method = cast(AsyncPollingMethod, AsyncNoPolling())
        else: polling_method = cast(AsyncPollingMethod, polling)
        if cont_token:
            return AsyncLROPoller.from_continuation_token(
    ...
    final object.
        ...
        if polling is True: polling_method = cast(AsyncPollingMethod, AsyncARMPolling(lro_delay, lro_options={'final-state-via': 'azure-async-operation'},  **kwargs))
        elif polling is False: polling_method = cast(AsyncPollingMethod, AsyncNoPolling())
        else: polling_method = cast(AsyncPollingMethod, polling)
        if cont_token:
            return AsyncLROPoller.from_continuation_token(
