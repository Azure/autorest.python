...
def build_create_request_initial(
    ...
    **kwargs: Any
    ...
    :param subscription_id: Gets subscription credentials which uniquely identify Microsoft Azure
     subscription. The subscription ID forms part of the URI for every service call.
    :type subscription_id: str
    :keyword json: The parameters to provide for the created account.
    :paramtype json: Any
    :keyword content: The parameters to provide for the created account.
    :paramtype content: Any
    :return: Returns an :class:`~azure.core.rest.HttpRequest` that you will pass to the client's `send_request` method.
     See https://aka.ms/azsdk/python/llcwiki for how to incorporate this response into your code flow.
    :rtype: ~azure.core.rest.HttpRequest
...
def build_regenerate_key_request(
    ...
    **kwargs: Any
    ...
    :param subscription_id: Gets subscription credentials which uniquely identify Microsoft Azure
     subscription. The subscription ID forms part of the URI for every service call.
    :type subscription_id: str
    :keyword json: Specifies name of the key which should be regenerated.
    :paramtype json: Any
    :keyword content: Specifies name of the key which should be regenerated.
    :paramtype content: Any
    :return: Returns an :class:`~azure.core.rest.HttpRequest` that you will pass to the client's `send_request` method.
     See https://aka.ms/azsdk/python/llcwiki for how to incorporate this response into your code flow.
    :rtype: ~azure.core.rest.HttpRequest
