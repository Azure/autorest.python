...
class StorageAccountsOperations:
    ...
    async def _create_initial(self, resource_group_name, account_name, account_type=None, cls=None, **kwargs):
        error_map = kwargs.pop('error_map', {})
    ...
    @distributed_trace_async
    async def create(self, resource_group_name, account_name, account_type=None, cls=None, polling=True, **kwargs):
