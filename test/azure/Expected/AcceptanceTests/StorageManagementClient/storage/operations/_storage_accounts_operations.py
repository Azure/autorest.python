...
class StorageAccountsOperations(object):
    ...
    def check_name_availability(
        ...
        **kwargs  # type: Any
        ...
        content = self._serialize.body(account_name, "StorageAccountCheckNameAvailabilityParameters")
        content = json.dumps(content)

        request = _rest.storage_accounts.build_check_name_availability_request(
    ...
    def _creat_initial(
        ...
        **kwargs  # type: Any
        ...
        content_type = kwargs.pop("content_type", "application/json")
        content = self._serialize.body(parameters, "StorageAccountCreateParameters")
        content = json.dumps(content)

        request = _rest.storage_accounts.build_create_request_initial(
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        if cont_token is None:
            raw_result = self._creat_initial(
                resource_group_name=resource_group_name,
                account_name=account_name,
    ...
    def delete(
        ...
        **kwargs  # type: Any
        ...
        request = _rest.storage_accounts.build_delete_request(
            resource_group_name=resource_group_name,
            account_name=account_name,
            subscription_id=self._config.subscription_id,
    ...
    def get_properties(
        ...
        **kwargs  # type: Any
        ...
        request = _rest.storage_accounts.build_get_properties_request(
            resource_group_name=resource_group_name,
            account_name=account_name,
            subscription_id=self._config.subscription_id,
    ...
    def update(
        ...
        **kwargs  # type: Any
        ...
        content_type = kwargs.pop("content_type", "application/json")
        content = self._serialize.body(parameters, "StorageAccountUpdateParameters")
        content = json.dumps(content)

        request = _rest.storage_accounts.build_update_request(
            resource_group_name=resource_group_name,
            account_name=account_name,
            subscription_id=self._config.subscription_id,
            content=content,
    ...
    def list_keys(
        ...
        **kwargs  # type: Any
        ...
        request = _rest.storage_accounts.build_list_keys_request(
            resource_group_name=resource_group_name,
            account_name=account_name,
            subscription_id=self._config.subscription_id,
    ...
    def list(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                request = _rest.storage_accounts.build_list_request(
    ...
    def list_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        def prepare_request(next_link=None):
            if not next_link:
                request = _rest.storage_accounts.build_list_by_resource_group_request(
                    resource_group_name=resource_group_name,
                    subscription_id=self._config.subscription_id,
    ...
    def regenerate_key(
        ...
        **kwargs  # type: Any
        ...
        content = self._serialize.body(_regenerate_key, "StorageAccountRegenerateKeyParameters")
        content = json.dumps(content)

        request = _rest.storage_accounts.build_regenerate_key_request(
            resource_group_name=resource_group_name,
            account_name=account_name,
            subscription_id=self._config.subscription_id,
            content=content,
