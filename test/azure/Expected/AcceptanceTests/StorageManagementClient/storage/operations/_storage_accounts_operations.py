...
class StorageAccountsOperations(object):
    ...
    def check_name_availability(self, account_name, cls=None, **operation_config):
    ...
    def delete(self, resource_group_name, account_name, cls=None, **operation_config):
    ...
    def get_properties(self, resource_group_name, account_name, cls=None, **operation_config):
    ...
    def update(self, resource_group_name, account_name, parameters, cls=None, **operation_config):
    ...
    def list_keys(self, resource_group_name, account_name, cls=None, **operation_config):
    ...
    def regenerate_key(self, resource_group_name, account_name, key_name=None, cls=None, **operation_config):
