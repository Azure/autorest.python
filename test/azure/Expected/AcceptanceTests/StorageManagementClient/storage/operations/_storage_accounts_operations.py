...
class StorageAccountsOperations(object):
    ...
    def check_name_availability(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Union["models.CheckNameAvailabilityResult", ClsReturnType]
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CheckNameAvailabilityResult", ClsReturnType]
    ...
    def _create_initial(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Union[Optional["models.StorageAccount"], ClsReturnType]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.StorageAccount"], ClsReturnType]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        api_version = "2015-05-01-preview"
        content_type = kwargs.pop("content_type", "application/json")
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller[Union["models.StorageAccount", ClsReturnType]]
        ...
        cls = kwargs.pop('cls', None)  # type: ClsType["models.StorageAccount", ClsReturnType]
    ...
    def get_properties(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Union["models.StorageAccount", ClsReturnType]
    ...
    def list_keys(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Union["models.StorageAccountKeys", ClsReturnType]
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.StorageAccountKeys", ClsReturnType]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        api_version = "2015-05-01-preview"
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable[Union["models.StorageAccountListResult", ClsReturnType]]
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.StorageAccountListResult", ClsReturnType]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        api_version = "2015-05-01-preview"
