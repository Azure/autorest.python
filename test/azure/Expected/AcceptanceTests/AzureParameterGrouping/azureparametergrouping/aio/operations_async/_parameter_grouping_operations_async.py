...
class ParameterGroupingOperations:
    ...
    async def post_required(self, path: str, body: int, custom_header: Optional[str] = None, query: Optional[int] = None, cls=None, **kwargs):
    ...
    @distributed_trace_async
    async def post_optional(self, custom_header: Optional[str] = None, query: Optional[int] = None, cls=None, **kwargs):
    ...
    @distributed_trace_async
    async def post_multi_param_groups(self, header_one: Optional[str] = None, query_one: Optional[int] = None, header_two: Optional[str] = None, query_two: Optional[int] = None, cls=None, **kwargs):
    ...
    @distributed_trace_async
    async def post_shared_parameter_group_object(self, header_one: Optional[str] = None, query_one: Optional[int] = None, cls=None, **kwargs):
