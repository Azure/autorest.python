...
class AutoRestParameterGroupingTestService(SDKClient):
    ...
    def __init__(
        ...
        self.config = config or AutoRestParameterGroupingTestServiceConfiguration(credentials, base_url)
        super(AutoRestParameterGroupingTestService, self).__init__(self.config.credentials, self.config, pipeline=pipeline)
