...
class ParameterGroupingOperations(object):
    ...
    def post_required(self, parameter_grouping_post_required_parameters, cls=None, **operation_config):
    ...
    def post_optional(self, parameter_grouping_post_optional_parameters=None, cls=None, **operation_config):
    ...
    def post_multi_param_groups(self, first_parameter_group=None, parameter_grouping_post_multi_param_groups_second_param_group=None, cls=None, **operation_config):
    ...
    def post_shared_parameter_group_object(self, first_parameter_group=None, cls=None, **operation_config):
