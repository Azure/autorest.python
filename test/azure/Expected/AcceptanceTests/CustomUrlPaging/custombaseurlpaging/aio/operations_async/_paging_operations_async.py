...
class PagingOperations:
    ...
    def get_pages_partial_url(
            self, account_name, *, cls=None, **kwargs):
        """A paging operation that combines custom url, paging and partial URL and
        expect to concat after host.

        :param account_name: Account Name
        :type account_name: str
        :return: An iterator like instance of Product
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~custombaseurlpaging.models.Product]
