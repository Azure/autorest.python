...
class AutoRestResourceFlatteningTestServiceAsync(AutoRestResourceFlatteningTestServiceOperationsMixin, SDKClientAsync):
    ...
    def __init__(
        ...
        super(AutoRestResourceFlatteningTestServiceAsync, self).__init__(self.config)
