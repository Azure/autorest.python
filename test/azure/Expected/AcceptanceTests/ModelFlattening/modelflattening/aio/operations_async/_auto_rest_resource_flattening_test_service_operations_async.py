...
class AutoRestResourceFlatteningTestServiceOperationsMixin:
    ...
    @distributed_trace_async
    async def post_flattened_simple_product(self, product_id, description=None, max_product_display_name=None, generic_value=None, odatavalue=None, cls=None, **kwargs):
