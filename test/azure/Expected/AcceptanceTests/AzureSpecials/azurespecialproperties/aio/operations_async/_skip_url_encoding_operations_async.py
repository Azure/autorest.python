...
class SkipUrlEncodingOperations:
    ...
    async def get_method_path_valid(self, unencoded_path_param: str, cls=None, **kwargs):
    ...
    @distributed_trace_async
    async def get_path_path_valid(self, unencoded_path_param: str, cls=None, **kwargs):
        """Get method with unencoded path parameter with value 'path1/path2/path3'.
    ...
    @distributed_trace_async
    async def get_method_query_valid(self, q1: str, cls=None, **kwargs):
    ...
    @distributed_trace_async
    async def get_method_query_null(self, q1: Optional[str] = None, cls=None, **kwargs):
    ...
    @distributed_trace_async
    async def get_path_query_valid(self, q1: str, cls=None, **kwargs):
        """Get method with unencoded query parameter with value 'value1&q2=value2&q3=value3'.
