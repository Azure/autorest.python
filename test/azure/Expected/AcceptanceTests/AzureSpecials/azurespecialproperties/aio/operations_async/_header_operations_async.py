...
class HeaderOperations:
    ...
    async def custom_named_request_id(self, foo_client_request_id: str, cls=None, **kwargs):
    ...
    @distributed_trace_async
    async def custom_named_request_id_param_grouping(self, foo_client_request_id: str, cls=None, **kwargs):
    ...
    @distributed_trace_async
    async def custom_named_request_id_head(self, foo_client_request_id: str, cls=None, **kwargs):
        """Send foo-client-request-id = 9C4D50EE-2D56-4CD3-8152-34347DC9F2B0 in the header of the request.
