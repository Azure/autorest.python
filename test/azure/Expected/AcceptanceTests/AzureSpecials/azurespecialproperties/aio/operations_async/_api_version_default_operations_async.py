...
class ApiVersionDefaultOperations:
    ...
    async def get_method_global_valid(self, *, cls=None, **operation_config):
    ...
    async def get_method_global_not_provided_valid(self, *, cls=None, **operation_config):
        """GET method with api-version modeled in global settings.
    ...
    async def get_path_global_valid(self, *, cls=None, **operation_config):
        """GET method with api-version modeled in global settings.
    ...
    async def get_swagger_global_valid(self, *, cls=None, **operation_config):
        """GET method with api-version modeled in global settings.
