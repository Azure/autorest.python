...
class ApiVersionDefaultOperations(object):
    ...
    def get_method_global_valid(self, cls=None, **operation_config):
    ...
    def get_method_global_not_provided_valid(self, cls=None, **operation_config):
        """GET method with api-version modeled in global settings.
    ...
    def get_path_global_valid(self, cls=None, **operation_config):
        """GET method with api-version modeled in global settings.
    ...
    def get_swagger_global_valid(self, cls=None, **operation_config):
        """GET method with api-version modeled in global settings.
