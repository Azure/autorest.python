...
class SkipUrlEncodingOperations(object):
    ...
    def get_method_path_valid(self, unencoded_path_param, cls=None, **operation_config):
    ...
    def get_path_path_valid(self, unencoded_path_param, cls=None, **operation_config):
        """Get method with unencoded path parameter with value
        'path1/path2/path3'.
    ...
    def get_swagger_path_valid(self, cls=None, **operation_config):
        """Get method with unencoded path parameter with value
        'path1/path2/path3'.
    ...
    def get_method_query_valid(self, q1, cls=None, **operation_config):
    ...
    def get_method_query_null(self, q1=None, cls=None, **operation_config):
    ...
    def get_path_query_valid(self, q1, cls=None, **operation_config):
        """Get method with unencoded query parameter with value
        'value1&q2=value2&q3=value3'.
    ...
    def get_swagger_query_valid(self, cls=None, **operation_config):
        """Get method with unencoded query parameter with value
        'value1&q2=value2&q3=value3'.
