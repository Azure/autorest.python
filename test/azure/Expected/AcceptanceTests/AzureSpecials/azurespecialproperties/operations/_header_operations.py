...
class HeaderOperations(object):
    ...
    def custom_named_request_id(self, foo_client_request_id, cls=None, **operation_config):
    ...
    def custom_named_request_id_param_grouping(self, header_custom_named_request_id_param_grouping_parameters, cls=None, **operation_config):
        """Send foo-client-request-id = 9C4D50EE-2D56-4CD3-8152-34347DC9F2B0 in
    ...
    def custom_named_request_id_head(self, foo_client_request_id, cls=None, **operation_config):
        """Send foo-client-request-id = 9C4D50EE-2D56-4CD3-8152-34347DC9F2B0 in
        the header of the request.
