...
class HttpSuccessOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        Instead, you should access the following operations through :class:`~headversiontolerant.aio.AutoRestHeadTestService`'s
        :attr:`~headversiontolerant.aio.AutoRestHeadTestService.http_success` attribute.
    """
