...
class StorageAccountsOperations:
    ...
    @distributed_trace
    def get_properties(self, resource_group_name: str, account_name: str, **kwargs: Any) -> JSONObject:
    ...
    @distributed_trace
    def list_keys(self, resource_group_name: str, account_name: str, **kwargs: Any) -> JSONObject:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> Iterable[JSONObject]:
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> Iterable[JSONObject]:
