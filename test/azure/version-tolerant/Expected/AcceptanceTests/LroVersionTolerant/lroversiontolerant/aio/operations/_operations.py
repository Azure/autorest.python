...
class LROsOperations:  # pylint: disable=too-many-public-methods
    ...
    async def _put201_succeeded_initial(self, product: Optional[Union[IO, JSON]] = None, **kwargs: Any) -> JSON:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    async def _put202_retry200_initial(self, product: Optional[Union[IO, JSON]] = None, **kwargs: Any) -> JSON:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    async def _put_no_header_in_retry_initial(self, product: Optional[Union[IO, JSON]] = None, **kwargs: Any) -> JSON:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    async def _put_async_retry_failed_initial(self, product: Optional[Union[IO, JSON]] = None, **kwargs: Any) -> JSON:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    async def _put_non_resource_initial(self, sku: Optional[Union[IO, JSON]] = None, **kwargs: Any) -> JSON:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    @distributed_trace_async
    async def begin_put_non_resource(
        self, sku: Optional[Union[IO, JSON]] = None, **kwargs: Any
    ) -> AsyncLROPoller[JSON]:
        """Long running put request with non resource.
    ...
    async def _put_async_non_resource_initial(self, sku: Optional[Union[IO, JSON]] = None, **kwargs: Any) -> JSON:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    async def _put_sub_resource_initial(self, product: Optional[Union[IO, JSON]] = None, **kwargs: Any) -> JSON:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    async def _put_async_sub_resource_initial(self, product: Optional[Union[IO, JSON]] = None, **kwargs: Any) -> JSON:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    async def _post202_no_retry204_initial(self, product: Optional[Union[IO, JSON]] = None, **kwargs: Any) -> JSON:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
...
class LROSADsOperations:  # pylint: disable=too-many-public-methods
    ...
    async def _put_non_retry400_initial(self, product: Optional[Union[IO, JSON]] = None, **kwargs: Any) -> JSON:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
