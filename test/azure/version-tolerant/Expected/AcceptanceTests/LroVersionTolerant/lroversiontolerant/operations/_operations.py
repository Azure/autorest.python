...
# --------------------------------------------------------------------------
from typing import Any, Callable, Dict, List, MutableMapping, Optional, TypeVar, Union, cast
...
class LROsOperations:  # pylint: disable=too-many-public-methods
    ...
    def _put200_succeeded_initial(self, product: Optional[JSONObject] = None, **kwargs: Any) -> Optional[JSONObject]:
    ...
    @distributed_trace
    def begin_put200_succeeded(self, product: Optional[JSONObject] = None, **kwargs: Any) -> LROPoller[JSONObject]:
    ...
    def _put201_succeeded_initial(self, product: Optional[JSONObject] = None, **kwargs: Any) -> JSONObject:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    @distributed_trace
    def begin_put201_succeeded(self, product: Optional[JSONObject] = None, **kwargs: Any) -> LROPoller[JSONObject]:
    ...
    def _put200_succeeded_no_state_initial(self, product: Optional[JSONObject] = None, **kwargs: Any) -> JSONObject:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    def _put202_retry200_initial(self, product: Optional[JSONObject] = None, **kwargs: Any) -> JSONObject:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    @distributed_trace
    def begin_put202_retry200(self, product: Optional[JSONObject] = None, **kwargs: Any) -> LROPoller[JSONObject]:
    ...
    def _put201_creating_succeeded200_initial(self, product: Optional[JSONObject] = None, **kwargs: Any) -> JSONObject:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    def _put200_updating_succeeded204_initial(self, product: Optional[JSONObject] = None, **kwargs: Any) -> JSONObject:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    def _put201_creating_failed200_initial(self, product: Optional[JSONObject] = None, **kwargs: Any) -> JSONObject:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    def _put200_acceptedcanceled200_initial(self, product: Optional[JSONObject] = None, **kwargs: Any) -> JSONObject:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    def _put_no_header_in_retry_initial(self, product: Optional[JSONObject] = None, **kwargs: Any) -> JSONObject:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    def _put_async_retry_succeeded_initial(self, product: Optional[JSONObject] = None, **kwargs: Any) -> JSONObject:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    def _put_async_no_retry_succeeded_initial(self, product: Optional[JSONObject] = None, **kwargs: Any) -> JSONObject:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    def _put_async_retry_failed_initial(self, product: Optional[JSONObject] = None, **kwargs: Any) -> JSONObject:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    def _put_async_no_retrycanceled_initial(self, product: Optional[JSONObject] = None, **kwargs: Any) -> JSONObject:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    def _put_async_no_header_in_retry_initial(self, product: Optional[JSONObject] = None, **kwargs: Any) -> JSONObject:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    def _put_non_resource_initial(self, sku: Optional[JSONObject] = None, **kwargs: Any) -> JSONObject:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    @distributed_trace
    def begin_put_non_resource(self, sku: Optional[JSONObject] = None, **kwargs: Any) -> LROPoller[JSONObject]:
    ...
    def _put_async_non_resource_initial(self, sku: Optional[JSONObject] = None, **kwargs: Any) -> JSONObject:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    @distributed_trace
    def begin_put_async_non_resource(self, sku: Optional[JSONObject] = None, **kwargs: Any) -> LROPoller[JSONObject]:
        """Long running put request with non resource.
    ...
    def _put_sub_resource_initial(self, product: Optional[JSONObject] = None, **kwargs: Any) -> JSONObject:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    @distributed_trace
    def begin_put_sub_resource(self, product: Optional[JSONObject] = None, **kwargs: Any) -> LROPoller[JSONObject]:
    ...
    def _put_async_sub_resource_initial(self, product: Optional[JSONObject] = None, **kwargs: Any) -> JSONObject:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    def _post202_no_retry204_initial(self, product: Optional[JSONObject] = None, **kwargs: Any) -> JSONObject:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    @distributed_trace
    def begin_post202_no_retry204(self, product: Optional[JSONObject] = None, **kwargs: Any) -> LROPoller[JSONObject]:
        """Long running post request, service returns a 202 to the initial request, with 'Location'
...
class LROSADsOperations:  # pylint: disable=too-many-public-methods
    ...
    def _put_non_retry400_initial(self, product: Optional[JSONObject] = None, **kwargs: Any) -> JSONObject:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    @distributed_trace
    def begin_put_non_retry400(self, product: Optional[JSONObject] = None, **kwargs: Any) -> LROPoller[JSONObject]:
    ...
    def _put_non_retry201_creating400_initial(self, product: Optional[JSONObject] = None, **kwargs: Any) -> JSONObject:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    def _put_async_relative_retry400_initial(self, product: Optional[JSONObject] = None, **kwargs: Any) -> JSONObject:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    def _put200_invalid_json_initial(self, product: Optional[JSONObject] = None, **kwargs: Any) -> Optional[JSONObject]:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    @distributed_trace
    def begin_put200_invalid_json(self, product: Optional[JSONObject] = None, **kwargs: Any) -> LROPoller[JSONObject]:
