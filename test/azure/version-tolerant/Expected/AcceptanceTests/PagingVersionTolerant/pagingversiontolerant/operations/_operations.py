...
def build_paging_get_multiple_pages_fragment_next_link_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct parameters
    query_parameters = kwargs.pop("params", {}) or {}  # type: Dict[str, Any]
    if _param_not_set(query_parameters, "api_version"):
