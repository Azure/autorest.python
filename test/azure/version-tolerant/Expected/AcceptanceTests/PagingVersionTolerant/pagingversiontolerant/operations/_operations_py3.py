...
class PagingOperations(object):
    ...
    @distributed_trace
    def get_no_item_name_pages(self, **kwargs: Any) -> Iterable[Any]:
    ...
    @distributed_trace
    def get_null_next_link_name_pages(self, **kwargs: Any) -> Iterable[Any]:
    ...
    @distributed_trace
    def get_single_pages(self, **kwargs: Any) -> Iterable[Any]:
    ...
    @distributed_trace
    def first_response_empty(self, **kwargs: Any) -> Iterable[Any]:
    ...
    @distributed_trace
    def get_with_query_params(self, *, required_query_parameter: int, **kwargs: Any) -> Iterable[Any]:
    ...
    @distributed_trace
    def get_multiple_pages_retry_first(self, **kwargs: Any) -> Iterable[Any]:
    ...
    @distributed_trace
    def get_multiple_pages_retry_second(self, **kwargs: Any) -> Iterable[Any]:
    ...
    @distributed_trace
    def get_single_pages_failure(self, **kwargs: Any) -> Iterable[Any]:
    ...
    @distributed_trace
    def get_multiple_pages_failure(self, **kwargs: Any) -> Iterable[Any]:
    ...
    @distributed_trace
    def get_multiple_pages_failure_uri(self, **kwargs: Any) -> Iterable[Any]:
    ...
    @distributed_trace
    def get_multiple_pages_fragment_next_link(self, tenant: str, *, api_version: str, **kwargs: Any) -> Iterable[Any]:
    ...
    @distributed_trace
    def get_paging_model_with_item_name_with_xms_client_name(self, **kwargs: Any) -> Iterable[Any]:
