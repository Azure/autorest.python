...
# --------------------------------------------------------------------------
from typing import Any, AsyncIterable, Callable, Dict, Optional, TYPE_CHECKING, TypeVar, Union
...
class PagingOperations:
    ...
    async def begin_get_multiple_pages_lro(
        ...
        **kwargs: Any
        ...
        if polling is True:
            polling_method = AsyncARMPolling(lro_delay, **kwargs)  # type: AsyncPollingMethod
        elif polling is False:
            polling_method = AsyncNoPolling()  # type: ignore
        else:
