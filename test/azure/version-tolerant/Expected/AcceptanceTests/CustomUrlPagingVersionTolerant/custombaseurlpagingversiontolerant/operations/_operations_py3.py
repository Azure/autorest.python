...
class PagingOperations(object):
    ...
    @distributed_trace
    def get_pages_partial_url(self, account_name: str, **kwargs: Any) -> Iterable[Any]:
    ...
    @distributed_trace
    def get_pages_partial_url_operation(self, account_name: str, **kwargs: Any) -> Iterable[Any]:
