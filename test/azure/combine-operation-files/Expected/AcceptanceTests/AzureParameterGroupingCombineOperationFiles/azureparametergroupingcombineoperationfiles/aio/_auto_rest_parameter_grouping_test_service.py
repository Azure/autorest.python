...
class AutoRestParameterGroupingTestService:
    ...
    :vartype parameter_grouping:
     azureparametergroupingcombineoperationfiles.aio.operations.ParameterGroupingOperations
    ...
    def _send_request(self, request: HttpRequest, **kwargs: Any) -> Awaitable[AsyncHttpResponse]:
        ...
        We have helper methods to create requests specific to this service in `azureparametergroupingcombineoperationfiles.rest`.
