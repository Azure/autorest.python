...
class OperationResult(msrest.serialization.Model):
    ...
    :param status: The status of the request. Possible values include: "Succeeded", "Failed",
     ...
     "OK".
    :type status: str or ~lrocombineoperationfiles.models.OperationResultStatus
    :param error:
    :type error: ~lrocombineoperationfiles.models.OperationResultError
    """
...
class Product(Resource):
    ...
    :vartype provisioning_state_values: str or
     ~lrocombineoperationfiles.models.ProductPropertiesProvisioningStateValues
    """
...
class SubProduct(SubResource):
    ...
    :ivar provisioning_state_values:  Possible values include: "Succeeded", "Failed", "canceled",
     "Accepted", "Creating", "Created", "Updating", "Updated", "Deleting", "Deleted", "OK".
    :vartype provisioning_state_values: str or
     ~lrocombineoperationfiles.models.SubProductPropertiesProvisioningStateValues
    """
