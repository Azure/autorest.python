...
class StorageAccountsOperations(object):
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        :return: An instance of LROPoller that returns either StorageAccount or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~storagecombineoperationfiles.models.StorageAccount]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop("content_type", "application/json")  # type: Optional[str]
    ...
    def list(
        ...
        :return: An iterator like instance of either StorageAccountListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~storagecombineoperationfiles.models.StorageAccountListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def regenerate_key(
        ...
        **kwargs  # type: Any
        ...
        :type regenerate_key:
         ~storagecombineoperationfiles.models.StorageAccountRegenerateKeyParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: StorageAccountKeys, or the result of cls(response)
        :rtype: ~storagecombineoperationfiles.models.StorageAccountKeys
        :raises: ~azure.core.exceptions.HttpResponseError
