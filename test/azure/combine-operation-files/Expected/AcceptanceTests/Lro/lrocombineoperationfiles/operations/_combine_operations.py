...
class LROsOperations(object):
    ...
    def begin_put200_succeeded(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~lrocombineoperationfiles.models.Product]
    ...
    def begin_post202_list(
        ...
        :return: An instance of LROPoller that returns either list of Product or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[list[~lrocombineoperationfiles.models.Product]]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        polling = kwargs.pop("polling", True)  # type: Union[bool, azure.core.polling.PollingMethod]
    ...
    def begin_put_non_resource(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~lrocombineoperationfiles.models.Sku]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop("content_type", "application/json")  # type: Optional[str]
        polling = kwargs.pop("polling", True)  # type: Union[bool, azure.core.polling.PollingMethod]
    ...
    def begin_put_sub_resource(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~lrocombineoperationfiles.models.SubProduct]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop("content_type", "application/json")  # type: Optional[str]
        polling = kwargs.pop("polling", True)  # type: Union[bool, azure.core.polling.PollingMethod]
