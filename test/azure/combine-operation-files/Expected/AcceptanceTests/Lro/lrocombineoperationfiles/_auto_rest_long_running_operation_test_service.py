...
class AutoRestLongRunningOperationTestService(object):
    ...
    :vartype lros: lrocombineoperationfiles.operations.LROsOperations
    :ivar lro_retrys: LRORetrysOperations operations
    :vartype lro_retrys: lrocombineoperationfiles.operations.LRORetrysOperations
    :ivar lrosads: LROSADsOperations operations
    :vartype lrosads: lrocombineoperationfiles.operations.LROSADsOperations
    :ivar lr_os_custom_header: LROsCustomHeaderOperations operations
    :vartype lr_os_custom_header: lrocombineoperationfiles.operations.LROsCustomHeaderOperations
