...
class AutoRestLongRunningOperationTestService:
    ...
    :vartype lros: lrocombineoperationfiles.aio.operations.LROsOperations
    :ivar lro_retrys: LRORetrysOperations operations
    :vartype lro_retrys: lrocombineoperationfiles.aio.operations.LRORetrysOperations
    :ivar lrosads: LROSADsOperations operations
    :vartype lrosads: lrocombineoperationfiles.aio.operations.LROSADsOperations
    :ivar lr_os_custom_header: LROsCustomHeaderOperations operations
    :vartype lr_os_custom_header:
     lrocombineoperationfiles.aio.operations.LROsCustomHeaderOperations
    ...
    def _send_request(self, request: HttpRequest, **kwargs: Any) -> Awaitable[AsyncHttpResponse]:
        ...
        We have helper methods to create requests specific to this service in `lrocombineoperationfiles.rest`.
