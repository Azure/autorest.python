...
class LROsOperations:
    ...
    :type models: ~lrocombineoperationfiles.models
    ...
    async def begin_put200_succeeded(
        ...
        :type product: ~lrocombineoperationfiles.models.Product
        ...
        :return: An instance of AsyncLROPoller that returns either Product or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~lrocombineoperationfiles.models.Product]
    ...
    async def begin_post202_list(self, **kwargs: Any) -> AsyncLROPoller[List["_models.Product"]]:
        ...
        :return: An instance of AsyncLROPoller that returns either list of Product or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[list[~lrocombineoperationfiles.models.Product]]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        polling = kwargs.pop("polling", True)  # type: Union[bool, azure.core.polling.AsyncPollingMethod]
    ...
    async def begin_put_non_resource(
        ...
        :type sku: ~lrocombineoperationfiles.models.Sku
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be AsyncARMPolling. Pass in False for
         this operation to not poll, or pass in your own initialized polling object for a personal
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~lrocombineoperationfiles.models.Sku]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop("content_type", "application/json")  # type: Optional[str]
        polling = kwargs.pop("polling", True)  # type: Union[bool, azure.core.polling.AsyncPollingMethod]
    ...
    async def begin_put_sub_resource(
        ...
        :return: An instance of AsyncLROPoller that returns either SubProduct or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~lrocombineoperationfiles.models.SubProduct]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop("content_type", "application/json")  # type: Optional[str]
        polling = kwargs.pop("polling", True)  # type: Union[bool, azure.core.polling.AsyncPollingMethod]
