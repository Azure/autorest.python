...
class PagingOperations:
    ...
    :type models: ~custombaseurlpagingcombineoperationfiles.models
    ...
    def get_pages_partial_url(self, account_name: str, **kwargs: Any) -> AsyncIterable["_models.ProductResult"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~custombaseurlpagingcombineoperationfiles.models.ProductResult]
