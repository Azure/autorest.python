...
class Product(msrest.serialization.Model):
    ...
    :param properties:
    :type properties: ~custombaseurlpagingcombineoperationfiles.models.ProductProperties
    """
...
class ProductResult(msrest.serialization.Model):
    ...
    :param values:
    :type values: list[~custombaseurlpagingcombineoperationfiles.models.Product]
    :param next_link:
    :type next_link: str
    """
