...
class AutoRestHeadExceptionTestService:
    ...
    :vartype head_exception:
     headexceptionscombineoperationfiles.aio.operations.HeadExceptionOperations
    ...
    def _send_request(self, request: HttpRequest, **kwargs: Any) -> Awaitable[AsyncHttpResponse]:
        ...
        We have helper methods to create requests specific to this service in `headexceptionscombineoperationfiles.rest`.
