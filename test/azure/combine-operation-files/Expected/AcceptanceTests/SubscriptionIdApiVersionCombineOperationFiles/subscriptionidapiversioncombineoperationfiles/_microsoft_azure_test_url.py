...
class MicrosoftAzureTestUrl(object):
    ...
    :vartype group: subscriptionidapiversioncombineoperationfiles.operations.GroupOperations
    ...
    def _send_request(
        ...
        **kwargs  # type: Any
        ...
        We have helper methods to create requests specific to this service in `subscriptionidapiversioncombineoperationfiles.rest`.
