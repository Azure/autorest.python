...
class AutoRestParameterizedHostTestPagingClient(object):
    ...
    :vartype paging: custombaseurlpagingcombineoperationfiles.operations.PagingOperations
    ...
    def _send_request(
        ...
        **kwargs  # type: Any
        ...
        We have helper methods to create requests specific to this service in `custombaseurlpagingcombineoperationfiles.rest`.
