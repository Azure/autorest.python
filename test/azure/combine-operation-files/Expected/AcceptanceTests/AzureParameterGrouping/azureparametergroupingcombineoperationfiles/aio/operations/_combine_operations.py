...
class ParameterGroupingOperations:
    ...
    :type models: ~azureparametergroupingcombineoperationfiles.models
    ...
    async def post_required(
        ...
        **kwargs: Any
        ...
        :type parameter_grouping_post_required_parameters:
         ~azureparametergroupingcombineoperationfiles.models.ParameterGroupingPostRequiredParameters
    ...
    async def post_optional(
        ...
        **kwargs: Any
        ...
        :type parameter_grouping_post_optional_parameters:
         ~azureparametergroupingcombineoperationfiles.models.ParameterGroupingPostOptionalParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    async def post_reserved_words(
        ...
        **kwargs: Any
        ...
        :type parameter_grouping_post_reserved_words_parameters:
         ~azureparametergroupingcombineoperationfiles.models.ParameterGroupingPostReservedWordsParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    async def post_multi_param_groups(
        ...
        **kwargs: Any
        ...
        :type first_parameter_group:
         ~azureparametergroupingcombineoperationfiles.models.FirstParameterGroup
        ...
        :type parameter_grouping_post_multi_param_groups_second_param_group:
         ~azureparametergroupingcombineoperationfiles.models.ParameterGroupingPostMultiParamGroupsSecondParamGroup
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
