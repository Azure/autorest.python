...
class StorageManagementClient(object):
    ...
    :vartype storage_accounts: storagecombineoperationfiles.operations.StorageAccountsOperations
    :ivar usage: UsageOperations operations
    :vartype usage: storagecombineoperationfiles.operations.UsageOperations
    ...
    def _send_request(
        ...
        **kwargs  # type: Any
        ...
        We have helper methods to create requests specific to this service in `storagecombineoperationfiles.rest`.
