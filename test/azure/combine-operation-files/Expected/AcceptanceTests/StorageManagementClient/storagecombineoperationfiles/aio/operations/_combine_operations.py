...
class StorageAccountsOperations:
    ...
    :type models: ~storagecombineoperationfiles.models
    ...
    async def check_name_availability(
        ...
        :type account_name:
         ~storagecombineoperationfiles.models.StorageAccountCheckNameAvailabilityParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: CheckNameAvailabilityResult, or the result of cls(response)
        :rtype: ~storagecombineoperationfiles.models.CheckNameAvailabilityResult
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type parameters: ~storagecombineoperationfiles.models.StorageAccountCreateParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of AsyncLROPoller that returns either StorageAccount or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~storagecombineoperationfiles.models.StorageAccount]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop("content_type", "application/json")  # type: Optional[str]
    ...
    async def get_properties(
        ...
        :rtype: ~storagecombineoperationfiles.models.StorageAccount
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop("cls", None)  # type: ClsType["_models.StorageAccount"]
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~storagecombineoperationfiles.models.StorageAccountUpdateParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: StorageAccount, or the result of cls(response)
        :rtype: ~storagecombineoperationfiles.models.StorageAccount
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    async def list_keys(
        ...
        :rtype: ~storagecombineoperationfiles.models.StorageAccountKeys
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.StorageAccountListResult"]:
        ...
        :return: An iterator like instance of either StorageAccountListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~storagecombineoperationfiles.models.StorageAccountListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def list(self, **kwargs: Any) -> "_models.UsageListResult":
        ...
        :rtype: ~storagecombineoperationfiles.models.UsageListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
