...
class AutoRestHeadTestService(object):
    ...
    :vartype http_success: headcombineoperationfiles.operations.HttpSuccessOperations
    ...
    def _send_request(
        ...
        **kwargs  # type: Any
        ...
        We have helper methods to create requests specific to this service in `headcombineoperationfiles.rest`.
