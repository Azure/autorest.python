...
class AutoRestPagingTestService:
    ...
    :vartype paging: pagingcombineoperationfiles.aio.operations.PagingOperations
    ...
    def _send_request(self, request: HttpRequest, **kwargs: Any) -> Awaitable[AsyncHttpResponse]:
        ...
        We have helper methods to create requests specific to this service in `pagingcombineoperationfiles.rest`.
