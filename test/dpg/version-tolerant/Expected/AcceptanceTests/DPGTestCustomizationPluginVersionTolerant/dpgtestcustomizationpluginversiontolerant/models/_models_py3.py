...
class Product(msrest.serialization.Model):
    ...
    :vartype received: str or ~dpgtestcustomizationpluginversiontolerant.models.ProductReceived
    """
    ...
    def __init__(self, *, received: Union[str, "_models.ProductReceived"], **kwargs):
        ...
        :paramtype received: str or ~dpgtestcustomizationpluginversiontolerant.models.ProductReceived
        """
...
class ProductResult(msrest.serialization.Model):
    ...
    :ivar values:
    :vartype values: list[~dpgtestcustomizationpluginversiontolerant.models.Product]
    :ivar next_link:
    ...
    def __init__(self, *, values: Optional[List["_models.Product"]] = None, next_link: Optional[str] = None, **kwargs):
        """
        :keyword values:
        :paramtype values: list[~dpgtestcustomizationpluginversiontolerant.models.Product]
        :keyword next_link:
