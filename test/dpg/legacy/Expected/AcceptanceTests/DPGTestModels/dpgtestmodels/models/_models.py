...
class Product(_serialization.Model):
    ...
    :vartype received: str or ~dpgtestmodels.models.ProductReceived
    """
    ...
    def __init__(self, **kwargs):
        ...
        :paramtype received: str or ~dpgtestmodels.models.ProductReceived
        """
...
class ProductResult(_serialization.Model):
    ...
    :ivar values:
    :vartype values: list[~dpgtestmodels.models.Product]
    :ivar next_link:
    ...
    def __init__(self, **kwargs):
        """
        :keyword values:
        :paramtype values: list[~dpgtestmodels.models.Product]
        :keyword next_link:
