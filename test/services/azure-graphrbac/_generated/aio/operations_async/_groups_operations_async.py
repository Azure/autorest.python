...
class GroupsOperations:
    ...
    async def is_member_of(self, group_id, member_id, cls=None, **kwargs):
    ...
    async def remove_member(self, group_object_id, member_object_id, cls=None, **kwargs):
    ...
    async def add_member(self, group_object_id, url, cls=None, **kwargs):
    ...
    async def create(self, display_name, mail_nickname, cls=None, **kwargs):
    ...
    async def get(self, object_id, cls=None, **kwargs):
    ...
    async def add_owner(self, object_id, url, cls=None, **kwargs):
    ...
    async def remove_owner(self, object_id, owner_object_id, cls=None, **kwargs):
