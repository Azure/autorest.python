...
class ServicePrincipalsOperations:
    ...
    async def update(self, object_id, parameters, cls=None, **kwargs):
    ...
    async def update_key_credentials(self, object_id, value, cls=None, **kwargs):
    ...
    async def update_password_credentials(self, object_id, value, cls=None, **kwargs):
