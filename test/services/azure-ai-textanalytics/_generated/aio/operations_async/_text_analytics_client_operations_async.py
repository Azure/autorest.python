...
class TextAnalyticsClientOperationsMixin:
    ...
    async def detect_language(self, show_stats=None, documents=None, cls=None, **kwargs):
    ...
    async def entities(self, show_stats=None, documents=None, cls=None, **kwargs):
    ...
    async def key_phrases(self, show_stats=None, documents=None, cls=None, **kwargs):
    ...
    async def sentiment(self, show_stats=None, documents=None, cls=None, **kwargs):
